 ...
 */
public class EcAuctionBuy extends BaseDomain implements Serializable {
	...
	private EcAuctionMain ecAuctionMain = new EcAuctionMain();
	...
	public EcAuctionMain getEcAuctionMain() {
		return ecAuctionMain;
	}

	public void setEcAuctionMain(EcAuctionMain ecAuctionMain) {
		this.ecAuctionMain = ecAuctionMain;
	}
}