 ...
 * @date 2014-11-12 19:13:15
 */
public class StatisticalDimensionData extends BaseDomain implements Serializable {
	...
	private Long loss_store_num;
	
	private Long add_store_num;
	
	private Long agent_num;
	
	private Long loss_agent_num;
	
	private Long ywy_num;
	
	private Long promoter_num;
	...
	private Long annual_settle_num;
	
	private Long settle_type_id;
	
	private Long annual_qdxt_order_num;
	
	private BigDecimal annual_qdxt_order_money;
	
	private BigDecimal annual_retail_money;
	
	private Long annual_retail_num;
	
	private Long retail_type_id;
	...
	public StatisticalDimensionData() {
	 ...
	 * @val 客户状态
	 */
	public void setShop_state(Long shop_state) {
	 ...
	 * @val 流失门店数
	 */
	public void setLoss_store_num(Long loss_store_num) {
	 ...
	 * @val 新增门店数
	 */
	public void setAdd_store_num(Long add_store_num) {
	 ...
	 * @val 流失网点数
	 */
	public void setLoss_agent_num(Long loss_agent_num) {
	 ...
	 * @val 业务员数
	 */
	public void setYwy_num(Long ywy_num) {
	 ...
	 * @val 促销员数
	 */
	public void setPromoter_num(Long promoter_num) {
	 ...
	 * @val 年度结算量
	 */
	public Long getAnnual_settle_num() {
	 ...
	 * @val 年度结算量
	 */
	public void setAnnual_settle_num(Long annual_settle_num) {
	 ...
	 * @val 结算额分类
	 */
	public void setSettle_type_id(Long settle_type_id) {
	 ...
	 * @val 年度渠道系统订单量
	 */
	public Long getAnnual_qdxt_order_num() {
	 ...
	 * @val 年度渠道系统订单量
	 */
	public void setAnnual_qdxt_order_num(Long annual_qdxt_order_num) {
	 ...
	 * @val 年度零售量
	 */
	public Long getAnnual_retail_num() {
	 ...
	 * @val 年度零售量
	 */
	public void setAnnual_retail_num(Long annual_retail_num) {
	 ...
	 * @val 零售额分类
	 */
	public void setRetail_type_id(Long retail_type_id) {
	 ...
	 * @val 回款额分类ID
	 */
	public Long getTurnover_type_id() {
	 ...
	 * @val 回款额分类ID
	 */
	public void setTurnover_type_id(Long turnover_type_id) {
	 ...
	 * @val 新增网点数
	 */
	public void setAdd_agent_num(Long add_agent_num) {
