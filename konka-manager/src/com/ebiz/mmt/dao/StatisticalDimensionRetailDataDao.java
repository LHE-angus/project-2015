 ...
 */
public interface StatisticalDimensionRetailDataDao extends EntityDao<StatisticalDimensionRetailData> {
	/**
	 ...
	 * 更新已经同步的数据 ---此处是将查询的无效数据更新为无效 2014-12-10
	 * 
	 * @return
	 */
	 ...
	 * 查询指定省份下各城市尺寸段数据
	 */
	List<HashMap> selectSizeOfCityList(StatisticalDimensionRetailData t);
	
	/**
	 * 根据城市ID，查询该城市下该年份，月份的销量前10机型
	 */
	List<HashMap> selectTop10CityList(StatisticalDimensionRetailData t);
	
	/**
	 * 根据城市id获取各机型销售数据
	 */
	List<HashMap> selectModleDataList(StatisticalDimensionRetailData t);
}
