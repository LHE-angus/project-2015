...
public class QuickPayQuery {
	...
	public String query(String transType, String orderNumber, String orderTime) {
		...
		return quickPayUtils.doPostQueryCmd(QuickPayConf.queryUrl, new QuickPayUtils().createBackStr(valueVo,
				QuickPayConf.queryVo));
	...
	public void merBusiness(String[] arr) {
		/**
		 * queryResult=0或者2时 respCode为00，其余情况下respCode为非全零的两位错误码 queryResult为空时报文格式错误 queryResult： 0：成功（响应码respCode为00）
