...
public class Column implements Serializable {
	...
	private String china_column_name;// 中文列名称
	...
	private Integer is_select;// 是否作为查询条件;0:否,1:是

	private Integer select_type;// 查询条件类型;1:数字,2:日期/时间,3:字符串,4:枚举

	private List<EnumEntity> enumEntityList;// 枚举类型的值列表
	...
	public String getChina_column_name() {
		return china_column_name;
	}

	public void setChina_column_name(String china_column_name) {
		this.china_column_name = china_column_name;
	}
	...
	public String toString() {
		...
		sb.append("'china_column_name':'").append(china_column_name).append("',");
		...
		sb.append("'is_select':'").append(is_select).append("',");
		sb.append("'select_type':'").append(select_type).append("'");
		sb.append("}");
		return sb.toString();
	}
}
