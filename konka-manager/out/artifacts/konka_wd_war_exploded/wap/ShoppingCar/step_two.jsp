...
<body> 
<div class="mainbox">
<div class="maincont"><!-- buy start -->
<html-el:form action="ShoppingCar">
...
<c:if test="${ecUser.map.web_type eq 2 }"><input type="hidden" name="pay_way" value="9" id="pay_way" /></c:if>
  <div style="width:100%;background-color:#ffffff;">
    ...
    <div style="margin-left:3px;padding: 3px;border: solid 1px #E6E6E6;"> 
      <table style="width:100%;"> 
          <tr height="26">
            ...
            <td width="" ><span class="modify_class_text" id="rel_name_txt"><c:out value="${ecUserAddrs.rel_name}" /></span><input id="rel_name" name="rel_name" type="text" maxlength="20" id="rel_name" class="input modify_class" value="${ecUserAddrs.rel_name}" style="width:100px;display:${empty ecUserAddrs.rel_name ? '' : 'none'};" /></td>
          </tr>
          <tr height="26">
   ...
   <div style="margin-top:5px;width:100%;background-color:#ffffff;"> 
    ...
    <div style="margin-top:5px;width:100%;background-color:#ffffff;"> 
	    ...
	    <div style="margin-left:3px;padding: 3px;border: solid 1px #E6E6E6;">
	      <table style="width:100%;"> 
	                <tr><td align="right" height="40" width="100"> 备注信息： </td><td align="left"><input name="logistic_sn" type="text" maxlength="80" id="logistic_sn" class="input modify_class" style="width:200px;height:20px;" /></td></tr> 
	     			<tr><td align="right" height="40" valign="top"><font color="red">*</font> 签字与验货： </td>
    ...
    <div style="margin-left:3px;padding: 3px;border: solid 1px #E6E6E6;">
      <table style="width:100%;border:1px;"> 
        <c:forEach items="${konkaBcompPdList}" var="cur">
	        <tr >
	          <td style="border-bottom:solid 1px #E6E6E6;" width="18%"><a href="<c:url value='/wap/PdShow.do?goods_id=${cur.id}' />" target="_blank">康佳${cur.pd_sn}</a></td>
  ...
  <div class="but_card">
    <ul><li><a href="<c:url value='/wap/ShoppingCar.do' />" id="step_one_go_shopping">返回购物车</a></li><li><a style="cursor:pointer;" id="step_two_btn">提交订单</a></li> </ul>
  </div> 
</html-el:form>
</div> 
</div> 
...
function checkExpress(){
	...
	$.ajax({
		type: "POST",
		url: "<c:url value='/wap/ShoppingCar.do' />",
...
function showDialog(){   
	 if(is_v==0){
		...
		$("#val_div").html("<font color='red'>验证支付密码...</font>");
	  	var url="<c:url value='/wap/ShoppingCar.do' />?method=checkPayPwd&time="+Math.random();  
	 	var str =window.showModalDialog(url,window,"dialogWidth=390px;dialogHeight=220px");   
	 	if (str == undefined) {  
	 		str = window.returnValue;  
	 	}  
	    if(str==1){
		  $("#val_div").html("<font color='red'>密码验证成功...正在获取购物券信息</font>"); //加载购物券			  
