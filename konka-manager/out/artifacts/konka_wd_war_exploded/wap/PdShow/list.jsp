...
<body> 
<form action="<c:url value='/wap/ShoppingCar.do' />" id="form_pd_buy" method="post">
...
<div class="mainbox">
   ...
   <div class="out2" style="margin-top:8px; background:#FFF;" onclick="location.href='${ctx}/wap/EcPdEavl.do?goods_id=${konkaBcompPd.id}';">
   ...
   <div class="out2" style="margin-top:8px; background:#FFF;" onclick="location.href='${ctx}/wap/PdContent.do?goods_id=${konkaBcompPd.id}&type=1';">
   ...
   <div class="out2" style="margin-top:8px; background:#FFF;" onclick="location.href='${ctx}/wap/PdContent.do?goods_id=${konkaBcompPd.id}&type=2';">
