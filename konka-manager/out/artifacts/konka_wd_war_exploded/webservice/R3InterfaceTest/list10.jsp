...
<body>
	<div class="oartop">
		<img src="${ctx}/styles/jxc/images/arrow3.gif" style="vertical-align: text-top;" /> 当前位置&gt;&gt;分公司库存(工厂库位物料)查询
	</div>
	<div>
		<div class="rtabcont1">
			<html-el:form action="/R3InterfaceTest.do" >
			<html-el:hidden property="method" value="list10" />
		...
		<div class="rtabcont1">
			<table width="100%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					...
					<th width="8%" nowrap="nowrap">物料机型</th>
					<th width="8%" nowrap="nowrap">工厂</th>
					<th width="8%" nowrap="nowrap">工厂名称</th>
					<th width="8%" nowrap="nowrap">库位</th>
					<th width="8%" nowrap="nowrap">库位名称</th>
					<th width="8%" nowrap="nowrap">非限制使用库存</th>
					<th width="8%" nowrap="nowrap">交货单锁定库存</th>
					<th width="8%" nowrap="nowrap">剩余量</th>
				</tr>
				  <c:forEach var="cur" items="${entityList}" varStatus="vs" >
				    <tr>
				      ...
				      <td align="center" nowrap="nowrap" >${cur.lgobe}</td>
				      <td align="center" nowrap="nowrap" >${cur.labst}</td>
				      <td align="center" nowrap="nowrap" >${cur.speme}</td>
				      <td align="center" nowrap="nowrap" >${cur.lamount}</td>
				    </tr>
				  </c:forEach>
			</table>
		</div>
