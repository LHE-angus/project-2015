...
<body>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="5" class="rtable1">
      	...
      	<tr>
      		<td width="18%" align="right" valign="top">客户类型：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top">客户细分类型：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top">产品属性：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top">产品系列：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top">规格尺寸：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top" height="35">日期：</td>
      	...
      	<tr>
      		<td width="18%" align="right" valign="top"  height="35">型号：</td>
      	...
      	<tr>
      		...
      		<td width="82%" align="left" colspan="2"><html-el:button styleId="btn_submit_search" property="btn_submit_search" styleClass="buttonSubSearch" value="搜索" /></td>
      	</tr>
      </table>
    </html-el:form>
