...
<div class="rtabcont1">
  <html-el:form action="/JnhmEntpSellDetailsAgentReport">
...
<c:url value="" var="expPara">
	...
	<div class="rtabcont1">
	<html-el:form action="/JnhmEntpSellDetailsAgentReport.do${expPara}">
...
<div class="rtabcont1">
    <div align="center" style="height:30px;font-size:20px;font-weight:bolder;">
      ${af.map.yyyy}年${af.map.mm}月${customer_name}销售机构出货信息汇总表</div>
