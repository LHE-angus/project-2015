...
<link rel=stylesheet type=text/css  href="${ctx}/styles/sfmall/css/togo.css" />
...
<div class="togo">
        ...
        <div class="tg_l">
          <div class="tg_left">
            <div class="tg_k">
              ...
              <div class="tg_cn"><a href="<c:url value='/sfmall/PshowOrderPanicBuying.do?method=add&goods_id=${cur.id}' />"><img src="${ctx}/styles/sfmall/images/qianggou.jpg" width="117" height="51" /></a></div>
              <div class="tg_down">
                <ul>
                  <li>原价<br>
          ...
          <div class="tg_right box_606_317">
            <table border="0" cellspacing="0" cellpadding="0" width="606">
              <tr>
                <td height="317" style="overflow:hidden;" width="606" valign="middle" align="center"><a href="<c:url value='/sfmall/PshowOrderPanicBuying.do?method=view&goods_id=${cur.id}' />">
  ...
  <div class="togo_right">
    ...
    <div class="togo_box_down">
      <ul>
      	<c:forEach items="${konkaPeArticleInfoList}" var="cur" varStatus="vs">
      		<li><a title="${cur.title}" href="<c:url value='/sfmall/KonkaGroupPeArticleInfo.do?method=view&id=${cur.id}' />">${fnx:abbreviate(cur.title, 2 * 18, '.')}</a></li>
    ...
    <c:if test="${not empty pd_list_cate5}">
      <div class="togo_box_down">
        <div class="title99"><a title="" href="<c:url value='/sfmall/PshowOrderPanicBuying.do?method=view&goods_id=${pd_list_cate5[0].id}' />" target="_blank">${fn:escapeXml(pd_list_cate5[0].pd_desc)}</a></div>
        <div class="pic99 box_270_202">
          <table border="0" cellspacing="0" cellpadding="0" width="270">
            <tr>
              <td height="202" style="overflow:hidden;" width="270" valign="middle" align="center"><a title="" href="<c:url value='/sfmall/PshowOrderPanicBuying.do?method=view&goods_id=${pd_list_cate5[0].id}' />" target="_blank">
        ...
        <div class="buy99">
          <div class="n-tg"><span class="tg-mg1"><a title="查看详情" href="<c:url value='/sfmall/PshowOrderPanicBuying.do?method=view&goods_id=${pd_list_cate5[0].id}' />" target="_blank"> </a></span> </div>
