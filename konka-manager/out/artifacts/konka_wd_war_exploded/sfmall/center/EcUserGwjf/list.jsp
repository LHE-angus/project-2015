...
<div class="maincont">
  ...
  <div class="sfmall_right padbot45">
    <div class="position"><a href="${ctx }/sfmall/Index.do">首页</a> &gt; <a href="${ctx }/sfmall/center/Index.do">会员中心</a> &gt; <a href="${ctx }/sfmall/center/EcUserScoreRec.do">我的积分</a></div>
        ...
        <tbody>
          <c:forEach var="cur" items="${orderDetailList}" varStatus="vs">
           <tr>
              ...
              <td align="center" nowrap="nowrap"> <fmt:formatNumber value="${cur.map.pay_price}" pattern="#,##0" /> </td>
              <td align="left" nowrap="nowrap"><fmt:formatNumber value="${cur.integral}" pattern="#,##0" /></td>
            </tr>
          </c:forEach>
          </tbody>
        </table>
