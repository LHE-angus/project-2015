...
<div class="maincont margintop10">
  ...
  <div class="listright-news">
    <div class="position"><a href="<c:url value='/sfmall/Index.do' />">首页</a> <c:if test="${not empty af.map.article_type_id}">&gt; <a href="<c:url value='/sfmall/KonkaGroupPeArticleInfo.do' />?article_type_id=${af.map.article_type_id}"><c:if test="${empty af.map.article_type_id}">新闻资讯</c:if>
