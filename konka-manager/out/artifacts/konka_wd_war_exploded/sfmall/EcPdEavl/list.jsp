...
<link rel=stylesheet type=text/css  href="${ctx}/styles/sfmall/css/ping.css" /> 
...
<div class="Wrap_ProComment" style="display: block; ">
  ...
  <div class="CommentForm" style="margin-top:10px;">
    <h5>发表评论并打分：</h5>
    <form action="${ctx }/sfmall/EcPdEavl.do?method=save" method="post">
...
$(document).ready(function(){
	...
	//$("#content").attr("dataType", "Require").attr("msg", "请填写总结！"); 
