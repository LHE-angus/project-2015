...
<div id="img_show">
    ...
    <div class="small_imgs">
    	...
    	<ul>
        	<li>
        		<a href="${ctx}/${fn:substringBefore(af.map.main_pic_file, '.')}_800.jpg" class="cloudzoom-gallery" title="" data-mimg ="${ctx}/${fn:substringBefore(af.map.main_pic_file, '.')}_350.jpg" data-bimg="${ctx}/${fn:substringBefore(af.map.main_pic_file, '.')}_800.jpg">
        			<img src="${ctx}/${fn:substringBefore(af.map.main_pic_file, '.')}_120.jpg" alt="" width="60" height="60" />
        		</a>
        	</li>
        	<c:if test="${not empty picList}">
	        	<c:forEach items="${picList}" var="cur" varStatus="vs">
		            <li>
		            	<a href="${ctx}/${fn:substringBefore(cur, '.')}_800.jpg" class="cloudzoom-gallery" title="" data-mimg ="${ctx}/${fn:substringBefore(cur, '.')}_350.jpg" data-bimg="${ctx}/${fn:substringBefore(cur, '.')}_800.jpg">
		            		<img src="${ctx}/${fn:substringBefore(cur, '.')}_120.jpg" alt="" width="60" height="60" />
		            	</a>
		            </li>
	        	</c:forEach>
        	</c:if>
