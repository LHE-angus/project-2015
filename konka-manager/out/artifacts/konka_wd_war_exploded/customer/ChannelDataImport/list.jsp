...
<div class="oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/manager/ChannelDataImport.do">
      ...
      <table width="100%" border="0" cellpadding="0" class="rtable1">
          ...
          <td>
          	<html-el:text property="s_date" styleId="s_date" size="10" maxlength="10" readonly="true" styleClass="webinput"  onclick="new Calendar(2011, 2031, 0).show(this);"  ></html-el:text>
                                至
            <html-el:text property="e_date" styleId="e_date" size="10"  maxlength="10" readonly="true" styleClass="webinput"  onclick="new Calendar(2011, 2031, 0).show(this);" ></html-el:text>
          </td>
          <td>
          	<strong class="fb">凭证日期:</strong>
          </td>
          <td colspan="4">
            <html-el:text property="startDate1" styleId="startDate1" size="10" maxlength="10" readonly="true" styleClass="webinput"  onclick="new Calendar(2011, 2031, 0).show(this);"  ></html-el:text>
		           至
		    <html-el:text property="endDate1" styleId="endDate1" size="10"  maxlength="10" readonly="true" styleClass="webinput"  onclick="new Calendar(2011, 2031, 0).show(this);" ></html-el:text>
          </td>
          <td>
        ...
        <tr>
	        ...
	        <td>
	        	<html-el:submit styleClass="but1" value=" " />
	        </td>
        </tr>
      </table>
    </html-el:form>
...
<!--    <input type="button" id="export_excel" value="导出数据" style="cursor: pointer;"></input>-->
<!--   	<input type="button" style="cursor: pointer;" id="syncBtn" value="同步30天数据"></input>&nbsp;&nbsp;-->
<!--   	<input type="button" style="cursor: pointer;" id="syncBtnAll" value="同步所有数据"></input>&nbsp;&nbsp;-->
...
<%--           <td align="center" nowrap="nowrap">${cur.column_2}</td> --%>
...
<!--         <td align="center" nowrap="nowrap">分类描述</td> -->
        ...
        <td align="center" nowrap="nowrap">机型</td>
        <td align="center" nowrap="nowrap">订单数量</td>
        <td align="center" nowrap="nowrap">已交货数量</td>
        <td align="center" nowrap="nowrap">单价（含税）</td>
        <td align="center" nowrap="nowrap">总金额（含税）</td>
<!--         <td align="center" nowrap="nowrap">交货单数量</td> -->
<!--         <td align="center" nowrap="nowrap">已发货数量</td> -->
...
$(document).ready(function(){
	...
	$("#syncBtn").click(function(){
		...
		var isExecute = doSyncMethod("我们强烈建议订单明细数据同步交由系统自动完成,你仍然坚持使用手工同步的方式来更新订单明细信息吗?", 'ChannelDataImport.do','ZbSync' ,$('#bottomPageForm').serialize());
		if( isExecute == true){
	...
	$("#syncBtnAll").click(function(){
			...
			var isExecute = doSyncMethod("此操作用于重置数据,执行后所有订单数据会被清空,然后同步所有数据,确认操作?", 'ChannelDataImport.do','ZbSync','&resetflag=true' ,$('#bottomPageForm').serialize());
			if( isExecute == true){
				$("#syncBtn").attr("disabled","disabled");
				$("#syncBtnAll").attr("disabled","disabled");
				$("font").text("数据同步中,请勿刷新页面!").css("color","red");
