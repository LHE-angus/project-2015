...
<div style="width:100%;margin-top:5px;">
  <html-el:form action="/manager/JxcKonkaOrderRegister" enctype="multipart/form-data" method="post">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
							<td class="ti" ><font color="red">*</font>退货类型：</td>
							<td >
						...
						<tr>
							<td class="ti"><font color="red" id="red_return_remark"></font>原因说明：</td>
							<td >
...
<!--        （<span id="btn_check" style="text-decoration:underline;cursor:pointer;color:#F00;">点击检查库存</span>）&nbsp;&nbsp;&nbsp;-->
        <span style="cursor:pointer;display:none;" title="添加" onclick="getPePdModel();"><img src="${ctx}/styles/jxc/images/+.gif" style="vertical-align:text-bottom;"/></span>
        <input class="but1" type="button" name="reset" value=" &lt;&lt;返回重新选择产品 " onclick="location.href='JxcKonkaOrderRegister.do?method=listTHpdselect&pd_ids=${af.map.pd_ids}';" /></td>
      </tr>
      <tr>
   ...
   <%-- <tr>
      ...
      <tr>
        ...
        <td><html-el:select property="doc_type" styleId="doc_type">
          ...
          <span style="color:#ccc;" id="ZFOR_info">备注：退货订单！</span> 
          </td>
      </tr>
      ...
      <tr>
							<td align="left" class="ti">退货原因</td>
							<td >
