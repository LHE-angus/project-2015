...
<div style="width:100%">
	<div class="oartop">
  	...
  	<div class="rtabcont1">
	  	...
	  	<html-el:form action="/manager/JxcKonkaOrderRegister" enctype="multipart/form-data">
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
		        ...
		        <tr>
		        	...
		        	<td colspan="3"><label for="pay_type_1"><input type="checkbox" name="pay_type" id="pay_type_1" />现汇</label>
		        	<label for="pay_type_2"><input type="checkbox" name="pay_type" id="pay_type_2" />帐期</label>
		        	<label for="pay_type_3"><input type="checkbox" name="pay_type" id="pay_type_3" />承兑</label>
		        	</td>
		          <td></td>
		        </tr>
