...
<div style="width:100%">
  ...
  <div class="rtabcont1">
    <html-el:form action="/manager/JxcKonkaOrderRegister">
      <html-el:hidden property="method" value="save" styleId="method"/>
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <input type="hidden" name="cust_id" id="cust_id" value="${af.map.cust_id}" />
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
        ...
        <tr> 
          ...
          <td colspan="3"><span><font color="red">${af.map.tradeIndex}</font></span></td>
        </tr>
        <tr>
          <td class="title_item" width="15%"><font color="red">*</font>订单日期：</td>
          <td width="35%"><html-el:text property="order_date" styleId="order_date" size="10" maxlength="9" readonly="true" styleClass="webinput" value="${af.map.today}"/></td>
          <td class="title_item" width="15%"><font color="red">*</font>配送方式：</td>
          <td><label for="send_type_1"><html-el:radio property="send_type" styleId="send_type_1" value="1" /> 自提</label>
		      <label for="send_type_2"><html-el:radio property="send_type" styleId="send_type_2" value="2" /> 配送</label></td>
        </tr>
        <tr>
          <td class="title_item"><font color="red">*</font>货款支付方式：</td>
          <td colspan="3"><label for="pay_type_4"><html-el:radio property="pay_type" styleId="pay_type_4" value="4" /> 现汇</label>
		          ...
		          <span style="color:#ccc;margin-left:5em;">使用银行提供的承兑支票支付货款</span></td>
        </tr>
        ...
        <tr>
          <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
              ...
              <tr id="trHidden" style="display:none;">
                ...
                <td align="center"><span id="good_sum_price">0.00</span>
                ...
                <td align="center"><span id="good_discount_price">0.00</span>
...
/*处理返回值数据 ===start===*/
	...
	function getProInfo(){
	    ...
	    pd_id_array = returnValue.ids.split(",");
	    md_name_array = returnValue.names.split(",");
