	...
	<tr>
		<td width="60%" valign="top" >
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
				<tr>
					<th align="center" nowrap="nowrap">客户</th>
					<th align="center" nowrap="nowrap" width="10%">级别</th>
					<th align="center" nowrap="nowrap" width="10%">销售数量</th>
					<th align="center" nowrap="nowrap" width="18%">收入</th>
					<th align="center" nowrap="nowrap" width="18%">成本</th>
					<th align="center" nowrap="nowrap" width="18%">利润</th>
				</tr>
				...
				<tr>
					<td align="left"><a href="JxcXsReport.do?method=list_xs&mod_id=${af.map.mod_id}&flag_type=${af.map.flag_type}&partner_id=${cur[0]}&st_date=${af.map.st_date}&en_date=${af.map.en_date}" style="color:#0072bc;">
					<c:if test="${(empty cur[1]) && (not empty shop_name)}">${shop_name}</c:if>
					${cur[1]}</a></td>
					<td align="right"><c:if test="${empty cur[6]}">顶</c:if>${cur[6]}级</td>
...
if(${not empty entityList}){
   ...
   chart.setDataURL("${ctx}/customer/manager/JxcXsReport.do?method=xs_store_chart");		
