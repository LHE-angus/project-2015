	...
	<tr>
		<td width="50%" valign="top" >
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
				<tr>
					<th align="center" width="20%">客户</th>
				...
				<tr>
					<td align="left"><a href="JxcXsReport.do?method=list_xs&mod_id=${af.map.mod_id}&flag_type=${af.map.flag_type}&partner_id=${cur[0]}&st_date=${af.map.st_date}&en_date=${af.map.en_date}" style="color:#0072bc;">${cur[1]}</a></td>
...
if(${not empty entityList}){
   ...
   chart.setDataURL("${ctx}/customer/manager/JxcXsReport.do?method=xs_partner_chart");		
