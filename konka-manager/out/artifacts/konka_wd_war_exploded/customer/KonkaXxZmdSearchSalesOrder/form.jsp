...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/manager/KonkaXxZmdSearchSalesOrder">
      ...
      <html-el:hidden property="sell_bill_id" styleId="sell_bill_id" value="${af.map.sell_bill_id}" />
      <html-el:hidden property="mod_id" styleId="mod_id" />
      <html-el:hidden property="method" styleId="method" value="jfSave" />
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td width="88%" align="left"><html-el:text property="scorts" size="8" maxlength="8" styleId="scorts" />
            &nbsp;<span>注：正数表示增加积分，负数表示减少积分</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="88%" align="left"><html-el:text property="remark" size="120" maxlength="120" styleId="remark" />
            &nbsp;<span id="jf_value_desc" class="note"></span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
