...
<font class="inf">注册会员身份验证</font> 
  ...
  <div class="login_int1"><label><span><i class="lg_redStar">&nbsp;*&nbsp;</i>姓名：</span><html-el:text property="member_name" styleClass="reUser_text" styleId="member_name" maxlength="15" /></label></div>
