...
<!-- buy start -->
<form action="<c:url value='/member/Auction.do' />" method="post" id="step_two_form">
...
<div class="card_center">
  ...
  <div class="card_b">
    <div class="card_dd">
      <ul><li>1、我的购物车</li><li><b>2、确认订单信息</b></li><li>3、提交订单</li></ul>
    </div>
  </div>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="mytable" width="80%" >
        <tbody>
          ...
          <tr>
            ...
            <td><select name="province" id="province" class="bd" >
                <option value="">-请选择省/直辖市/自治区-</option>
              </select>
              <select name="city" id="city" class="bd">
                <option value="">-请选择市-</option>
              </select><select name="p_index1" id="p_index1" onchange="checkExpress();" class="input_txt" style="width:100px;">
            ...
            <td><ul>
                <table border="0"> 
                    <tr> 
                      ...
                      <td align="left" valign="middle"><label class="bank--bank_card" for="pay_way_6" style="cursor:pointer;">民生e支付 </label>&nbsp;&nbsp;<div style="margin-top:0px;width:550px;">&nbsp;&nbsp;即时到账，支持绝大数银行借记卡和部分银行信用卡&nbsp;&nbsp;<a href="${ctx}/member/KonkaGroupPeArticleInfo.do?method=view&id=837917" style="color: #08C;">查看银行及限额</a></div></td>
                     </tr> 
                </table>
              </ul> 
              </td>
                ...
                <table border="0">
                   <tr>
                      ...
                      <td align="left" valign="middle" colspan="5"><label for="pay_way_1" style="cursor:pointer;">户名：康佳集团股份有限公司
						帐号：744557963343
						开户行：中国银行深圳沙河支行   （银行转账时请备注：康佳epp内购平台购机款 ,收款人手机:18207556878）</label>
						</td>
                     </tr> 
                </table>
              </ul> 
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input id="deliver_way_0" type="radio" name="deliver_way" value="0" checked="checked"/>
                        <label for="deliver_way_0"  style="cursor:pointer;">否 <span style="color: red;margin-left:10px; ">上门安装普通挂架/底座需要另外收费，具体费用请拨打400-880-0016咨询<a href="${ctx}/member/KonkaGroupPeArticleInfo.do?method=view&id=838940" style="color: #08C;">（参考费用）</a></span></label></td>  
                    </tr>
                  </tbody>
                </table>
              </ul></td>
...
<div class="login_div" id="login_div" style="display:none;z-index:10000;position:absolute;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable3">
      <tbody>
	    ...
	    <tr>
	      <td style="border-bottom:solid 1px #E6E6E6;">${goods_id}</td>
	      <td style="border-bottom:solid 1px #E6E6E6;">${goods_name}</td>
	      <td style="border-bottom:solid 1px #E6E6E6;">1</td>
	      <td style="border-bottom:solid 1px #E6E6E6;">￥<fmt:formatNumber value="${goods_price}" pattern="#,#00" /></td>
	      <td style="border-bottom:solid 1px #E6E6E6;">无 </td>
	      <td style="border-bottom:solid 1px #E6E6E6;">无 </td>
	      <td valign="middle" style="text-align:left;border-bottom:solid 1px #E6E6E6;">没有选择增值服务 </td>
	    </tr> 
      </tbody>
    </table> 
  </div>
...
$(document).ready(function(){
	...
	$("#city").attr({"subElement": "p_index1", "defaultText": "-请选择市-", "defaultValue": "", "selectedValue": "${city}","datatype": "Require", "msg": "请选择市名称！"});
