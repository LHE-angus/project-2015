...
<div class="viewleft1">
  <div class="changeBox_a1">
    <div id="img_show">
      <div class="middle_img box_350_350"><img src="${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_350.jpg" data-cloudzoom="'zoomImage': '${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_800.jpg', 'zoomPosition':'inside'" id="zoom1" class="cloudzoom" width="350" style="max-height:350px;" /> </div>
      <div class="small_imgs">
        <div class="small_imgs_fixed">
          <ul>
            <li> <a href="${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_800.jpg" class="cloudzoom-gallery" title="" data-mimg ="${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_350.jpg" data-bimg="${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_800.jpg"> <img src="${ctx}/${fn:substringBefore(ecGift.main_pic, '.')}_120.jpg" alt="" width="60" height="60" /> </a> </li>
            <c:if test="${not empty picList}">
              <c:forEach items="${picList}" var="cur" varStatus="vs" begin="1">
                <li> <a href="${ctx}/${fn:substringBefore(cur, '.')}_800.jpg" class="cloudzoom-gallery" title="" data-mimg ="${ctx}/${fn:substringBefore(cur, '.')}_350.jpg" data-bimg="${ctx}/${fn:substringBefore(cur, '.')}_800.jpg"> <img src="${ctx}/${fn:substringBefore(cur, '.')}_120.jpg" alt="" width="60" height="60" /> </a> </li>
              </c:forEach>
            </c:if>
          </ul>
        </div>
