...
<!-- buy start -->
<form action="<c:url value='/member/EcGroupBuy.do' />" method="post" id="step_two_form">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <span class="modify_class">用于接收验证码等重要信息，请认真填写</span></td>
          </tr>
        </tbody>
      </table>
    </div>
...
$(document).ready(function(){
	...
	$("#rel_phone").attr("datatype", "Mobile").attr("msg", "请填写有效的手机号码！");   
