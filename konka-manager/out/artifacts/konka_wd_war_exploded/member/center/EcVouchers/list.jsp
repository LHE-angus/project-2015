...
<div class="maincont">
  ...
  <div class="member_right padbot45">
    <div class="position"><a href="${ctx }/member/Index.do">首页</a> &gt; <a href="${ctx }/member/center/Index.do">会员中心</a> &gt; 购物券兑换</div>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="member_form_table1">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr height="30">
              ...
              <td align="center" nowrap="nowrap"><a href="${ctx}/member/center/EcVouchers.do?method=add&id=${cur.id}">兑换</a></td>
            </tr>
          </c:forEach>
