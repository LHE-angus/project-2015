...
<body><div class="top_class"><span class="lspan"><a href="javascript:void(0);history.back();"><img src="${ctx}/styles/epp/mobile/images/return.gif" /></a></span><h3>商品评价</h3><a href="javascript:void(0);showNav();" id="btnJdkey" class="new-a-jd"><span>开心猫</span></a>
...
<div class="maincont">
    ...
    <div class="Nodata">
      <div class="tabbtn">
        <ul>
          ...
          <li class="${af.map.eavl eq '1' ? 'current':'' }" style="width:70px;"><a href="EcPdEavl.do?method=list&goods_id=${af.map.goods_id }&eavl=1" >好评(${eval_score_a})</a></li>
          <li class="${af.map.eavl eq '2' ? 'current':'' }" style="width:70px;"><a href="EcPdEavl.do?method=list&goods_id=${af.map.goods_id }&eavl=2" style="width:60px;">中评(${eval_score_b})</a></li>
          <li class="${af.map.eavl eq '3' ? 'current':'' }" style="width:70px;"><a href="EcPdEavl.do?method=list&goods_id=${af.map.goods_id }&eavl=3" style="width:60px;">差评(${eval_score_c})</a></li>
        </ul>
      </div>
  ...
  <div class="CommentForm" style="margin-top:10px;">
    <h5>发表评论并打分：</h5><form action="${ctx }/epp/mobile/EcPdEavl.do?method=save" method="post"> <input type="hidden"  name="goods_id" value="${af.map.goods_id }"/>
