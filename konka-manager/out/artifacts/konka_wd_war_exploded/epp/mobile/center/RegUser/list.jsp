...
<body><div class="top_class"><span class="lspan"><a href="javascript:void(0);history.back();"><img src="${ctx}/styles/epp/mobile/images/return.gif" /></a></span><h3>会员注册</h3><a href="javascript:void(0);showNav();" id="btnJdkey" class="new-a-jd"><span>开心猫</span></a>
...
<div class="membertab3" id="div_info">
     <p style="margin-left:10px;font-size:16px;line-height:26px;"> 
     	 您好， 欢迎您初次登陆康佳EPP内部优惠购机平台!
     </p>
     <p style="margin-left:15px;margin-top:15px;font-size:14px;color:red;line-height:26px; "> 
     	  为了保障您的权益，请认证阅读会员规则、会员权益、积分规则和佣金规则，并同意《康佳EPP内部优惠购机平台网站用户协议》,并完善您的基本信息
     </p>
     <div style="margin-left:5px;margin-top:15px;font-size:14px;line-height:26px;"> 
		<div> 
			<div style="overflow-y:auto; text-align:left;padding:5px;width:300px;height:400px;font-size:12px;background-color:#cccccc;"> 
			<div style="text-align:center;font-size:14px;"><b>康佳EPP内部优惠购机平台网站用户协议</b>
			<p>请仔细阅读本协议</p></div>
     ...
     <div style="margin-left:100px;margin-top:15px;width:200px;"  > 
...
$(document).ready(function(){ 
	$("#xycheck").click(function(){
		if(confirm("确定同意上述协议吗！")){
		 window.location.href="${ctx}/epp/mobile/center/RegUser.do?method=add";
		}
	});
});                                         
