...
$(document).ready(function(){
	$.ajax({//ajax 取记录数：
		type: "POST",
		url: "OaFileSearch.do",
		data: "method=getCount2&username="+getQueryString("username")+"&userpass="+getQueryString("userpass"),
		dataType: "text",
...
function goback(page,username,userpass) {
	if(goPage(null,page,-1,5)){
		window.location.href="OaFileSearch.do?"+"method=list2&username="+getQueryString("username")+"&userpass="+getQueryString("userpass")+"&page="+page+"&forward=-1";
	}
}
