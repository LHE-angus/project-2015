  ...
  <div class="content-primary">
    <form id="iForm" name="iForm">
      ...
      <div data-role="fieldcontain">
        ...
        <input type="text" name="apply_user_name" id="apply_user_name" maxlength="50" style="width:150px;"/>
        <label for="apply_user_tel">电　　话：</label>
        <input type="text" name="apply_user_tel" id="apply_user_tel" maxlength="20"  style="width:130px;" onkeyup="javascript:setOnlyNum(this);"/>
        <label for="file_title">标　　题：</label>
        <input type="text" name="file_title" id="file_title" maxlength="100"  style="width:200px;"/>
        <label for="audit_user_name">审&nbsp;&nbsp;批&nbsp;&nbsp;人:</label>
        <input type="text" name="audit_user_name" id="audit_user_name" maxlength="50" style="width:150px;"/>
        <label for="content">请示内容：</label>
        <textarea cols="35" rows="8" name="content" id="content"></textarea>
      </div>
    </form>
  </div>
  <div data-role="footer" class="ui-bar" data-position="fixed">
    <div data-role="controlgroup"  data-type="horizontal"> <a id="submitBtn" data-role="button" data-icon="plus" data-theme="b" data-inline="true">提交</a> </div>
  </div>
