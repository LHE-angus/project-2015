...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/jf/JfSearch">
  ...
  <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'JfSearch.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看明细</span></td>
          </tr>
        </c:forEach>
    ...
    <br />
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="JfSearch.do">
