...
#timetb {width:262px;border: 0px solid #CCCCCC;}
#timetb td {border: 0px solid #E3E3E3;}

#timeList {width:262px;}
  ...
  <div class="oartop">
    <table width="400" border="0" cellpadding="0" cellspacing="0">
      ...
      <html-el:form action="/ywygps/KonkaYwyMobileSetPlan">
        ...
        <html-el:hidden property="fs_id" value="${af.map.s_id}"/>    
        <html-el:hidden property="p_id" value="${af.map.p_id}"/>
        <html-el:hidden property="s_id" value="${af.map.s_id}"/>
        <html-el:hidden property="s_version" value="${af.map.version}"/>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
          ...
          <tr>
            ...
            <td>
                 ...
                 &nbsp;<input name="chkAll" type="checkbox" id="chkAll1" value="-1" onclick="checkAll(this,'dayList');" />&nbsp;<label for="chkAll1">全选</label>      
            </td>
          </tr>
          <tr>
                        ...
                        <table border="0">
                          <tbody id="timeList">
                           <tr>
                             ...
                             <td align="center" nowrap="nowrap" width="60" style="border-bottom:1px solid #E3E3E3;">操作</td>
                           </tr> 
                           <tr id="tr_0">
                             ...
                             <td><a href="javascript:void(0);" style="cursor:pointer;color:blue;" onclick="deleteTimeElement('timeList',0);" >删除</a></td>
                           </tr>
                           </tbody>   
                        </table>
                        <span style="cursor:pointer;color:blue;padding-top:3px;" onclick="addTimeElement('timeList','');" >&nbsp;新增</span>
                     </td>
                   </tr>
                 </table>
                 <br/> 
          ...
          <tr>
              <td width="18%" height="30" align="right">定位信息发送方式：</td>
              <td>
                <html-el:select property="gps_sendType" styleId="gps_sendType">
                  <html-el:option value="0">手动</html-el:option>
                  <html-el:option value="1">自动</html-el:option>
                </html-el:select>
               </td>
          </tr>
           <tr>
            ...
            <td>
                 <c:if test="${not empty af.map.id}">
                   ...
                   &nbsp;<input name="chkAll" type="checkbox" id="chkAll3" value="-1" onclick="checkAll(this,'noList');" /><label for="chkAll3">&nbsp;全选</label>    
                 </c:if>
                 <br/>               
                 <html-el:textarea property="add_nos" styleId="add_nos" cols="40" rows="3" style="width:300px;"/>
                 <br/>
                 &nbsp;*添加多个手机号，请用“,”隔开
                 <br/><br/>
            </td>
...
function addTimeElement(tb_id,times_str){
	if(timecount > 4){alert("发送时间段不能超过5个！");return;}
    ...
    td3.innerHTML = "<a href=\"javascript:void(0);\" style=\"cursor:pointer;color:blue;\" onclick=\"deleteTimeElement('"+tb_id+"',"+timeListCount+");\" >删除</a>";
