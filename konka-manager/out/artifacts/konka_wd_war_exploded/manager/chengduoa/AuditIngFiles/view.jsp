...
<div style="width:100%;background:white;">
  <html-el:form action="/chengduoa/AuditFiles">
    ...
    <table id="table_footer" width="95%" align="center" class="list" style="margin-top:3px;" align="center">
      <tr>
        <td align="center"><html-el:button property="" value="关 闭" styleClass="but5" styleId="btn_back" onclick="window.close();" />
          <html-el:button property="" value="打 印" styleClass="but4" styleId="btn_print" onclick="alert('请在浏览器中进行打印页面设置，将页眉页脚去掉，可以获得更好的打印效果。');$('#table_footer').hide();window.print();$('#table_footer').show();" /></td>
      </tr>
    </table>
  </html-el:form>
</div>
