...
<div class="oarcont" id="body_oarcont">
  <div class="rtabcont1">
      <html-el:form action="/chengduoa/Dialog">
        ...
        <html-el:hidden property="selectedIds" styleId="selectedIds" />
        ...
        <table width="100%" border="0" align="left" class="list">
          <tr>
            <td>&nbsp;&nbsp;搜索：<html-el:text property="key_word" styleId="key_word" size="24" maxlength="50" style="width:140px;" /></td>
            <c:if test="${not empty konkadeptList}">
	            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;部门
	              <html-el:select property="role_id" styleId="role_id" style="width:200px;align:right;" onchange="getQueryUserNames($('#key_word').val(),$('#role_id').val());">
          ...
          <tr>
            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>&nbsp;&nbsp;<html-el:select property="select1" multiple="true" style="width:235px;height:235px;" styleId="select1" onchange="moveSelected(this.form.select1, this.form.select2);">
                      <c:if test="${not empty entityList}">
                        <html-el:optionsCollection label="map.department" value="id"  name="entityList" />
                      </c:if>
                    </html-el:select></td>
                  <td><html-el:select property="select2" multiple="true" style="width:235px;height:235px;" styleId="select2" onchange="moveSelected(this.form.select2, this.form.select1);">
...
function getQueryUserNames(key_word, role_id) {
   	...
   	$.ajax({
		...
		data: "method=" + "getQueryUserNames" + "&key_word=" + $("#key_word").val() + "&role_id=" + $("#role_id").val()+ "&selectedUsersID=" + getSelect2Value(),
		dataType: "json",
