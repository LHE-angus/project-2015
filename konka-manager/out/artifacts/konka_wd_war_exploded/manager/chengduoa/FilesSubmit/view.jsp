...
<div class="oarcont">
  ...
  <div>
    <h3 align="center" ><strong class="fb">文件查看</strong></h3>
  </div>
  ...
  <div class="rtabcont2">
    <html-el:form >
      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr>
          <td  align="center" nowrap="nowrap" class="td_bord">申请负责人</td>
          <td>${fn:escapeXml(af.map.apply_user_name)}&nbsp;</td>
          <td  align="center" class="td_bord" nowrap="nowrap">电　　话</td>
          <td >${fn:escapeXml(af.map.apply_user_tel)}&nbsp;</td>
          <td align="center" class="td_bord" nowrap="nowrap">编　　号</td>
          <td >${fn:escapeXml(af.map.file_no)}&nbsp;</td>
        </tr>
        <tr>
          <td align="center" class="td_bord" nowrap="nowrap">标　　题</td>
          <td colspan="3" nowrap="nowrap">${fn:escapeXml(af.map.file_title)}</td>
        ...
        <tr>
          <td align="center" class="td_bord" nowrap="nowrap">提 案 人</td>
          <td>${af.map.submit_user}</td>
          <td align="center" class="td_bord" nowrap="nowrap">提案时间</td>
          <td nowrap="nowrap"><fmt:formatDate value="${af.map.submit_datetime}" pattern="yyyy-MM-dd HH:mm" /></td>
          <td align="center" class="td_bord" nowrap="nowrap">类　　别</td>
          <td>${lb_name}</td>
        </tr>
        <tr>
          <td align="center" class="td_bord" nowrap="nowrap">审 批 人</td>
          <td>
	          <div id="audits">
        ...
        <tr>
          <td align="center" class="td_bord" nowrap="nowrap">是否下发</td>
          <td nowrap="nowrap" colspan="5"><c:if test="${af.map.is_forward eq 0}">否</c:if>
        ...
        <tr style="display:${display};">
          <td nowrap="nowrap" align="center" class="td_bord">下发用户</td>
          <td nowrap="nowrap" colspan="5">${af.map.fa_names} </td>
        </tr>
        <tr style="display:${display};">
          <td nowrap="nowrap" align="center" class="td_bord">下发部门</td>
          <td nowrap="nowrap" colspan="5">${af.map.dept_names} </td>
        </tr>
      </table>
         ...
         <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          ...
          <c:set var="begin_time" value="${af.map.submit_datetime}" />
	          <c:forEach var="cur" items="${filesAuditNodeList}" varStatus="vs">
	            ...
	            <tr>
	              <td align="center" nowrap="nowrap">${audit_result}</td>
	              ...
	              <td nowrap="nowrap">${cur.audit_user}</td>
	            </tr>
	          </c:forEach>
        </table>
      </c:if>
