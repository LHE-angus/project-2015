...
<html-el:form action="/leader/JcfxReportKczzfx">
	<div class="rtabcont1">
	<html-el:hidden property="method" value="view3" />
	 <html-el:hidden property="mod_id"	value="${af.map.mod_id}" />
	  ...
	  <html-el:hidden property="type" styleId="type" value="${af.map.type}" />
	   ...
	   <html-el:hidden property="year" styleId="year" value="${af.map.year}" />
	   <html-el:hidden property="month" styleId="month" value="${af.map.month}" />
		<c:if test="${not empty is_bi}">
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
	<tr class="tabtt1">
		<td nowrap="nowrap" width="150px;" align="left" colspan="10" style="color: red;">${custmsg}</td><td  nowrap="nowrap" width="150px;" align="right"  colspan="16">单位：万元</td>
	</tr>
	 <tr class="tabtt1">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <td align="right" nowrap="nowrap"><fmt:formatNumber value="${cur.init_money + cur.come_money - cur.sale_cost}" pattern="0" /></td>
