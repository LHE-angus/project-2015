...
<table class="table table-striped table-bordered table-hover"
	...
	<tr>
		<td align="center" width="70" rowspan="2">部门</td>
		<td align="center" rowspan="2">目标销售额</td>
		<td align="center" rowspan="2">实际销售额</td>
		<td align="center" rowspan="2">同期销售额</td>
		<td align="center" rowspan="2">完成率</td>
		<td align="center" rowspan="2" width="80">增长率</td>
		<td align="center" rowspan="2">累计目标额</td>
		<td align="center" rowspan="2">累计销售额</td>
		<td align="center" rowspan="2">累计完成率</td>
	...
	<c:forEach items="${fgsList}" var="cur" varStatus="vs">
		...
		<c:set var="s_month_settle_money_gm"
			value="${s_month_settle_money_gm + cur.map.month_settle_money_gm}"></c:set>
		<c:set var="s_month_settle_money_sn"
			value="${s_month_settle_money_sn + cur.map.month_settle_money_sn}"></c:set>
		<c:set var="s_month_settle_money_qtls"
			value="${s_month_settle_money_qtls + cur.map.month_settle_money_qtls}"></c:set>
		<c:set var="s_month_settle_money_csqd"
			value="${s_month_settle_money_csqd + cur.map.month_settle_money_csqd}"></c:set>
		<c:set var="s_month_settle_money_cskh"
			value="${s_month_settle_money_cskh + cur.map.month_settle_money_cskh}"></c:set>
		<c:set var="s_month_settle_money_xxkh"
			value="${s_month_settle_money_xxkh + cur.map.month_settle_money_xxkh}"></c:set>
		<c:set var="s_month_settle_money_qtkh"
			value="${s_month_settle_money_qtkh + cur.map.month_settle_money_qtkh}"></c:set>
		<tr style="">
			...
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_gm}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_sn}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_qtls}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_csqd}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_cskh}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_xxkh}" pattern="0.00" /></td>
			<td align="right"><fmt:formatNumber
					value="${cur.map.month_settle_money_qtkh}" pattern="0.00" /></td>
		</tr>
	</c:forEach>
	<tr style="">
