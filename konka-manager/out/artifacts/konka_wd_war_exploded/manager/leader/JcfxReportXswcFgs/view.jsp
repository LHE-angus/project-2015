...
<div class="page-head">
<h2 class="pull-left"><i class="icon-home"></i>分公司销售完成率</h2>
...
<td align="left"><button name="button" type="button" class="btn btn-success"
				onClick=sbt();>搜 索</button></td>
</tr>
</table>
</html-el:form>
</div> 
...
<div class="widget" >
<div class="widget-head">
<div class="pull-left">多媒体销售情况</div>
<div class="widget-icons pull-right"><a href="#" class="wminimize"><i
	class="icon-chevron-up"></i></a> <a href="#" class="wclose"><i
	class="icon-remove"></i></a></div>
<div class="clearfix"></div>
...
<table id="table1" style="width:100%;">
    <tr>
    	<td >
	        <span class="mychar_title" style="text-align:center;padding: 10px 0 10px;" id="title1">...</span>
	        <p style="text-align:center;margin-top:5px;color:blue;font: normal 14px '微软雅黑';">目标销售额:<span id="option1_b">... </span>万元 </p> 
	        <p style="text-align:center;margin-top:5px;color:red;font: normal 14px '微软雅黑';">实际销售额: <span id="option1_a">... </span>万元</p> 
...
<div class="widget">
<div class="widget-head">
<div class="pull-left">区域销售情况</div>
<div class="widget-icons pull-right"><a href="#" class="wminimize"><i
	class="icon-chevron-up"></i></a> <a href="#" class="wclose"><i
	class="icon-remove"></i></a></div>
<div class="clearfix"></div>
...
<div class="widget-content referrer">
<table id="table1" style="width: 100%;height:420px;">
    <tr>
         <td  valign="top" align="center" id="option_table1"> 
        </td>
        </tr>
</table> 
</div></div>
...
<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">分公司销售情况</div>
...
<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">分公司渠道销售信息</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
							...
							<div class="widget-content referrer">
<table id="table5" style="width:100%;height:700px;">
    <tr>
        <td width="100%" valign="top"  id="option_table2"> 
...
$(".sidebar #nav > li > a:eq(2)").attr("class","open subdrop");
...
function myChart1(year,month,fgs_id){
	...
	$.ajax({
		type: "POST",
		url: "<c:url value='/manager/leader/JcfxReportXswcFgs.do' />",
