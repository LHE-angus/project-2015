			...
			<div class="pageContent">
				...
				<html-el:form action="/paragon/KonkaParagonShowversion" enctype="multipart/form-data">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="list">
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">形象版本ID：</td>
							<td width="88%" align="left"><c:out value="${af.map.version_id}" /></td>
						</tr>
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">版本名称：</td>
							<td width="88%" align="left"><c:out value="${af.map.version_name}" /></td>
						</tr>
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">版本代码：</td>
							<td width="88%" align="left"><c:out value="${af.map.version_code}" /></td>
						</tr>
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">版本备注：</td>
							<td width="88%" align="left"><c:out value="${af.map.version_memo}" /></td>
						</tr>
						<tr>
