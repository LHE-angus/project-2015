...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
        <html-el:form action="/paragon/SelectShowInfo">
  ...
  <div class="rtabcont1">
    <html-el:form action="/paragon/SelectShowInfo" enctype="multipart/form-data" >
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
       	    <tr class="tabtt1">
				...
				<tr>
					...
					<c:forEach var="cur1" items="${showManreList}">
					  <c:if var="isChecked" test="${(cur.show_shop_id eq cur1.map.show_shop_id) or isChecked}" />
					</c:forEach>
					<c:if test="${isChecked}">
						<input name="pks" type="checkbox" id="pks" value="${cur.show_shop_id}" checked="checked"/>
					</c:if>
					 <c:if test="${not isChecked}">
						<input name="pks" type="checkbox" id="pks" value="${cur.show_shop_id}"/>
					</c:if>
     ...
     <form id="bottomPageForm" name="bottomPageForm" method="post" action="SelectShowInfo.do">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
...
function goBack(){
	this.location.href = 'KonkaParagonShowmanre.do?method=edit&user_id='+$("#user_id").val()+"&mod_id="+$("#mod_id").val() ;
}
//]]></script>
