...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <div id="div_1">
      <html-el:form action="/admin/RetailSalesQuery" method="post">
        ...
        <table width="1500" border="0" cellpadding="0" cellspacing="1" class="rtable2">
          <tr class="tabtt1">
            ...
            <td width="60" align="center">产品品牌</td>
          ...
          <tr>
            ...
            <td nowrap="nowrap">索尼</td>
            <td nowrap="nowrap">LED</td>
            <td nowrap="nowrap">14</td>
            <td nowrap="nowrap"> LED46IS95D</td>
      ...
      <br />
      <form id="bottomPageForm" name="bottomPageForm" method="post" action="RetailSalesQuery.do">
