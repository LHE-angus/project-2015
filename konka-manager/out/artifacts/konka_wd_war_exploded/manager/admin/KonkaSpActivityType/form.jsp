...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaSpActivityType" method="post">
      ...
      <html-el:hidden property="p_type" styleId="p_type" value="0"/>
      <html-el:hidden property="meeting_type" styleId="meeting_type" value="0"/>
      <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">【必填】 </font>活动达标金额（万元）：</td>
          <td width="88%" align="left"><html-el:text property="money" size="40" maxlength="15" styleId="money" /></td>
        </tr>
        <tr>
...
var isRomveYwy2 = '${isRomveYwy}';	
	...
	$("#money").attr("dataType" , "Require").attr("msg" , "请填写活动达标金额.");
	$("#money").attr("focus",setOnlyNum);
	//$("#content").attr("datatype","LimitB").attr("max","500").attr("min","1").attr("msg","反馈内容必须在1-500字范围内.");
	$("#btn_submit").click(function(){
		//处理、验证职务多选，Begin
/* 		var num_jxs = $("#md_name_jxs_ms2side__dx").find("option").length;
		if (0 == num_jxs || null == num_jxs) {
			alert("请选择指定机型！");
			$("#md_name_jxs_ms2side__dx").focus();
			return false;
		} */
	...
	/* 	var num_pls = $("#md_name_pls_ms2side__dx").find("option").length;
		if (0 == num_pls || null == num_pls) {
			alert("请选择指定品类！");
			$("#md_name_pls_ms2side__dx").focus();
			return false;
		} */
