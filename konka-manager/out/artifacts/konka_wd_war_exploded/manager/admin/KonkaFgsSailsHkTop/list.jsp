...
<div class="oarcont" id="body_oarcont">
  ...
  <html-el:form action="/admin/KonkaFgsSailsHkTop">
  ...
  <div class="rtabcont1" style="overflow-x: auto;">
    ...
    <table class="rtable6" width="100%" cellspacing="1" cellpadding="0" border="0">
      ...
      <c:forEach var="cur1" items="${qtList}" varStatus="vs1">
	          ...
	          <td nowrap="nowrap" align="right"><fmt:formatNumber value="${cur1.map.ratio}" pattern="###,##0.00" /></td>
	          ...
	          <td nowrap="nowrap" align="right"><fmt:formatNumber value="${cur1.map.tq_hk_money}" pattern="###,##000" /></td>
	          <td nowrap="nowrap" align="right">
		          <c:choose>
      ...
      <tr>
       ...
       <td nowrap="nowrap" align="right" style="font-weight:600;"><fmt:formatNumber value="${t_dr_hs_money}" pattern="###,##000" /></td>
       ...
       <td nowrap="nowrap" align="right" style="font-weight:600;"><fmt:formatNumber value="${t_hs_money*10000/t_pb_num}" pattern="###,##0" />
