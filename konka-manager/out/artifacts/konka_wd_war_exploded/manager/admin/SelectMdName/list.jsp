...
<div class="oarcont" id="body_oarcont">
	...
	<div class="rtabcont1">
		<html-el:form action="/admin/SelectMdName">
			...
			<table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
				<tr>
					<td height="36" align="left" style="padding-left:5px;">
		        		&nbsp;型号名称：
		        		<html-el:text property="md_name_like" styleId="md_name_like" styleClass="webinput" />
		        		&nbsp;
	...
	<div class="rtabcont1">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
				<tr class="tabtt1">
		           ...
		           <td nowrap="nowrap" align="center">型号名称</td>
				...
				<tr>
					...
					<td align="center" nowrap="nowrap"><a href="javascript:selectPd('${cur.pd_id}','${cur.md_name}');">选择</a></td>
				</tr>
  				</c:forEach>
			</table>
	  		<c:if test="${not vs.last}"><div style="height:40px;"></div></c:if>
		<form id="bottomPageForm" name="bottomPageForm" method="post" action="SelectMdName.do">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td height="40">
...
function selectPd(pd_id,md_name){
	window.opener.set_value(pd_id,md_name);
	window.close();
}
