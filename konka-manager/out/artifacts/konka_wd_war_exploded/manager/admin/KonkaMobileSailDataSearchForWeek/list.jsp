...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
  	<html-el:form action="/admin/KonkaMobileSailDataSearchForWeek">
  ...
  <div class="rtabcont1" style="overflow-x: auto;height:400px;" id="divExcel_all" title="销售明细">
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
  		<tr class="tabtt1">
        	...
        	<td align="center" nowrap="nowrap">周</td>
  		...
  		<c:forEach var="cur" items="${entityList}" varStatus="vs">
  			<tr class="list-tr">
  				...
  				<td align="left" nowrap="nowrap">第${cur[0]}周</td>
  				...
  				<td align="right" nowrap="nowrap">
	  				...
	  				<c:if test="${cur[8] ne '-'}"><fmt:formatNumber value="${cur[8]}" pattern="#,##0.0000"/>%</c:if></td>
  			</tr>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	toExcel('divExcel_all', '${ctx}/manager/admin/KonkaMobileSailDataSearchForWeek.do?method=toExcel');
    });
