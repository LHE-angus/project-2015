...
<div class="rtabcont1">
  <html-el:form action="/admin/KonkaR3ShopHomePage">
    ...
    <html-el:hidden property="r3_money_gt" styleId="r3_money_gt" />
    <html-el:hidden property="r3_money_lt" styleId="r3_money_lt" />
  ...
  <div class="rtabcont1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      		<tr class="tabtt1">
		    	...
		    	<td width="20%" nowrap="nowrap" align="center">${(not empty af.map.r3_money_gt or not empty af.map.r3_money_lt)?"当年":""}结算额（元）</td>
		    	<td width="20%" nowrap="nowrap" align="center">${(not empty af.map.r3_money_gt or not empty af.map.r3_money_lt)?"当年":""}零售额（元）</td>
      		</tr>
      		<c:forEach var="cur" items="${entityList}" varStatus="vs">
      			<tr>
      				<td align="center">${vs.count}</td>
      				<td align="left">${cur.map.customer_name}</td>
      				<td align="right"><fmt:formatNumber value="${cur.map.r3_money}" pattern="#,##0.00"/></td>
