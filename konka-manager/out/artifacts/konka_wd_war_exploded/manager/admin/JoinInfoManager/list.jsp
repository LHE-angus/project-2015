...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/JoinInfoManager">
  ...
  <div class="rtabcont1">
    <%@ include file="/commons/pages/messages.jsp" %>
	    <input class="but2" type="button" name="Submit2" value="新增" onclick="location.href='JoinInfoManager.do?method=add&mod_id=${af.map.mod_id}&';" />
	    <input class="but3" type="button" name="Submit3" value="删除" onclick="confirmDeleteAll(document.getElementById('listForm'));" />
  </div>
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="JoinInfoManager.do?method=delete">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            <td align="center" nowrap="nowrap"><input name="pks" type="checkbox" id="pks" value="${cur.id}" />
            </td>
            ...
            <td align="center">
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'JoinInfoManager.do', 'view','id=${cur.id}&'+$('#bottomPageForm').serialize())">查看</span>
            |
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'JoinInfoManager.do', 'edit','id=${cur.id}&'+$('#bottomPageForm').serialize())">修改</span>
            |
            <span style="cursor:pointer;" class="fblue" onclick="confirmDelete('确定删除加盟信息吗?', 'JoinInfoManager.do', 'id=${cur.id}&'+$('#bottomPageForm').serialize())">删除</span> </td>
          </tr>
    ...
    <br />
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="JoinInfoManager.do">
