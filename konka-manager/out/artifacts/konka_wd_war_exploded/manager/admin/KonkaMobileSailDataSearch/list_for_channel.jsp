...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
      ...
      <html-el:hidden property="method" value="toSailDataByChannel" />
  ...
  <form action="${ctx}/manager/admin/KonkaMobileSailDataSearch.do" method="post">
	    ...
	    <input type="hidden" name="hiddenName" id="hiddenName" value="进销存-渠道" />
	    <input type="hidden" name="hiddenHtml" id="hiddenHtml"/>
	</form>
  <div class="rtabcont1" style="overflow-x: auto;" id="jxc_channel_div" title="销售明细">
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
  		<tr class="tabtt1">
  			<td width="5%" align="center" nowrap="nowrap">序号</td>

        	<td width="10%" align="center" nowrap="nowrap">渠道分类</td>
  		...
  		<c:forEach var="cur" items="${entityList}" varStatus="vs">
  			<tr class="list-tr">
  				...
  				<td align="left" nowrap="nowrap">
  					<a title="点击可查看该渠道详情" style="cursor:pointer;" class="fblue" onclick="showChannels('${cur.PAR_INDEX}','${cur.C_COMM }');">${cur.C_COMM}</a>
  				</td>
...
<script type="text/javascript">
	...
	function showChannels(par_index,c_comm){
		c_comm = encodeURI(encodeURI(c_comm));
		$.dialog({
			title:  "细分类型列表",
			width:  1000,
			height: 500,
	        lock:true ,
			content:"url:KonkaMobileSailDataSearch.do?method=listForChannels&par_index="+par_index+"&c_comm="+c_comm+"&dept_id="+$("#dept_id").val()+
					"&l4_dept_id="+$("#l4_dept_id").val()+"&l5_dept_id="+$("#l5_dept_id").val()+
  ...
  $(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	if(confirm("提示，您确认导出数据？")){
    		var ff = document.forms[1];
    		var divExcel = document.getElementById("jxc_channel_div");
