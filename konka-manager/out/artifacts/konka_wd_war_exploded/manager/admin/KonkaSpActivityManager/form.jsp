  	...
  	<div class="rtabcont2">
	  	...
	  	<html-el:form action="/admin/KonkaSpActivityManager" enctype="multipart/form-data">
			<html-el:hidden property="method" value="save" styleId="method"/>
	      	...
	      	<html-el:hidden property="file_status" styleId="file_status" value="${file_status}" />
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtable3">
		        ...
		        <tr>
					<td class="title_item" align="right"><font color="red">* </font>主题：</td>
					<td align="left" colspan="4" width="90%">
					<html-el:text property="sp_name" styleId="sp_name"  maxlength="50" style="width:300px;"/>
					</td>
				</tr>
		        <tr>
					<td class="title_item" align="right"><font color="red">* </font>活动类型：</td>
					<td width="50%">
					<html-el:select property="hd_id" styleId="hd_id">
					<html-el:option value="">请选择…</html-el:option>
					<html-el:optionsCollection name="spActivityList" label="hd_type"   value="id"/>
					</html-el:select>
					</td>
					<td class="title_item" align="right" nowrap="nowrap"><font color="red">* </font>活动状态：</td>
					<td width="50%">
				...
				<tr>
				 ...
				 <tr>
					...
					<td align="left">
					<html-el:text property="main_customer" styleId="main_customer" style="width:200px;" maxlength="30" readonly="true" onclick="getKonkaR3List();"/>
					</td>
					<td class="title_item" align="right" nowrap="nowrap"><font style="color:red;">*</font>主要R3编码：</td>
				 ...
				 <tr>
					...
					<td align="left">
					<html-el:text property="other_customer" styleId="other_customer" style="width:200px;" maxlength="60" readonly="true" onclick="getKonkaOhterR3List();"/>
					</td>
				...
				<tr>
					<td class="title_item" align="right" nowrap="nowrap">活动目标：</td>
					<td align="left">
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
							<tr>
								...
								<td align="left" width="80%"><html-el:text property="task_money" styleId="task_money" style="width:100px;" maxlength="10"/></td>
							</tr>
							<tr>
								<td class="title_item" align="right" nowrap="nowrap"><font color="red">* </font>任务销量(台):</td>
								<td align="left"><html-el:text property="task_sail_num" styleId="task_sail_num" style="width:100px;" maxlength="10"/></td>
							</tr>
							<tr>
								<td class="title_item" align="right" nowrap="nowrap"><font color="red">* </font>活动渠道排名:</td>
								<td align="left"><html-el:text property="activity_ranking" styleId="activity_ranking" style="width:100px;" maxlength="10"/></td>
							</tr>
						</table>
<!--					<html-el:textarea property="target" styleId="target" style="resize:none;" cols="50" rows="5"></html-el:textarea>-->
<!--					<div id="info_tip1" style="color:#0066FF;font-size:12px;display:none"><img src="${ctx}/images/tishi.gif" style="vertical-align:middle;" /></div>-->
					</td>
		          ...
		          <input name="zb_s_date" id="zb_s_date" size="12" value="${_zb_s_date}" readonly="readonly" class="Wdate" type="text" onclick="WdatePicker({readOnly:true,minDate:'2013-11-01',maxDate:'#F{$dp.$D(\'zb_e_date\')}'})" /></td>
								<td nowrap="nowrap" class="" align="center"><font color="red">* </font>至：</td>
								<td align="center"><fmt:formatDate value="${af.map.zb_e_date}" pattern="yyyy-MM-dd" var="_zb_e_date" />
		          <input name="zb_e_date" id="zb_e_date" size="12" value="${_zb_e_date}" readonly="readonly" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,minDate:'#F{$dp.$D(\'zb_s_date\')||\'%y-%M-{%d}\'}'})" /></td>
							</tr>
							<tr>
		          ...
		          <input name="bf_s_date" id="bf_s_date" size="12" value="${_bf_s_date}" readonly="readonly" class="Wdate" type="text" onclick="WdatePicker({readOnly:true,minDate:'2013-11-01',maxDate:'#F{$dp.$D(\'bf_e_date\')}'})" /></td>
								<td nowrap="nowrap" class="" align="center"><font color="red">* </font>至：</td>
								<td align="center"><fmt:formatDate value="${af.map.bf_e_date}" pattern="yyyy-MM-dd" var="_bf_e_date" />
		          <input name="bf_e_date" id="bf_e_date" size="12" value="${_bf_e_date}" readonly="readonly" class="Wdate" type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,minDate:'#F{$dp.$D(\'bf_s_date\')||\'%y-%M-{%d}\'}'})" /></td>
							</tr>
						</table>
					</td>
				</tr>
...
<%-- 				    <html-el:hidden property="charge_person" /> --%>
					<html-el:select property="charge_person_job_id" styleId="charge_person" multiple="multiple">
					...
					<td align="left">
					<html-el:text property="charge_person_tel" maxlength="15" styleId="charge_person_tel" style="width:200px;"/>
					</td>
				</tr>
				<tr>
					...
					<html-el:text property="jyb_name"  styleId="jyb_name" readonly="true" style="width:200px;"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<html-el:text property="hd_addr" maxlength="60" styleId="hd_addr" style="width:400px;"/>
					</td>
				</tr>
		        <tr>
					<td class="title_item" align="right" nowrap="nowrap">活动备注：</td>
					<td align="left" colspan="4">
					<html-el:textarea property="hd_remark" styleId="hd_remark" style="resize:none;" cols="50" rows="5"></html-el:textarea>
...
$(document).ready(function(){
	...
	$("#file_remark").attr("dataType", "Require").attr("msg", "请填写文件备注");
...
// 	$("#total_sail_num").attr("dataType", "Require").attr("msg", "请填写销售总数量");
	...
	$("#customer_type_name").attr("dataType", "Require").attr("msg", "请在客户管理模块维护客户类别 ");
	$("#jyb_name").attr("dataType", "Require").attr("msg", "请给客户分配经营部 ");
	$("#task_money").attr("dataType", "Require").attr("msg", "请填写任务金额 ").focus(setOnlyNum);
	$("#task_sail_num").attr("dataType", "Require").attr("msg", "请填写任务销售数量 ").focus(setOnlyNum2);
	$("#activity_ranking").attr("dataType", "Require").attr("msg", "请填写活动渠道排名 ").focus(setOnlyNum2);
	//$("#charge_person_tel").attr("datatype", "Phone"  ).attr("require", "true").attr("msg", "请正确填写联系电话");
//	$("#target").attr("dataType", "Require").attr("msg", "请填写活动目标");
//	$("#target").textbox({
//		maxLength: 200,
//		onInput: function(event, status) {
////			var img = '<img src="${ctx}/images/tishi.gif" style="vertical-align:middle;" />';
//			$("#info_tip1").slideDown("fast").html(img + " 请将字数限制在：" + status.maxLength + " 个字内，您还可以输入：<b style='color:red;'>" + status.leftLength + "</b> 个字。");
//		}
//	}).blur(function() {
//		$("#info_tip1").slideUp("normal");
//	});
	$("#hd_remark").textbox({
		maxLength: 200,
		onInput: function(event, status) {
 ...
 $("#btn_temp_save").click(function() {
	 var m_r3_code =$("#main_r3_code").val();
	 var o_r3_code =$("#other_r3_code").val();
	 if(Validator.Validate(this.form, 3)){
		 if(o_r3_code.indexOf(m_r3_code)>-1){//判断主客户中是否和其他客户有相同的，相同的话不能提交
			 alert("主要客户不能和其他客户重复，请重新选择");
		 } else {
			$("#file_status").val("1");
 ...
 $("#charge_person").multiselect({
		noneSelectedText: '<span >=请选择=</span>',
		selectedList: 1,
		multiple: false,
		minWidth:160
	}).multiselectfilter({label:"<span>搜索：</span>"}).attr("datatype", "Require").attr("msg", "请选择负责人！");
...
function getKonkaR3List() { 
	var returnValue = window.showModalDialog("${ctx}/manager/admin/KonkaSpActivityManager.do?method=spActivityManagerForMainR3List&azaz=" + Math.random(),window,"dialogWidth:650px;status:no;dialogHeight:390px");
	if (!returnValue) returnValue = window.returnValue;
	$("#main_customer").val(returnValue.customer_name);
	$("#main_r3_code").val(returnValue.r3_code);
	$("#jyb_id").val(returnValue.l4_dept_id);
	$("#jyb_name").val(returnValue.l4_dept_name);
	$("#customer_type").val(returnValue.customer_type);
	$("#customer_type_name").val(returnValue.customer_type_name);
	$("#par_customer_type").val(returnValue.par_customer_type);
	$("#par_customer_type_name").val(returnValue.par_customer_type_name);
	$("#ywy_id").val(returnValue.user_id);
	$("#ywy_name").val(returnValue.ywy_user_name);
	
}
	
function getKonkaOhterR3List() { 
var returnValue = window.showModalDialog("${ctx}/manager/admin/KonkaSpActivityManager.do?method=spActivityManagerForOtherR3List&azaz=" + Math.random(),window,"dialogWidth:650px;status:no;dialogHeight:390px");
