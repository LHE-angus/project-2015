  	...
  	<div class="rtabcont1">
		  ...
		  <tr>
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
				...
				<tr>
					<td nowrap="nowrap" class="title_item" align="right">目标：</td>
					<td align="left">
					${af.map.target}
					</td>
				...
				<tr>
					<td nowrap="nowrap" class="title_item" align="right">客户类别：</td>
					<td align="left" width="40%">
				...
				<tr>
					<td nowrap="nowrap" class="title_item" align="right">文件备注：</td>
