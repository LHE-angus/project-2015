		...
		<div class="rtabcont2">
			...
			<div style="width: 100%;height: 120px;">
			  ...
			  <div style="float: right;width: 30%;">
                   <img align="right" width="120px" height="120px" src="${ctx}/images/QRCode.jpg?s=http://qdgl.konka.com/webservice/KonkaOrderInfoTrans.do?param=${trans_index_detail},${user_id},${password}" />
               </div>
			</div>
