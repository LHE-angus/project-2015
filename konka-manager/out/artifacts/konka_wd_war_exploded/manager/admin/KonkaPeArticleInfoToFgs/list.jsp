...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaPeArticleInfoToFgs">
    ...
    <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><input class="but2" type="button" name="Submit2" value="新增" onclick="location.href='KonkaPeArticleInfoToFgs.do?method=add&mod_id=${af.map.mod_id}&receive_user_type=${af.map.receive_user_type}&public_target=${af.map.public_target}';" />
    ...
    <div class="rtabcont1">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue"><a href="${https}/webservice/KonkaPeArticleInfoInterface.do?method=view&id=${cur.id}" target="_blank">预览</a></span> | <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaPeArticleInfoToFgs.do', 'view','id=${cur.id}&'+$('#bottomPageForm').serialize())">查看</span>
                <c:if test="${userInfo.id eq cur.add_user_id}"> | <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaPeArticleInfoToFgs.do', 'edit','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">修改</span> | <span style="cursor:pointer;" class="fblue" onclick="confirmDelete(null, 'KonkaPeArticleInfoToFgs.do', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">删除</span> </c:if>
      ...
      <br />
      <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaPeArticleInfoToFgs.do">
