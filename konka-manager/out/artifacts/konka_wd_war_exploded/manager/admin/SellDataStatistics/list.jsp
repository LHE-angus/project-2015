        ...
        <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
 		<table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
            ...
            <html-el:text property="handle_name_like" size="20" maxlength="20" styleId="handle_name_like"  /></td>
 			<td><strong class="fb">客户名称：</strong><html-el:text property="customer_name_like" size="15" maxlength="20" styleId="customer_name_like"  />
       	 </td>
       	 </tr>
       	 <tr>
       	     <td width="15"></td>
 			 <td><strong class="fb">上报时间：</strong> <html-el:text property="add_date_start"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
                 	 至
      			<html-el:text property="add_date_end"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
 			 </td>
 			  <td><strong class="fb">销售状态：</strong><html-el:select property="sell_type">
		     	    <html-el:option value="">请选择销售状态</html-el:option>
		     	    <html-el:option value="0">未报销售</html-el:option>
		     	    <html-el:option value="1">已报销售</html-el:option>
		     	    </html-el:select></td>
	        <td></td>
          </tr>
          <tr>
          <td  width="15"></td>
          <td colspan="2"><jsp:include page="../_inc/search_fgs_jyb_bsc_ywy.jsp?fgs_dept_id=${af.map.fgs_dept_id}&jyb_dept_id=${af.map.jyb_dept_id}&bsc_dept_id=${af.map.bsc_dept_id}&ywy_user_id=${af.map.ywy_user_id}" /></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <td align="center"><span style="cursor:pointer; margin:0 7px 0 7px;" class="fblue" onclick="doNeedMethod(null, 'SellDataStatistics.do','toStatistics' ,'r3_shop_id=${cur.id}&' + $('#bottomPageForm').serialize())">查询上报记录</span> </td>
          </tr>
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40" align="right"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
	        ...
	        pager.addHiddenInputs("sell_type", "${af.map.sell_type}");
