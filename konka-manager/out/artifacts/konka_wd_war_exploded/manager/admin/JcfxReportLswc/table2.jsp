...
<%@ include file="/commons/pages/taglibs.jsp" %>
	<div style="text-align:right;margin-right:20px;">单位：万元</div> 
	        ...
	        <tr  style="background-color: #E1F3EB;">
		        ...
		        <td align="right"><fmt:formatNumber value="${cur.pre_month_retail_money}" pattern="0.00"/></td>
		        <td align="center">
		        ...
		        <td align="right">
		        	<c:if test="${cur.pre_month_retail_money gt 0 or cur.pre_month_retail_money lt 0 }">
		        		<c:if test="${cur.month_retail_money gt cur.pre_month_retail_money}">
			        		<fmt:formatNumber value="${(cur.month_retail_money-cur.pre_month_retail_money)*100/cur.pre_month_retail_money}" pattern="0.00"/>%
		        			<font color="green">↑</font>
		        		</c:if>
		        		<c:if test="${cur.month_retail_money lt cur.pre_month_retail_money}">
			        		<fmt:formatNumber value="${(cur.month_retail_money-cur.pre_month_retail_money)*100/cur.pre_month_retail_money}" pattern="0.00"/>%
		        			<font color="red">↓</font>
		        		</c:if>
		        	</c:if>
		        	<c:if test="${!(cur.month_retail_money gt 0 or cur.pre_month_retail_money lt 0) }">
		        		-
		        	</c:if>
		        </td> 
		        ...
		        <td align="center">
		        	<c:if test="${cur.map.month_retail_money_task_lj gt 0 or cur.map.month_retail_money_task_lj lt 0 }">
		        		<fmt:formatNumber value="${cur.map.retail_money_lj*100/cur.map.month_retail_money_task_lj}" pattern="0.00"/>%
		        	</c:if>
		        	<c:if test="${!(cur.map.month_retail_money_task_lj gt 0 or cur.map.month_retail_money_task_lj lt 0) }">
		        		-
		        	</c:if>
	        ...
	        <tr style="background-color: #5BCAC6;">
		        ...
		        <td align="right"><fmt:formatNumber value="${s_pre_month_retail_money}" pattern="0.00"/></td>
		        <td align="center">
		        ...
		        <td align="center">
		        	<c:if test="${s_pre_month_retail_money gt 0 or s_pre_month_retail_money lt 0 }">
		        		<c:if test="${s_month_retail_money gt s_pre_month_retail_money}">
			        		<fmt:formatNumber value="${(s_month_retail_money-s_pre_month_retail_money)*100/s_pre_month_retail_money}" pattern="0.00"/>%
		        			<font color="green">↑</font>
		        		</c:if>
		      ...
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_gm}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_sn}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_qtls}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_csqd}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_cskh}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_xxkh}" pattern="0.00"/></td>
		      <td align="right" ><fmt:formatNumber value="${s_month_retail_money_qtkh}" pattern="0.00"/></td> 
	         </tr>
	        </table> 