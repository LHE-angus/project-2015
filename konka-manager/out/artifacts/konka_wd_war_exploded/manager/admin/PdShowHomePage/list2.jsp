...
<div class="m_l">
			...
			<div class="right_contcont2"
				style="margin-bottom: 24px; height: 1200px;">    
				<div id="chartdiv"></div>
			</div>
			<div class="clear"></div>
		</div> 
<div class="m_r">
      <div class="k_tongzhi"><font class="">库存预警</font><span style="float: right; font-size: 12px;"><a href="PdShowHomePage.do?method=listAll">更多</a></span></div>
      <div class="right_contcont2">
       ...
       <div class="k_tongzhi"><font class="">待审核订单</font><span style="float: right; font-size: 12px;"><a href="${ctx}/manager/spgl/PshowOrderAudit.do?method=audit&mod_id=905604">更多</a></span></div>
      <div class="right_contcont2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtab5">
          <tr>
      ...
      <div class="k_tongzhi"><font class="">待审核会员</font><span style="float: right; font-size: 12px;"><a href="${ctx}/manager/spgl/EcUser.do?is_act=2&mod_id=905901">更多</a></span></div>
      <div class="right_contcont2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtab5">
          <tr>
       ...
       <div class="k_tongzhi"><font class="">待发放佣金</font><span style="float: right; font-size: 12px;"><a href="${ctx}/manager/spgl/EcJieSuanRebatesPay.do?mod_id=905509">更多</a></span></div>
      <div class="right_contcont2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtab5">
          <tr>
        ...
        <div class="k_tongzhi"><font class="">大宗采购</font><span style="float: right; font-size: 12px;"><a href="${ctx}/manager/spgl/EcBuyInfo.do?mod_id=907210">更多</a></span></div>
      <div class="right_contcont2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtab5">
          <tr>
	   ...
	   $.ajax({
		   type : "POST",
			...
			success : function(data) {
				var flash = "MSBar2D.swf";
				var chart = new FusionCharts("${ctx}/scripts/fusioncharts/swf/"+flash, "ChartId", "96%", "1200", "0", "0");
		        ...
		        xmldata += "<categories>";
	     		var xml_data_set1 = "<dataset seriesName='销售额' showValues='0' color='F1683C'>";
	     		var xml_data_set2 = "<dataset seriesName='销售量' showValues='0' color='AFD8F8'>";
	     		var xml_data_set3 = "<dataset seriesName='订单数' showValues='0' color='F6BD0F'>";
	     		var xml_data_set4 = "<dataset seriesName='新增会员数' showValues='0' color='8BBA00'>";
