...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaMobileSailDataBill">
      <html-el:hidden property="method" value="listForAudit" />
      <html-el:hidden property="mod_id" styleId="mod_id" />
      <html-el:hidden property="is_del" styleId="is_del" />
      <html-el:hidden property="ext_audit_state" styleId="0" />
...
<!--             <td align="right"> -->
<!--            	  <strong class="fb">是否初审：</strong> -->
<!--            </td> -->
<!--            <td> -->
<%--            	 <html-el:select property="ext_audit_state" styleId="ext_audit_state" style="width:50px;" > --%>
...
<!--        <td width="6%" align="center" nowrap="nowrap">客户所在经办</td>-->
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        ...
        <td align="center" nowrap="nowrap">${(af.map.pager.currentPage - 1) * af.map.pager.pageSize + vs.count}</td>
           ...
           <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null,'KonkaMobileSailDataBill.do', 'view','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span>
           <logic-el:match name="popedom" value="+2+">
            <c:if test="${(ext_audit_state eq 0 || cur.audit_state eq 4) && (role_id_124 || role_id_125 )}">
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null,'KonkaMobileSailDataBill.do', 'toAudit','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">审核</span>
            </c:if>
            <c:if test="${!role_id_124 && !role_id_125 }">
             <span style="cursor:pointer;color:grey;">审核</span>
              </c:if>
                  </logic-el:match>	
            </td>
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="60" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
            ...
            pager.addHiddenInputs("method", "listForAudit");
