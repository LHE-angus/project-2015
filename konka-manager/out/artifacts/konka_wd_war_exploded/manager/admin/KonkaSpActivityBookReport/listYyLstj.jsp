  ...
  <div class="oartop">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td>当前位置：促销预约—>预约零售统计</td>
      </tr>
    </table>
  </div>
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaSpActivityBookReport">
      <html-el:hidden property="method" value="listYyLstj" />
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
           ...
           ${cur.map.fgs_name}
            ...
            <font color="red"><fmt:formatNumber  value="${cur.map.yy_money}" pattern="￥00.00" /></font>
           </td>
             <td align="center"nowrap="nowrap">${cur.map.ls_num}</td> 
            <td  align="right"nowrap="nowrap">
            <font color="red"><fmt:formatNumber  value="${cur.map.ls_money}" pattern="￥00.00" /></font>
           </td>
        ...
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;">
              ...
              <script type="text/javascript">
				...
				pager.addHiddenInputs("method", "listYyLstj");
