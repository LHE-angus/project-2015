  ...
  <div class="rtabcont2">
      ...
      <div id=tab3>
        ...
        <td colspan="4" align="left" class="title_item">竞品价格</td>
         ...
         <c:if test="${af.map.is_win eq 0}"><span style="color:#ff0000;">中标</span></c:if>
         <c:if test="${af.map.is_win eq 1 or empty af.map.is_win}"><span style="color:#300000;">未中标</span></c:if>
         </td>
         </tr>
          <tr>
