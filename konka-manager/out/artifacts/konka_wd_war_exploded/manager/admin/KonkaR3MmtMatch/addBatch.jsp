...
<div class="oarcont">
 ...
 <a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/shop_import_help.doc">网点导入说明下载</a><br />
 <a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/shop_import_template.xls">网点导入Excel模板下载</a>
