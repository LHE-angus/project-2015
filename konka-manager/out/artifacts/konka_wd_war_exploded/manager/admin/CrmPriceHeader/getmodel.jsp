...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont2">
    <form action="${ctx}/manager/admin/CrmPriceHeader.do" method="post" id="dataform" enctype="application/x-www-form-urlencoded">
...
<!--           </td> -->
        ...
        <tr>
          ...
          <td width="40%">
		   	   <select id="modelcode" name="modelcode" style="width:172px" class="easyui-combobox" missingMessage="机型不能为空" data-options=" required:true,mode:'local',valueField:'modelcode',textField:'modelcode',value:'${af.map.modelcode}'">
...
<%--           <td width="40%"><html-el:text property="modelname" styleId="modelname" readonly="true"/></td> --%>
		...
		<td class="title_item" width="10%">返利：</td>
          <td width="40%">
          	<input type="text" name="fl" id="fl"  value="${af.map.fl}" readonly="true" alt="不需要手工填写">
          </td>
        </tr>
        ...
        <tr>
        <td class="title_item" width="10%">折扣：</td>
          <td width="40%">
          	<input class="easyui-numberbox" data-options="max:0" style="width:140px;" value="${af.map.discount}" name="discount" id="discount" ></input>%
          </td>
