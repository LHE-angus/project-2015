...
<div class="oarcont" id="body_oarcont">
  ...
  <html-el:form action="/admin/KonkaR3DeptStockInfoTop">
        ...
        <tr>
          <td height="36" align="left" style="padding-left:5px;">
           &nbsp; <strong class="fb">分公司：</strong>
            <html-el:select property="v_class" styleId="v_class">
              <html-el:option value="">-请选择-</html-el:option>
              <c:forEach items="${kdeptList}" var="kcur">
              	<html-el:option value="${kcur.map.dept_name}">${kcur.map.dept_name}</html-el:option>
              </c:forEach>
            </html-el:select>
           &nbsp;&nbsp;<strong class="fb">年月：</strong>
            ...
            &nbsp;<input name="but_exl" type="button" class="bgSearch" id="but_exl" value="导出" /></td>
        </tr>
      </table>
    </div>
  </html-el:form>
  <h1 align="center" style="padding-top: 20px;font-size: 22px;">${af.map.year}年${af.map.month}月份各分公司平板销售评估表</h1>
  <div><span style="color: red;float:right; padding-right: 10px;" >单位:台</span></div>
  <div class="rtabcont1" style="overflow-x: auto;">
    <table class="rtable6 datatable" width="100%" cellspacing="1" cellpadding="0" border="0">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        ...
        <tr>
          <td nowrap="nowrap" colspan="3" align="left">合计</td>
...
$(document).ready(function(){
	$("#but_exl").click(function(){
		$("#mod_id").append("<input type='hidden' name='excel_all' value='1' />");
		this.form.submit();
	});
});
//]]></script>
