  			...
  			<td width="48%" valign="top" >
			      ...
			      <c:forEach items="${entityList}" var="cur" varStatus="vs">
			        <tr>
			          ...
			          <td align="left" nowrap="nowrap">${cur[1]}&nbsp;&nbsp;${cur[3]}&nbsp;&nbsp;${cur[5]}</td>
			          <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur[6]}" type="number" pattern="#,##0.00" /></span></td>
			          <td align="right" nowrap="nowrap">${cur[7]}</td>
			          <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur[8]}" type="number" pattern="#,##0.00" /></span></td>
			        </tr>
			        <c:set var="total_money" value="${total_money+cur[6] }" />
	  			    <c:set var="total_num" value="${total_num+cur[7] }" />
			      </c:forEach>
			      <tr>
			    ...
			    <c:if test="${empty af.map.l4_dept_id }">
  				<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable6">
			      <tr class="tabtt6">
			        <td width="5%" nowrap="nowrap">排名</td>
			        <td nowrap="nowrap" width="10%">分公司</td>
			      ...
			      <c:forEach items="${entityList}" var="cur" varStatus="vs">
			        <tr>
			          <td align="center">${vs.count}</td>
			          <td align="left" nowrap="nowrap">${cur[1]}&nbsp;&nbsp;${cur[3]}</td>
			          <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur[4]}" type="currency" /></span></td>
			          <td align="right" nowrap="nowrap">${cur[5]}</td>
			          <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur[6]}" type="currency" /></span></td>
			        </tr>
			        <c:set var="total_money" value="${total_money+cur[4] }" />
...
$(document).ready(function(){
	...
	if(${not empty entityList}){
		   ...
		   chart.setDataURL("${ctx}/manager/admin/KonkaSellRank.do?method=chart_200");		
