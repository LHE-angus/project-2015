...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/NewProducts">
    ...
    <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
        <td width="18%">
      <input class="but2" type="button" name="Submit2" value="新增" onclick="location.href='NewProducts.do?method=add&mod_id=${af.map.mod_id}&receive_user_type=${af.map.receive_user_type}&public_target=${af.map.public_target}';" />
    ...
    <html-el:form action="/admin/NewProducts">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'NewProducts.do', 'view','id=${cur.id}&'+$('#bottomPageForm').serialize())">查看</span>
              |
			  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'NewProducts.do', 'edit','id=${cur.id}&'+$('#bottomPageForm').serialize())">修改</span>
			  |
			  <span style="cursor:pointer;" class="fblue" onclick="confirmDelete(null, 'NewProducts.do', 'id=${cur.id}&'+$('#bottomPageForm').serialize())">删除</span></td>
            </tr>
      ...
      <br />
      <form id="bottomPageForm" name="bottomPageForm" method="post" action="NewProducts.do">
