...
<div class="rtabcont2">
	<html-el:form action="/admin/KonkaMobileStorages" enctype="post">
		...
		<html-el:hidden property="method" styleId="method" value="saveForStorages" />
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
			...
			<tr>
				...
				<td width="88%" align="left">
				  <html-el:select property="par_id" styleId="par_id" style="width:130px;" value="${af.map.storage_id}">
