  ...
  <div class="rtabcont1" style="overflow-x:auto;">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      ...
      <tr>
        ...
        <td align="right" nowrap="nowrap"><fmt:formatNumber value="${cur.PRE_OUT_MONEY}" pattern="0.00" /></td> 
        <td align="right" nowrap="nowrap"><fmt:formatNumber value="${cur.END_MONEY}" pattern="0.00" /></td> 
        <td align="center" nowrap="nowrap"><fmt:formatNumber value="${cur.CUR_DAY}" pattern="0" /></td> 
        <td align="center" nowrap="nowrap"> <fmt:formatNumber value="${cur.UP_DAY}" pattern="0" /></td> 
