  ...
  <div class="oartop">
   ...
   <div class="rtabcont1">
        <html-el:form action="/admin/KonkaMobileCategorys">
         ...
         <tr>
              <td height="28" width="15%" nowrap="nowrap" class="title_item" align="right"><strong>父类别类型：</strong><font color="red">*</font></td>
            <td>
             <html-el:select property="c_name_1" styleId="c_name_1">
             	 <html-el:optionsCollection name="category" label="c_name" value="c_index" />
           <!--     <c:forEach var="cur" items="${category}">
              	<html-el:option value="${af.map.c_name_1}">${cur.c_name}</html-el:option>
              	 </c:forEach>-->
              </html-el:select>
           </td> 
            </tr> 
            <tr>
             <td height="28" width="15%" nowrap="nowrap" class="title_item" align="right"><strong>子类别说明：</strong></td>
