    ...
    <html-el:form action="/admin/KonkaR3Shop" enctype="multipart/form-data">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td width="88%" align="left"><html-el:text property="birthday" size="15" maxlength="30" styleId="birthday" readonly="true" onclick="new Calendar(1900, 2011, 0).show(this);"/></td>
        </tr>
        <tr>
...
$(document).ready(function(){
	...
	$("#mobile").attr("datatype","Mobile").attr("msg","请正确填写");
