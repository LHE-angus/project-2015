...
<div class="oarcont">
 ...
 <div>
  <h3 align="center" ><strong class="fb">反馈信息查看</strong></h3>
  </div>
   <div class="rtabcont2">
		...
		<tr>
			...
			<td width="88%" align="left">
				<c:forEach  var="cur" items="${konkaMobileTerminalFbBackList}" varStatus="vs">
					回复${vs.count}: ${cur.content}
						<div style="margin-left:250px;">
									---- 
										<c:if test="${not empty cur.map.subcomp_name}">${cur.map.subcomp_name}--</c:if>${cur.map.subcomp_name}
