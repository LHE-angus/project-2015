...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/GcxmProjCompet">
      ...
      <tr>
        ...
        <html-el:text property="brand_name_like" styleId="brand_name_like" size="20" maxlength="20" />
       &nbsp;
      	<strong class="fb">型号：</strong>
        <html-el:text property="compet_model_like" styleId="compet_model_like" size="20" maxlength="20" />
       &nbsp;
       <strong class="fb">报备人：</strong>
        <html-el:text property="create_name_like" styleId="create_name_like" size="20" maxlength="20" />
       &nbsp;
      	</td></tr>
        <tr>
        	<td nowrap="nowrap">&nbsp;&nbsp;
        	<strong class="fb">报备日期</strong>
  ...
  <div class="rtabcont1" style="overflow: auto;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="left" nowrap="nowrap">${cur.compet_model}</td>
             ...
             <c:otherwise>
              ...
              <td nowrap="nowrap" align="left"  >${cur.map.pj_code}</a></td>
             ...
             <c:otherwise>
              ...
              <td align="left" nowrap="nowrap">${cur.map.create_name}</td>
              </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="GcxmProjCompet.do">  
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
			...
			pager.addHiddenInputs("compet_model_like", "${af.map.compet_model_like}");
   ...
   $(document).ready(function() {
	    ...
	    $("#export_excel").click(function(){
			var forms =  document.forms[0];
	    	 this.value="正在提交...";
	    	 this.disabled=true;
	    	 forms.action="${ctx}/manager/admin/GcxmProjCompet.do?method=sheet";
	    	 forms.submit();
	    	 forms.action="${ctx}/manager/admin/GcxmProjCompet.do";
	    	 this.value="导出Excel";
	    	 this.disabled=false;
	    });  
