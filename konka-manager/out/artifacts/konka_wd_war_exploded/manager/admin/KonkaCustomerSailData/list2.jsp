...
<div class="oarcont" style="position:relative;overflow:hidden;">
  <div class="oartop">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td>当前位置：进销存 > 销售管理 > 零售数据 > 专卖店销售历史<span class="sel-tab sel-tab-active">专卖店销售历史</span><span class="sel-tab"><a href="${ctx}/manager/admin/KonkaCustomerSailData.do?mod_id=211800">客户端销售查询</a></span></td>
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaCustomerSailData">
      <html-el:hidden property="method" value="showcust" />
...
<!--    </div>-->
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td width="20%" style="display:none;" align="center" nowrap="nowrap">操作</td>
      </tr>
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          <td align="center" nowrap="nowrap"><a href="${ctx}/manager/admin/KonkaCustomerSailData.do?method=view&sell_bill_id=${cur.sell_bill_id}&mod_id=${af.map.mod_id}"><font class="fblue">
          ...
          ${empty cur.take_googs_date ? '-' : ''}
            ...
            <td align="center" nowrap="nowrap"  style="display:none;"><!-- <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaXxZmdAddSalesOrder.do', 'view','sell_bill_id=${cur.sell_bill_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span> -->
          <c:if test="${cur.is_switch ne 1}">
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('是否确认转R3订单？', 'KonkaXxZmdSearchSalesOrder.do', 'switchR3', 'sell_bill_id=${cur.sell_bill_id}&mod_id=${af.map.mod_id}');$('#message_tip').show();">转R3单</span> |&nbsp;
           </c:if>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaCustomerSailData.do?method=showcust">
