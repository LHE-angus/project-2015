				...
				<html-el:form action="/admin/KonkaContractManager" enctype="multipart/form-data">
					...
					<table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
						<tr>
							...
							<td nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>单据编码：</td>
							<td align="left"><span><font color="red"></font><font color="red">${af.map.bill_sn}</font></span>
							<html-el:hidden property="bill_sn" value="${af.map.bill_sn}"/></td>
						</tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>合同名称：</td>
							<td align="left"><html-el:text property="con_name" size="40" maxlength="30" styleId="con_name" />
							</td>
							<td nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>合同编码：</td>
							<td align="left"><html-el:text property="con_sn" size="40" maxlength="30" styleId="con_sn" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td nowrap="nowrap" class="title_item" align="right">合同基本目标：</td>
							<td align="left"><html-el:text property="con_base_money" size="40" maxlength="12" styleId="con_base_money" onfocus="javascript:setOnlyNum(this);" />
							</td>
							<td nowrap="nowrap" class="title_item" align="right">合同挑战目标：</td>
							<td align="left"><html-el:text property="con_expect_money" size="40" maxlength="12" styleId="con_expect_money" onfocus="javascript:setOnlyNum(this);" /></td>
						</tr>
						<tr>
							...
							<td align="left"><html-el:text property="scale_sb" size="40" maxlength="12" styleId="scale_sb" onfocus="javascript:setOnlyNum(this);" />%</td>	
						</tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right">月返：</td>
							<td align="left"><html-el:text property="month_sb" size="40" maxlength="12" styleId="month_sb" onfocus="javascript:setOnlyNum(this);" />%
							</td>
							<td nowrap="nowrap" class="title_item" align="right">特价机点位：</td>
							<td align="left"><html-el:text property="tjj_money" size="40" maxlength="12" styleId="tjj_money" onfocus="javascript:setOnlyNum(this);" /></td>
						</tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right">其他返利：</td>
							<td align="left"><html-el:text property="other_sb" size="40" maxlength="12" styleId="other_sb" onfocus="javascript:setOnlyNum(this);"/>
							</td>
							<td nowrap="nowrap" class="title_item" align="right">工程机点位：</td>
							<td align="left"><html-el:text property="gcj_money" size="40" maxlength="12" styleId="gcj_money" onfocus="javascript:setOnlyNum(this);"/></td>
						</tr>
						<tr>
				          <td width="12%" nowrap="nowrap" class="title_item" align="right">其他返利备注：</td>
				          <td width="88%" align="left">
				          	<html-el:textarea property="o_remark" styleId="o_remark" cols="5" style="width:450px;height:70px;" />
				          	<div id="info_tip_2" style="color:#0066FF;font-size:12px;display:none"><img src="${ctx}/images/tishi.gif" style="vertical-align:middle;" /></div>
				          </td>
				        </tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right">合同条款：</td>
							<td align="left" colspan="3"><html-el:text property="con_content" size="100" maxlength="100" styleId="con_content" /></td>
						</tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>洽谈甲方：</td>
							<td align="left"><html-el:text property="talks_man_a" size="40" maxlength="30" styleId="talks_man_a" />
							</td>
							<td nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>洽谈乙方：</td>
							<td align="left"><html-el:text property="talks_man_b" size="40" maxlength="30" styleId="talks_man_b" /></td>
						</tr>
						<tr>
							<td nowrap="nowrap" class="title_item" align="right">经营部：</td>
							<td align="left">
							<html-el:text property="jyb_name_1" size="40" maxlength="30" styleId="jyb_name_1"  value="${af.map.jyb_name}" disabled="true" />
							...
							<td align="left">
							<html-el:text property="ywy_name_1" size="40" maxlength="30" styleId="ywy_name_1"  value="${af.map.ywy_name}" disabled="true" />
						...
						<tr>
							...
							<td align="left"><html-el:text property="user_name" size="40" maxlength="30" styleId="user_name" value="${user_name}" disabled="true" />
							...
							<html-el:text property="add_date" size="40" maxlength="30" styleId="add_date" value="${add_date}" disabled="true" style="width:80px;background-color: #D8D8D8;" onclick="new Calendar(2005, 2030, 0).show(this);"/></td>
						</tr>
						<tr>
			          ...
			          <tr>
			           ...
			           <tr>
							<td nowrap="nowrap" class="title_item" align="right">合同期结算额：</td>
							<td align="left"><html-el:text property="con_date_money" size="40" maxlength="12" styleId="con_date_money" />
							</td>
							<td nowrap="nowrap" class="title_item" align="right">基本目标完成率：</td>
							<td align="left"><html-el:text property="base_target_wcl" size="40" maxlength="12" styleId="base_target_wcl" /></td>
						</tr>
						 <tr>
							<td nowrap="nowrap" class="title_item" align="right">合同期回款额：</td>
							<td align="left" colspan="3"><html-el:text property="con_date_backmoney" size="40" maxlength="12" styleId="con_date_backmoney" />
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
