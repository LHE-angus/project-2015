...
<body>
	<div class="oarcont">
		...
		<div class="rtabcont2">
			<html-el:form action="/admin/R3UserCodeMerge" method="post">
				...
				<table class="rtable3" width="100%" border="0" cellspacing="1"
					...
					<tr>
						...
						<td>
						<label> 
						<input class="but4" id="btn_commit"  type="button" value="合并" /> 
						</label>
						<label><input class="but5" type="button"  value="返回" onclick="history.back();" /></label>
						</td>
					</tr>
				</table>
			</html-el:form>
