...
<div align="center" style="margin-top: 20px;">
 ...
 <td>
       <table>
		 <tr>
		    <td>快速搜索:</td>
			<td><input type="text" name="no_choose_user_like" id="no_choose_user_like" size="24" maxlength="30" style="width:100px;" /></td>
			<td><input type="button" name="search" id="search" size="24" value="搜索" /></td>
		 </tr>
		 <tr>
		 <td>待选列表</td><td></td><td>已选列表</td>
		 </tr>
		 <tr>
		   <td rowspan="4"> 
