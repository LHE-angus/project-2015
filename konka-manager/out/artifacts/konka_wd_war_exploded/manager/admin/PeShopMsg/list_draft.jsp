        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <c:if test="${cur.par_id eq 0}"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PeShopMsg.do', 'editMsg', 'id=${cur.id}&tag_id=${af.map.tag_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">编辑</span></c:if>
              <c:if test="${cur.par_id ne 0}"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PeShopMsg.do', 'editReply', 'id=${cur.id}&tag_id=${af.map.tag_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">编辑</span></c:if>
              |
