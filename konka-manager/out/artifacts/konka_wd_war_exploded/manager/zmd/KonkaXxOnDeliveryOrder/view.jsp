...
<!--      </tr>-->
      ...
      <table width="100%" style="margin-top:10px;font-weight:bold;text-align:center;font-size:14px;">
      	<tr>
      		<td>已发货订单数：${empty dailyDist.today_total_bill_count?0:dailyDist.today_total_bill_count}</td>
      		<td>已发货产品数：${empty dailyDist.today_total_pd_count?0:dailyDist.today_total_pd_count}</td>
      	</tr>
      </table>
  </div>
