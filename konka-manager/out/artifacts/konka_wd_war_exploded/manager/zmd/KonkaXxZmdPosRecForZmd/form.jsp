...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/zmd/KonkaXxZmdPosRecForZmd">
      ...
      <html-el:hidden property="pos_id" value="${af.map.pos_id}" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
        ...
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">账单金额：</td>
        ...
        <tr>
          <td nowrap="nowrap" height="28" class="title_item" align="right">账单提交结算时间：</td>
          <td><fmt:formatDate value="${af.map.plan_date}" pattern="yyyy-MM-dd"/></td>
        </tr>
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">账单结算状态：</td>
          <td width="85%"><html-el:select property="state" style="state">
              <html-el:option value="1" >==未结算==</html-el:option>
              <html-el:option value="2">==已结算==</html-el:option>
            </html-el:select></td>
        </tr>
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">账单结算备注：</td>
          <td width="85%"><html-el:textarea property="memo" styleId="memo" style="height:60px;width:270px;"/></td>
        </tr>
        <tr>
          <td>&nbsp;&nbsp;</td>
