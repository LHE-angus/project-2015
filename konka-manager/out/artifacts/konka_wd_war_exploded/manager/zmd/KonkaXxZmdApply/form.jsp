...
<div class="oarcont">
  ...
  <div class="rtabcont2" style="position:relative;overflow:hidden;">
    <html-el:form action="/zmd/KonkaXxZmdApply"  styleClass="form_cust" enctype="multipart/form-data">
      <html-el:hidden property="method" value="save" />
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <html-el:hidden property="zmd_user_id" value="${af.map.zmd_user_id}" />
      <html-el:hidden property="zmd_sn" value="${af.map.zmd_sn}" />
      <html-el:hidden property="host_name" value="${af.map.zmd_user_name}" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
        <tr>
          <td colspan="4" style="font-weight:bold;font-size:18px;height:40px;text-align:center;border-bottom:none;">提交备案申请</td>
        </tr>
        <tr>
          <td colspan="4" style="font-weight:900;"><strong class="fb">专卖店基础信息</strong></td>
        </tr>
        <tr>
          <td width="18%" nowrap="nowrap" class="title_item" align="right">分公司：</td>
          <html-el:hidden property="dept_id" value="${dept_id}" />
          <td colspan="3">${dept_name}</td>
          <!-- 
          <td class="title_item" align="right">大区：</td>
          <td><html-el:select property="area_id" styleId="area_id" style="width:150px;">
              <html-el:option value="">==请选择==</html-el:option>
              <c:forEach var="cur" items="${baseTypesList140000}">
        ...
        <tr>
          <td width="18%" nowrap="nowrap" class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>专卖店编号：</td>
          <td width="32%"><html-el:text property="zmd_sn" styleId="zmd_sn" size="20" value="${af.map.zmd_sn}" maxlength="20" disabled="true" /></td>
          <td width="18%" nowrap="nowrap" class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>R3专卖店名称：</td>
          <td width="32%"><html-el:text property="r3_name" styleId="r3_name" size="20" maxlength="20" /></td>
        </tr>
        <tr>
          <td width="18%" nowrap="nowrap" class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>R3编码：</td>
          <td width="32%"><html-el:text property="r3_id" styleId="r3_id" size="20" maxlength="20" /></td>
          <td width="18%" nowrap="nowrap" class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>R3送达方编码：</td>
          <td width="32%"><html-el:text property="r3_send_num" styleId="r3_send_num" size="20" maxlength="20" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>专卖店地址：</td>
          <td valign="middle" colspan="3"><select name="province" id="province" >
        ...
        <tr>
          <td class="title_item" align="right"><span style="color:#FF0000;">[必填]</span>详细地址：</td>
          <td ><html-el:text property="addr" styleId="addr" size="20" maxlength="130" /></td>
          <td class="title_item" align="right">营业面积(平方米)：</td>
          <td><html-el:text property="busi_area" styleId="busi_area" size="20" maxlength="4" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right">租赁期：</td>
          <td><html-el:text property="rent_start" styleId="rent_start" value="${rent_start}"  size="10" maxlength="10" readonly="true" styleClass="webinput" style="cursor:pointer;"  title="点击选择日期" />
            至
          ...
          <td><html-el:text property="rent_fee" styleId="rent_fee" size="20" maxlength="5" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><html-el:text property="host_name" styleId="host_name" value="${af.map.zmd_user_name}" size="20" maxlength="30" disabled="true" /></td>
          <td class="title_item" align="right">专卖店负责人电话：</td>
          <td><html-el:text property="host_phone" styleId="host_phone" size="20" value="${af.map.tel}" maxlength="30" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right">分公司负责人：</td>
          <td><html-el:text property="dept_leader_name" styleId="dept_leader_name" size="20"  maxlength="30" /></td>
          <td class="title_item" align="right">分公司负责人电话：</td>
          <td><html-el:text property="dept_leader_phone" styleId="dept_leader_phone" size="20" maxlength="30" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right">分公司总经理：</td>
          <td><html-el:text property="dept_main_man" styleId="dept_main_man" size="20" maxlength="20" /></td>
          <td class="title_item" align="right">分公司财务经理：</td>
          <td><html-el:text property="dept_fnc_man" styleId="dept_fnc_man" size="20" maxlength="30" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right">申请样机额度(万元)：</td>
          <td><html-el:text property="money_of_dm_apply" styleId="money_of_dm_apply" size="20" maxlength="5" /></td>
          <td class="title_item" align="right">计划投放专卖店样机：</td>
          <td><html-el:textarea property="put_dm_plan" styleId="put_dm_plan" /></td>
        </tr>
        <tr>
          <td class="title_item" align="right">申请建店费用(万元)：</td>
          <td colspan="3"><html-el:text property="money_of_dcrt_apply" styleId="money_of_dcrt_apply" size="20" maxlength="5" /></td>
          <!-- 
          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
              ...
              <c:forEach items="${konkaXxZmdResList}" var="cur">
                <tr>
                  ...
                  <td align="left"><html-el:text property="res_pro_${cur.res_id}" styleId="res_pro_${cur.res_id}" style="width:70%;" maxlength="80" /></td>
                </tr>
              </c:forEach>
            </table></td>
          -->
        	...
        	<td colspan="4" width="100%">
	        	 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2" id="categorys_td">
	              	<tr class="tabtt1" style="height: 28px;">
	              	  <td align="center" nowrap="nowrap">工程项目</td>
	              	...
	              	<c:forEach items="${baseTypesList150000}" var="cur">
	              	  <tr>
	              	  	<td>
	              	  		<html-el:hidden property="item_name" value="${cur.type_name}" styleId="item_name_${cur.type_id}" />
	              	  		${cur.type_name}
	              	  	</td>
	              	  	<td><html-el:text property="pd_name" style="width:80px;" styleId="pd_name_${cur.type_id}" maxlength="30" /></td>
	              	  	<td><html-el:text property="model_name" style="width:80px;" styleId="model_name_${cur.type_id}" maxlength="30" /></td>
	              	  	<td><html-el:text property="item_num" style="width:80px;" maxlength="16" styleId="item_num_${cur.type_id}" onchange="javascript:setOnlyDouble(this);" onblur="sum_money(this);" /></td>
	              	  	<td><html-el:text property="unit" style="width:80px;" maxlength="10" styleId="unit_${cur.type_id}" /></td>
	              	  	<td><html-el:text property="price" style="width:80px;" maxlength="12" styleId="price_${cur.type_id}" onchange="javascript:setOnlyDouble(this);" onblur="sum_money(this);" /></td>
	              	  	<td><html-el:hidden property="total" style="width:80px;" styleId="total_${cur.type_id}"/>
	              	  		<html-el:text property="total_value" style="width:80px;" styleId="total_value_${cur.type_id}" disabled="true"/>
	              	  	</td>
	              	  	<td>&nbsp;</td>
	              	  </tr>
	              	</c:forEach>
        ...
        <tr>
          <td align="right" class="title_item">专卖店押金(万元)：</td>
          <td colspan="3" align="left"><html-el:text property="money_of_deposit" styleId="money_of_deposit" size="20" maxlength="5" /></td>
        </tr>
        <tr>
          <td nowrap="nowrap" class="title_item" align="right">固定资产配置：</td>
          <td colspan="3"><html-el:textarea property="fixed_asset" styleId="fixed_asset" rows="3" cols="60" /></td>
        </tr>
        <tr>
        ...
        <tr class="tr_type">
          <td nowrap="nowrap"  colspan="4"><table width="99%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
              <c:forEach var="cur_08" items="${baseTypesList80000}">
                <tr>
                  <td width="12%" nowrap="nowrap" class="title_item" align="right">${cur_08.type_name}：</td>
                  <td width="88%"> 返佣比例（百分比）：
                    ...
                    锁定 <span id="locked_id_${cur_08.type_id}"></span></td>
                </tr>
              </c:forEach>
            </table></td>
        </tr>
        <!-- <c:if test="${not empty konkaXxStdStoreList}"> -->
          <tr>
            <td colspan="4" style="font-weight:900;"><strong class="fb">专卖店仓库分配</strong> &nbsp;&nbsp;
          ...
          <tr>
            <td colspan="4"><ul id="fact_str">
                <c:forEach var="cur" items="${konkaXxStdStoreList}" varStatus="vs">
                  <li>
                    <html-el:checkbox property="" styleId="${cur.fac_sn}_${cur.store_sn}" styleClass="zmd_values" />
                    &nbsp;${cur.fac_sn}
                    &nbsp;${cur.store_desc} </li>
                </c:forEach>
              </ul>
       ...
       <!-- </c:if>-->
        ...
        <tr>
          <td colspan="4" height="40"  align="center"><input class="but4" type="submit" name="submit" value="提交 " id="submit" />
...
$(document).ready(function(){
	...
	$("#busi_type").attr("dataType", "Require").attr("msg", "请选择经营性质！");
	$("#put_dm_plan").attr("dataType", "Limit").attr("max", "200").attr("msg", "计划投放样机不能超过200个文字");
	...
	$("input[id^=is_enabled_]").attr("checked", "checked");
	$("#addr").attr("datatype", "Require").attr("msg", "请输入专卖店详细地址");
	$("#busi_type").attr("dataType", "Require").attr("msg", "请选择经营性质！");
	$("#busi_mod").attr("dataType", "Require").attr("msg", "请选择经营模式！");
	$("#zmd_status").attr("dataType", "Require").attr("msg", "请选择专卖店状态！");
	...
	$("#province").change();
	 ...
	 $("input[id^=reward_ratio_]").focus(setOnlyNum);
	 ...
	 $("#money_of_deposit").focus(setOnlyNum);
	 $("#money_of_sell_by_year_plan").focus(setOnlyNum);
	 $("#dept_leader_phone").focus(setOnlyNum);
	 
$(".form_cust").submit(function(){

		if($("#check_all").val() == 10100){
			$("input[id^=reward_ratio_]").attr("datatype", "Require").attr("msg", "请输入返佣比例");
		}
	
		 $("span[id^=tip_msg_]").remove();
		 var b = true ;
		...
		if (isSubmit) {
		 $("input[id^=reward_ratio_]").each(function(){
	           var reward_ratio = $(this).val();
	           var type_id =  this.id.replace("reward_ratio_","");
	           if($.trim(reward_ratio)>100){
	        	   $("#locked_id_"+ type_id).after("<span id=\"tip_msg_\"+type_id style=\"color:#F00;margin-left:5px;\">* 返佣比例不能超过100%！</span>");
                   b = false;
	           }
		 });
         if(!b){
