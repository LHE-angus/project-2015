  ...
  <div id="divExcel" class="rtabcont2" align="center" title="${stm_title}" style="margin-top:4px;">
    ...
    <table id="table1" width="100%" border="1" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap" align="center">金额合计（元）</td>
      </tr>
      ...
      <table width="100%" style="margin-top:10px;font-weight:bold;text-align:center;font-size:14px;">
      	<tr>
      		<td align="left">截至昨日总收款：<fmt:formatNumber value="${his_total_money}" pattern="#,#00.00#" /> 元</td>
      		<td>今日收款：<fmt:formatNumber value="${today_total_money}" pattern="#,#00.00#" /> 元</td>
      		<td align="right">总收款：<fmt:formatNumber value="${today_total_money + his_total_money}" pattern="#,#00.00#" /> 元</td>
      	</tr>
      </table>
  </div>
