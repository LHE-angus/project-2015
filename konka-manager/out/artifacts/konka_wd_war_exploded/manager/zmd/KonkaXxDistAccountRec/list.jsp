  ...
  <div class="rtabcont1">
    <html-el:form action="/zmd/KonkaXxDistAccountRec">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td width="15">&nbsp;</td>
          <td><strong class="fb">计划结算时间：</strong>
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2" >
      ...
      <tr class="tabtt1">
        ...
        <td width="10%" align="center" nowrap="nowrap"><font class="blue">计划结算时间</font></td>
        <td width="10%" align="center" nowrap="nowrap"><font class="blue">物流结算人</font></td>
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="confirmUpdate(null, 'KonkaXxDistAccountRec.do', 'dist_id=${cur.dist_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">汇款确认</span></td>
        </tr>
      </c:forEach>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaXxDistAccountRec.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>&nbsp;</td>
