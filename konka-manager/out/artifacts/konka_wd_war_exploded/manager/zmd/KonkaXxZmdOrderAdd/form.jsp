...
<style type="text/css">
	...
	.son_ul {width:40px; position:absolute;z-index:1;left:27px; top:20px; border:1px solid #ccc; background:#f2f2f2;}
	.son_ul li {display:block; line-height:25px;}
	.hover {background:#fff;color:#6699ff;}
	.disButton{background:url(${ctx}/images/manager/butbg1.gif) repeat-x;border:1px #c4c4c4 solid;font:normal 12px/20px "宋体";color:#333;padding: 0px 1px 0px 1px !important;padding: 0px 1px 0px 1px;letter-spacing: 1px;font-size:12px; cursor:pointer;}
</style>
</head>
<body>
<div class="oarcont" style="position:relative;overflow:hidden;">
  ...
  <div class="rtabcont2">
	  <html-el:form action="/zmd/KonkaXxZmdOrderAdd">
		  ...
		  <table id="main_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
		  	...
		  	<tr>
		  		<td colspan="4" style="font-weight:900;">销售单信息
		  			<c:if test="${not empty af.map.sell_bill_id}">（订单流水号：<span style="color:#FF0000;font-size:15px;">${fnx:leftPad_sis(af.map.sell_bill_id, 12, '0')}</span>）</c:if>
		  			<a id="more_pd" href="javascript:void(0);" onclick="$('#message_tip_more_pd').show();" onmousemove="$(this).css('color', '#FF0000');" onmouseout="$(this).css('color', '#6699ff');" style="color:#6699ff;margin-left:5px;text-decoration:none;float:right;">点击进入“康佳在线销售系统”采购更多康佳产品&gt;&gt;</a>
		  		</td>
		  	</tr>
		  	<tr>
	            ...
	            <td width="35%" align="left" style="padding-bottom:5px;font-weight:700;font-size:16px;color:#F00;font-style:italic;">
		  	...
		  	<tr>
		  		<td class="title_item" nowrap="nowrap" align="right"><span style="color:#FF0000;">[必填]</span>下单人员：</td>
		  		<td align="left" style="padding-bottom:5px;"><html-el:text property="sell_man" styleId="sell_man" value="${userInfo.real_name}" maxlength="20" size="30" /><a id="delSalesUser" href="javascript:void(0);" onclick="$(this).prev().val('').focus();" onmousemove="$(this).css('color', '#FF0000');" onmouseout="$(this).css('color', '#6699ff');" style="color:#6699ff;margin-left:5px;text-decoration:underline;">清空</a></td>
		  		<td class="title_item" nowrap="nowrap" align="right"><span style="color:#FF0000;">[必填]</span>下单时间：</td>
		  		<td align="left" style="padding-bottom:5px;">
		  			<fmt:formatDate value="${af.map.sell_date}" pattern="yyyy-MM-dd" var="sell_date_" />
		  	...
		  	<tr>
		  		<td colspan="4" style="font-weight:900;">收货人信息</td>
		  	</tr>
	        <tr>
	        ...
	        <tr>
	        	...
	        	<td align="left" colspan="3" style="padding-bottom:5px;"><html-el:text property="sell_post_addr" styleId="sell_post_addr" maxlength="30" size="80" value="${af.map.konkaXxZmd.addr}" /></td>
	        </tr>
	        <tr>
	        	<td class="title_item" nowrap="nowrap" align="right"><span style="color:#FF0000;">[必填]</span>收货人姓名：</td>
	        	<td align="left" style="padding-bottom:5px;"><html-el:text property="sell_rec_name" styleId="sell_rec_name" maxlength="20" value="${userInfo.real_name}" /></td>
	        	<td class="title_item" nowrap="nowrap" align="right"><span style="color:#FF0000;">[必填]</span>收货人联系电话：</td>
	        	<td align="left" style="padding-bottom:5px;"><html-el:text property="sell_rec_link_mp" styleId="sell_rec_link_mp" maxlength="13" value="${userInfo.link_phone}" /></td>
	        </tr>
	        <tr>
	        	<td class="title_item" nowrap="nowrap" align="right">备注：</td>
	        	<td align="left" colspan="3" style="padding-bottom:5px;">
	        		<html-el:textarea property="sell_remarks" styleId="sell_remarks" cols="70" rows="2" />
	        ...
	        <!-- 商品信息Begin -->
	        <tr>
		  		<td colspan="4" style="font-weight:900;"><span style="color:#FF0000;">[必填]</span>商品信息</td>
		  	</tr>
	        <tr>
	        	<td colspan="4" align="left" style="padding-top:5px;padding-bottom:5px;">
	        	  <div id="div_2">
	        		<!-- 产品信息Begin -->
	        		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
				        <tr class="tabtt1" style="background-image:url('${ctx}/images/manager/tabtitbg1.gif') repeat-x;background:#F0F0F0;">
				          ...
				          <td width="7%" align="center" nowrap="nowrap">品类</td>
				          ...
				          <td width="14%" align="center" nowrap="nowrap">备注</td>
				        ...
				        <tr id="pdModel" style="display:none;height:40px;">
				        	...
				        	<td align="center" nowrap="nowrap">
				        		<html-el:text property="counts" styleId="counts" disabled="true" style="width:40px;border:0;border-bottom:1 solid black;" maxlength="5" value="0" />
				        	</td>
				        	<td align="center" nowrap="nowrap">
				        		<ul id="main_box">
  									<li class="select_box">
  										<img src="${ctx}/images/yen.png" alt="￥" title="RMB" />
						        		<html-el:text property="price" styleId="price" disabled="true" style="width:45px;" maxlength="8" />
				        ...
				        <tbody id="showSalesOrderTbody">
				        	<c:forEach items="${sellBillDetailsList}" var="cur_" varStatus="vs">
				        		<tr id="hx_tr_${vs.count}">
				        			...
				        			<td align="center">${cur_.pd_cls_name}</td>
				        			<td align="center">${cur_.map.pdStocksNum}</td>
				        			<td align="center"><html-el:text property="counts" styleId="counts" style="width:40px;cursor:pointer;border:0;border-bottom:1 solid black;background:#CBF7C5;" maxlength="5" value="${cur_.counts}" readonly="true" onclick="openDeliveryDiv('${cur_.md_name}', '${cur_.pd_cls_name}', $('#hx_tr_${vs.count}'), '${af.map.reserverd_stock}')" /></td>
				        			<td align="center">
				        				<ul id="main_box">
		  									<li class="select_box">
		  										<img src="${ctx}/images/yen.png" alt="￥" title="RMB" />
								        		...
								        		<ul class="son_ul" style="display:none;">
											     	<li id="son_li"><a href="#" data-reveal-id="myModal" onclick="discount('${cur_.md_name}', ${cur_.map.price_ref}, '${cur_.map.price_min}', $(this).parent().parent().parent().parent().parent().parent(), $('#price', $(this).parent().parent().parent().parent().parent().parent()).val())">折扣</a></li>
											   	</ul>
											</li>
										</ul>
				        			</td>
				        			<td align="right"><img src="${ctx}/images/yen.png" alt="￥" title="RMB" /><span id="pdAmount"><fmt:formatNumber value="${cur_.counts * cur_.price}" pattern="0.00" /></span></td>
				        			<td align="center">
				        				<html-el:select property="pd_type" styleId="pd_type" value="${cur_.pd_type}">
				        ...
				        <tr id="total">
				        	...
				        	<td></td>
				        	<td align="right" nowrap="nowrap"><img src="${ctx}/images/yen.png" alt="￥" title="RMB" /><html-el:text property="total_money" styleId="total_money" styleClass="price" style="width:70px;color:red;font-weight:bold;margin-right:3px;" maxlength="8" value="${empty af.map.total_money ? '0.00' : af.map.total_money}" /></td>
				        	<td colspan="3"></td>
				        </tr>
				    </table>
				    <!-- 产品信息End -->
	        ...
	        <tr>
		  	...
		  	<tr>
		  		...
		  		<td align="left" style="padding-bottom:5px;">
		  			<label for="pay_way_1" style="cursor:pointer;"><html-el:radio property="pay_way" styleId="pay_way_1" value="1">全额现金支付</html-el:radio></label>
		  			<label for="pay_way_2" style="cursor:pointer;"><html-el:radio property="pay_way" styleId="pay_way_2" value="2">全额POS刷卡</html-el:radio></label>
		  			<label for="pay_way_3" style="cursor:pointer;"><html-el:radio property="pay_way" styleId="pay_way_3" value="3">货到付款</html-el:radio></label>
		  		</td>
		  	...
		  	<tr id="money_of_deposit_tr" style="display: none;">
		  		...
		  		<td align="left" colspan="3" style="padding-bottom:5px;"><html-el:text property="money_of_deposit" styleId="money_of_deposit" maxlength="8" value="${empty af.map.money_of_deposit?0:af.map.money_of_deposit}" />&nbsp;<img src="${ctx}/images/yen.png" alt="￥" title="RMB" /></td>
		  	</tr>
		  	<tr id="pos_bill_sn_tr" style="display: none;">
		  		...
		  		<td align="left" colspan="3" style="padding-bottom:5px">
		  			<html-el:text property="pos_bill_sn" styleId="pos_bill_sn" maxlength="20"></html-el:text>
		  		</td>
		  	</tr>
		  	<tr>
		  		<td class="title_item" nowrap="nowrap" align="right"><span style="color:#FF0000;" id="sell_bill_head_span"></span>发票抬头：</td>
		  		<td align="left" style="padding-bottom:5px;">
		  			<html-el:text property="sell_bill_head" styleId="sell_bill_head" maxlength="20"></html-el:text>
		  		</td>
		  		<td class="title_item" nowrap="nowrap" align="right">发票纳税人识别号：</td>
		  		<td align="left" style="padding-bottom:5px;">
		  			<html-el:text property="sell_bill_taxpayer_id" styleId="sell_bill_taxpayer_id" maxlength="20"></html-el:text>
		  		</td>
		  	</tr>
		  	<!-- 付款方式End -->
	        <!-- 财务审核信息Begin -->
	        <c:if test="${af.map.sell_state gt 10}">
	        	<tr>
			  	...
			  	<tr>
			  		...
			  		<td align="left" colspan="3" style="padding-bottom:5px;">
			  			<c:if test="${af.map.sell_state eq 20}">已审核通过</c:if>
			  			<c:if test="${af.map.sell_state eq 21}">已审核不通过</c:if>
			  			<c:if test="${af.map.sell_state gt 21}">已审核通过</c:if>
			  		</td>
			  	</tr>
			  	<tr>
			  		<td class="title_item" nowrap="nowrap" align="right">备注：</td>
  ...
  <div id="message_tip" style="display:none;">
    ...
    <div style="position:fixed;width:280px;height:130px;left:35%;top:30%;padding:10px;" class="ui-widget ui-widget-content ui-corner-all">
	  <span><img id="loading" src="${ctx}/images/loading.gif" style="display:none;" /><img src="${ctx}/images/wait.gif" />&nbsp;正在提交订单，请稍等...</span>
    </div>
  </div>
  <div id="message_tip_2" style="display:none;">
    ...
    <div style="position:fixed;width:280px;height:130px;left:35%;top:30%;padding:10px;" class="ui-widget ui-widget-content ui-corner-all">
    	<div style="width:95%;margin-bottom:10px;margin-top:10px;font-size:15px;"><img src="${ctx}/styles/message/images/16.gif" />&nbsp;恭喜您，添加销售单成功！</div>
  ...
  <div id="message_tip_more_pd" style="display:none;">
    <div class="ui-overlay">
  	  <div class="ui-widget-overlay"></div>
  	  <div class="ui-widget-shadow ui-corner-all" style="width:302px;height:152px;position:fixed;left:35%;top:30%"></div>
    </div>
    <div style="position:fixed;width:280px;height:130px;left:35%;top:30%;padding:10px;" class="ui-widget ui-widget-content ui-corner-all">
    	<div style="width:95%;margin-bottom:10px;margin-top:10px;font-size:15px;">感谢您对康佳的支持，该功能目前正在研发中，敬请期待！</div>
    	<div style="position:absolute;bottom:10px;right:10px;"><button type="button" onclick="$('#message_tip_more_pd').hide();">关闭</button></div>
    </div>
  </div>
</div>
		...
		<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td align="left" colspan="2" nowrap="nowrap">
					<label for="discount_radio_9" style="cursor:pointer;"><input type="radio" name="discount_radio" id="discount_radio_9" value="9.5" />九五折</label>
					<label for="discount_radio_8" style="cursor:pointer;"><input type="radio" name="discount_radio" id="discount_radio_8" value="9" />九折</label>
					<label for="discount_radio_7" style="cursor:pointer;"><input type="radio" name="discount_radio" id="discount_radio_7" value="8" />八折</label>
					<label for="discount_radio_0" style="cursor:pointer;"><input type="radio" name="discount_radio" id="discount_radio_0" value="0" />其他</label>
				</td>
			</tr>
			<tr>
				<td align="right" nowrap="nowrap" height="35" style="font-weight:bold;">单价：</td>
				<td align="left" nowrap="nowrap">
					<input type="text" name="discount" id="discount" readonly="readonly" style="width:60px;background:#f2f2f2;" maxlength="8" /><img src="${ctx}/images/yen.png" alt="￥" title="RMB" />
				</td>
...
$(document).ready(function(){
	...
	if ("" != "${af.map.msg}") {
		$.jGrowl("${af.map.msg}", {theme:'success', life: 4500});
	}
	...
	$("#printRece").button({icons: {primary: "ui-icon-arrowreturnthick-1-s"}}).click(function(){
		location.href = "KonkaXxPrintReceipt.do?method=showReceipt&sell_bill_id=${af.map.billId}&mod_id=802014";
	});
	...
	$("#country").attr({"subElement": "town","defaultText": "=请选择区/县=", "defaultValue": "", "selectedValue": "${fn:substring(af.map.zmd_p_index, 0, 6)}"});
	$("#town").attr({"defaultText": "=请选择乡/镇=", "defaultValue": "", "selectedValue": "${af.map.zmd_p_index}"});
	...
	$("#addPdTD").click(function(){
		...
		$("#total_money", lastTR).focus(setOnlyNum1);
		
		$("#price", lastTR).hover(function(){ //鼠标移动函数
		   	$(this).parent().find('ul.son_ul').slideDown();  //找到ul.son_ul显示
		   	$(this).parent().find('li').hover(function(){$(this).addClass('hover');},function(){$(this).removeClass('hover');}); //li的hover效果
		   	$(this).parent().hover(function(){},function(){
 				$(this).parent().find("ul.son_ul").slideUp(); 
			...
			click: function(event, ui){
		       if(ui.value != ""){
				   ...
				   $("#counts", lastTR).click(function(){
					   openDeliveryDiv($("#md_name", lastTR).val(), $("#pd_cls_name", lastTR).val(), lastTR, "${af.map.reserverd_stock}");
				   });

				   //折扣
				   $("#son_li", lastTR).empty().append('<a href="#" data-reveal-id="myModal" onclick="discount(\'' + md_name +'\', ' + price_ref + ', ' + price_min + ', $(this).parent().parent().parent().parent().parent().parent(), $(\'#price\', $(this).parent().parent().parent().parent().parent().parent()).val())">折扣</a>');
		       }
			}
...
//				alert("counts = " + counts);
		...
		if (flag5) {
			alert("您购买的商品〖" + mdName + "〗还未查看库存填写购买数量");
			$("#search_btn", $(obj)).focus();
			return false;
		}
		if (flag6) {
			alert("您购买的商品〖" + mdName + "〗更改了销售数量，请重新查看库存填写购买数量");
			$("#search_btn", $(obj)).focus();
			return false;
		}
	...
	$.ajax({
        ...
        success: function (result) {
            if ("" == result[0].pdStocksNum || undefined == result[0].pdStocksNum) {
            	...
            	else parObj.children().eq(3).html("<span style='color:#F00;'>无</span>");
            	flag = true;
			}
        }
	}); 
...
function openDeliveryDiv(md_name, pd_cls_name, parObj, reserverd_stock){
	...
	$("#newDeliveryDiv").dialog({
	      ...
	      open: function(event, ui) {
		  			getPdStoresList(md_name, counts, str, parObj, reserverd_stock);
	      		},
...
function getPdStoresList(md_name, counts, str, parObj, reserverd_stock){
    $.ajax({
    	type: "POST" , 
        url: 'KonkaXxZmdAddSalesOrder.do' , 
        data: "method=getPdStoresList&zmd_id=${af.map.zmd_id}&md_name=" + escape(encodeURIComponent(md_name)) + "&sell_bill_id=${af.map.sell_bill_id}&n=" + Math.random(), 
        dataType: "json" , 
        async: true, 
...
//折扣
function discount(md_name, price_ref, price_min, parObj, price){
	//alert(parObj.attr("id"));
	//alert(price);
