  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap" align="center" >属性类别名称</td>
      </tr>
        <tr>
          <td align="center" nowrap="nowrap"><input name="pks" type="checkbox" class="pks"  value="0" /></td>   
          <td align="center" nowrap="nowrap">1</td>
          <td align="left" nowrap="nowrap" id="s_0">新品</td>
        </tr>
        <tr>
          <td align="center" nowrap="nowrap"><input name="pks" type="checkbox" class="pks"  value="2" /></td>
          <td align="center" nowrap="nowrap">2</td>
          <td align="left" nowrap="nowrap" id="s_2">热销</td>
        </tr>
        <tr>
          <td align="center" nowrap="nowrap"><input name="pks" type="checkbox" class="pks"  value="3" /></td>
          <td align="center" nowrap="nowrap">3</td>
          <td align="left" nowrap="nowrap" id="s_3">特惠</td>
        </tr>
        <tr>
          <td align="center" nowrap="nowrap"><input name="pks" type="checkbox" class="pks"  value="7" /></td>
          <td align="center" nowrap="nowrap">4</td>
          <td align="left" nowrap="nowrap" id="s_7">精品</td>
        </tr>
        <tr>
...
$(document).ready(function(){
	...
	var cs= W.document.getElementById("goods_types_hid").value;    
	var prod_names= W.document.getElementById("type_name_hid").value;  
	...
	$(document).delegate(".pks", "click", function(){
		...
		W.document.getElementById("goods_types_hid").value=cs;  
		W.document.getElementById("type_name_hid").value=prod_names;
		W.document.getElementById("goods_types").value=p_name_show;     
	});
