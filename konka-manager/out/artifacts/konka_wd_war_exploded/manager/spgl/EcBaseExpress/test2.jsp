...
<style type="text/css">  
<!-- fixed 不随页面滚动 absolute 随页面滚动-->
#bg{display:none;position: fixed;top:0%;left: 0%; width: 100%;height: 5500px;background-color: black;z-index:10001;-moz-opacity: 0.7;opacity:.70;filter: alpha(opacity=70);} 
...
function showdiv() {
	var url="${ctx}/manager/spgl/EcBaseExpress.do?method=show";
