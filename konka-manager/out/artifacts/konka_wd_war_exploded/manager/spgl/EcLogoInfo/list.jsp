...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
      <html-el:form action="/spgl/EcLogoInfo">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
          <tr>
            ...
            <html-el:select property="plat_sys" styleId="plat_sys" style="width:120px;">
              ...
              &nbsp;&nbsp;
					 <strong class="fb">添加人  ：</strong> <html-el:text property="add_user_name_like" styleId="add_user_name_like" maxlength="30" styleClass="webinput" />&nbsp;&nbsp;
    ...
    <html-el:form action="/spgl/EcLogoInfo?method=delete">
      <div class="rtabcont1">
        <!--   <input type="button" class="but3" name="delete" id="delete" value="回收站" onclick="confirmDeleteAll(this.form);" />  -->
         <logic-el:match name="popedom" value="+1+"> 
        <input type="button" class="but2" name="add" value="添加 " onclick="location.href='EcLogoInfo.do?method=add&mod_id=${af.map.mod_id}';" />
        </logic-el:match>
        <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
        <html-el:hidden property="method" value="delete" />
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr class="tabtt1">
          <td width="5%" align="center" nowrap="nowrap" style="display: none;"><input name="chkAll" type="checkbox" id="chkAll" value="-1" onclick="checkAll(this);" /></td>
          ...
          <td width="8%" align="center" nowrap="nowrap">LOGO类型</td>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          ...
          <tr>
            ...
            <td align="left"><a class="preview" href="EcLogoInfo.do?method=view&id=${cur.id}&mod_id=${af.map.mod_id}" rel="${cur.logo_url}" title="${fn:escapeXml(cur.title)}">${fn:escapeXml(cur.title)}</a></td>
           ...
           <!--   <c:if test="${cur.del_mark eq 1}">
              <span style="color:#ccc">修改 | 删除</span>
                 ...
                 <logic-el:match name="popedom" value="+2+"> 
              	<a href="#" onclick="confirmUpdate(null, 'EcLogoInfo.do', 'id=${cur.id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">修改</a>  
                </logic-el:match>
                <logic-el:notMatch name="popedom" value="+2+"> 
            	 <span style="color: #ccc">修改</span>
            	 </logic-el:notMatch>
              <!--    <a href="#" onclick="confirmDelete(null, 'EcLogoInfo.do', 'mod_id=${af.map.mod_id}&id=${cur.id}&pager.requestPage=${af.map.pager.requestPage}')">删除</a> -->
            </td>
          </tr>
        </c:forEach>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="../spgl/EcLogoInfo.do">
