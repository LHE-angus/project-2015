    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
      ...
      <tr>
       ...
       <tr>
        ...
        <td align="left">${af.map.original_price}</td>
      </tr>
      <tr>
        <td class="title_item" nowrap="nowrap">所需积分：</td>
        <td align="left">${af.map.need_integral}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="title_item" nowrap="nowrap">下架时间：</td>
        <td align="left"><fmt:formatDate value="${af.map.down_time}" pattern="yyyy-MM-dd" /></td>
      </tr>
      <tr>
        <td class="title_item" nowrap="nowrap">最后上架时间：</td>
        <td align="left"><fmt:formatDate value="${af.map.last_up_time}" pattern="yyyy-MM-dd" /></td>
      </tr>
      <tr>
        <td class="title_item" nowrap="nowrap">状态：</td>
        <td align="left"><c:set var="now">
            <fmt:formatDate value="${today}" pattern="yyyy-MM-dd" />
          </c:set>
          <c:choose>
            <c:when test="${not empty af.map.down_time}">
              <c:set var="downDate">
                <fmt:formatDate value="${af.map.down_time}" pattern="yyyy-MM-dd" />
              </c:set>
            </c:when>
            <c:otherwise>
      ...
      <tr>
        ...
        <td align="left">
        	<c:if test="${af.map.own_sys eq 1}">工卡系统</c:if>
        	<c:if test="${af.map.own_sys eq 2}">触网系统</c:if>
        </td>
      </tr>
      <tr>
