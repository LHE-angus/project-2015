...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcJieSuanRebates">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr style="height:25px;">
          <td style="height:25px;" nowrap="nowrap"> <strong class="fb">月份选择：</strong>
            ...
            <html-el:option value="4">已抵扣货款</html-el:option>
            </html-el:select>&nbsp;&nbsp;
              <br/>
            </td>
        </tr>
        <tr style="height:25px;">
          ...
          <strong class="fb">交易流水号：</strong>
           ...
           <strong class="fb">工卡号：</strong>
            <html-el:text property="card_no_like" styleId="card_no_like" style="width:100px;" />&nbsp;&nbsp;
             <strong class="fb">真实姓名：</strong>
            <html-el:text property="real_name_like" styleId="real_name_like" style="width:100px;" />&nbsp;&nbsp;  
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tbody>
         ...
         <!-- 员工姓名  工卡号  开户银行 银行账号  银行户名   产品  销售价格  现款价 佣金  结算金额-->
            ...
            <td width="15%" nowrap="nowrap" align="center">佣金发放时间</td>
          </tr>
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="center"><c:if test="${cur.rebates_status eq 4}">已抵扣货款</c:if><c:if test="${cur.rebates_status eq 0}">未确认</c:if><c:if test="${cur.rebates_status eq 2}">提现 未发放</c:if><c:if test="${cur.rebates_status eq 1}">提现 已发放</c:if><c:if test="${cur.rebates_status eq 3}">已兑换积分</c:if></td>
              <td align="center" nowrap="nowrap"><fmt:formatDate value="${cur.rebates_date}" pattern="yyyy-MM-dd" /> </td>
             </tr>
        ...
        <tr>
          <td height="40" align="right"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
            <script type="text/javascript">
	            ...
	            pager.addHiddenInputs("rebates_status", "${af.map.rebates_status}");
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/manager/spgl/EcJieSuanRebates.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/manager/spgl/EcJieSuanRebates.do";
    	 this.value="Excel";
    	 this.disabled=false;
    });
});
