    ...
    <html-el:form action="/spgl/EcVouchersGl" method="post">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td width="88%" align="left"><html-el:text property="num" styleId="num" size="30" maxlength="6"/></td>
        </tr>
        <tr>
...
$(document).ready(function(){
	...
	$("#num").attr("datatype", "Require").attr("msg", "申请数量必须为大于0的整数！").focus(function(){setOnlyInt(this);});;
