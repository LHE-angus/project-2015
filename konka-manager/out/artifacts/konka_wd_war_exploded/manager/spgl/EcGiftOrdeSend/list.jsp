...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcGiftOrdeSend">
  ...
  <div class="rtabcont1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tbody>
          <tr class="tabtt1">
            ...
            <td nowrap="nowrap" width="5%">正在处理的部门</td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcGiftOrdeSend.do','send' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">发货</span>
              </c:when>
              <c:otherwise>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcGiftOrdeSend.do">
