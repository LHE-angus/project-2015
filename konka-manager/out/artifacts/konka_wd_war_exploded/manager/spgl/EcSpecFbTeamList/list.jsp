...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcSpecFbTeamList">
      <html-el:hidden property="method" value="list" />
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td height="36" align="left" style="padding-left:5px;">
          			&nbsp;&nbsp;球队名称  ： <html-el:text property="team_name_like" styleId="team_name_like" styleClass="webinput" />&nbsp;&nbsp;
          			&nbsp;&nbsp;球队组  ：
          			<html-el:select property="group_name" styleId="group_name" style="width:120px;">
          			    <html-el:option value="">请选择组队</html-el:option>
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;&nbsp;<input type="button" class="but2" value="新 增" onclick="location.href='EcSpecFbTeamList.do?method=add&mod_id=${af.map.mod_id}';" />
				</td>
			</tr>
		</table>		
	</div>
  <div class="rtabcont1">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap" align="center" >球队名称</td>
        <td nowrap="nowrap" align="center" >球队组名</td>
        <td width="15%" nowrap="nowrap" align="center">球队国旗</td>
         <td width="15%" nowrap="nowrap" align="center">球队图片</td>
        <td width="20%" nowrap="nowrap" align="center">球队介绍</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="left" nowrap="nowrap">${cur.team_name}</td>
          <td align="left" nowrap="nowrap">${cur.group_name}</td>
          <td align="center" nowrap="nowrap"><img width="60px" height="40px" src="${ctx}/${fn:substringBefore(cur.team_flag_pic_url, '.')}_191.jpg" /></td>
          <td align="center" nowrap="nowrap"><img width="60px" height="40px"  src="${ctx}/${fn:substringBefore(cur.team_main_pic_url, '.')}_191.jpg" /></td>
           <td align="left" nowrap="nowrap">${cur.team_intro}</td>
          ...
          <td align="center" nowrap="nowrap"> 
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcSpecFbTeamList.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
            <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('您确定删除吗？', 'EcSpecFbTeamList.do','delete' ,'id=${cur.id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">删除</span>
          </td> 
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcSpecFbTeamList.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;">
              ...
              <script type="text/javascript">
								...
								pager.addHiddenInputs("team_name_like", "${af.map.team_name_like}");
