		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					...
					<input type="button" class="but2" value="新增" onclick="location.href='EcGoodsRebateNew.do?method=add2&mod_id=${af.map.mod_id}&goods_id_1=${af.map.goods_id}&pd_name=${af.map.pd_name}';" />
					</c:if>
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr >
        ...
        <td  width="10%"  align="center">所属客户</td>
        <td  width="10%"  align="center" >计算类型</td>
        <td  width="10%"  align="center" >佣金值</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="center" >  
           ...
           <td align="center" >  
          	${cur.ecCust.cust_name}
          </td>
           <td align="center" >
          	<c:if test="${cur.rebate_way eq 1}">固定值</c:if>
          	<c:if test="${cur.rebate_way eq 2}">比例</c:if>
          </td>
          <td align="center" >
          	${cur.rebate_value}
          </td>
          ...
          <td align="center"  nowrap="nowrap">
             <c:if test="${is_admin eq 1}"> 
         	 <input type="button" class="but2" value="修改" onclick="location.href='EcGoodsRebateNew.do?method=edit2&id=${cur.id}&goods_id=${af.map.goods_id}&mod_id=${af.map.mod_id}';" />
         	 <input type="button" class="but2" value="删除" onclick="location.href='EcGoodsRebateNew.do?method=delete2&id=${cur.id}&goods_id=${af.map.goods_id}&mod_id=${af.map.mod_id}';" />
          	 </c:if>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcGoodsRebateNew.do">
