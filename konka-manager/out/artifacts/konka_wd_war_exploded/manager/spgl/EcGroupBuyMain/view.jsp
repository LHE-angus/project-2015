...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
      ...
      <tr>
        <td width="12%" class="title_item" nowrap="nowrap">所属商家：</td>
        <td align="left">
        <c:if test="${af.map.shop_id eq 1001}">西北印象</c:if>
        <c:if test="${af.map.shop_id eq 1002}">待定</c:if>
        </td>
      </tr>
      <tr>
        <td width="12%" class="title_item" nowrap="nowrap">商家地址：</td>
        <td align="left">${fn:escapeXml(af.map.addr)}</td>
      </tr>
      <tr>
        <td width="12%" class="title_item" nowrap="nowrap">商家电话：</td>
        <td align="left">${fn:escapeXml(af.map.tel)}</td>
      </tr>
      <tr>
