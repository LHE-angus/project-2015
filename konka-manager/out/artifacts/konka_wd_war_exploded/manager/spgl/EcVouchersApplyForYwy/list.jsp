...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcVouchersApplyForYwy">
  ...
  <div class="rtabcont1">
        ...
        <tr>
         ...
         <c:if test="${cur.info_state eq 2}">
          ...
          <td align="center" nowrap="nowrap"> 
         	   ...
         	   <c:if test="${cur.info_state eq 0 and cur.state eq 10 and cur.is_send eq 0}"> 
         	   <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcVouchersApplyForYwy.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">审核</span>   
          	   </c:if>	 
          	<!-- <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('您确定删除吗？', 'EcVouchersApply.do','delete' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">删除</span> -->
          </td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcVouchersApplyForYwy.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
