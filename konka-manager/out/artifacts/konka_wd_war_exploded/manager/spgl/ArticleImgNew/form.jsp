...
<div class="oarcont" style="margin-bottom: 100px;">
    ...
    <table width="500" border="0" cellpadding="0" cellspacing="0">
 	...
 	<div class="rtabcont2">
    <html-el:form action="/spgl/ArticleImgNew" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          <td nowrap="nowrap" class="title_item"><span style="color: #F00;">* </span>栏目：</td>
          <td><html-el:select property="news_module" styleId="news_module">
        ...
        <tr>
          ...
          <td><c:if test="${not empty (af.map.image_path)}" var="hasImage"> <img src="${ctx}/${fn:substringBefore(af.map.image_path, '.')}_240.jpg" title="${af.map.image_desc}" /> <br />
            ...
            <div class="desc">上传的主图尺寸高度 为<span style="color:#f00;"> 372(像素)长度尽可能长</span>，格式为jpg，否则在首页幻灯片显示中会变形或模糊(<span style="color:#f00;">其中：(1)触网首页通屏轮播(PC)图片的大小应为990*400,
         (2)   触网登陆通屏轮播(PC)图片的大小应为990*400,
（3）触网手机端主页面轮播图（MB）图片的大小应为640*260;</span>)</div></td>
        </tr>
        <tr>
          <td nowrap="nowrap" class="title_item"><span style="color: #F00;">* </span>链接：</td>
          <td><html-el:text property="image_url" size="40" maxlength="100" />
          <div class="desc"><span style="color: #F00;">注：若上传栏目为触网移动端商城主界面轮播图，并且上传的为产品购买链接，则需要将链接的格式填写为",productDetail,id,其中id使用您发布的产品ID代替；例如",productDetail,100031203,表示点击后跳转到id为100031203的商品购买页面. </span></div>
          </td>
        </tr>
        <tr>
...
$(document).ready(function(){
	...
	$("#news_module").attr("dataType" , "Require").attr("msg" , "栏目没有填写");
