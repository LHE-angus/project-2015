...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
    ...
    <html-el:form action="/spgl/PdShowNew?method=insertBatch">
      <div class="rtabcont1"> 
        <input type="button" class="but4" name="delete" id="delete" value="提交" onclick="insertAll(this.form);" />
        <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
         <html-el:hidden property="flag" styleId="flag" value="${af.map.flag}" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr class="tabtt1">
          ...
          <td nowrap="nowrap" align="center">商品所属</td>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <c:if test="${cur.label_of_cate eq 9}">样机专区</c:if>
             ...
             <td align="center">
             <c:if test="${cur.dept_sn eq 0}">总部</c:if>
             <c:if test="${cur.dept_sn gt 0}">分公司</c:if>  
             </td>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="../spgl/PdShowNew.do?method=addBatch">
...
function insertAll(form){
	...
	if (checkedCount == 0) {
		...
		if(confirm("\u60a8\u786e\u8ba4\u63d0\u4ea4\u8fd9\u4e9b\u6570\u636e\u5417\uff01")) {
			form.action="${ctx}/manager/spgl/PdShowNew.do?method=insertBatch&mod_id=${af.map.mod_id}";
			form.submit();
		}
	}
