...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/KonkaGroupPeArticleInfoNew">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td width="20%" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;<strong class="fb">资讯标题：</strong>
            ...
            &nbsp;
            所属系统：
            <html-el:select property="msg_info_type" styleId="msg_info_type">
             	<html-el:option value="">全部</html-el:option>
                <html-el:option value="1">触网商城</html-el:option>  
              </html-el:select>
            </td></tr><tr><td><strong class="fb">&nbsp;&nbsp;&nbsp;&nbsp;资讯类别：</strong>
            <html-el:select property="article_type_id" style="width:80px;">
                <html-el:option value="">全部</html-el:option>
                <html-el:option value="2000">康佳资讯</html-el:option>
                <html-el:option value="2100">新手上路</html-el:option>
                <html-el:option value="2200">支付方式</html-el:option>
                <html-el:option value="2300">物流配送</html-el:option>
                <html-el:option value="2400">售后服务</html-el:option>
                <html-el:option value="2500">特色服务</html-el:option>
                <html-el:option value="2600">走进康佳</html-el:option>
                <html-el:option value="2700">会员规则</html-el:option>
                <html-el:option value="2800">球队介绍</html-el:option>
                <html-el:option value="3100">延保服务</html-el:option>
                <html-el:option value="3200">大宗采购</html-el:option>
                 、    	    <html-el:option value="3300">综合服务</html-el:option>
                <html-el:option value="4001">其它</html-el:option>
            </html-el:select>
    ...
    <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <input class="but2" type="button" name="Submit2" value="新增" onclick="location.href='KonkaGroupPeArticleInfoNew.do?method=add&mod_id=${af.map.mod_id}&receive_user_type=${af.map.receive_user_type}&public_target=${af.map.public_target}';" />
           </logic-el:match>
    ...
    <div class="rtabcont1">
      <html-el:form action="/spgl/KonkaGroupPeArticleInfoNew">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          <tr class="tabtt1">
            ...
            <td align="center" width="10%">资讯类别</td>
            <td align="center" width="10%">所属组织</td>
            <td align="center" width="10%">添加人</td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center" nowrap="nowrap">
                  <c:if test="${cur.msg_info_type eq 0}">内购平台</c:if><c:if test="${cur.msg_info_type eq 1}">触网商城 </c:if><c:if test="${cur.msg_info_type eq 2}">NEWSHOP</c:if><c:if test="${cur.msg_info_type eq 3}">顺丰商城 </c:if><c:if test="${cur.msg_info_type eq 5}">直销平台 </c:if>
              	<c:forEach items="${peArticleTypeList}" var="cur_at">
              		<c:if test="${cur_at.id eq cur.article_type_id}">${fn:escapeXml(cur_at.type_name)}</c:if>
              	</c:forEach>
              </td>
              <td align="left" nowrap="nowrap">${fn:escapeXml(cur.map.group_name)}</td>  
              <td align="left" nowrap="nowrap">${fn:escapeXml(cur.add_user_name)}</td>
              <td align="center"><fmt:formatDate value="${cur.pub_date}" pattern="yyyy-MM-dd hh:mm"/></td>
              <td align=left nowrap="nowrap"><c:choose>
              ...
              <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue"><a href="${https}/webservice/KonkaPeArticleInfoInterface.do?method=view&id=${cur.id}" target="_blank">预览</a></span> | <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaGroupPeArticleInfoNew.do', 'view','id=${cur.id}&'+$('#bottomPageForm').serialize())">查看</span>
                 | 
                 <logic-el:match name="popedom" value="+2+"> 
                 <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaGroupPeArticleInfoNew.do', 'edit','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">修改</span>
                 </logic-el:match>
            	 ...
            	 <span style="color: #ccc">修改</span>
                  ...
                  | 
                   <logic-el:match name="popedom" value="+4+"> 
                  <span style="cursor:pointer;" class="fblue" onclick="confirmDelete(null, 'KonkaGroupPeArticleInfoNew.do', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">删除</span>
                  </logic-el:match>
      ...
      <br />
      <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaGroupPeArticleInfoNew.do">
            ...
            <td height="40" align="right"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
              <script type="text/javascript">
            	var pager = new Pager(document.bottomPageForm, ${af.map.pager.recordCount}, ${af.map.pager.pageSize}, ${af.map.pager.currentPage});
			            ...
			            pager.addHiddenInputs("msg_info_type", "${af.map.msg_info_type}");
