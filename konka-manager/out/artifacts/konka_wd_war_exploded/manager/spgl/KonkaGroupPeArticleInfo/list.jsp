...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/KonkaGroupPeArticleInfo">
        ...
        <tr>
          <td width="20%" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;<strong class="fb">资讯标题：</strong>
            ...
            <html-el:select property="msg_info_type" styleId="msg_info_type">
                ...
                <html-el:option value="0">内购平台</html-el:option>
                <html-el:option value="1">触网商城</html-el:option>
                <html-el:option value="2">NEWSHOP</html-el:option>
                <html-el:option value="3">顺丰触网</html-el:option>
                <html-el:option value="5">直销平台</html-el:option>  
              </html-el:select>
    ...
    <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><input class="but2" type="button" name="Submit2" value="新增" onclick="location.href='KonkaGroupPeArticleInfo.do?method=add&mod_id=${af.map.mod_id}&receive_user_type=${af.map.receive_user_type}&public_target=${af.map.public_target}';" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue"><a href="${https}/webservice/KonkaPeArticleInfoInterface.do?method=view&id=${cur.id}" target="_blank">预览</a></span> | <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaGroupPeArticleInfo.do', 'view','id=${cur.id}&'+$('#bottomPageForm').serialize())">查看</span>
                 | <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaGroupPeArticleInfo.do', 'edit','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">修改</span> | <span style="cursor:pointer;" class="fblue" onclick="confirmDelete(null, 'KonkaGroupPeArticleInfo.do', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">删除</span></td>
            </tr>
