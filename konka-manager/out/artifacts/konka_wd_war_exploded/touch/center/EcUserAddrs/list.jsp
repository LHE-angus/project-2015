...
<div class="maincont">
  ...
  <div class="touch_right padbot45">
    <div class="position"><a href="${ctx }/touch/Index.do">首页</a> &gt; <a href="${ctx }/touch/center/Index.do">会员中心</a> &gt; 地址簿</div>
    <div class="touchtab3">
...
function deleteInfo(obj){
	...
	if(confirm("您确定删除吗？")){
		location.href="${ctx}/touch/center/EcUserAddrs.do?method=delete"+id;
	}
}
