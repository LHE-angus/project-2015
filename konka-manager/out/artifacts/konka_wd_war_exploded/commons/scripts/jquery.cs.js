 ...
 * @version Build 20090627 change the return type of json from [{text:t1, value:v1}...] to [[t1,v1]...]
 * 
 * @author jinqinghua
...
jQuery.fn.extend({
	...
	cs : function(url, reqParamName, reqParamValue, isHideNoOptionSelect) {
		...
		this.change(function(){
			...
			if ( typeof( window.jquerycs_callback ) == 'function' ) {
				window.jquerycs_callback();
			}
