...
function() {
    ...
    function(d) {
        ...
        function f(a, b) {
            ...
            if (a && "." === a.charAt(0)) if (b) {
                for (n = n.slice(0, n.length - 1), a = a.split("/"), g = a.length - 1, s.nodeIdCompat && w.test(a[g]) && (a[g] = a[g].replace(w, "")), a = n.concat(a), k = 0; k < a.length; k += 1) if (m = a[k], "." === m) a.splice(k, 1),
                k -= 1;
                else if (".." === m) {
        ...
        m = function(a, b, c, f) {
            ...
            if (f = f || a, "undefined" === v || "function" === v) {
                for (b = !b.length && c.length ? ["require", "exports", "module"] : b, n = 0; n < b.length; n += 1) if (m = o(b[n], f), k = m.f, "require" === k) u[n] = p.require(a);
                else if ("exports" === k) u[n] = p.exports(a),
                s = !0;
    ...
    function() {
        ...
        b.Decorate = function(b, c) {
            function d() {
                ...
                d > 0 && (a.call(arguments, b.prototype.constructor), e = c.prototype.constructor),
        ...
        c.prototype.invoke = function(a, b) {
            for (var c = 0,
            d = a.length; d > c; c++) a[c].apply(this, b)
        },
        b.Observable = c,
    ...
    c("select2/results", ["jquery", "./utils"],
    function(a, b) {
        function c(a, b, d) {
            this.$element = a,
            this.data = d,
        ...
        c.prototype.bind = function(b) {
            ...
            function() {
                ...
                if (0 !== a.length) {
                    var b = a.data("data");
                    "true" == a.attr("aria-selected") ? c.trigger("unselected", {
                        data: b
                    }) : c.trigger("selected", {
                        data: b
                    })
            ...
            this.on("results:message",
            function(a) {
                c.displayMessage(a)
            }),
            a.fn.mousewheel && this.$results.on("mousewheel",
            function(a) {
            ...
            function() {
                ...
                c.getHighlightedResults().removeClass("select2-results__option--highlighted"),
    ...
    c("select2/selection/base", ["../utils", "../keys"],
    function(a, b) {
        function c(a, b) {
            this.$element = a,
            this.options = b,
        ...
        return a.Extend(c, a.Observable),
        c.prototype.render = function() {
        ...
        c.prototype.bind = function(a) {
            ...
            this.container = a,
            this.$selection.attr("aria-owns", d),
            ...
            function() {
                ...
                c.$selection.focus(),
                c._detachCloseHandler(a)
            })
        },
        c.prototype._attachCloseHandler = function(a) {
            var b = this;
            $(document.body).on("mousedown.select2." + a.id,
            function(a) {
                var b = $(a.target),
                c = b.closest(".select2"),
                d = $(".select2.select2-container--open");
                d.each(function() {
                    var a = $(this);
                    if (this != c[0]) {
        ...
        c.prototype._detachCloseHandler = function(a) {
            ...
            $(window).off("scroll.select2." + a.id)
        },
        c.prototype.position = function(a, b) {
    ...
    c("select2/selection/single", ["./base", "../utils", "../keys"],
    function(a, b) {
        function c() {
        ...
        c.prototype.render = function() {
            ...
            return a.attr("title", this.$element.attr("title")),
            this.$selection = a,
            a
        },
        c.prototype.bind = function(a) {
    ...
    c("select2/selection/multiple", ["./base", "../utils"],
    function(a, b) {
        function c() {
            c.__super__.constructor.apply(this, arguments)
        }
    ...
    c("select2/selection/placeholder", ["../utils"],
    function() {
        function a(a, b, c) {
    ...
    c("select2/selection/allowClear", [],
    function() {
        function a() {}
        return a.prototype.bind = function(a, b, c) {
            ...
            function(a) {
                a.stopPropagation(),
                d.$element.val(d.placeholder.id).trigger("change"),
                d.trigger("toggle")
            })
        },
        a.prototype.update = function(a, b) {
    ...
    c("select2/selection/search", ["../utils", "../keys"],
    function(a, b) {
        function c(a, b, c) {
            a.call(this, b, c)
        }
        ...
        c.prototype.bind = function(a, c, d) {
            ...
            this.$selection.on("keyup", ".select2-search--inline",
            function(a) {
                e.handleSearch(a)
            })
        },
        ...
        c.prototype.resizeSearch = function() {
            ...
            var a = "";
            if ("" !== this.$search.attr("placeholder")) a = this.$selection.innerWidth(),
    ...
    c("select2/data/select", ["./base", "../utils", "jquery"],
    function(a, b, c) {
        function d(a, b) {
            this.$element = a,
            this.options = b,
        ...
        d.prototype.select = function(a) {
            var b = this;
            if (c(a.element).is("option")) return a.element.selected = !0,
            void this.$element.trigger("change");
            if (this.$element.prop("multiple")) this.current(function(c) {
                var d = [];
                a = [a],
                a.push.apply(a, c);
                for (var e = 0; e < a.length; e++) id = a[e].id,
                -1 === d.indexOf(id) && d.push(id);
                b.$element.val(d),
        ...
        d.prototype.unselect = function(a) {
            ...
            if (this.$element.prop("multiple")) return c(a.element).is("option") ? (a.element.selected = !1, void this.$element.trigger("change")) : void this.current(function(c) {
                for (var d = [], e = 0; e < c.length; e++) id = c[e].id,
                id !== a.id && -1 === d.indexOf(id) && d.push(id);
                b.$element.val(d),
                b.$element.trigger("change")
            })
        },
    ...
    c("select2/data/array", ["./select", "../utils", "jquery"],
    function(a, b, c) {
        function d(a, b) {
            var c = b.get("data");
            d.__super__.constructor.call(this, a, b),
            this.convertToOptions(c)
        }
        return b.Extend(d, a),
        d.prototype.select = function(a) {
            var b = this.$element.find('option[value="' + a.id + '"]');
            0 === b.length && (b = this.option(a), this.$element.append(b)),
        ...
        d.prototype.convertToOptions = function(a) {
            ...
            for (var d = this,
            e = this.$element.find("option"), f = e.map(function() {
    ...
    c("select2/data/ajax", ["./array", "../utils", "jquery"],
    function(a, b, c) {
        function d(b, c) {
            this.ajaxOptions = c.get("ajax"),
            null != this.ajaxOptions.processResults && (this.processResults = this.ajaxOptions.processResults),
            a.__super__.constructor.call(this, b, c)
        }
        return b.Extend(d, a),
    ...
    function() {
        ...
        return a.prototype.query = function(a, b, c) {
            ...
            null == b.term || "" === b.term || null != b.page ? void a.call(this, b, c) : void a.call(this, b, d)
        },
    ...
    function() {
        ...
        a.prototype.query = function(a, b, c) {
            ...
            f.term !== b.term && (this.$search.length && (this.$search.val(f.term), this.$search.focus()), b.term = f.term),
            a.call(this, b, c)
        },
        a.prototype.tokenizer = function(a, b, c, d) {
            for (var e = c.get("tokenSeparators") || [], f = b.term, g = 0, h = this.createTag ||
            function(a) {
                return {
                    id: a.term,
                    text: a.term
    ...
    c("select2/data/minimumInputLength", [],
    function() {
        function a(a, b, c) {
    ...
    c("select2/data/maximumInputLength", [],
    function() {
        function a(a, b, c) {
    ...
    c("select2/dropdown/search", ["../utils"],
    function() {
        function a() {}
        return a.prototype.render = function(a) {
            var b = a.call(this),
            c = $('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" role="textbox" /></span>');
            return this.$searchContainer = c,
    ...
    c("select2/dropdown/hidePlaceholder", [],
    function() {
        function a(a, b, c, d) {
            this.placeholder = this.normalizePlaceholder(c.get("placeholder")),
            a.call(this, b, c, d)
    ...
    c("select2/dropdown/infiniteScroll", ["jquery"],
    function(a) {
        function b(a, b, c, d) {
            this.lastParams = {},
            a.call(this, b, c, d),
    ...
    function() {
        ...
        a.prototype._positionDropdown = function() {
            ...
            d = null,
            e = (this.$container.position(), this.$container.offset());
            e.bottom = e.top + this.$container.outerHeight(!1);
            var f = {
                height: this.$container.outerHeight(!1)
            };
            f.top = e.top,
            f.bottom = e.top + f.height;
            var g = {
            ...
            i = h.top < e.top - g.height,
            j = h.bottom > e.bottom + g.height,
            k = {
                left: e.left,
                top: f.bottom
            };
            b || c || (d = "below"),
            j || !i || b ? !i && j && b && (d = "below") : d = "above",
            ("above" == d || b) && (k.top = f.top - g.height),
            null != d && (this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--" + d), this.$container.removeClass("select2-container--below select2-container--above").addClass("select2-container--" + d)),
    ...
    c("select2/dropdown/minimumResultsForSearch", [],
    function() {
        function a(b) {
            count = 0;
    ...
    function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
        ...
        y.prototype.apply = function(j) {
            if (j = a.extend({},
            this.defaults, j), null == j.dataAdapter && (j.dataAdapter = null != j.ajax ? m: null != j.data ? l: k, j.minimumInputLength > 0 && (j.dataAdapter = h.Decorate(j.dataAdapter, p)), j.maximumInputLength > 0 && (j.dataAdapter = h.Decorate(j.dataAdapter, q)), null != j.tags && (j.dataAdapter = h.Decorate(j.dataAdapter, n)), (null != j.tokenSeparators || null != j.tokenizer) && (j.dataAdapter = h.Decorate(j.dataAdapter, o))), null == j.resultsAdapter && (j.resultsAdapter = b, null != j.ajax && (j.resultsAdapter = h.Decorate(j.resultsAdapter, u)), null != j.placeholder && (j.resultsAdapter = h.Decorate(j.resultsAdapter, t))), null == j.dropdownAdapter) {
                if (j.multiple) j.dropdownAdapter = r;
                else {
                    var x = h.Decorate(r, s);
                    j.dropdownAdapter = x
                }
                j.minimumResultsForSearch > 0 && (j.dropdownAdapter = h.Decorate(j.dropdownAdapter, w)),
                j.dropdownAdapter = h.Decorate(j.dropdownAdapter, v)
            }
        ...
        y.prototype.reset = function() {
            ...
            function c(d, e) {
                ...
                if (e.children && e.children.length > 0) {
                    for (var f = a.extend(!0, {},
                    e), g = e.children.length - 1; g >= 0; g--) {
                        var h = e.children[g],
                        i = c(d, h);
    ...
    c("select2/options", ["jquery", "./defaults"],
    function(a, b) {
        function c(a, c) {
            this.options = a,
            null != c && this.fromElement(c),
        ...
        return c.prototype.fromElement = function(b) {
            ...
            var d = ["select2"];
            null == this.options.multiple && (this.options.multiple = b.prop("multiple")),
            ...
            null == this.options.dir && (this.options.dir = b.prop("dir") ? b.prop("dir") : b.closest("[dir]").prop("dir") ? b.closest("[dir]").prop("dir") : "ltr"),
            b.prop("disabled", this.options.disabled),
            b.prop("multiple", this.options.multiple),
            b.data("select2-tags") && (console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'), b.data("data", b.data("select2-tags")), b.data("tags", !0)),
            b.data("ajax-url") && (console && console.warn && console.warn("Select2: The `data-ajax-attribute` has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."), b.data("ajax--url", b.data("ajax-url")));
            var e = b.data();
            e = c(e);
    ...
    c("select2/core", ["jquery", "./options", "./utils", "./keys"],
    function(a, b, c, d) {
        var e = function(a, c) {
            ...
            this._tabindex = a.attr("tabindex") || 0,
            a.attr("tabindex", "-1"),
            a.data("select2", this)
        };
        ...
        e.prototype._placeContainer = function(a) {
            ...
            a.width(this.$element.outerWidth(!1))
        },
        ...
        e.prototype._registerSelectionEvents = function() {
            ...
            this.selection.on("results:select",
            function() {
                a.trigger("results:select")
            }),
            this.selection.on("results:previous",
            function() {
                a.trigger("results:previous")
            }),
            this.selection.on("results:next",
            function() {
                a.trigger("results:next")
            }),
            this.selection.on("unselected",
            function(b) {
                a.trigger("unselect", b),
                a.close()
            }),
            this.selection.on("query",
            function(b) {
                a.trigger("query", b)
            }),
            this.selection.on("keypress",
            function(b) {
        ...
        e.prototype._registerDropdownEvents = function() {
            var a = this;
            this.dropdown.on("query",
            function(b) {
                a.trigger("query", b)
            }),
            this.dropdown.on("keypress",
            function(b) {
                a.trigger("keypress", b)
            })
        },
        e.prototype._registerResultsEvents = function() {
            var a = this;
            this.results.on("query:append",
            function(b) {
                a.trigger("query:append", b)
            }),
            this.results.on("selected",
            function(b) {
                a.trigger("select", b),
                a.close()
            }),
            this.results.on("unselected",
            function(b) {
                a.trigger("unselect", b),
                a.close()
            }),
            this.results.on("results:focus",
            function(b) {
        ...
        e.prototype._syncAttributes = function() {
            ...
            this.options.get("disabled") ? (this.isOpen() && this.trigger("close"), this.trigger("disable")) : this.trigger("enable")
        },
        ...
        e.prototype.enable = function(a) {
            console && console.warn && console.warn('Select2: The `select2("val")` method has been deprecated and will be removed in later Select2 versions. Use $element.prop("disabled") instead.'),
            0 === a.length && (a = [!0]);
            var b = !a[0];
    ...
    c("jquery.select2", ["jquery", "select2/core"],
    function(a, c) {
        try {
            b("jquery.mousewheel")
        } catch(d) {}
