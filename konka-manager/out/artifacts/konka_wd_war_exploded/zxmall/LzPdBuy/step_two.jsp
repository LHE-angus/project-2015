...
<!-- buy start -->
<form action="<c:url value='/zxmall/LzPdBuy.do' />" method="post" id="step_two_form">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable3">
      <tbody>
        <tr class="item">
          ...
          <td>商品名称</td>
          <td width="10%">商品数量</td>
          <td width="10%"><c:if test="${zxmall.user_type eq 1 }">内购价</c:if><c:if test="${zxmall.user_type eq 2 }">结算价</c:if></td>
          <td width="10%">物流费</td>
          <td width="10%">优惠</td>
          <td width="30%">增值服务</td>
