...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/zxmall/center/Zwtest.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/zxmall/center/Zwtest.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });
	...
	$("#ajaxEcUserList").click(function(){
		...
		$.ajax({
			type: "POST",
			/* url: "<c:url value='/zxmall/center/Zwtest.do' />", */
			url: "${ctx}/zxmall/center/Zwtest.do",
