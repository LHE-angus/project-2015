...
<!-- buy start -->
<form action="<c:url value='/zxmall/EcGift.do' />" method="post" id="step_two_form">
      ...
      <tbody>
        <tr class="item">
          ...
          <td width="10%">所需积分</td>
	        ...
	        <tr>
	          <td>${ecGift.id}</td>
	          <td><a href="<c:url value='/zxmall/EcGift.do?method=view&gift_id=${ecGift.id}' />" target="_blank">${ecGift.pd_name}</a></td>
	          <td>1</td>
