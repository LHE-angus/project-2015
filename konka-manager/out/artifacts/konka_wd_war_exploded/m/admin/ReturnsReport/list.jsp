...
<form id="iForm">
    <div data-role="fieldcontain">
      ...
      <input type="text" value="销量" name="sales_count" id="sales_count" class="input" data-form="ui-body-a" onkeyup="javascript:setOnlyInter(this);"/>
      <input type="text" value="价格" name="sales_price" id="sales_price" class="input" data-form="ui-body-b" onkeyup="javascript:setOnlyDouble(this);"/>
