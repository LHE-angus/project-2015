...
<body>
	<div style="width: 100%">
		<div class="oartop">
			<img src="${ctx}/styles/jxc/images/arrow3.gif" style="vertical-align: text-top;" /> 当前位置：订单管理 &gt; 订单登记
		</div>
		<div class="rtabcont1">
			<html-el:form action="/JxcKonkaOrderRegister">
                ...
                -->
								...
								<tr id="trHidden" style="display: none;">
									<td align="center"><html-el:hidden property="pd_ids" styleId="pd_ids" /> <html-el:hidden property="pd_id" styleId="pd_id" /> <span id="md_name"></span></td>
									...
									<td align="center"><span id="good_sum_price">0</span> <html-el:hidden property="sum_price" styleId="sum_price" /></td>
									...
									<td align="center"><span id="good_discount_price">0</span> <html-el:hidden property="discount_price" styleId="discount_price" /></td>
					...
					<tr>
						...
						<td width="35%"><html-el:text property="user_shop_name" styleId="user_shop_name" value="${af.map.userShopName}" style="width:90%" maxlength="20"
					...
					<tr>
						...
						<td width="35%"><html-el:text property="user_tel" styleId="user_tel" value="${af.map.userTel}" style="width:40%" maxlength="20" styleClass="webinput" /> <span
							id="span_msg_tel__error" style="display: none;"><font style="color: red">正确格式,如：0551-3698754</font></span></td>
						<td class="title_item" width="15%">收货人手机：</td>
						<td><html-el:text property="user_phone" styleId="user_phone" style="width:40%" maxlength="11" styleClass="webinput" /> <span id="span_msg_phone__error"
							style="display: none;"><font style="color: red">正确格式,如：13966557733</font></span></td>
					</tr>
					<tr>
						<td class="title_item" width="15%">收货人所属地区：</td>
						<td colspan="3" width="85%"><html-el:hidden property="user_p_index" styleId="user_p_index" /> <select name="province" id="province" style="width: 175px;">
								<option value="${af.map.province}">请选择...</option>
						</select> &nbsp; <select name="city" id="city" style="width: 157px;">
								<option value="${af.map.city}">请选择...</option>
						</select> &nbsp; <select name="country" id="country" style="width: 157px;">
								<option value="${af.map.country}">请选择...</option>
						</select></td>
					</tr>
					<tr>
						<td class="title_item" width="15%">收货人地址：</td>
						<td colspan="3" width="85%"><html-el:text property="user_addr" styleId="user_addr" value="${af.map.userAddr}" style="width:92%" maxlength="100"
								styleClass="webinput" /></td>
					</tr>
					<tr>
          ...
          <td><html-el:text styleId="money" property="money" maxlength="12" styleClass="webinput"/></td>
        	-->
					...
					<tr>
						<td colspan="4" align="center"><input type="button" name="save" class="bgButtonSave" value=" 提 交 " id="btn_submit" /> <input type="button" name="temp_save"
							class="bgButtonSave" value=" 暂 存 " id="btn_temp_save" /> <input class="bgButtonBack" type="reset" name="reset" value="重填" id="btn_reset" /></td>
					</tr>
				</table>
			</html-el:form>
		</div>
