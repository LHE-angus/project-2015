  ...
  <div class="rtabcont1">
    <table width="50%" border="0" cellpadding="0" cellspacing="1" class="tableClass" align="center">
      ...
      <tr>
        ...
        <td width="45%">${fn:escapeXml(stdEntpMain.entp_name)}</td>
      </tr>
      <c:if test="${stdEntpMain.map.is_binding eq 1}">
      	<tr>
      ...
      <tr>
        <c:if test="${stdEntpMain.map.is_binding eq 0}">
        ...
        <td colspan="2"><html-el:form action="/KonkaJxcBindingMobile.do">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
              <tr>
                ...
                <td width="45%"><c:if test="${stdEntpMain.map.is_binding eq 1}">
