      ...
      <div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableTop">
          <tr>
            ...
            <th colspan=3>${shopName}进货数量总数:<font color="red">${pd_jh_num}</font></th>
          </tr>
        </table>
      </div>
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
        <tr>
          <th colspan=6><b>${shopName}&nbsp;&nbsp;${start_date}至${end_date}发货来源详细表</b></th>
        </tr>
        <tr>
          ...
          <th width="8%" nowrap="nowrap">发货来源</th>
        </tr>
        <c:forEach items="${entityList}" var="cur" varStatus="vs">
          <tr>
            ...
            <td align="center" nowrap="nowrap"><c:if test="${cur.map.data_src eq 1}">系统录入</c:if>
              <c:if test="${cur.map.data_src eq 2}">R3销售导入</c:if></td>
          </tr>
        </c:forEach>
        <tr>
          <td colspan="4" align="center" nowrap="nowrap">发货数量合计</td>
