...
// UPDATED: 24-Sep-2012
// Version: v24
// CHANGE LOG: SC15 update fix, dgc IR fix, added dynamic account change, changed cookieLifetime, removed eVar13,#749 request,updated s7
var version = 'S.NG v24 24-Sep-2012';
...
s_dell.linkInternalFilters=s_dell.localDoms+',alienware.,dell-ins,easy2.,ideastorm.,livelook.,sellpoint.,syndication.intel.,triaddigital.,webcollage.,force.,salesforce.,delldigitalmodule.,dellcoloradvantage.';
...
s_dell.eventList="event81,event82,event83,event84,event85,event86,event87";
...
function s_dell_doPlugins(s){
	...
	/** Capture Partner Type and Parter Status - Updated to add the 'c' 5 Jan 2012 by Jason Case **/
	if(document.getElementById("ctl00_ctl00_PartnerTypeStatus")){
	    var element = document.getElementById("ctl00_ctl00_PartnerTypeStatus");
        s.eVar57 = element.value;
	}else if(document.getElementById("ctl00_PartnerTypeStatus")){
	    var element = document.getElementById("ctl00_PartnerTypeStatus");
        s.eVar57 = element.value;
	}
...
var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.cookieLifetime=6.31139e7;s.version='H.24.1';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(m,\"\\n\",\"\\\\n\"),\""
