...
<script src="${ctx}/styles/shop/js/jquery.superslide.2.1.1.js" type="text/javascript"></script>
<div class="menu" >
    	...
    	<div id="my360buy-2013">
			<dl class="" load="1">
                ...
                <div id="jduc-orderlist">
                 ...
                 <div class="uclist"> 
                 <ul class="fore1 fl">
                 <li><a target="_blank" href="<c:url value='/shop/center/Orders.do' />">我的订单&nbsp;&gt;</a></li>
                 <li> </li>               	
               	 <li> </li>
                 </ul>                
                 <ul class="fore2 fl"> 
...
<div class="category" > 
    ...
    <ul class="tit" style="list-style:none; margin:0px; padding:0px;">    
      <li class="mod_cate">
        <h2 class="dianshi"><a href="#">品牌</a></h2>
        <p class="mod_cate_r"><a href="<c:url value='/shop/KonkaBcompPd.do?brand_name=KONKA' />">KONKA</a><a href="<c:url value='/shop/KonkaBcompPd.do?brand_name=KKTV' />">KKTV</a><a href="<c:url value='/shop/KonkaBcompPd.do?brand_name=HYUNDAI' />">HYUNDAI</a></p>
      </li>
      <li class="mod_cate">
        <h2 class="pingban"><a href="#">品类</a></h2>
        <p class="mod_cate_r">
            ...
            <a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_type=4' />">4K电视</a></p>
        <div class="mod_subcate">
          <dl> 
            <dt><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0' />" style="text-decoration: underline;">康佳电视</a></dt>
            <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_type=4' />">4K电视</a>|</dd>
            <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_type=1' />">3D电视</a>|</dd>
            <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_type=2' />">智能电视</a></dd>
          </dl>
          <dl> 
           <dt><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=31' />"  style="text-decoration: underline;">屏幕尺寸</a></dt>
           <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=31' />">32英寸以下</a>|</dd>
           <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=32' />" >32英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=37' />" >37英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=39' />" >39英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=42' />" >42英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=47' />" >47英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=50' />" >50英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=55' />" >55英寸</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=0&pd_size_type=56' />">55英寸以上</a></dd>
    	 </dl>
    	 <dl> 
    	  <dt><a  style="text-decoration: underline;">分类标签</a></dt>
    	   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?label_of_cate=0' />">新 品</a>|</dd>
           <dd><a href="<c:url value='/shop/KonkaBcompPd.do?label_of_cate=7' />">精品</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?label_of_cate=2' />">热 销</a>|</dd>
		   <dd><a href="<c:url value='/shop/KonkaBcompPd.do?label_of_cate=3' />">特 惠</a>|</dd>
		   <dd><a href="<c:url value='/shop/PshowOrderPanicBuying.do' />">限时抢购</a></dd>
		 </dl>
		 <dl> 
    	    <dt><a style="text-decoration: underline;">价&nbsp;&nbsp;&nbsp;&nbsp;格</a></dt>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=1' />">1000元以下</a>|</dd>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=2' />">1000-2000元</a>|</dd>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=3' />">2000-3000元</a>|</dd>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=4' />">3000-5000元</a>|</dd>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=5' />">5000-10000元</a>|</dd>
		    <dd><a href="<c:url value='/shop/KonkaBcompPd.do?pd_price=6' />" style="width:80px">10000元以上</a></dd>
		  </dl>
        </div>
      </li>
      <li class="mod_cate">
        <h2 class="peijian"><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=10' />">配件专区</a></h2>
        <p class="mod_cate_r"><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=10' />">电视挂架</a><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=10' />">影音线材</a><a href="<c:url value='/shop/KonkaBcompPd.do?prod_type=10' />">遥控器</a></p>
      </li>
   	 </ul>
    </div>
