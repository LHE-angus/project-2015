...
<div class="card_center">
  ...
  <form action="<c:url value='/shop/ShoppingCar.do' />" method="post" id="shopping_car_form">
    ...
    <c:forEach items="${konkaBcompPdList}" var="cur" varStatus="vs">
	  <div class="card_content" id="div_${cur.id}">
	    ...
	    <ul>
	      ...
	      <li class="c_two">
	      <a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" target="_blank" title="${cur.pd_name}">${fnx:abbreviate(cur.pd_name, 2 * 26, '...')}</a>
	      </li>
	      <li class="c_three"><table border="0" cellspacing="0" cellpadding="0"><tr><td height="70" width="100" style="overflow:hidden;" valign="middle" align="center"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img alt="${cur.pd_name}" src="${ctx}/${fn:substringBefore(cur.main_pic, '.')}_060.jpg" style="max-width:60px;max-height:60px;" /></a></td></tr></table></li>
	      <li class="c_four">
	        <div class="fout_left"><img src="${ctx}/styles/shop/images/jian_1.jpg" width="11" height="11" class="num_jian_class" data="${cur.id}" style="cursor:pointer;" /></div>
	        ...
	        <div class="fout_right"><img src="${ctx}/styles/shop/images/jia_1.jpg" width="11" height="11" class="num_jia_class" data="${cur.id}" style="cursor:pointer;" /></div>
