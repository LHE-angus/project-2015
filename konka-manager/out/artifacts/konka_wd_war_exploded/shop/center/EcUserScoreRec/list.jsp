...
<div class="maincont">
  ...
  <div class="shop_right padbot45">
    <div class="position"><a href="${ctx }/shop/Index.do">首页</a> &gt; <a href="${ctx }/shop/center/Index.do">会员中心</a> &gt; 我的积分</div>
    <div class="shoptab3">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="shop_form_table1">
        <tr class="tabtt1">
