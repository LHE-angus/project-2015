...
<link rel=stylesheet type=text/css  href="${ctx}/styles/shop/css/citybox.css" />
...
<br/>
  <div class="position"><a href="<c:url value='/shop/Index.do' />">首页</a> &gt; <a href="<c:url value='/shop/KonkaBcompPd.do' />">平板电视</a> &gt; 康佳&nbsp;<c:out value="${konkaBcompPd.pd_sn}" /></div>
  <div class="viewbox1" style="min-height:450px;">
  	<!-- 产品展示详细 -->
    <jsp:include page="../__inc/_pd_images.jsp" flush="true" />
    
    <!-- 表单开始 -->
    <form action="<c:url value='/shop/ShoppingCar.do' />" id="form_pd_buy" method="post">
    ...
    <div class="viewright">
      ...
      <div class="viewtab1">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
            ...
            <c:if test="${ecUser.user_type eq 1 and shop eq 1 }">
      ...
      <div class="viewtab2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
          <tbody>
            <tr>
              <td width="10%">购买数量：</td>
              <td width="90%"><div class="addtab"><img src="${ctx}/styles/shop/images/edd.gif" id="num_jian" style="cursor:pointer;" /></div>
                <div class="proinput1">
                  <input type="text" class="proinput2" name="buy_num" id="buy_num" value="1" onfocus="javascript:setOnlyInt(this);" maxlength="3" />
                </div>
                <div class="addtab"><img src="${ctx}/styles/shop/images/add.gif" id="num_jia" style="cursor:pointer;" /></div></td>
            </tr>
            ...
            <tr>
              <td colspan="2"><div class="padtop20"><img alt="加入购物车" src="${ctx}/styles/shop/images/but_joinshop.gif" width="132" height="38" style="cursor:pointer;" id="add_shoping_car_btn" />&nbsp;&nbsp;<img alt="立即购买" src="${ctx}/styles/shop/images/but_buy2.gif" style="cursor:pointer;" id="buy_btn" /></a>&nbsp;&nbsp;<img alt="关注" style="cursor:pointer;" id="add_favotrites_btn" src="${ctx}/styles/shop/images/but_attention.gif" /></a></div></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <ul class="listul4" style="padding:0;">
           <c:forEach items="${bcomp_pd_list_top_5}" var="cur" varStatus="vs">
	          ...
	          <li style="padding:0;" class="${li_class}">
	            <div class="listpic1"><table border="0" cellspacing="0" cellpadding="0" width="120"><tr><td height="110" style="overflow:hidden;" width="120" valign="middle" align="center"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img src="${ctx}/${cur.main_pic}" style="max-height:100px;" width="100"/></a></td></tr></table></div>
	            <div class="listrxt1">
	              <h3><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />">康佳&nbsp;<c:out value="${cur.pd_sn}" />&nbsp;<c:out value="${cur.pd_name}" /></a></h3>
	...
	<div class="right">
		...
		<div id="newFittign-tab" data-widget="tabs">
		  ...
		  <div class="tab-cat-content">
		   <form action="<c:url value='/shop/ShoppingCar.do' />" id="form_pd_buy2" method="post">
		    <input type="hidden" name="method" value="buyByGoodsId" />
	...
	$(document).delegate(".pd_content", "click", function(){
		...
		$(".pd_content").each(function(){
		    ...
		    if($(this).attr("hover") == "hover"){
				 ...
				 // 如果是评论则加载Iframe
				 if("pdc3" == id){
					var url = "${ctx}/shop/EcPdEavl.do?goods_id=" + $("#goods_id").val() + "&timestamp=" + new Date().getTime();
