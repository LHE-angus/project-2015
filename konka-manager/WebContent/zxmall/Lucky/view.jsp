...
<br/>
  <div class="position"><a href="<c:url value='/zxmall/Index.do' />">首页</a> &gt; 0元抽奖</div>
  <div class="viewbox1" style="min-height:450px;">
  	<!-- 产品展示详细 -->
    <jsp:include page="../__inc/ec_lucky_images.jsp" flush="true" /> 
    <!-- 表单开始 -->
    <form action="<c:url value='/zxmall/Lucky.do' />" id="form_pd_buy" method="post">
      ...
      <div class="viewtab2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
          <tbody>
            <tr>
              <td width="10%">状态：</td>
              <td width="90%"><c:if test="${entity.lucky_state eq 0 }"><font  style="font-size: 18px;color: red;margin-left:-35px;">活动未开始</font>（7.24--8.3）</c:if>   
            ...
            <tr>
              <td colspan="2">
              	<div class="padtop20"><img class="gray" alt="立即抢购" src="${ctx}/styles/zxmall/images/but_qianglou.jpg" style="cursor:pointer;" id="buy_btn" />
...
<div class="maincont"> 
  <!--left--> 
  <!--right-->
  <div class="liscont3" style="width:100%;">  
	<div class="viewtit2"  >	
      <ul>
