        ...
        <div class="tg_l">
          <div class="tg_left">
            <div class="tg_k">
              ...
              <div class="tg_cn"><a href="<c:url value='/zxmall/PshowOrderPanicBuying.do?method=add&goods_id=${cur.id}' />"><img src="${ctx}/styles/zxmall/images/qianggou.jpg" width="117" height="51" /></a></div>
              <div class="tg_down">
                <ul>
                  <li>原价<br>
            ...
            <div class="tg_clock"><font class="black_14">离抢购结束还剩<br/>
          ...
          <div class="tg_right box_606_317">
            <table border="0" cellspacing="0" cellpadding="0" width="606">
              <tr>
                <td height="317" style="overflow:hidden;" width="606" valign="middle" align="center"><a href="<c:url value='/zxmall/PshowOrderPanicBuying.do?method=view&goods_id=${cur.id}' />">
