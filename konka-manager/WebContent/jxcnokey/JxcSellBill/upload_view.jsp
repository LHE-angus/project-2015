...
<div style="width:100%">
  ...
  <div class="rtabcont1">
  <html-el:form action="/JxcSellBill.do" enctype="multipart/form-data">
    <html-el:hidden property="method" value="saveUploadFile" />
		       ...
		       <tr>
		         ...
		         <td colspan="3"><ol>
		             <c:forEach var="cur" items="${attachmentList}" varStatus="vs">
		               <li><a href="${ctx}/jxcnokey/Download.do?method=downloadFile&save_name=${cur.save_name}">${cur.file_name}</a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" id="del_${cur.id}" onclick="deleteFile('${cur.id}','${cur.save_path}');">删除</a></li>
		             </c:forEach>
		           </ol></td>
		       </tr>
		    </c:if>
...
function deleteFile(id, file_path){
	 ...
	 if (k) {
			$.post("JxcSellBill.do?method=deleteFile" , {
