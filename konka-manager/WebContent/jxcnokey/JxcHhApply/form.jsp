      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
        ...
        <tr>
          ...
          <td width="85%" align="left"><label for="own_sys_0">
           ...
           <font color="red">注：无密钥登录只能操作非家电下乡产品</font></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item"><font color="red">*</font>产品品牌：</td>
        ...
        <tr>
          ...
          <td><html-el:select property="hh_type">
        ...
        <tr>
          ...
          <td><html-el:text property="hh_count" styleId="hh_count" maxlength="6" size="6" styleClass="webinput" /></td>
        </tr>
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item"><font color="red" >*</font>换货原因：</td>
          <td><html-el:text property="hh_reason" styleId="hh_reason" maxlength="100" style="width:60%" styleClass="webinput" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" align="center"><html-el:button property="save" styleClass="bgButtonSave" styleId="btn_submit" value="保 存"/>
            <html-el:button property="back" styleClass="bgButtonBack" value="返 回" onclick="history.back();" /></td>
        </tr>
      </table>
    </html-el:form>
  </div>
...
$(document).ready(function() {
	...
	$("#hh_count").attr("dataType", "Number").attr("msg", "请填写换货数量，且必须是正整数！");
	$("#brand_name").attr("dataType","Require").attr("msg","请选择产品品牌！");
	$("#hh_reason").attr("dataType","Require").attr("msg","请填写换货原因！");
