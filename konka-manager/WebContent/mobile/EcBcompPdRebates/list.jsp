...
<div class="maincont">
  ...
  <div class="member_right padbot45">
    <div class="membertab3">
      <html-el:form action="/EcBcompPdRebates">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="member_form_table0">
          <tr height="40">
         	 <th width="30%">商品型号</th>
         	<td><!--   <html-el:text  property="pd_sn" styleId="pd_sn" ></html-el:text>  -->
         ...
         <tr height="40">
          	<th width="30%">验证码</th>
         	<td><html-el:text  styleId="verificationCode" property="verificationCode" />&nbsp;&nbsp;</td>
          </tr>
          <tr height="40">
         	 <td width="30%">       </td>
         	 <td width="30%"><a class="roundCode" hidefocus="hideFocus" style="hide-focus: true"><img src="${ctx}/images/VerificationCode.jpg" width="76" height="24" style="border:1px solid #A1BCA3;cursor:pointer;" alt="验证码，看不清楚请用鼠标点击此处！" onclick="$(this).hide().attr('src', this.src + '?' + new Date().getTime()).fadeIn();" /></a></td>
          </tr>           
          <tr height="40">
         	 <td width="30%">       </td>
         	 <td width="30%"><input class="inputbtn" type="submit" name="Submit" value="查询" /></td>
          </tr>          
        </table>
      </html-el:form>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtab1">
        <tr class="tr1">
          <th width="30%" nowrap="nowrap" align="center">商品型号</td>
          <th width="20%" nowrap="nowrap" align="center">佣金</td>
        </tr>
        <tbody>
          ...
          <c:if test="${empty entityList }">
            <tr height="60">
              <td align="center" nowrap="nowrap" colspan="5"> 暂无佣金记录 </td>
            </tr>
          </c:if>
        </tbody>
      </table>
