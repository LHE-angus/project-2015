...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
   <html-el:form  action="/demo/RetailTerminalMaterialQuery">
     <html-el:hidden property="method" value="list" />
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          ...
          <td><strong class="fb">物料名称：</strong>  
 ...
 <div class="rtabcont1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr class="tabtt1">
	          ...
	          <td nowrap="nowrap" align="center">物料名称</td>
    ...
    <br />
      <form id="bottomPageForm" name="bottomPageForm" method="post" action="RetailTerminalMaterialQuery.do">
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            pager.addHiddenInputs("wl_index", "${af.map.wl_index}");
