          ...
          <td><FCK:editor instanceName="content3">
          	...
          	<tr>
          		<td align="center" colspan="2">
					<input class="but_ec" type="button" name="Submit5" value="返回" id="btn_back" onclick="location.href = '${ctx}/manager/spgl/PdShow.do?method=list&mod_id=905101&own_sys=${af.map.own_sys}' "/> 
          		</td>
          	</tr>
      	</table>
      </html-el:form>
