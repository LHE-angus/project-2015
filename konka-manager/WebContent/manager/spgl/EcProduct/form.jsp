...
<div class="oarcont">
  ...
  <div class="viewbox4" id="pdc1_pdc1" style="display:'';overflow-x:hidden;">
	  <html-el:form action="/spgl/EcProduct" enctype="multipart/form-data" method="post">
	    ...
	    <html-el:hidden property="queryString" />
      	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
          	...
          	<tr>
          		<td class="title_item" nowrap="nowrap">产品型号：</td>
          		<td><html-el:text property="pd_sn" styleId="pd_sn" styleClass="webinput" maxlength="18" /> &nbsp; <span style="color:#f00;display:none;" id="user_name_exist_error">产品型号已经存在，请重新输入！</span><span style="color:#f00;display:none;" id="user_name_erro">产品型号不能含空白字符！</span></td>
          	</tr>
          	<tr>
...
$(document).ready(function(){
	...
	$("#pd_sn").blur(function(){
		...
		$("#user_name_exist_error").hide();
		$(this).css("background-color", "#fff");
		if(pd_sn != '${af.map.pd_sn}'){
			$.ajax({
				type: "POST",
				url: "EcProduct.do",
				data: "method=validatePdSn&pd_sn=" + $(this).val(),
				dataType: "json",
				error: function(request, settings) {
					alert("检查产品型号重复失败，请稍候再次尝试。");
