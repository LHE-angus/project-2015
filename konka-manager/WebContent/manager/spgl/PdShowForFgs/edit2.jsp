...
<div class="oarcont">
  ...
  <div class="viewbox4" id="pdc1_pdc1" style="display:'';overflow-x:hidden;">
	  <html-el:form action="/spgl/PdShowForFgs" enctype="multipart/form-data" styleClass="f1" method="post">
	    ...
	    <html-el:hidden property="queryString" styleId="queryString" />
      	...
      	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
          	...
          	<tr>
          		...
          		<td>
          			<select name="pd_spec" id="pdIds" multiple="multiple" disabled="disabled">
		          	</select>
          		</td>
          	</tr>
          	<tr>
          		<td class="title_item" nowrap="nowrap">商品编码：</td>
          		<td><html-el:text property="pd_sn" styleId="pd_sn" styleClass="webinput" maxlength="18" onkeyup="upperCase(this.id)" disabled="true"/></td>
          	</tr>
          	<tr>
          		<td class="title_item" nowrap="nowrap">商品名称：</td>
          		<td><html-el:text property="pd_name" styleId="pd_name" styleClass="webinput" size="60" maxlength="100" disabled="true" /></td>
          	</tr>
          	<tr>
          		...
          		<input type="button" class="but_ec" value="编 辑" disabled="disabled" onclick="getEcBinding('${af.map.id}', '${af.map.own_sys}');" style="cursor:pointer;" />
          		...
          		<td>
          			...
          			<c:if test="${not empty af.map.id}">
          				...
          				<div style="margin-top:5px;">
		        			<input type="checkbox" name="chkReUploadMainPicFileImage" id="chkReUploadMainPicFileImage" value="1" onclick="$('#main_pic_file').toggle();" style="vertical-align:middle;cursor:pointer;"  disabled="disabled"  />
          	...
          	<tr>
          		...
          		<td><html-el:text property="pd_size" styleId="pd_size" styleClass="webinput" size="4" maxlength="4" disabled="true"/>&nbsp;&nbsp;英寸</td>
          	</tr>
          	<tr>
          		<td class="title_item" nowrap="nowrap">分辨率：</td>
          		<td align="left">
          			<html-el:text property="pd_res_x" styleId="pd_res_x" value="${af.map.pd_res_x}" styleClass="webinput" size="5" maxlength="5"  disabled="true"/>&nbsp;×&nbsp;<html-el:text property="pd_res_y" styleId="pd_res_y" value="${af.map.pd_res_y}" styleClass="webinput" size="5" maxlength="5" />
          		</td>
          	</tr>
          	<tr>
          		<td class="title_item" nowrap="nowrap">商品描述：</td>
          		<td>
          			<html-el:textarea property="pd_desc" styleId="pd_desc" styleClass="webinput" style="width:70%;height:60px;" onchange="checkMaxLen(this,50)" disabled="true"/>	
          		</td>
          	</tr>
          	 <tr>
          ...
          <td><FCK:editor instanceName="content3">
          	...
          	<tr>
          		...
          		<td>
          		<html-el:radio property="integral_type" styleClass="integral_type"  value="0" disabled="true" >按比例</html-el:radio>&nbsp;
          		<html-el:radio property="integral_type" styleClass="integral_type"  value="1" disabled="true" >按固定积分</html-el:radio>
          		</td>
          	</tr>
          	<tr>
          		<td class="title_item" nowrap="nowrap">积分值：</td>
          		<td><html-el:text property="integral" styleId="integral" styleClass="webinput" size="10" maxlength="10"  disabled="true"/></td>
          	</tr>
          	<c:if test="${af.map.own_sys eq 2}">
          		<c:if test="${empty af.map.fgs_id}">
		          	<tr>
		          		<td class="title_item" nowrap="nowrap">是否锁定：</td>
		          		<td>
		          		<html-el:radio property="lock_state" styleClass="lock_state"  value="0"  disabled="true" >不锁定</html-el:radio>&nbsp;
		          		<html-el:radio property="lock_state" styleClass="lock_state"  value="1"  disabled="true" >锁定</html-el:radio>
		          		</td>
		          	</tr>
          		</c:if>
          	...
          	<tr>
          		...
          		<td><html-el:text property="order_value" styleId="order_value" styleClass="webinput" size="4" maxlength="4"  disabled="true"/></td>
          	</tr>
          	<tr>
          		<td align="center" colspan="2">
					<input class="but_ec" type="button" name="Submit5" value="返回" id="btn_back" onclick="location.href = '${ctx}/manager/spgl/PdShowForFgs.do?method=list&mod_id=905101&own_sys=${af.map.own_sys}' "/> 
          		</td>
          	</tr>
      	</table>
      </html-el:form>
	...
	$(document).delegate(".pd_content", "click", function(){
		...
		$(".pd_content").each(function(){
		    ...
		    if($(this).attr("hover") == "hover"){
				 ...
				 // 如果是价格维护
				 if("pdc2" == id){
					var url = "${ctx}/manager/spgl/EcGoodsPrice.do?method=list2&mod_id=${af.map.mod_id}&goods_id=${af.map.id}&own_sys=${af.map.own_sys}";
					$("#pc_pd_eavl_iframe").hide();
					$("#pc_pd_eavl_loading_gif").show();
					$("#pc_pd_eavl_iframe").attr("src", url);
				 }else if("pdc3" == id){
					//如果是库存维护
					var url = "${ctx}/manager/spgl/EcStocks.do?method=list2&mod_id=${af.map.mod_id}&goods_id=${af.map.id}&own_sys=${af.map.own_sys}";
