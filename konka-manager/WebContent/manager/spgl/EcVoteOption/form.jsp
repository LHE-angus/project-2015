...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcVoteOption" method="post" enctype="multipart/form-data"> 
      <html-el:hidden property="id" styleId="id" />
       <html-el:hidden property="vote_id" styleId="vote_id" />
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td nowrap="nowrap" class="title_item">简介：</td>
          <td><html-el:text property="brief" styleId="brief" size="30" maxlength="200"/> 
          </td>
        </tr> 
        <tr>
          <td nowrap="nowrap" class="title_item">介绍：</td>
          	...
          	<td>
          			...
          			<c:if test="${not empty af.map.id}">
          				<div id="main_pic_div" class="main_box">
	          				<div class="pic_box">
	          					<a id="main_pic_a" href="${ctx}/${af.map.main_pic_file}" title="！">
			       					...
			       					<ul style="display:block;list-style-type:none;">
				       					<c:forEach items="${picList}" var="cur" varStatus="vs">
				       						<li id="pic_${vs.count}_li" class="main_box" style="display:inline-table;margin:5px 0px 5px 20px">
			       								<div class="pic_box">
					       							<a rel="group" href="${ctx}/${cur}" title="">
...
$(document).ready(function(){
	...
	$("a[id^='att_del_']").click(function() {
	  	  var a = this;
	  	   ...
	  	   // $.post("EcVoteOption.do", { method : "deleteFile", id : $(this).attr("id").replace(/att_del_/g, '')}, function(success) {
