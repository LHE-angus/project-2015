...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcVoteOption">
      <html-el:hidden property="method" value="list" />
      <html-el:hidden property="vote_id" value="${af.map.vote_id}" />
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;&nbsp;<input type="button" class="but2" value="新 增" onclick="location.href='EcVoteOption.do?method=add&mod_id=${af.map.mod_id}&vote_id=${af.map.vote_id}';" />
				</td>
			</tr>
		</table>		
	</div>
  <div class="rtabcont1">
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap">  
          	  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcVoteOption.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看</span>
         	 <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcVoteOption.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
          </td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcVoteOption.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;">
              ...
              <script type="text/javascript">
								...
								pager.addHiddenInputs("vote_id", "${af.map.vote_id}");
