...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcGoodsPrice" method="post">
      ...
      <html-el:hidden property="price_type" styleId="price_type" value="${af.map.price_type}" />
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        <c:if test="${af.map.price_type eq 2}">
          <tr>
            <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>分公司ID：</td>
        ...
        <c:if test="${af.map.price_type eq 3}">
          <tr>
        ...
        <tr>
          ...
          <td><html-el:button property="" value="提交" styleClass="but4" styleId="btn_submit" />
            <html-el:button property="" value="返 回" styleClass="but5" styleId="btn_back" onclick="location.href='${ctx}/manager/spgl/EcGoodsPrice.do?method=view&id=${af.map.goods_id}&price_type=${af.map.price_type}&mod_id=${af.map.mod_id} ' " /></td>
        </tr>
      </table>
    </html-el:form>
  </div>
...
$(document).ready(function(){
	...
	$("#price").attr("datatype", "Require").attr("msg", "现销售价格不能为空！");
