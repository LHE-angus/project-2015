...
$(document).ready(function(){
		...
		$("#c_name").click(function(){
			...
			var returnValue = window.showModalDialog("EcUser2.do?method=listCustomer&fgs_id=" + fgs_id +"&ts=" + Math.random(), window, "dialogWidth:800px;status:no;dialogHeight:600px");
