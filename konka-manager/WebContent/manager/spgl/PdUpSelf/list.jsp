...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/PdUpSelf">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
         ...
         <tr>   <td height="36" align="left" style="padding-left:5px;"> 
  ...
  <div class="rtabcont1">
    ...
    <c:forEach items="${entityList}" var="cur" varStatus="vs">
      ...
      <div style="margin:3px auto;">
        ...
        <div style="float:right;">
               <c:if test="${not empty cur.map.is_upSelf}"><span class="fblue" style="cursor:pointer;" onclick="doNeedMethod('确定下架此商品？', 'PdUpSelf.do', 'offShelf', 'id=${cur.id}&own_sys=${af.map.own_sys}&prod_type=${af.map.prod_type}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">下架</span></c:if>
               <c:if test="${empty cur.map.is_upSelf}"><a style="color: blue" href="javascript:loading();doNeedMethod(null, 'PdUpSelf.do', 'upShelf', 'id=${cur.id}&own_sys=${af.map.own_sys}&prod_type=${af.map.prod_type}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">上架</a> </c:if>
         </div>
      </div>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="PdUpSelf.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
