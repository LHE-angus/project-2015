...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;&nbsp;<input type="button" class="but2" value="新 增" onclick="location.href='EcAuctionMain.do?method=add&mod_id=${af.map.mod_id}';" />
				</td>
			</tr>
		</table>		
	</div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td width="8%" nowrap="nowrap" align="center">活动状态</td>
         ...
         <td width="8%" nowrap="nowrap" align="center">起拍价</td>
         <td width="8%" nowrap="nowrap" align="center">最低加价幅度</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="left" nowrap="nowrap">
           ...
           <td align="left" nowrap="nowrap"><c:if test="${cur.auction_state eq 0}">竞拍中</c:if>  
           <c:if test="${cur.auction_state eq 1}">竞拍成功</c:if>
           <c:if test="${cur.auction_state eq 2}">竞拍失败</c:if>
           </td>
          ...
          <td align="right" nowrap="nowrap">${cur.auction_price}</td>  
          <td align="right" nowrap="nowrap">${cur.add_price}</td>  
          <td align="right" nowrap="nowrap">${cur.order_value}</td>  
          <td align="center" nowrap="nowrap">  
          	  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcAuctionMain.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看</span>
         	 <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcAuctionMain.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
          </td>
        </tr>
      </c:forEach>
    </table>
