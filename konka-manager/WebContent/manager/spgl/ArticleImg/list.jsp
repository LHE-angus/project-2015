...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
      <html-el:form action="/spgl/ArticleImg">
    ...
    <html-el:form action="/spgl/ArticleImg?method=delete">
      <div class="rtabcont1">
        <input type="button" class="but3" name="delete" id="delete" value="回收站" onclick="confirmDeleteAll(this.form);" />
        <input type="button" class="but2" name="add" value="添加 " onclick="location.href='ArticleImg.do?method=add&mod_id=${af.map.mod_id}&news_module=${af.map.news_module}';" />
        <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          ...
          <tr>
            ...
            <td align="left"><a class="preview" href="ArticleImg.do?method=view&id=${cur.id}&mod_id=${af.map.mod_id}" rel="${ctx}/${fn:substringBefore(cur.image_path, '.')}_400.jpg" title="${fn:escapeXml(cur.title)}">${fn:escapeXml(cur.title)}</a></td>
            <td>
            ...
            <td align="center" nowrap="nowrap"><c:if test="${cur.info_state eq -1}">
              ...
              <c:if test="${cur.info_state ne -1}">
                ...
                <a href="#" onclick="confirmDelete(null, 'ArticleImg.do', 'mod_id=${af.map.mod_id}&id=${cur.id}&news_module=${cur.news_module}&pager.requestPage=${af.map.pager.requestPage}')">删除</a>
              </c:if>
            </td>
          </tr>
        </c:forEach>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="../spgl/ArticleImg.do">
...
$(document).ready(function(){
	...
	$("td.order_value_td").inputable({
		...
		url : '../spgl/ArticleImg.do?method=updateOrderValue',
