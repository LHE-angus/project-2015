...
<div class="oarcont">
  ...
  <div id="print" style="width:100%;height:100%;border: 1px #ccc solid " align="left" title="电子账单" style="margin-top:4px;">
    	<img src="${ctx}/images/SFCode.jpg?order_id=${af.map.id}" style="width:465px;height:658px;" ></img> <div style="position:absolute;width:71px;height:42px;z-indent:2;left:380px;top:268px;">
    	${af.map.sf_type}
    	</div>
  </div>
  <div align="left" style="margin-left:10px;margin-bottom:20px;">
    ...
    <input class="bgButtonPrint" type="button"  value="打印" onclick="win_print();" />
  </div>
  <div class="clear"></div>
</div>
...
function win_print(){
	prnhtml=$("#print").html();
	prnhtml=prnhtml.replace("top:268px","top:258px"); 
