...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/PshowOrderSend">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PshowOrderSend.do', 'showPrint','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())" title="打印配货单">配货单</span>
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PshowOrderSend.do', 'showPrint2','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())" title="打印购物单">购物单</span>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/manager/spgl/PshowOrderSend.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/manager/spgl/PshowOrderSend.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });	
