...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr style="height:25px;">
          <td style="height:25px;" nowrap="nowrap">&nbsp;<strong class="fb">交易流水号：</strong>
            <html-el:text property="trade_index_like" styleId="trade_index_like" maxlength="30" style="width:300px;" />
            &nbsp;<strong class="fb">下单人姓名：</strong>
            <html-el:text property="order_user_name_like" styleId="order_user_name_like" maxlength="30" style="width:100px;" />
            ...
            <html-el:text property="buyer_name_like" styleId="buyer_name_like" maxlength="30" style="width:100px;" />
            &nbsp;
            <strong class="fb">购买人手机：</strong>
            <html-el:text property="buyer_mp_like" styleId="buyer_mp_like" maxlength="30" style="width:100px;" />
            &nbsp;
              &nbsp;<strong class="fb">嘿客订单号：</strong>
            <html-el:text property="sf_order_id_like" styleId="sf_order_id_like" maxlength="30" style="width:100px;" />&nbsp;
   ...
   <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td> 
            <input style="align:left" name="button" type="button"  value="确认收款"  onclick="confirmCheckAll(document.getElementById('listForm'));" />
            &nbsp; &nbsp;<a href="?method=index&mod_id=${af.map.mod_id }" style="color:blue;" >按订单编号批量确认</a>
            <span  style="font-weight:700;color:#F00;">
  ...
  <div class="rtabcont1" style="overflow-x:auto;">
        ...
        <tbody>
          <tr class="tabtt1">
            ...
            <td width="10%" nowrap="nowrap" align="center">下单人姓名</td>
             <td width="10%" nowrap="nowrap" align="center">嘿客订单号</td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <td align="center">
                  <c:out value="${cur.pay_price}" />
              </td>
              <td align="center" nowrap="nowrap">
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PshowOrderConfirmForSfhk.do','confirm' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">确认收款</span>
              </td>
            </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="PshowOrderConfirmForSfhk.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/manager/spgl/PshowOrderConfirmForSfhk.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/manager/spgl/PshowOrderConfirmForSfhk.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });
});
