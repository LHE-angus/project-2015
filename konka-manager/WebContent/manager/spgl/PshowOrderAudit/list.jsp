...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/PshowOrderAudit">
  ...
  <div class="rtabcont1">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'PshowOrderAudit.do','audit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">审核</span>
              </td>
            </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="PshowOrderAudit.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
