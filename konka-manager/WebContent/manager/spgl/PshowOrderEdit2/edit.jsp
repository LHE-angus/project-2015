...
<div>
  <div class="rtabcont1">
  	<html-el:form action="/spgl/PshowOrderEdit2" method="post">
      ...
      <div class="rtabcont1">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
         ...
         <tr>
          ...
          <tr>
             ...
             <td colspan="2">
             	<html-el:text property="pay_price" styleId="pay_price" size="15" maxlength="10"/> (元)
             </td>
          </tr>
          <tr>
          ...
          <tr>
             ...
             <td colspan="5">
            	...
            	<html-el:radio property="deliver_time" value="2">只工作日送货（双休日、假日不用送）</html-el:radio>             </td>
          </tr>
       <c:if test="${not empty af.map.ecVouchersList }">
		<tr>
          ...
          <tr>
          <td class="title_item" width="15%" style="text-align: center;" >备注：</td>
      ...
      <div style="margin-top: 30px">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
          ...
          <td colspan="6"><html-el:text property="remark1"  maxlength="200" style="width:70%"></html-el:text></td>
          </tr>
          <tr>
          	  <td colspan="7" height="40" align="center"><input class="bgButtonSave" type="button" name="Submit4" value=" 保存 " id="btn_submit" />
