...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/TouchOrderLook">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
           ...
           <strong class="fb">下单客户R3编码：</strong>&nbsp;
            <html-el:text property="r3_code" styleId="r3_code" style="width:100px;"  maxlength="20"/> &nbsp; &nbsp;
  ...
  <div class="rtabcont1" style="overflow-x:auto;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tbody>
          <tr class="tabtt1">
            ...
            <td width="10%" nowrap="nowrap" align="center">嘿客下单人</td>
            ...
            <td width="5%" nowrap="nowrap" align="center">物流费用</td>
             <td width="5%" nowrap="nowrap" align="center">订单商品</td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <c:if test="${empty cur.map.old_dept_name}"><c:out value="${cur.map.dept_name_new}" /></c:if>
              ...
              <td align="right" nowrap="nowrap"><c:out value="${cur.sfhk_order_name}" /></td> 
              ...
              <td align="right" nowrap="nowrap"><span class="kz-price-12"> <fmt:formatNumber value="${cur.map.logistic_price}" type="currency" /> </span> </td>
              ...
              <td align="center" nowrap="nowrap">
              	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'TouchOrderLook.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看</span>
              </td>
            </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="TouchOrderLook.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/manager/spgl/TouchOrderLook.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/manager/spgl/TouchOrderLook.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });
