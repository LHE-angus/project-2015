...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcGiftOrdeEdit">
  ...
  <div class="rtabcont1" style="overflow: auto;">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <c:choose>
              <c:when test="${cur.state eq -30 || cur.state eq -20 || cur.state eq -10 || cur.state eq 0 || cur.state eq 10 }">
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcGiftOrdeEdit.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span>
             </c:when>
             <c:otherwise>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcGiftOrdeEdit.do">
