...
<div class="oarcont">
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcStocksNew" method="post">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          <tr id="t0" >
            ...
            <td width="88%" align="left"><html-el:select property="store_id_1" styleId="store_id_1">
                ...
                <c:forEach var="cur" items="${entityList1}">
                  <html-el:option value="${cur.store_id}">${cur.store_name}<c:if test="${cur.plat_sys eq 0}">(总部)</c:if><c:if test="${cur.plat_sys eq 1}">(分公司)</c:if></html-el:option>
                </c:forEach>
              </html-el:select>
            </td>
          </tr>
        ...
        <tr>
          ...
          <td><html-el:button property="" value="提交" styleClass="but4" styleId="btn_submit" />
            <html-el:button property="" value="返 回" styleClass="but5" styleId="btn_back" onclick="location.href = '${ctx}/manager/spgl/EcStocksNew.do?method=list2&mod_id=${af.map.mod_id}&goods_id=${af.map.goods_id}&own_sys=${af.map.own_sys}' " /></td>
        </tr>
      </table>
    </html-el:form>
  </div>
