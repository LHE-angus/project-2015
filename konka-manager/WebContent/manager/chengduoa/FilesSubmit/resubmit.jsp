...
<div class="oarcont">
      ...
      <tr>
        ...
        <c:if test="${empty p_audit_node_id}">
	        <c:if test="${af.map.file_status ne -1}">
	          <td>当前位置：行政办公系统&nbsp;&gt;&nbsp;提交文件</td>
	        </c:if>
	        <c:if test="${af.map.file_status eq -1}">
	          <td>当前位置：行政办公系统&nbsp;&gt;&nbsp;待办文件</td>
	        </c:if>
        </c:if>
  ...
  <div class="rtabcont2">
    <html-el:form action="/chengduoa/FilesSubmit" enctype="multipart/form-data">
      <html-el:hidden property="queryString" styleId="queryString" />
      <html-el:hidden property="method" styleId="method" value="resave" />
        ...
        <c:if test="${af.map.file_status ne -1}">
          ...
          <tr>
           ...
           <html-el:select property="audit_node_id" styleId="audit_node_id" style="width:385px;">
            ...
            <td><html-el:select property="time_limit" style="width:140px;">
          ...
          <tr>
           <td class="title_item"></td>
            <td colspan="4"><FCK:editor instanceName="content" width="96%" height="250">
...
<%--               </c:if></td> --%>
<!--           </tr> -->
<%--           <tr id="is_countersign_tr" style="display:${display};"> --%>
...
<!--           </tr> -->
        ...
        <c:if test="${af.map.file_status eq -1}">
          <tbody style="display:none;">
            <tr>
              <td width="90" align="center">负&nbsp;&nbsp;责&nbsp;&nbsp;人</td>
              <td><html-el:text property="apply_user_name" styleId="apply_user_name" maxlength="200" style="width:95%" /></td>
              <td width="80" align="center">电　　话</td>
              <td width="140"><html-el:text property="apply_user_tel" styleId="apply_user_tel" maxlength="20" style="width:120px" /></td>
              <td width="80" align="center">编　　号</td>
              <td width="122"><html-el:text property="file_no" styleId="file_no" maxlength="15" style="width:115px" /></td>
            </tr>
            <tr>
              <td align="center">申&nbsp;&nbsp;请&nbsp;&nbsp;人</td>
              <td><html-el:text property="submit_user" styleId="submit_user" maxlength="125" style="width:95%" readonly="true" value="${userInfo.real_name}" /></td>
              <td align="center">标　　题</td>
              <td colspan="3"><html-el:text property="file_title" styleId="file_title" maxlength="500" style="width:95%" /></td>
              <td align="center">申请时间</td>
              <td nowrap="nowrap"><fmt:formatDate value="${submit_datetime}" pattern="yyyy-MM-dd HH:mm:ss" var="_submit_datetime" />
                <html-el:text property="submit_datetime" styleId="submit_datetime" size="20" maxlength="20" readonly="true" value="${_submit_datetime}" style="width:120px;" /></td>
            </tr>
            <tr>
              <td align="center">审批人</td>
              <td nowrap="nowrap"><div id="audits">
                  <c:set var="audit_node_num" value="2" />
                  <c:if test="${not empty filesAuditNodeList}">
                    <c:set var="cur" value="${filesAuditNodeList[fn:length(filesAuditNodeList) - 1]}" />
                    <div style="padding:3px 2px;">
                      <input type="hidden" name="audit_user_id" id="audit_user_id" value="${cur.audit_user_id}" />
                      <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" value="${cur.audit_user}" style="width:88%;vertical-align:middle;" />
                      <img onclick="selectUser(this);" src="${ctx}/images/search.gif" style='cursor: pointer;vertical-align:middle;' alt='选择人员' title="选择人员" /> </div>
                  </c:if>
                  <c:if test="${empty filesAuditNodeList}">
                    <div style="padding:3px 2px;">
                      <input type="hidden" name="audit_user_id" id="audit_user_id" />
                      <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" style="width:88%;vertical-align:middle;" />
                      <img onclick="selectUser(this);" src="${ctx}/images/search.gif" style='cursor: pointer;vertical-align:middle;' alt='选择人员' title="选择人员" /></div>
                  </c:if>
                </div></td>
              <td align="center">类　　别</td>
              <td><html-el:select property="category11" style="width:120px;">
                  <html-el:optionsCollection name="category11List" label="c_name" value="c_index" />
                </html-el:select></td>
              <td align="center">时　　限</td>
              <td><html-el:text property="time_limit" styleId="time_limit" maxlength="4" style="width:40px" />
                &nbsp;天</td>
              <td align="center"></td>
              <td></td>
            </tr>
            <tr>
              ...
              <td colspan="5"><FCK:editor instanceName="content" width="96%" height="250">
                ...
                <div id="divFile">
                  ...
                  <img src="${ctx}/images/+.gif" style="vertical-align:middle; cursor: pointer;" id="imgAddTr" title="再添加一个" /></div>
                <c:forEach var="cur" items="${attachmentList}" varStatus="vs"><span>${vs.count}、<a href="${ctx}/manager/admin/Download.do?method=downloadFile&save_name=${cur.save_name}" target="_blank">${cur.file_name}</a>&nbsp;(<a id="del_${cur.id}">删</a>) <br />
                  </span></c:forEach></td>
            </tr>
<!--             <tr> -->
<!--               <td align="center">是否会签</td> -->
<%--               <td colspan="5"><html-el:radio property="is_countersign" value="0" styleId="is_countersign_0" /> --%>
<!--                 <label for="is_countersign_0"> 否 </label> -->
<%--                 <html-el:radio property="is_countersign" value="1" styleId="is_countersign_1" /> --%>
<!--                 <label for="is_countersign_1"> 是 </label> -->
...
<!--             </tr> -->
<%--             <tr id="is_countersign_tr" style="display:${display};"> --%>
<!--               <td align="center">会&nbsp;&nbsp;签&nbsp;&nbsp;人</td> -->
<%--               <td colspan="5"><input type="hidden" name="countersign_ids" id="countersign_ids" value="${af.map.countersign_ids}" /> --%>
<%--                 <input type="text" name="countersign_names" id="countersign_names" value="${af.map.countersign_names}" readonly="readonly"  style="width:95%;vertical-align:middle;" /> --%>
<%--                 <img id="add_coun" src="${ctx}/images/search.gif" style='vertical-align:middle;cursor: pointer;' alt='选择人员' /> <br /></td> --%>
<!--             </tr> -->
            <tr>
          ...
          <table width="90%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
            <tr>
              <td align="center" nowrap="nowrap">负&nbsp;&nbsp;责&nbsp;&nbsp;人</td>
              <td colspan="2" width="15%">${fn:escapeXml(af.map.apply_user_name)}&nbsp;</td>
              <td align="center" nowrap="nowrap">电　　话</td>
              <td width="20%">${fn:escapeXml(af.map.apply_user_tel)}&nbsp;</td>
              <td align="center" nowrap="nowrap">编　　号</td>
              <td width="15%">${fn:escapeXml(af.map.file_no)}&nbsp;</td>
            </tr>
            <tr class="rtable1">
              <td align="center" nowrap="nowrap">申&nbsp;&nbsp;请&nbsp;&nbsp;人</td>
              <td colspan="2">${af.map.submit_user}</td>
              <td align="center" nowrap="nowrap">标　　题</td>
            ...
            <tr>
              <td align="center" nowrap="nowrap">审&nbsp;&nbsp;批&nbsp;&nbsp;人</td>
              <td colspan="4"><div id="audits">
                  <c:set var="audit_node_num" value="2" />
                  <c:if test="${not empty filesAuditNodeList}">
              ...
              <td align="center" nowrap="nowrap">时　　限</td>
              <td>${af.map.time_limit}&nbsp;天</td>
            </tr>
            <tr>
              <td height="200" align="center" valign="top" >请示内容</td>
              <td colspan="7" valign="top" style="padding-top:10px;">${af.map.content}
            ...
            <tr>
              <td align="center">是否下发</td>
              <td colspan="7"><c:if test="${af.map.is_forward eq 0}">否</c:if>
      ...
      <div align="center" style="padding:15px; 0 0;">
        <input class="but4" type="button" name="Submit4" value="提交" id="btn_submit" style="align:center;"/>
        <input class="but5" type="button" name="Submit5" value="返回" style="align:center;" onclick="history.back();return false;" />
      </div>
    </html-el:form>
  </div>
  <div class="clear"></div>
