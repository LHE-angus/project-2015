...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaProSq">
  ...
  <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><input style="align:left" name="button" type="button"  value="新增" class="but2" onclick="location.href='KonkaProSq.do?method=add&mod_id=${af.map.mod_id}';" />
         <!-- 
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaProSq.do?method=delete">
            ...
            <tr>
             ...
             <td align="center" nowrap="nowrap">
              ...
              <td align="center" valign="top">
                <c:if test="${cur.file_state eq 0 || cur.file_state eq 5}">
                <span style="cursor: pointer;color: blue;" onclick="confirmUpdate(null, 'KonkaProSq.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span>
                </c:if>
                 <c:if test="${cur.file_state ne 0 && cur.file_state ne 5}">
                 <span style="color:#ccc;">修改</span>
                 </c:if>
                |
                <c:if test="${cur.file_state eq 0  || cur.file_state eq 5}">
                <span style="cursor: pointer;color: blue;" onclick="confirmDelete(null, 'KonkaProSq.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())">删除</span>
                </c:if>
                <c:if test="${cur.file_state ne 0  && cur.file_state ne 5}">
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaProSq.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
