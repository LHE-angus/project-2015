...
<!--	    	</html-el:select>-->
 ...
 <td align="center" nowrap="nowrap" class="title_item">客户地址:</td> <!--公司地址-->
   <td align="left" nowrap="nowrap" >
  <html-el:text property="link_man_addr" styleId="link_man_addr" maxlength="30"></html-el:text>
   </td>
   </tr>
   ...
   <td align="left" nowrap="nowrap">
  <html-el:text property="link_man_name[0]" styleId="link_man_name1" maxlength="10" ></html-el:text>
   </td>
   </tr>   
    	 <tr>
   <td align="center" nowrap="nowrap" class="title_item"><font color="red">* </font>联系人电话1:</td>
   <td align="left" nowrap="nowrap" >
  <html-el:text property="link_man_tel[0]" styleId="link_man_tel1" maxlength="15"></html-el:text>
   </td>
   </tr>
    <tr>
   <td align="center" nowrap="nowrap" class="title_item">联系人姓名2:</td>
   <td align="left" nowrap="nowrap">
  <html-el:text property="link_man_name[1]" styleId="link_man_name2" maxlength="10"></html-el:text>
   </td>
   </tr>   
    	 <tr>
   <td align="center" nowrap="nowrap" class="title_item">联系人电话2:</td>
   <td align="left" nowrap="nowrap" >
  <html-el:text property="link_man_tel[1]" styleId="link_man_tel2" maxlength="15"></html-el:text>
   </td>
   </tr>
 ...
 <tr>
  ...
  <html-el:text property="entp_scale" styleId="entp_scale"></html-el:text>
   ...
   <td align="left" nowrap="nowrap">
  <html-el:text property="total_area" styleId="total_area" maxlength="8"></html-el:text>
   </td>
   </tr>
   <!-- 
      <tr>
...
<tr>
  ...
  <html-el:text property="entp_main_pds" styleId="entp_main_pds"></html-el:text>
   ...
   <tr>
    ...
    <td align="left" nowrap="nowrap">
    	<html-el:textarea property="memo" styleId="memo" style="width:300px;height:50px;resize:none"  value="${af.map.memo}" />
            ...
            <td class="title_item" align="center" nowrap="nowrap">附件:</td>
					...
					<c:if test="${fn:startsWith(cur.file_desc, 'policy_file')}">
					 <li><a href="${ctx}/${cur.save_path}">${cur.file_name}</a>
