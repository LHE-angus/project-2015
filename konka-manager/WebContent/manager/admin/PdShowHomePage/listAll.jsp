  ...
  <div class="oartop">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td nowrap="nowrap">当前位置：首页 &gt; 触网平台</td>
      </tr>
    </table>
  </div>
  <div class="rtabcont1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
       <tbody>
          <tr class="tabtt1">
              <td width="50%" align="center" ><font class="blue">商品型号</font></td>
              <td width="30%" nowrap="nowrap" align="center"><font class="blue">R3库存</font></td>
               <td width="20%" nowrap="nowrap" align="center"><font class="blue">操作</font></td>
          </tr>
         <c:forEach var="cur" items="${entityList}" varStatus="vs">
           <tr>
                <td align="center">${cur.pd_sn}</td>
                <td align="center" >${cur.map.r3_stcok}</td>
