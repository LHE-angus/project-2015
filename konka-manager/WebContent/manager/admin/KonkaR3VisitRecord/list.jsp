...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaR3VisitRecord">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          ...
          <td><strong class="fb">业务员：</strong>
              <html-el:text property="ywy_name_like" styleId="ywy_name_like" size="15" maxlength="20"/>
          </td>
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaR3VisitRecord.do">
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaR3VisitRecord.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
