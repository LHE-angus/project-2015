...
$(document).ready(function(){
	...
	$("#category_id" ).attr("dataType" , "Require").attr("msg" , "请选择网点类别！");
	 $("#send").click(function(){
...
function openChild(num){
	if(num == 1) {
	    var returnValue = window.showModalDialog("PeShop.do?method=listBasePropCategory" + "&time=" + new Date().getTime(), window, "dialogWidth:655px;status:no;dialogHeight:438px");
	    if(returnValue != null) {
			var value = new Array();
