...
<div class="oarcont" id="body_oarcont">
  ...
  <html-el:form action="/admin/KonkaR3FgsOrderSailTop">
    <html-el:hidden property="method" value="list" />
 	<html-el:hidden property="mod_id" styleId="mod_id" />
	<div class="rtabcont1">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableTop">
			<tr>
					<td height="36" align="left" style="padding-left: 5px; width: 60px">&nbsp;<strong class="fb">年月：</strong>
					</td>
					<td height="36" align="left" style="padding-left: 5px; width: 130px"><html-el:select property="year" styleId="year">
				...
				<td height="36" align="left" style="padding-left: 5px; width: 90px">&nbsp;<strong class="fb">含业绩划拨：</strong></td >
				
				<td height="36" align="left" style="padding-left: 5px; width: 130px">
					<html-el:select property="yjhb" styleId="yjhb">
						<html-el:option value="Y">包含</html-el:option>
						<html-el:option value="N">不包含</html-el:option>
					</html-el:select>
				</td>
				<td height="36" align="left" style="padding-left: 5px; width: 300px"><input name="button" type="submit" class="bgSearch" id="sear_btn" value="搜 索" /></td>
			</tr>
		</table>
	</div>
</html-el:form>
  ...
  <div class="rtabcont1" style="overflow-x: auto;">
    ...
    <table class="rtable6" width="100%" cellspacing="1" cellpadding="0" border="0">
      ...
      <tr>
        <td colspan="4" align="center" style="border-bottom: 1px solid #E3E3E3;background-color: #A4D3EE;">业绩完成情况</td>
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
   		<c:choose>
	        ...
	        <tr style="background-color: #FFEBCD;">
	          ...
	          <td nowrap="nowrap" align="right"><fmt:formatNumber value="${cur.map.dr_hs_money}" pattern="###,##0.00" /></td>
      ...
      <tr>
       ...
       <td nowrap="nowrap" align="right" style="font-weight:600;"><fmt:formatNumber value="${t_dr_hs_money}" pattern="###,##0.00" /></td>
       ...
       <td nowrap="nowrap" align="right" style="font-weight:600;"><fmt:formatNumber value="${t_hs_money*10000/t_pb_num}" pattern="###,##0.00" />
