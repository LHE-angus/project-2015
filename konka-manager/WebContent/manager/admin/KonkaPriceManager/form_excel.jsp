...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<html-el:form action="/admin/KonkaPriceManager" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      	...
      	<tr>
      		<td colspan="3"><a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/konka_price_manager_import_template.xls">Excel模板下载</a></td>
      	</tr>
      </table>
    </html-el:form>
  </div>
