...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;&nbsp;<input type="button" class="but2" value="新 增" onclick="location.href='KonkaInterfaceIp.do?method=add&mod_id=${af.map.mod_id}';" />
				</td>
			</tr>
		</table>		
	</div>
  <div class="rtabcont1">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap" width="25%" align="center">IP</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaInterfaceIp.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">${cur.licenses_sn}</span></td>
          ...
          <td align="center" nowrap="nowrap"> 
          	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaInterfaceIp.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看</span>
         	 <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaInterfaceIp.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
          </td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaInterfaceIp.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
