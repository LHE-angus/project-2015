...
<div class="oarcont">
 ...
 <div class="rtabcont1">
  ...
  <tr>
   ...
   <tr >
          ...
          <td width="88%" align="left">
			...
			<html-el:text property="add_date" styleId="add_date" disabled="true" size="10" maxlength="10" readonly="true" onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期"  value="${_add_date}"/>
				
			 <fmt:formatDate value="${af.map.add_date}" pattern="yyyy-MM-dd" var="add_date" />
			<html-el:hidden property="add_date" styleId="add_date"  onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期"  value="${add_date}"/>
          </td>
   </tr>
  <tr>
  ...
  <tr>
    <td align="center" nowrap="nowrap" class="title_item">上架照片:</td>
    <td align="left" nowrap="nowrap">
           <table>
