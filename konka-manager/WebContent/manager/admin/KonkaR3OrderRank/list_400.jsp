...
$(document).ready(function(){
	...
	if(${not empty entityList}){
		...
		var dataStr = "KonkaR3OrderRank.do?method=chart_400";
		...
		dataStr += "&ywy_user_name=${af.map.ywy_user_name}";
		dataStr += "&customer_name=${af.map.customer_name}";
		$.ajax({
		    type: "POST",
		    url: dataStr,
