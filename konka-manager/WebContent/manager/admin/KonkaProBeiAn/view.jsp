...
<div class="oarcont">
  ...
  <div class="rtabcont2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        	...
        	<td colspan="4" width="100%">
	        	 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2" id="categorys_td">
	              	<tr class="tabtt1" style="height: 28px;">
	              	  <td align="center" nowrap="nowrap">品牌</td>
	              	...
	              	<tr >
	              	  	...
	              	  	<td><html-el:text property="md_name" value="${cur.md_name}" style="width:80px;" styleId="md_name_${_cur.id}" maxlength="30" readonly="true" /></td>
	              	  	<td><html-el:text property="param" value="${cur.param}" style="width:80px;" maxlength="16" styleId="param_${_cur.id}"   readonly="true" /></td>
        ...
        <tr>
          <td class="title_item" align="center" colspan="4" >
