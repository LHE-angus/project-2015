...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaProBeiAn">
  ...
  <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
          <c:if test="${not empty is_admin}"><input class="but3" type="submit" name="Submit3" value="删除" onclick="confirmDeleteAll(document.getElementById('listForm'));" /></c:if>
  ...
  <div style="overflow-x: auto">
    <form id="listForm" name="listForm" method="post" action="KonkaProBeiAn.do?method=delete">
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaProBeiAn.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td width="10%" nowrap="nowrap" align="center">报备时间</td>
        <td width="10%" nowrap="nowrap" align="center">项目状态</td>
        <td width="10%" align="center" nowrap="nowrap">品牌</td>
      ...
      <c:forEach var="cur" items="${allList}" varStatus="vs">
        <tr class="list-tr">
          ...
          <td align="left" nowrap="nowrap">${cur.map.brand_name}</td>
          <td align="left" nowrap="nowrap">${cur.map.md_name}</td>
          <td align="left" nowrap="nowrap">${cur.map.param}</td>
          <td align="left" nowrap="nowrap">${cur.map.sail_money}</td>
          <td align="left" nowrap="nowrap">${cur.map.bd_tb_price}</td>
        </tr>
      </c:forEach>
    </table>
  </div>
...
<script type="text/javascript">//<![CDATA[
   $(document).ready(function() {
		...
		if("1" == excel_all){
			toExcel('divExcel_all', '${ctx}/manager/admin/KonkaProBeiAn.do?method=toExcel');
		}
