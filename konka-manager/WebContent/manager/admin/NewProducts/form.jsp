...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/NewProducts" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          <td nowrap="nowrap" class="title_item">产品标题：</td>
        ...
        <tr>
          ...
          <td><html-el:textarea property="summary" styleId="summary" cols="70" rows="7" style="resize:none" />
...
$(document).ready(function(){
 var acceptUploadFileExts = "7z, aiff, asf, avi, bmp, csv, doc, fla, flv, gif, gz, gzip, jpeg, jpg, mid, mov, mpc, mpeg, mpg, ods, odt, pdf, png, ppt, pxd, qt, ram, rar, rmi, rtf, sdc, sitd, swf, sxc, sxw, tar, tgz, tif, tiff, txt, vsd, wav, wma, wmv, xls, xml, zip, docx, xlsx, pptx";

  $("#title").attr("dataType", "Require").attr("msg", "请填写产品标题");
  ...
  $("#province").change(function(){
    ...
    $("#select_type0").click(function(){{$("#type0").show();$("#peShopCategoryName").removeAttr("dataType");  $("#shop_name").attr("dataType", "Require").attr("msg", "请选择投放网点");}$("#type1").hide();});
	$("#select_type1").click(function(){{$("#type1").show();$("#shop_name").removeAttr("dataType");$("#peShopCategoryName").attr("dataType", "Require").attr("msg", "请选择投放网点的类别");}$("#type0").hide();});
...
function getPeShopCategoryInfo(){
	var returnValue = window.showModalDialog("PeShopCategory.do?method=listForLevel&selects=" + $("#peShopCategoryId").val() +  "&azaz=" + Math.random(),window,"dialogWidth:600px;status:no;dialogHeight:400px");
	if (returnValue != null) {
