  ...
  <div>
    <table width="100%" cellspacing="1" cellpadding="0" border="1">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        ...
        <tr>
          <td nowrap="nowrap" colspan="3" align="left">合计</td><td><fmt:formatNumber value="${v_pdlabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_pclabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_zzlabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_bclabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_jylabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_yjlabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_cllabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_tjlabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_zclabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_dzlabst}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_mzt}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_mwf}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_sum}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_lfimg1}" pattern="###,##0" /></td><td><fmt:formatNumber value="${v_lfimg}" pattern="###,##0" /></td><td class="bg_y"><fmt:formatNumber value="${v_zzl}" pattern="###,##0.00" /></td>
        </tr>
    </table>
  </div>
</div>
