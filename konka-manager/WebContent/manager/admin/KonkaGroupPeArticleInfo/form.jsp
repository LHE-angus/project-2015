...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaGroupPeArticleInfo" enctype="multipart/form-data">
        ...
        <tr>
          ...
          <td width="88%"><c:if test="${not empty af.map.img_path}"><a href="${ctx}/${af.map.img_path}" target="_blank"><img src="${ctx}/${fn:substringBefore(af.map.img_path,'.')}_240.jpg" style="width:150px;height:100px;border:1px solid #ccc;" /></a>
            ...
            <c:if test="${empty af.map.img_path}">
              <html-el:file property="img_path" style="width:300px;" styleId="img_path" />
            </c:if></td>
        </tr>
        <tr>
        ...
        <tr id="select_5">
          ...
          <td><html-el:select property="group_id" styleId="group_id">
              ...
              <c:forEach items="${konkaPeArticleUserGroupList}" var="cur" varStatus="vs">
                <html-el:option value="${cur.id}">${cur.groupname}</html-el:option>
              </c:forEach>
            </html-el:select></td>
        </tr>
        <tr>
...
$(document).ready(function(){
  ...
  $("#img_path").attr("dataType", "Filter" ).attr("msg", "图片的格式必须是(bmp,gif,jpeg,jpg)！").attr("require", "false").attr("accept", "bmp, gif, jpeg, jpg");
