  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/StatisticalDimensionTime">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        <tr>
          <td nowrap="nowrap" height="28" class="title_item" align="right" width="15%">年度：</td>
          <td width="85%">
        ...
        <tr>
          <td nowrap="nowrap" height="28" class="title_item" align="right">年度类别：</td>
          <td>
...
$(document).ready(function(){
	...
	$("#is_cw").attr("dataType", "Require").attr("msg", "请选择年度类别");
