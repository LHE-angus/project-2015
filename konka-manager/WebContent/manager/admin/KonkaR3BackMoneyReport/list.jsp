...
<div class="oarcont" id="body_oarcont">
	...
	<div class="rtabcont1">
		<html-el:form action="/admin/KonkaR3BackMoneyReport">
	...
	<div class="rtabcont1">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
			<tr class="tabtt1">
				...
				<td width="20%" nowrap="nowrap">任务销售额（元）</td>
				<td width="20%" nowrap="nowrap">回款（元）</td>
			...
			<c:set var="total_money" value="0" />
		  	<c:forEach items="${entityList}" var="cur" varStatus="vs">
		  		<tr>
		  			...
		  			<td align="left">${fn:escapeXml(cur[2]) }</td>
		  			...
		  			<td align="right">${fn:escapeXml(cur[5]) }%</td>
		  		</tr>
		  	...
		  	<tr>
		  		...
		  		<td align="right"><span class="kz-price-12"><fmt:formatNumber value="${total_rw_money}" type="currency" /></span></td>
		  		<td align="right"><span class="kz-price-12"><fmt:formatNumber value="${total_back_money}" type="currency" /></span></td>
		  		<td align="center"><span style="font-size:14px;font-family:verdana;font-weight:700;">/</span></td>
		  	</tr>
	  	</table>
	  	</div>
