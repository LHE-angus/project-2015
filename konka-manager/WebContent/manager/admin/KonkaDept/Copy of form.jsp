  ...
  <div class="rtabcont2">
    ...
    <c:if test="${not empty af.map.bj}">
      <html-el:form action="/admin/KonkaDept.do">
        ...
        <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
          <tr class="oartop">
            <td colspan="2"><c:if test="${not empty af.map.add}">〖${af.map.par_dept_name}〗子</c:if>
              部门基本信息</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="85%"><html-el:select property="p_area" styleId="p_area">
                <html-el:option value="">请选择...</html-el:option>
                <html-el:option value="1">华北</html-el:option>
                <html-el:option value="2">东北</html-el:option>
                <html-el:option value="3">华东</html-el:option>
                <html-el:option value="4">华中</html-el:option>
                <html-el:option value="5">西南</html-el:option>
                <html-el:option value="6">华南</html-el:option>
                <html-el:option value="7">西北</html-el:option>
                <html-el:option value="8">山东</html-el:option>
              </html-el:select>
              <span onclick="$(this).next().toggle();">点击查询大区按行政区域划分参考标准</span>
              <div style="display:none;">
				华北地区：北京、天津、河北、山西、内蒙古（5个省、区、市）。<br/>
				东北地区：辽宁、吉林、黑龙江、大连（4个省、市）。<br/>
				华东地区：上海、江苏、浙江、安徽、福建、江西、山东、宁波、厦门、青岛（10个省、市）。<br/>
				中南地区：河南、湖北、湖南、广东、广西、海南、深圳（7个省、区、市）。<br/>
				西南地区：重庆、四川、贵州、云南、西藏（5个省、区、市）。<br/>
				西北地区：陕西、甘肃、青海、宁厦、新疆（5个省、区）。
              </div>
            </td>
          </tr>
          <tr>
