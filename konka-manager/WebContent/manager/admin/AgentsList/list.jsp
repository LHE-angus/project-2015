  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/AgentsList">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        ...
        <tr>
          <td width="15"></td> 
          <td><jsp:include page="../_inc/search_fgs_jyb_bsc_ywy.jsp?fgs_dept_id=${af.map.fgs_dept_id}&jyb_dept_id=${af.map.jyb_dept_id}&bsc_dept_id=${af.map.bsc_dept_id}&ywy_user_id=${af.map.ywy_user_id}" /></td>
    ...
    <html-el:form action="/admin/AgentsList" method="post">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        <tr class="tabtt1">
          ...
          <td width="5%" nowrap="nowrap" width="60">R3编码</td>
          <td nowrap="nowrap">代理商名称</td>
          <td width="10%" nowrap="nowrap">分配分公司</td>
          <td width="10%" nowrap="nowrap">分配经营部或办事处</td>
          <td width="5%" nowrap="nowrap">分配业务员</td>
          <td width="5%" nowrap="nowrap">代理商下的客户</td>
          <!-- <td width="5%" nowrap="nowrap">直接开拓</td> -->
        </tr>
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            <td align="center" nowrap="nowrap" width="5%">${vs.count}</td>
            ...
            <td nowrap="nowrap" align="center" width="5%"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'AgentsList.do', 'jxsShopList','r3_id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span></td>
            <!-- 
            <td nowrap="nowrap" align="center" width="5%">
             <logic-el:match name="popedom" value="+2+">
               <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'AgentsList.do', 'AgentsDirectDevelop','r3_id=${cur.id}&shop_id=${cur.map.mmt_shop_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">直接开拓</span>
             </logic-el:match>
             <logic-el:notMatch name="popedom" value="+2+">
               <span class="fblue" style="color:#ccc">直接开拓</span>
             </logic-el:notMatch>
            </td> -->
          </tr>
