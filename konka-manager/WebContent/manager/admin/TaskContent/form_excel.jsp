...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<html-el:form action="/admin/TaskContent" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      	...
      	<tr>
      		<td colspan="2"><img src="${ctx }/manager/admin/TaskContent/task_content_tpl.jpg" alt="sry,load fail" border="1"></img></td>
      	</tr>
      	<tr>
      		<td>请阅读操作提示:</td>
      		<td colspan="1">
      			<ul>
      				<li><font color="red" style="font-weight: bold;">1.下载Excel2003模板,导入内容放在第一个工作表中!</font>&nbsp;<a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/task_content_tpl.xls">Excel2003模板下载</a></li>
      				<li>2.参照上图样例,excel列不能调整,红色区为必填,黄色和橙色区2选1填写,任务系数和任务额2选1填写</li>
      				<li>3.任务类型固定为客户/业务员.如果任务类型为客户,那么意味你需要维护客户编码和客户名称!业务员类似</li>
      			</ul>
      		</td>
      	</tr>
      </table>
