      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td class="title_item" nowrap="nowrap" align="right">参数附件2：</td>
           <td width="30%"> <c:if test="${not empty af.map.id }"><a href="${ctx}/${af.map.fj_1}" target="_blank" >${af.map.fj_name_2}</a></c:if></td>
        </tr>
        <tr>
          ...
          <td class="title_item" nowrap="nowrap" align="right">参数附件3：</td> 
           <td width="30%"><c:if test="${not empty af.map.id }"><a href="${ctx}/${af.map.fj_1}" target="_blank" >${af.map.fj_name_3}</a>
           </c:if></td>
        </tr>
        </table>
        </td>
        ...
        <table width="100%">
        		...
        		<c:choose>
        			<c:when test="${fn:length(cur.audit_idea)>50}">
        			<c:out value="${fn:substring(cur.audit_idea,0,50)}..."></c:out>
        			</c:when>
        			<c:otherwise>
      ...
      <div id=tab2>
        ...
        <tr>
          ...
          <td class="title_item" nowrap="nowrap" align="right">参数附件3：</td>
           ...
           <td width="30%"><c:if test="${not empty af.map.id }"><a href="${ctx}/${af.map.fj_1}" target="_blank" >
          ${af.map.fj_name_3}</a>
           </c:if></td>
        </tr>
        </table>
