    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:0px;">
        <tr>
           ...
           <td class="oartop" align="left" style="padding-left:20px;" valign="middle">共有
               <span id="count_sum">-</span> 个直营网点符合您的查询要求.
      ...
      <td valign="top">
           <table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr id="onsaleInfoBox" style="display:none;">
               <td colspan="4" style="text-align:center;" id="onsale_info" title="<c:url value='/EntpShop.do?method=viewShoponsaleinfo&index_type=news&shop_id=000000000&id=000000001' />"></td>
            </tr>
            <tr id="productBox" style="display:none;">
              <td width="50" class="product">
                 <a class="imgWrap" href="<c:url value='/EntpShop.do?method=viewPd&index_type=news&shop_id=000000000&id=000000001' />">
                   <img id="img_0" width="46" height="45" />
                 </a>
              </td>
              <td width="95" class="product" style="color:#555;padding-left:5px;">
          		<a id="md_name_0" href="<c:url value='/EntpShop.do?method=viewPd&index_type=news&shop_id=000000000&id=000000001' />">&nbsp;</a>
          		<br />
          		<a id="price_0" href="<c:url value='/EntpShop.do?method=viewPd&index_type=news&shop_id=000000000&id=000000001' />">&nbsp;</a> 元
          	  </td>
              ...
              <td width="95" class="product" style="color:#555;padding-left:5px;" id="product4">
          		<a id="md_name_1" href="<c:url value='/EntpShop.do?method=viewPd&index_type=news&shop_id=000000000&id=000000001' />">&nbsp;</a><br />
          		<a id="price_1" href="<c:url value='/EntpShop.do?method=viewPd&index_type=news&shop_id=000000000&id=000000001' />">&nbsp;</a> 元
          	  </td>
             </tr>
           </table>
      </td>
...
function resetGMarkersOfEntpShopToMap(map, entp_shop_list_json){
	...
	for (var i = 0; i < entp_shop_list_json.length; i++) {
		...
		GEvent.addListener(gMarker, "click", function(latlng) {
        	...
        	$.ajax({
        		type: "POST",
        		url: "${ctx}/manager/admin/KonkaBranchShopGSite.do",
...
function resetGMarkersToMap(map, options) {
	...
	$("#pager_control").pager("${ctx}/manager/admin/KonkaBranchShopGSite.do", $.extend({}, {
...
function setMapCenterByPIndex(map, p_index) {
	...
	$.post("${ctx}/manager/admin/KonkaBranchShopGSite.do", {method : 'ajaxGetPIndexNamesStr', p_index : p_index}, function(ret){
		if (!/^\s*$/.test(ret)) {
