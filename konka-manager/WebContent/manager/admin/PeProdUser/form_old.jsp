      ...
      <div align="left">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="datagrid">
          ...
          <tr>
            ...
            <td colspan="3">
	              <!-- 复选框，Ren zhong， 2013-06-25，Begin -->
	              <div id="sel">
				      <select name="roleIds_" id="roleIds" multiple="multiple" size="8">
          ...
          <tr>
            ...
            <td colspan="3"><html-el:password property="pass_word" styleId="pass_word" size="40" maxlength="20" />
               &nbsp;<span style="color:red">*</span> <span> 请切记系统默认密码为：888888</span></td>
          </tr>
          <tr class="oartop">
...
$(document).ready(function(){
	...
	*/
		...
		$("#btn_submit").click(function(){
			...
			var num = $("#roleIds_ms2side__dx").find("option").length;
			if (0 == num || null == num) {
				alert("请选择职务！");
				$("#roleIds_ms2side__dx").focus();
				return false;
			}

			var arrs = new Array();
			var obj = document.forms[0].roleIds_ms2side__dx;
			for(var i = 0; i < obj.length; i++){
				arrs.push(obj.options[i].value);
			}
			//var roleIds = arrs.join(",");
			$("#roleIdsHidden").val(arrs);
			//处理、验证职务多选，Renzhong, 2013-06-25，end
