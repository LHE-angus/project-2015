			...
			$(function(){
				...
				$.post('${ctx}/manager/admin/CreateCustomer.do?method=init&mod_id='+mod_id,function(result){
					...
					$("#table").datagrid({
					    ...
					    rownumbers:true,
					    columns:[[
						{title:'操作',field:'IS_SYN',width:40,editor:'text',sortable:'true',align:'center',
						 	formatter: function(value,row,index){
						 		if(value=='0'&&row.AUDIT_STAT=='2'&&result.role_id1=='35'){
						 			return "<a class='fblue' href='${ctx}/manager/admin/CreateCustomer.do?method=view&mod_id="+mod_id+"&cust_id="+row.CUST_ID+"&oper=view&type=syn'>同步</a>";
						 		}else{
						 			return "<span class='fblue' style='color:#ccc;'>同步</span>";
						 		}
						 	}
						 },
