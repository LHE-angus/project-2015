...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    ...
    <html-el:hidden property="id" styleId="id" value="${allmap.entity.id }" />
      ...
      <html-el:hidden property="receive" styleId="receive" value="${receive}" />
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
         ...
         <tr>
          ...
          <td width="12%" nowrap="nowrap" class="title_item" align="left">
		   	...
		   	&nbsp;&nbsp;&nbsp;
		   	父任务名称：
		   	<html-el:text property="par_task_name" styleId="par_task_name" value="${allmap.par_task_name}" disabled="true"/>
    		<html-el:hidden property="par_task_id" styleId="oar_task_id" value="${allmap.par_task_id }"/>
          </td>
        </tr>
  	   <tr>
