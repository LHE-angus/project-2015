...
<!-- 					<span style="color:red;" onclick="getKonkaR3List();">选择</span> -->
						<input class="but2" type="button" name="Submit2" value="添加" onclick="getKonkaR3List();" />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<!-- 					<span style="color:red;" onclick="getKonkaOtherR3List();">选择</span> -->
						<input class="but2" type="button" name="Submit3" value="添加" onclick="getKonkaOtherR3List();" />
					</td>
				 </tr>
				 <tr>
					...
					<td class="title_item" align="left" nowrap="nowrap">
						<html-el:textarea property="songdf_ids" styleId="songdf_ids" style="width:200px;" cols="5" rows="7" readonly="true"/>
					</td>
				</tr>
		        <tr>
...
var returnValue = window.showModalDialog("${ctx}/manager/admin/KonkaPartership.do?method=songDFList&azaz=" + Math.random(),window,"dialogWidth:650px;status:no;dialogHeight:390px");
	...
	if (returnValue != null && returnValue.ids != "") {
	    ...
	    if(r3_code_array.length>30){
	    	alert("送达方超过30位，请重新选择！");
	    } else {
		   var  r3_codes = '';
