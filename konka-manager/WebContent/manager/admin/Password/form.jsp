...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/Password.do">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td>
			<input name="new_password" id="new_password" maxlength="16" type="password" onkeyup="pwStrength(this.value);" onBlur="pwStrength(this.value);" style="width:200px" />
        ...
        <tr >
	         <td style="background-color: #FFFFCC ;color: #FF9900 ;" colspan="2" >
	         <ul>
	         	<li>提示:</li>
