...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
  	<html-el:form action="/admin/KonkaMobileSailDataSearchForPriceSize">
  ...
  <div class="rtabcont1" style="overflow-x: auto;height:400px;" id="divExcel_all" title="销售明细">
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
  		<tr class="tabtt1">
        	...
        	<td align="center" nowrap="nowrap">销售规模（万元）</td>
        	<td width="10%" align="center" nowrap="nowrap">结算额</td>      
        	<td width="10%" align="center" nowrap="nowrap">结算量</td>     	
        	<td width="10%" align="center" nowrap="nowrap">型号数量</td>   
        	<td width="10%" align="center" nowrap="nowrap">同期增长</td>  
  		...
  		<c:forEach var="cur" items="${entityList}" varStatus="vs">
  			<tr class="list-tr">
  				...
  				<td align="left" nowrap="nowrap">
  					<c:if test="${cur[0] eq 1}">10000万以上</c:if>
  					<c:if test="${cur[0] eq 2}">5000~10000</c:if>
  					<c:if test="${cur[0] eq 3}">2000~5000</c:if>
  					<c:if test="${cur[0] eq 4}">1000~2000</c:if>
  					<c:if test="${cur[0] eq 5}">500~1000</c:if>
  					<c:if test="${cur[0] eq 6}">200~500</c:if>
  					<c:if test="${cur[0] eq 7}">100~200</c:if>
  					<c:if test="${cur[0] eq 8}">50~100</c:if>
  					<c:if test="${cur[0] eq 9}">50万以下</c:if></td>
  				...
  				<td align="right" nowrap="nowrap"><fmt:formatNumber value="${cur[3]}" pattern="#,###"/></td>  			
  				<td align="right" nowrap="nowrap">
  					<c:if test="${cur[4] lt 0}"><span style="color:red;"><fmt:formatNumber value="${cur[4]}" pattern="#,###"/></span></c:if>
  					<c:if test="${cur[4] ge 0}"><span style="color:green;"><fmt:formatNumber value="${cur[4]}" pattern="#,###"/></span></c:if>
  				</td>
  				...
  				<td align="right" nowrap="nowrap">
  					<c:if test="${cur[8] lt 0}"><span style="color:red;"><fmt:formatNumber value="${cur[8]}" pattern="#,###"/></span></c:if>
  					<c:if test="${cur[8] ge 0}"><span style="color:green;"><fmt:formatNumber value="${cur[8]}" pattern="#,###"/></span></c:if>
  				</td>
  			</tr>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	toExcel('divExcel_all', '${ctx}/manager/admin/KonkaMobileSailDataSearchForPriceSize.do?method=toExcel');
    });
