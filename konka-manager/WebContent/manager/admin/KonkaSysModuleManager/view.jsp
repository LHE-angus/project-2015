    ...
    <html-el:form action="/admin/KonkaSysModuleManager.do">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
          ...
          <tbody>
            ...
            <c:if test="${not urlIsNull}">
              <tr class="cls_${cur.mod_id}">
                ...
                <td style="text-align:left;"><c:forEach begin="1" end="${cur.tree_level}">&nbsp;&nbsp;&nbsp;&nbsp;</c:forEach>
                  ${cur.mod_name}</td>
                <td><input type="checkbox" id="checkbox_${cur.mod_id}" name="checkbox_${cur.mod_id}" <c:if test="${cur.is_view eq 1}">checked="checked"</c:if> disabled="disabled" /></td>
              </tr>
            </c:if>
          </tbody>
        </c:forEach>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><input class="but4" type="submit" name="Submit4" id="btn_submit" value="修改" /></td>
        </tr>
      </table>
    </html-el:form>
  </div>
