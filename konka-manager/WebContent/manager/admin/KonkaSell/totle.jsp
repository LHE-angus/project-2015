        ...
        <table width="100%" border="0"  cellpadding="0" cellspacing="1" class="rtable2">
		  ...
		  <c:forEach items="${kpmList}" var="kpm">
				  <tr>
		            ...
		            <td align="left">销售数量：<span style="color:#F00;">${kpm.map.sellCountForPd}</span> 台，销售总价：<span style="color:#F00;"><fmt:formatNumber pattern="#0.00" value="${kpm.map.sellCostForPd}" /></span>元。</td>
		          </tr>
	       </c:forEach>
		  <tr>
            <td width="15%" align="center" ><strong>合计</strong></td>
            <td align="left">销售数量：<span style="color:#F00;">${af.map.sellCountTotle}</span> 台，销售总价：<span style="color:#F00;"><fmt:formatNumber pattern="#0.00" value="${af.map.sellCostTotle}" /></span>元。</td>
          </tr>
