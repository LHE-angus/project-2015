...
function resetGMarkersToMap(map, options) {
	...
	$("#pager_control").pager("${ctx}/manager/admin/EntpShopSearch.do", $.extend({}, {
...
function setMapCenterByPIndex(map, p_index) {
	...
	$.post("${ctx}/manager/admin/EntpShopSearch.do", {method : 'ajaxGetPIndexNamesStr', p_index : p_index}, function(ret){
		if (!/^\s*$/.test(ret)) {
...
function hidchart(obj){
	...
	var chart_tr = document.getElementById("chart_3D_tr");
