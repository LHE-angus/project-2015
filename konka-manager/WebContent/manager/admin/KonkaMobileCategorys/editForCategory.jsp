...
<div class="rtabcont2">
        <html-el:form action="/admin/KonkaMobileCategorys">
          ...
          <html-el:hidden property="method" styleId="method" value="saveEdit" />
          <html-el:hidden property="queryString" styleId="queryString" />
          <html-el:hidden property="order_value" styleId="order_value" value="0" />
          <html-el:hidden property="old_index" styleId="old_index" value="${af.map.c_index}" />
           <html-el:hidden property="c_index" styleId="c_index"/>
           <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
            <tr>
             <td height="28" width="15%" nowrap="nowrap" class="title_item" align="right"><strong>父类别名称：</strong><font color="red">*</font></td>
              <td><html-el:text property="c_name" size="40" maxlength="40" styleId="c_name" /></td>
            </tr>
            <tr>
            <td height="28" width="15%" nowrap="nowrap" class="title_item" align="right"><strong>说明：</strong></td>
              <td><html-el:textarea property="c_comm" rows="6" cols="60" styleId="c_comm" /></td>
            </tr>
            <tr>
            <td height="28" width="15%" nowrap="nowrap" class="title_item" align="right"><strong>父类别状态：</strong></td>
...
$(document).ready(function(){
	$("#c_name"    ).attr("dataType", "Require").attr("msg", "请填写父类别名称");
