...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaR3StoreTask" method="post">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right">门店ID：</td>
          <td width="88%" align="left">
          	${af.map.store_id}
          </td>
        </tr>
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right">门店名称：</td>
          <td width="88%" align="left">
          	${af.map.store_name}
          </td>
        </tr>
        ...
        <tr >
          ...
          <tr >
            <td width="12%" nowrap="nowrap" class="title_item" align="right">任务额：</td>
