      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="datagrid">
          <tr class="oartop">
              <td colspan="4" style="padding-bottom:10px;fontweight:bold;">
                                              企业人员 <span style="font-size:14px;font-weight:bolder;">${af.map.user_name}</span> 
                                              岗位  <span style="font-size:14px;font-weight:bolder;">${empty af.map.job_id ? '未指定岗位ID，请尽快完善' : af.map.job_id}</span>
                                              的详细信息
              </td>
          </tr>
                  <tr class="oartop">
                  ...
                  <tr>
                    ...
                    <td colspan="3"><c:out value="${role_name}" /></td>
                  </tr>
                  <tr>
                    <td height="28" width="15%" nowrap="nowrap" class="title_item">关联门店：</td>
                    <td colspan="3"><c:if test="${empty konkaMobileSpRelationList}"><span style="color:#ccc;">暂无关联门店</span></c:if>
		              	<c:if test="${not empty konkaMobileSpRelationList}">
		              		<c:forEach items="${konkaMobileSpRelationList}" var="cur2" varStatus="vs2">
		              			<c:out value="${cur2.map.shop_name}" /><c:if test="${not vs2.last}">，</c:if>
		              		</c:forEach>
		              	</c:if></td>
                  </tr>
                  <tr class="oartop">
                  ...
                  <tr>
                    <td nowrap="nowrap">出生日期：</td>
                  	<td colspan="3"><fmt:formatDate value="${af.map.birthday}" pattern="yyyy-MM-dd" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><c:out value="${af.map.link_post}" /></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap">手机：</td>
                    <td colspan="3"><c:out value="${af.map.link_phone}" /></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap">电话：</td>
                    <td colspan="3"><c:out value="${af.map.link_tel}" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><c:out value="${af.map.link_qq}" /></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap">MSN：</td>
                    <td colspan="3"><c:out value="${af.map.link_msn}" /></td>
                  </tr>
                  <tr class="oartop">
                  ...
                  <tr>
                    ...
                    <td colspan="3"><c:out value="${af.map.r3_job_id}" /></td>
                  </tr>
          <tr>
