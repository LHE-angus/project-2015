...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/GcxmProjQuery">
      ...
      <tr>
       ...
       &nbsp;<strong class="fb">项目状态</strong>
        ...
        <html-el:text property="proj_code_like" styleId="proj_code_like" onkeyup="upperCase(this.id);" size="20" maxlength="20" />
        ...
        <html-el:text property="offer_offer_model_like" styleId="offer_offer_model_like" onkeyup="upperCase(this.id);" size="20" maxlength="20" />&nbsp;
        	<strong class="fb">供货机型</strong>
        	<html-el:text property="supply_model_like" styleId="supply_model_like" onkeyup="upperCase(this.id);" size="20" maxlength="20" />
  ...
  <div class="rtabcont1" style="overflow: auto;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td nowrap="nowrap" align="left"  ><a style="color: blue;" href="#" onclick="doNeedMethod(null, 'GcxmProjQuery.do', 'view', 'id=${cur.id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">${cur.proj_code}</a></td>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="GcxmProjQuery.do">  
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
   ...
   $(document).ready(function() {
	    ...
	    $("#export_excel").click(function(){
			var forms =  document.forms[0];
	    	 this.value="正在提交...";
	    	 this.disabled=true;
	    	 forms.action="${ctx}/manager/admin/GcxmProjQuery.do?method=sheet";
	    	 forms.submit();
	    	 forms.action="${ctx}/manager/admin/GcxmProjQuery.do";
	    	 this.value="导出Excel";
	    	 this.disabled=false;
	    });  
