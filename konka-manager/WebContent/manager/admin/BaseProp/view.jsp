...
<div class="oarcont">
  ...
  <div>
  <h3 align="center" ><strong class="fb">产品属性查看</strong></h3>
  </div>
    <div class="rtabcont2">
     <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr >
        <td height="28" width="15%" nowrap="nowrap" class="title_item">属性名称：</td>
        <td><c:out value="${entity.prop_name}" /></td>
      </tr>
      <tr >
      ...
      <tr >
        <td height="28" nowrap="nowrap" class="title_item">属性类别：</td>
        <td><c:out value="${category_name}" /></td>
      </tr>
      <tr >
        <td height="28" class="title_item">单位：</td>
        <td><c:out value="${entity.prop_unit}" /></td>
      </tr>
      <tr >
        <td height="28" class="title_item">是否必填：</td>
        <td><c:choose>
      ...
      <tr >
        <td height="28" class="title_item">属性类型：</td>
        <td><c:choose>
      ...
      <tr >
        <td height="28" class="title_item">属性值类型：</td>
        <td><c:choose>
      ...
      <tr >
        <td height="28" class="title_item">属性值范围最小值：</td>
        <td><c:out value="${entity.prop_val_min}" /></td>
      </tr>
      <tr >
        <td height="28" class="title_item">属性值范围最大值：</td>
        <td><c:out value="${entity.prop_val_max}" /></td>
      </tr>
      <tr >
