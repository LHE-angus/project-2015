...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
        <html-el:form action="/paragon/SelectVersion">
         <html-el:hidden property="queryString" styleId="queryString" />
          ...
          <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
            <div style="height:5px;"></div>
	         ...
	         <tr>
	           <td>搜索形象版本名称：
	             <html-el:text property="version_name_like" styleId="version_name_like" size="24" maxlength="100" style="width:100px;" />
	             &nbsp;&nbsp;
                ...
                <tr>
                  <td>待选择区<html-el:select property="select1" multiple="true" style="width:290px;height:358px;" styleId="select1" onchange="moveSelected(this.form.select1, this.form.select2);">
                      <c:forEach var="cur" items="${entityList}" varStatus="vs">
                        <option value="${cur.version_id}">${fn:escapeXml(cur.version_name)}</option>
                      </c:forEach>
                    </html-el:select></td>
                  <td>已选择区<html-el:select property="select2" multiple="true" style="width:290px;height:358px;" styleId="select2" onchange="moveSelected(this.form.select2, this.form.select1);">
                      <c:if test="${not empty selectList}">
                        <html-el:optionsCollection label="version_name" value="version_id"  name="selectList" />
                      </c:if>
                    </html-el:select></td>
                </tr>
              </table></td>
...
$(document).ready(function(){
	...
	$("#version_name_like").attr("autocomplete", "off");
	$("#version_name_like").attr("disableautocomplete", "true");
