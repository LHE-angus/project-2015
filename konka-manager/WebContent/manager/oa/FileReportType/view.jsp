...
<div class="oarcont">
  ...
  <div>
  <h3 align="center" ><strong class="fb">资讯类别查看</strong></h3>
  </div>
    <div class="rtabcont2">
     <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr >
        ...
        <td><c:out value="${entity.type_name}" /></td>
      </tr>
      <tr >
      ...
      <tr >
        ...
        <td><fmt:formatDate value="${entity.add_datetime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
      </tr>
    </table>
    <div>
     <br />
