          ...
          <td width="385" style="position:absolute; top:15px; left:225px;"><table style="width:363;height:364 ;border-spacing : 2px 0px" border="0">
              <tr>
                <td colspan="3" width="361" style="align:right">快速搜索:&nbsp;&nbsp;&nbsp;
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <html-el:button property="" value="搜索" styleClass="but1" styleId="btn_search" style="align:right"/></td>
              </tr>
              <tr>
                <td>
                 <table style="width:365;height:360 ; border-style:double ; bordercolor:black; border-width :4px ;" border="1" cellpadding="0" >
                    ...
                    <tr>
                      ...
                      <td style="border-style:double ; bordercolor:#000000; border-width :4px ;">
                        ...
                        <div>&nbsp;<html-el:button property="" value="全部添加" styleId="btn_add_all" />&nbsp;</div>
                        <div>&nbsp;<html-el:button property="" value="全部删除" styleId="btn_del_all"/>&nbsp;</div></td>
                      <td style="border-style:double ; bordercolor:#000000; border-width :4px ;">&nbsp;
              ...
              <tr>
                <td colspan="3" style="text-align:center;padding:10px; 0 0;"><html-el:button property="" value="确定" styleClass="but4" styleId="btn_submit" />
                  &nbsp;&nbsp;
                  <html-el:button property="" value="取消" styleClass="but5" styleId="btn_back" onclick="window.close();" /></td>
              </tr>
            </table></td>
        </tr>
      </table>
