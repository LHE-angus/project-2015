      ...
      <html-el:form action="/ywygps/KonkaYwyInvalidMobile">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
           <tr class="tabtt1">
               ...
               <c:if test="${not empty af.map.id}">确认激活业务员手机</c:if>
               </td>
           </tr>
           <tr>
            <td width="18%" class="title_item" nowrap="nowrap" align="right"><strong>手机号：</strong></td>
            <td align="left" >           
                	<html-el:text property="mobile_no" styleId="mobile_no" maxlength="11" size="80" style="width:240px;" readonly="readonly"/>
