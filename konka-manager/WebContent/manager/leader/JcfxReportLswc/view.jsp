				...
				<div class="container" align="center">
					...
					<div style="padding: 7px; width: 100%;" class="middle">
									...
									<c:if test="${not empty is_bi}">
										...
										<table width="100%" border="0" cellspacing="5" cellpadding="0"
											...
											<tr>
												...
												<td align="right"><b>年度</b> <html-el:select
														property="year" styleId="year">
														<c:forEach begin="2012" end="2015" var="cur"
															varStatus="vs">
															<html-el:option value="${cur}">${cur}</html-el:option>
														</c:forEach>
													</html-el:select> <b>月份</b> <html-el:select property="month" styleId="month">
											...
											<tr>
												<td width="40%"><span class="mychar_title"
													...
													<p
														...
														目标零售额:<span id="option1_b">... </span>万元
													</p>
													<p
														style="margin-top: 5px; color: red; font: normal 14px '微软雅黑';">
														实际零售额: <span id="option1_a">... </span>万元
													</p>
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">分公司零售完成情况</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">分公司零售情况分析</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
							...
							<div class="widget-content referrer">
								<table id="table5" style="width: 100%;height:3900px; ">
									<tr>
...
<script type="text/javascript">
	...
	$(".sidebar #nav > li > a:eq(1)").parent().click();
	...
	function myChart1(year, month) {
		...
		$.ajax({
			type : "POST",
			url : "<c:url value='/manager/leader/JcfxReportLswc.do' />",
			data : {
				"method" : "option1",
				"year" : year,
				"month" : month
