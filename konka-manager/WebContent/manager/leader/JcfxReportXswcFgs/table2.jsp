...
<%@ include file="/commons/pages/taglibs.jsp" %>
	<div style="text-align:right;margin-right:20px;">单位：万元</div> 
	        <table class="table table-striped table-bordered table-hover" border="0" cellspacing="5" cellpadding="0" style="width:100%;font-size:12px;line-height:22px;padding-right: 50px;">
	        <tr style="">
	        	<td align="center" width="120" rowspan="1" >部门</td><td  align="center" rowspan="1" >目标销售额</td><td  align="center" rowspan="1" >实际销售额</td><td align="center"  rowspan="1" >同期销售额</td><td  align="center"  rowspan="1" >完成率</td><td align="center"  rowspan="1" >增长率</td><td align="center"  rowspan="1" >累计目标额</td><td align="center"  rowspan="1" >累计销售额</td><td align="center"  rowspan="1" >累计完成率</td>
