...
<style type="text/css">
.btn_back {width:115px;height:20px;background:url(${ctx}/images/manager/but_l.gif) no-repeat;font:normal 12px/20px "宋体";text-align:left;color:#fff;padding-left:27px;border:1px #ccc solid;border-left:0;cursor:pointer;}
</style>
</head>
<body>
<div class="oarcont" style="position:relative;overflow:hidden;">
  ...
  <div class="rtabcont1">
    <html-el:form action="/zmd/KonkaXxSellBillJSStatisForZMD">
  ...
  <div class="rtabcont1" style="overflow:auto;">
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaXxSellBillJSStatisForZMD.do">
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="200" align="left"><input class="btn_back" type="button" id="btn_back" value="返回统计页面" onclick="$('#message_tip').show();goBack('${af.map.date_start}','${af.map.date_end}');" /></td>
...
$(document).ready(function(){
	$("#add_date_ge").datepicker({ maxDate: '+0d' });
	$("#add_date_le").datepicker({ maxDate: '+0d' });
	...
	if("3" != pay_way){ // 不是货到付款则隐藏物流条件
		...
		$("#checkout_zmd_state_text").html("结算状态：");
	}else{
		$("#checkout_zmd_state_text").html("专卖店结算状态：");
	}
...
function goBack(date_start, date_end){
	location.href = "${ctx}/manager/zmd/KonkaXxSellBillJSStatisForZMD.do?date_start=" + date_start + "&date_end=" + date_end;
}
//]]></script>
