  ...
  <div class="rtabcont2">
    <html-el:form action="/zmd/KonkaXxDistAccountForZmd">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
        ...
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">应收款（元）：</td>
        ...
        <tr>
          ...
          <td width="85%">${af.map.remit_sn}
            <c:if test="${empty af.map.remit_sn}"><span style="color:gray;">未填写</span></c:if></td>
        </tr>
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">物流结算人：</td>
          <td width="85%">${af.map.man}
            <c:if test="${empty af.map.man}"><span style="color:gray;">未填写</span></c:if></td>
        </tr>
        <tr>
          <td nowrap="nowrap" height="28" class="title_item" align="right">物流提交结算时间：</td>
