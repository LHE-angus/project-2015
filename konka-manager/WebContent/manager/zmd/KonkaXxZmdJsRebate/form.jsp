  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaXxZmdJsRebate.do">
      ...
      <div style="text-align:left;margin-left:5px;margin-top:-5px;margin-bottom:5px;">
        <input type="button" class="but8" value="批量结算" id="plJs" />
      ...
      <table id="tab_3" width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr class="tabtt1">
          ...
          <td width="12%" nowrap="nowrap" align="center">开单时间</td>
          <td width="8%" nowrap="nowrap" align="center">操作</td>
        </tr>
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            <td align="center"><input name="pks" type="checkbox" class="pks" id="pks" value="${cur.sell_bill_id}" /></td>
            <td align="left" nowrap="nowrap"><font class="blue12px">${cur.map.zmd_sn}</font></td>
            <td align="center" nowrap="nowrap"><a href="${ctx}/manager/zmd/KonkaXxZmdAddSalesOrder.do?method=view&sell_bill_id=${cur.sell_bill_id}&mod_id=802001"><font class="fblue">
              <c:out value="${fnx:leftPad_sis(cur.sell_bill_id, 12, '0')}" />
              </font></a></td>
            <td align="right" nowrap="nowrap"><font class="kz-price-12">
              <fmt:formatNumber value="${cur.js_bill_money}" type="currency" />
              </font></td>
            <td align="center" nowrap="nowrap"><font class="blue12px">
              <fmt:formatDate value="${cur.add_date}" pattern="yyyy-MM-dd HH:mm:ss" />
              </font></td>
            <td align="center" nowrap="nowrap"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('确定结算该订单？', 'KonkaXxZmdJsRebate.do', 'save', 'sell_bill_id=${cur.sell_bill_id}&mod_id=${af.map.mod_id}&zmd_id=${af.map.zmd_id}&dept_id=${af.map.dept_id}&' + $('#bottomPageForm').serialize())">结算</span></td>
          </tr>
        ...
        <tr>
          <td height="40" align="right"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
            <script type="text/javascript">
			            ...
			            pager.addHiddenInputs("method", "stepOne");
