...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/zmd/KonkaXxZmdHistory">
  ...
  <div align="right" style="margin-right:7px;"><span style="color: red;font-size: 12px;">温馨提示：年租金的单位：万元</span></div>
  <div class="rtabcont1">
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap" align="center"><font class="blue">专卖店编号</font></td>
        <td width="7%" align="center" nowrap="nowrap"><font class="blue">营业面积(㎡)</font></td>
        <td width="8%" align="center" nowrap="nowrap"><font class="blue">年租金</font></td>
        <td width="8%" align="center" nowrap="nowrap"><font class="blue">经营性质</font></td>
        <td width="12%" align="center" nowrap="nowrap"><font class="blue">审核状态</font></td>
        <td width="15%" align="center" nowrap="nowrap"><font class="blue">租赁期</font></td>
        <td width="11%" align="center" nowrap="nowrap"><font class="blue">备案申请时间</font></td>
        <td width="5%" align="center" nowrap="nowrap"><font class="blue">查看</font></td>
      </tr>
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          <td align="center" nowrap="nowrap">${(af.map.pager.currentPage - 1) * af.map.pager.pageSize + vs.count}</td>
          <td title="${cur.zmd_sn}"><font class="blue12px">
            <c:out value="${fnx:abbreviate(cur.zmd_sn, 2 * 10, '...')}" />
            </font></td>
          <td nowrap="nowrap" align="right"><font class="blue12px">${cur.busi_area}
            <c:if test="${empty cur.busi_area}"><span style="color:#999;">未填写</span></c:if>
            </font></td>
          <td align="right" nowrap="nowrap"><font class="blue12px">
            <fmt:formatNumber value="${cur.rent_fee}" pattern="0.00" />
            </font></td>
          ...
          <td align="center"  nowrap="nowrap"><font class="blue12px"><span style="cursor:pointer;"  class="fblue" onclick="doNeedMethod(null, 'KonkaXxZmdHistory.do', 'view','zmd_id=${cur.zmd_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span> </font></td>
        </tr>
      </c:forEach>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaXxZmdHistory.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
