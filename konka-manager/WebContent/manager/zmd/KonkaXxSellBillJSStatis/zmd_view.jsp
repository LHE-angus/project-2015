...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/zmd/KonkaXxSellBillJSStatis" styleClass="form_search">
      <html-el:hidden property="method" value="zmdView" />
    ...
    <c:if test="${(not empty af.map.date_start) and (not empty af.map.date_end)}">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=3&zmd_id=${af.map.zmd_id}&checkout_dist_state=1&checkout_zmd_state=1&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=2&zmd_id=${af.map.zmd_id}&checkout_dist_state=&checkout_zmd_state=1&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=1&zmd_id=${af.map.zmd_id}&checkout_dist_state=&checkout_zmd_state=1&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=3&zmd_id=${af.map.zmd_id}&checkout_dist_state=1&checkout_zmd_state=0&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=3&zmd_id=${af.map.zmd_id}&checkout_dist_state=0&checkout_zmd_state=1&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=3&zmd_id=${af.map.zmd_id}&checkout_dist_state=0&checkout_zmd_state=0&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          <td nowrap="nowrap">全额POS机刷卡</td>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=2&zmd_id=${af.map.zmd_id}&checkout_dist_state=&checkout_zmd_state=0&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
          <td nowrap="nowrap">全额现金支付</td>
          ...
          <td align="center"><span style="cursor:pointer;" class="fblue" onclick="$('#message_tip').show();doNeedMethod(null, 'KonkaXxSellBillJSStatis.do', 'list', 'pay_way=1&zmd_id=${af.map.zmd_id}&checkout_dist_state=&checkout_zmd_state=0&mod_id=${af.map.mod_id}&date_start=${af.map.date_start}&date_end=${af.map.date_end}');">订单</span></td>
        </tr>
        <tr>
      ...
      <input class="btn_back" type="button" id="btn_back" value="返回上一步" onclick="$('#message_tip').show();goBack('${af.map.zmd_id}','${af.map.date_start}','${af.map.date_end}','${af.map.mod_id}');" style="margin-top:5px;" />
    </c:if>
  </div>
  <div class="clear"></div>
</div>
...
function goBack(zmd_id, date_start, date_end, mod_id){
	location.href = "${ctx}/manager/zmd/KonkaXxSellBillJSStatis.do?method=view&date_start=" + date_start + "&date_end=" + date_end + "&zmd_id=" + zmd_id + "&mod_id=" + mod_id;
}
//]]></script>
