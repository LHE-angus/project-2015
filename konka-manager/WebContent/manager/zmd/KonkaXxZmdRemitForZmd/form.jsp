    ...
    <html-el:form action="/zmd/KonkaXxZmdRemitForZmd">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
        ...
        <tr>
          ...
          <td width="85%"><span style="color:blue;">${zmd_sn}</span></td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="1" class="rtable2">
              <tr class="tabtt1" style="background-image:url('${ctx}/images/manager/tabtitbg1.gif') repeat-x;background:#F0F0F0;">
                ...
                <td width="10%" align="center" nowrap="nowrap"><font class="blue">实收款金额</font></td>
        ...
        <tr>
          <td width="15%" nowrap="nowrap" class="title_item" align="right">应收款：</td>
        ...
        <tr>
          ...
          <td width="85%"><html-el:select property="state" style="state">
              ...
              <html-el:option value="2">==结算==</html-el:option>
            </html-el:select></td>
        </tr>
        <tr>
