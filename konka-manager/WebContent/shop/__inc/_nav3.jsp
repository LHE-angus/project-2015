...
<div class="nav" >
	<div id="allclass">
			<dl class="">
				<dt class="ld"><a href="#">全部商品分类</a></dt>
        		...
        		<a href="<c:url value='/shop/KonkaBcompPd.do?pd_type=2' />">智能电视</a>
	            <a href="<c:url value='/shop/KonkaBcompPd.do?pd_type=1' />">3D电视</a>
	            <a href="<c:url value='/shop/KonkaBcompPd.do?pd_type=4' />">4K电视</a></p><div class="clear"></div>
	            </li>
    	...
    	<div id="my360buy-2013">
			<dl class="" load="1">
                ...
                <div id="jduc-orderlist">
                 ...
                 <ul class="fore2 fl"> 
                 <li><a target="_blank" href="<c:url value='/shop/center/EcUserFavotrites.do' />">我的关注&nbsp;&gt;</a></li>
                 <li> </li>
                 <li> </li>
                 </ul> 
                 </div>
