...
<div class="maincont">
  ...
  <div class="shop_right padbot45">
    <div class="position"><a href="${ctx }/shop/Index.do">首页</a> &gt; 我的关注</div>
    <div class="shoptab3">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="shop_form_table0">
            ...
            <tbody>
              <c:forEach var="cur" items="${entityList}" varStatus="vs">
                <tr style="border:1px solid #e3e3e3;" >
                  ...
                  <td align="center" nowrap="nowrap"> <a href="${ctx }/shop/PdShow.do?goods_id=${cur.goods_id}"><img src="${ctx}/${cur.img_url }" width="81" height="80"/></a></td>
          ...
          <c:if test="${empty entityList}">
            <tr style="border:1px solid #e3e3e3;height:46px;" >
              <td colspan="6" align="center"> 您还没有关注任何商品,点击<a href="${ctx }/shop/Index.do"><font color="#2233ff">这里</font></a>去关注您喜爱的商品吧</td>
            </tr>
          </c:if>
        </table>
      </form>
...
function deleteInfo(obj){
	...
	if(confirm("您确定取消关注吗？")){
		...
		location.href="${ctx}/shop/center/EcUserFavotrites.do?method=delete"+id;
		}
	}
}
