...
<div class="maincont">
  ...
  <div class="shop_right padbot45">
    <div class="position"><a href="${ctx }/shop/Index.do">首页</a> &gt; <a href="${ctx }/shop/center/Index.do">会员中心</a> &gt;评论信息</div>
    <div class="shoptab3">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="shop_form_table2">
        ...
        <tbody>
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr height="60">
              <td align="center" nowrap="nowrap"><a href="${ctx }/shop/PdShow.do?goods_id=${cur.goods_id }"><c:out value="${cur.map.pd_name }"/></a></td>
