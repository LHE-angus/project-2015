...
<div class="maincont">
  ...
  <div class="shop_right padbot45">
    <div class="position"><a href="${ctx }/shop/Index.do">首页</a> &gt; <a href="${ctx }/shop/center/Index.do">会员中心</a> &gt; 地址簿</div>
    <div class="shoptab3">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr onmouseover="shows('s${vs.count }');" onmouseout="hides('s${vs.count }');">
              ...
              <td align="center" nowrap="nowrap"><c:if test="${cur.default_addr eq 1 }" ><font color="blue">默认地址</font></c:if>
                <c:if test="${cur.default_addr ne 1 }" ><a id="s${vs.count }" style="display: none;" href="EcUserAddrs.do?method=defaultaddr&id=${cur.id }"><font color="red">设为默认</font></a></c:if>
              </td>
...
function deleteInfo(obj){
	...
	if(confirm("您确定删除吗？")){
		location.href="${ctx}/shop/center/EcUserAddrs.do?method=delete"+id;
	}
}
