...
var url="${ctx}/shop/FlvPlayer.do?method=view&id=${af.map.id}&width=720&height=426";
var img_url="${ctx}/shop/FlvPlayer.do?method=showImg&id=${af.map.id}&width=720&height=426"; 
function showdiv() {  
