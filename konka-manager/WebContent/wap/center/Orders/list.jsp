...
<div class="membertab3"><html-el:form action="/center/Orders"><html-el:hidden property="method" styleId="method" value="list" /><html-el:hidden property="orderState" />
...
function deleteInfo(obj){
	...
	if(confirm("您确定取消订单吗？")){
		location.href="${ctx}/wap/center/Orders.do?method=delete"+id; 
	}
}
...
function view(id){
	var buyer_mp="";
	if("${touch}"!="1"){
		var buyer_mp=prompt("查看订单,请输入联系人手机号","");
	...
	location.href="${ctx}/wap/center/Orders.do?method=view"+id;  
}
