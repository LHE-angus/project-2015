	...
	var g = o.document, q = g.documentElement, J = function() {
		...
		d.prototype = {
			...
			createOverlay : function() {
				...
				//b.cssText = "margin:0;padding:0;border:none;width:100%;height:100%;background-image: url('../styles/shop/easydialog/dialogBg.png') !important;background-image: none;filter: progid : DXImageTransform.Microsoft.AlphaImageLoader(src = '../styles/shop/easydialog/dialogBg.png', sizingMethod = 'crop' );_background-image: url('../styles/shop/easydialog/dialogBg.png');z-index:9999;position:fixed;top:0;left:0;";
				if (r) {
					p.style.height = "100%";
					b.position = "absolute";
					b.setExpression("top",
