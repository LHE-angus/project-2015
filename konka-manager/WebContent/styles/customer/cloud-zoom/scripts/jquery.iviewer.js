...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    **/
    createui: function()
    {
		...
		var _tools_container = $(this.options.tools_container);
		var _tools_title = $('#iviewer_ui_title');

        $("<div>", { 'class': "iviewer_zoom_in iviewer_common iviewer_button", 'data-title': "放大"})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(_tools_container);

        $("<div>", { 'class': "iviewer_zoom_out iviewer_common iviewer_button", 'data-title': "缩小"})
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(_tools_container);

        $("<div>", { 'class': "iviewer_zoom_zero iviewer_common iviewer_button", 'data-title': "原始尺寸"})
                    .bind('mousedown touchstart',function(){me.set_zoom(100); return false;})
                    .appendTo(_tools_container);

        $("<div>", { 'class': "iviewer_zoom_fit iviewer_common iviewer_button", 'data-title': "最合适尺寸"})
        ...
        $("<div>", { 'class': "iviewer_rotate_left iviewer_common iviewer_button", 'data-title': "逆时针旋转"})
                    .bind('mousedown touchstart',function(){me.angle(-90); return false;})
                    .appendTo(_tools_container);

        $("<div>", { 'class': "iviewer_rotate_right iviewer_common iviewer_button", 'data-title': "顺时针旋转" })
                    .bind('mousedown touchstart',function(){me.angle(90); return false;})
                    .appendTo(_tools_container);
