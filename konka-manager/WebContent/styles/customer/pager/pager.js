...
Pager.prototype.toString = function (){
	...
	switch (this.lang) {
		case "online": //\u5171共 \u4e2a\u5546\u54c1个商品  \u9875页
			pagerStrings[pagerStrings.length] = '<div class="six_r"><font class="orange">\u5171' + this.recordCount + '\u4e2a\u5546\u54c1</font> ' + this.currentPage + '/' + pageCount + '\u9875</div>';
			if (this.currentPage == 1 || pageCount <= 1) {
				pagerStrings[pagerStrings.length] = '<div class="six_com"><ul><li class="_prev">\u4e0a\u4e00\u9875</li>'; //<li class="down">下一页</li></ul></div>'
			} else {
				pagerStrings[pagerStrings.length] = '<div class="six_com"><ul><li class="prev" onclick="pager.gotoPage(' + previousPage + ');">\u4e0a\u4e00\u9875</li>';
			}
			if (this.currentPage == pageCount || pageCount <= 1) {
				pagerStrings[pagerStrings.length] = '<li class="_next">\u4e0b\u4e00\u9875</li></ul></div>';
			} else {
				pagerStrings[pagerStrings.length] = '<li class="next" onclick="pager.gotoPage(' + nextPage + ');">\u4e0b\u4e00\u9875</li></ul></div>';
			}
			pagerStrings[pagerStrings.length] = '<input type="hidden" name="pager.requestPage" id="requestPage" value="' + this.currentPage + '" /> ';
			pagerStrings[pagerStrings.length] = '<input type="hidden" name="isNext" id="isNext" value="" /> ';
			break;
		case "cn":
