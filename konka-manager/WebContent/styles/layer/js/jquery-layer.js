...
$.extend({
	...
	layershow:function(){		
		...
		var __left = (__bw - _width) > 0 ? (__bw - _width)/4 : 0;
		//var __left = document.documentElement.scrollLeft + document.documentElement.clientWidth/2 - _width/2;
		var __top = 60;
		...
		$("#"+_titleid).css("font-weight", "bold").append($.layerSettings.title);
		var idd = ___id___;
