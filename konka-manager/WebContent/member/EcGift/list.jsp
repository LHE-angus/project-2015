...
<style type="text/css">
#topFilterSelected a {display: inline;float: left;height: 18px;line-height: 22px\9;_line-height: 18px;margin: 0px 4px 5px 0px;;padding: 0 0 0 6px;color: #fff;white-space: nowrap;background: url(${ctx}/images/repeatX.png) repeat-x 0 -120px;border-left: 1px solid #fe6e0d;border-bottom: 1px solid #ff6501;border-radius: 3px;}
#topFilterSelected a em {cursor: pointer;float: left;font-style: normal;}
#topFilterSelected a i {cursor: pointer;display: inline;float: left;width: 19px;height: 19px;background: url(${ctx}/images/topF.png) no-repeat;background: url(${ctx}/images/topFIe.png) no-repeat\9;}
.i {color: #f60;font-style: normal;}
#resetFilter {float: left;margin-top: 1px;margin-top: 3px\9;_margin-top: 1px;white-space: nowrap;}
.buttonPBSearch{width:46px;height:20px;repeat-x;font:normal 12px/20px "宋体";text-align:center;color:#fff;border:1px #ccc solid;border-left:0;background: #F00B0B;}
</style>
</head>
<body>
<!-- head start -->
      ...
      <div class="liscont1">
        ...
        <div class="jifen-box">
          <div class="jifen-font">
            ...
            <span>积分不足： <a href="${ctx }/member/EcGiftJf.do" >[去充值]</a> </span>
            <span></span></div>
        </div>
        <div class="clear"></div>
      </div>
      ...
      <tbody>
        <tr>
          ...
          <td><div class="listul2">
              <div class="rpic2 box_295_220"><a title="" href="<c:url value='/member/EcGift.do?method=view&gift_id=${cur.id}' />"><img alt="" src="${ctx}/${fn:substringBefore(cur.main_pic, '.')}.jpg" width="280" height="210" align="absmiddle" /></a></div>
              <div class="ltt2"><a href="<c:url value='/member/EcGift.do?method=view&gift_id=${cur.id}' />">
                <h4> ${fn:escapeXml(cur.pd_sn)}</h4>
                <font class="redfont">${fn:escapeXml(cur.pd_name)}</font></a></div>
              <div class="ltt3">
                <h3><font color="#000000"> 所需积分:</font> ${fn:escapeXml(cur.need_integral)}
                ...
                <a href="<c:url value='/member/EcGift.do?method=stepTwo&gift_id=${cur.id}' />"><img alt="立即兑换" src="${ctx}/styles/member/images/but_jifen.jpg" style="cursor:pointer;" /></a>
               <c:if test="${not empty cur.ecGiftComm and not empty cur.ecGiftComm.price and not empty cur.ecGiftComm.goods_url}"> 
                 &nbsp;&nbsp;&nbsp;&nbsp;<a href="${cur.ecGiftComm.goods_url}"><img alt="立即购买" src="${ctx}/styles/member/images/but_comm.jpg" style="cursor:pointer;" /></a>
              </c:if>
              </div>
            </div></td>
