...
<div class="card_center">
  ...
  <form action="<c:url value='/member/Lucky.do' />" method="post" id="shopping_car_form">
	...
	<input type="hidden" name="buy_json_object" value="${buy_json_object}" />
	 <div class="card_content" id="div_${ecLuckyMain.id}">
	    <ul>
	      ...
	      <li class="c_two" style="width:410px;"> <a href="<c:url value='/member/Lucky.do?method=view&lucky_id=${ecLuckyMain.id}' />" target="_blank" title="${ecLuckyMain.title}">${fnx:abbreviate(ecLuckyMain.title, 2 * 16, '...')}</a> </li>
	      <li class="c_three" style="width:170px;"><table border="0" cellspacing="0" cellpadding="0"><tr><td height="70" width="100" style="overflow:hidden;" valign="middle" align="center"><a href="<c:url value='/member/Lucky.do?method=view&lucky_id=${ecLuckyMain.id}' />"><img alt="${ecLuckyMain.title}" src="${ctx}/${fn:substringBefore(ecLuckyMain.main_pic, '.')}_060.jpg" style="max-width:60px;max-height:60px;" /></a></td></tr></table></li>
