  ...
  <div class="changeBox_a1">
    <div id="img_show">
      <div class="middle_img box_350_350">
       <c:if test="${not empty entity.map.picArray}">
     <c:forEach items="${entity.map.picArray}" var="cur" varStatus="vs" begin="0" end="0">
      ...
      <div class="small_imgs">
        <div class="small_imgs_fixed">
          <ul>
             <c:if test="${not empty entity.map.picArray}">
              <c:forEach items="${entity.map.picArray}" var="cur" varStatus="vs" begin="0">
...
<c:if test="${not empty entity.map.picArray}"> <c:forEach items="${entity.map.picArray}" var="cur" varStatus="vs" begin="0" end="1">
