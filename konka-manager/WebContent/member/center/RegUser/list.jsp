...
<jsp:include page="/member/__inc/_nav3.jsp" flush="true" />
<!-- second start -->
<div class="maincont">
  <jsp:include page="/member/__inc/_mleft.jsp" flush="true" />
  <!--right-->
  <div class="member_right padbot45">
    <div class="position"><a href="${ctx }/member/Index.do">首页</a> &gt; <a href="${ctx }/member/center/Index.do">会员中心</a> &gt; 完善用户资料</div>
    ...
    <div class="membertab3" id="div_info">
     ...
     <p style="margin-left:50px;margin-top:15px;font-size:14px;color:red;line-height:36px; "> 
     	  为了保障您的权益，请认证阅读会员规则、会员权益、积分规则和佣金规则，并同意《康佳EPP内部优惠购机平台网站用户协议》，<br/>并完善您的基本信息
     </p>
...
$(document).ready(function(){ 
	$("#xycheck").click(function(){
		if(confirm("确定同意上述协议吗！")){
		 window.location.href="${ctx}/member/center/RegUser.do?method=add";
		}
	});
}); 
//]]></script>
