...
<div class="maincont">
  ...
  <div class="member_right padbot45">
    <div class="position"><a href="${ctx }/member/Index.do">首页</a> &gt; <a href="${ctx }/member/center/Index.do">会员中心</a> &gt;积分礼品兑换</div>
    <div class="membertab3">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="member_form_table2">
        <tr class="tr1">
          ...
          <td width="15%" nowrap="nowrap" align="center">备注</td>
        </tr>
        <tbody>
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr height="60">
              <td align="center" nowrap="nowrap"><a href="${ctx }/member/EcGift.do?method=view&gift_id=${cur.ecGift.id }"><c:out value="${cur.ecGift.pd_name }"/></a></td>
