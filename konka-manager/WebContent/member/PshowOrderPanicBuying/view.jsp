...
<div class="togo">
  <div class="togo_left" style="width: 889px;">
   <div class="tg_center" style="border:1px #ddd solid;"> 
      ...
      <div class="tg_l">
        <div class="tg_left">
          <div class="tg_k">
            ...
            <div class="tg_cn"><a href="<c:url value='/member/PshowOrderPanicBuying.do?method=add&goods_id=${konkaBcompPd.id}' />"><img src="${ctx}/styles/member/images/qianggou.jpg" width="117" height="51" /></a></div>
            <div class="tg_down">
              <ul>
                <li>原价<br/>
          ...
          <div class="tg_clock"><font class="black_14"><span id="dd">离抢购开始还剩</span><br/>
            <div id="divTimeRemains">&nbsp;</div>
            </font></div>
          <div class="tg_success"><font class="pink16px" color="red">抢购时间</font> <br/>
             ${konkaBcompPd.map.start_time} -  ${konkaBcompPd.map.end_time}</div>
        </div>
    ...
    if (iTime >= 0)
    {
        ...
        if(iTime==0){
            clearTimeout(Account);
              ...
              document.getElementById("dd").innerHTML = "抢购中";
        }
        else
        {
