...
<div class="maincont margintop10">
  ...
  <div class="listright">
    <div class="liscont2">
      <div class="listbox2">
        <div class="listbox3">
          <form id="listForm" name="listForm" method="post" action="YjPd.do" >
      ...
      <tbody>
        <tr>
          ...
          <td><div class="listul2">
              <div class="rpic2 box"><a title="" href="<c:url value='/member/PdShow.do?goods_id=${cur.id}' />"><img alt="" src="${ctx}/${fn:substringBefore(cur.main_pic, '.')}.jpg" align="absmiddle" style="max-height:216px;" width="288"/></a></div>
              <div class="ltt2" ><a href="<c:url value='/member/PdShow.do?goods_id=${cur.id}' />" title="${fn:escapeXml(cur.pd_name)}">
              ...
              <div class="ltt3"><c:if test="${ecUser.user_type eq 1 }">
                <p style="color:#666666;"><font color="#d40207" style="font-size:12px;">￥<a href="<c:url value='/member/PdShow.do?goods_id=${cur.id}' />" style="color:red;font-size:18px;font-family:arial,宋体b8b\4f53;"><fmt:formatNumber value="${cur.map.price}" pattern="0" />
                </a></font>&nbsp; <del >市场价：￥<fmt:formatNumber value="${cur.map.original_price}" pattern="0" /></del></c:if>
                <c:if test="${ecUser.user_type eq 2 }">
                <p style="color:#666666;"><font color="#d40207" style="font-size:12px;">￥<a href="<c:url value='/member/PdShow.do?goods_id=${cur.id}' />" style="color:red;font-size:18px;font-family:arial,宋体b8b\4f53;"><fmt:formatNumber value="${cur.map.original_price}" pattern="0" />
                </a></font>&nbsp; </c:if>
    ...
    <!--page-->
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="YjPd.do">
      <div class="pagebox">
