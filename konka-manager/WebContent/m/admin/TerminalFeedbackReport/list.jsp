    ...
    <div data-role="fieldcontain">
  	...
  	<div data-role="footer" class="ui-bar" data-position="fixed" data-theme="b">
    	<div data-role="controlgroup"  data-type="horizontal">
			<a onclick="goPage(location.href,null,'${page}',-1,'${pagelimit}');" data-role="button" data-icon="arrow-l" data-theme="b" data-inline="true">上条</a>
			<a onclick="goPage(location.href,null,'${page}',1,'${pagelimit}');" data-role="button" data-icon="arrow-r" data-theme="b" data-inline="true">下条</a>
