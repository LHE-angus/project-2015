...
<link rel="stylesheet" type="text/css" href="${ctx}/styles/sfmall/register/css/global.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/styles/sfmall/register/css/css.css" />
<style type="text/css">
...
<div class="top_cont">
<div class="t_c">
<div class="logo" style="margin-top:10px;"><span class="l" style="margin-top:5px;"><img src="${ctx}/styles/sfmall/images/k_logo1.gif" width="429" height="25" /></span><span class="r"><img src="${ctx}/styles/sfmall/images/tel.gif" width="166" height="33" /></span></div>
</div>
</div>
</div>
<div class="clear"></div>
...
<font class="inf">注册会员身份验证</font> 
  ...
  <div class="login_int1"><label><span><i class="lg_redStar">&nbsp;*&nbsp;</i>姓名：</span><html-el:text property="sfmall_name" styleClass="reUser_text" styleId="sfmall_name" maxlength="15" /></label></div>
