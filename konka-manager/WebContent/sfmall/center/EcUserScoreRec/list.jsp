...
<div class="maincont">
  ...
  <div class="sfmall_right padbot45">
    <div class="position"><a href="${ctx }/sfmall/Index.do">首页</a> &gt; <a href="${ctx }/sfmall/center/Index.do">会员中心</a> &gt; 我的积分</div>
    <div class="sfmalltab3">
      <p style="margin-top:15px;font-size:14px;"> 您当前的积分:<span style="color:#FF2200;font-weight:bold;">${totalScore }</span>，其中付款积分:<span id="fk" style="color:#FF2200;font-weight:bold;"></span>，奖励积分：<span id="jl" style="color:#FF2200;font-weight:bold;"></span></p>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sfmall_form_table1">
        <tr class="tabtt1">
        ...
        <tbody>
          <c:forEach var="cur" items="${orderDetailList}" varStatus="vs">
           <tr>
              ...
              <td align="center" nowrap="nowrap" class="s1_${vs.count}"> <fmt:formatNumber value="${cur.map.pay_price}" pattern="#0" /> </td>
              <td align="center" nowrap="nowrap" class="s2_${vs.count}"><fmt:formatNumber value="${cur.map.jl_jf}" pattern="#0" /></td>
              <td align="center" nowrap="nowrap" class="s3_${vs.count}"><fmt:formatNumber value="${cur.map.pay_price+cur.map.jl_jf}" pattern="#0" /></td>
            </tr>
          </c:forEach>
          <tr class="tabtt1">
