  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
    ...
    <c:forEach items="${konkaEntpShopList}" var="cur" varStatus="status">
      <tr>
        ...
        <td align="center">
        <span style="cursor:pointer;"  class="fblue"  onclick="doNeedMethod(null, 'KonkaJxcShopStatisticsByArea.do', 'view','id=${cur.shop_id}&shop_name=${cur.shop_name}&area_code_search=${af.map.area_code_search}&'+$('#bottomPageForm').serialize())">报表</span>
        </td>
      </tr>
    </c:forEach>
