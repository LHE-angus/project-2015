...
<div class="top_cont">
<div class="t_c">
<div class="logo" ><span class="l"><img src="${ctx}/styles/touch/images/pingtai.jpg" /></span><span class="r"><img src="${ctx}/styles/touch/images/tel.gif" width="166" height="33" /></span></div>
</div>
</div>
</div>
<div class="clear"></div>
...
<font class="inf">会员身份验证</font> 
  ...
  <div class="login_int"><label><span class="s2"><i class="lg_redStar">&nbsp;*&nbsp;</i>登录名：</span><html-el:text property="user_name" styleClass="reUser_text" styleId="user_name" maxlength="15" /></label></div>
...
$("#user_name").attr("datatype", "Require").attr("msg", "登录名不能为空！");
