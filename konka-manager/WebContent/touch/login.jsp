...
<link rel=stylesheet type=text/css  href="${ctx}/styles/touch/css/global.css" />
<link rel=stylesheet type=text/css  href="${ctx}/styles/touch/css/login-new.css" />
<link rel=stylesheet type=text/css  href="${ctx}/styles/touch/css/footer.css" />
<script type="text/javascript" src="${ctx}/commons/scripts/jquery.js"></script>
</head>
<body>
<div class="head">
  <div class="logo" style="padding-top: 0px;padding-bottom: 10px;"><span class="l"><img src="${ctx}/styles/touch/images/pingtai2.jpg" width="429" /></span><span class="r" style="padding-top: 20px;"><img src="${ctx}/styles/touch/images/tel.gif" width="166" height="33" /></span></div>
  <div class="main">
    <div class="guanggao">
    ...
    <form action="${ctx }/touch/login.do?method=login" method="post" style="margin:0;padding:0;" id="login_form"> 
    <div class="signin">
      <div class="loginbox">
        <h3 class="logintit">欢迎登录康佳触网直销商城</h3>
        <table width="307" border="0" cellpadding="0" cellspacing="0">
         <tr>
          ...
          <tr>
            <td class="logintd3" colspan="2"><p style="margin-left:26px;" >
            <input name="is_remember" type="checkbox" id="is_rememer" value="1" />
             <font>记住密码</font><a href="${ctx}/touch/EcBackPassword.do" style="margin-left: 70px;color: #08C;">忘记登录密码？</a></p></td>
          </tr>
          <tr>
            <td class="logintd4"  colspan="2"><a title="登录" id="btn_sub" style="margin-left:12px;cursor:pointer;"><img alt="登录" src="${ctx}/styles/touch/images/but_login.gif" width="280" height="34" /></a></td>
          </tr>
        </table>
      </div>
    </div>
   ...
   <div class="bottom2" style="width:100%"><span><img src="${ctx}/styles/touch/images/bottom4.gif"/></span>
    <div class="b_service_pic_sub"><img src="${ctx}/styles/touch/images/bottom1.gif" height="38" width="114" border="0"/></div>
    <div class="b_service_pic_sub"><img src="${ctx}/styles/touch/images/bottom2.gif"  height="38" width="114"border="0"/></div>
    <div class="b_service_pic_sub"><img src="${ctx}/styles/touch/images/bottom3.gif" height="38" width="114" border="0"/></div>
    <div class="clear"></div>
  </div>
...
<!--<div class="konka_float_index">
	<ul><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li><li><img src="${ctx}/styles/touch/images/998.jpg" width="125" height="43" /></li>
</ul>-->
</body>
<script type="text/javascript" src="${ctx}/commons/scripts/validator.js"></script>
<script type="text/javascript" src="${ctx}/styles/touch/js/dell-epp-track.js"></script>
<script type="text/javascript" src="${ctx}/styles/touch/js/slides4epp.js"></script>
