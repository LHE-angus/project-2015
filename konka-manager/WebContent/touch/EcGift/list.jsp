...
<link rel=stylesheet type=text/css  href="${ctx}/styles/touch/css/jifen.css" />
      ...
      <div class="liscont1">
        ...
        <div class="jifen-box">
          <div class="jifen-font">
            <h1>${fn:escapeXml(ecUser.real_name)} [<a href="${ctx}/touch/login.do?method=logout">退出</a>]</h1>
      ...
      <tbody>
        <tr>
          ...
          <td><div class="listul2">
              <div class="rpic2 box_295_220"><a title="" href="<c:url value='/touch/EcGift.do?method=view&gift_id=${cur.id}' />"><img alt="" src="${ctx}/${fn:substringBefore(cur.main_pic, '.')}.jpg" width="280" height="210" align="absmiddle" /></a></div>
              <div class="ltt2"><a href="<c:url value='/touch/EcGift.do?method=view&gift_id=${cur.id}' />">
              ...
              <div class="ltt3">
                ...
                <a href="<c:url value='/touch/EcGift.do?method=stepTwo&gift_id=${cur.id}' />"><img alt="立即兑换" src="${ctx}/styles/touch/images/but_jifen.jpg" style="cursor:pointer;" /></a>
              </div>
            </div></td>
