...
.ph_con{width:991px; margin:0 auto; border:1px solid #ccc; border-top:none; margin-top:-1px; padding-bottom:30px;}
...
<div id="content" style="margin:20px 10px 20px 10px; min-height:450px;">
        ...
        <p class="ph_list_title"><span class="ph_title_font">商用电视</span></p> 
        <div class="ph_con">
        ${entity.content }
        </div>
        </div>
  		<div class="ph_list_box">
        <p class="ph_list_title"><span class="ph_title_font">网上下单</span></p>
        <div class="ph_con">
        ...
        <div class="ph_list_box">
        <p class="ph_list_title"><span class="ph_title_font">康佳特色</span></p>
        <div class="ph_con">
        <table border="0" cellpadding="0" cellspacing="0" class="ph_ts_table">
            <tbody>
                <tr>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_1.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_2.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_3.jpg"></td>
                </tr>
                <tr>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_4.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_5.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/touch/images/ph_teshe_pic_6.jpg"></td>
                </tr>
            </tbody>
        </table>
        </div>
