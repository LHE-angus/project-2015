...
<div class="maincont">
  ...
  <div class="touch_right padbot45">
    <div class="position"><a href="${ctx }/touch/Index.do">首页</a> &gt; <a href="${ctx }/touch/center/Index.do">会员中心</a> &gt; 购物券兑换</div>
    <div class="touchtab3">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="touch_form_table1">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr height="30">
              ...
              <td align="center" nowrap="nowrap"><a href="${ctx}/touch/center/EcVouchers.do?method=add&id=${cur.id}">兑换</a></td>
            </tr>
          </c:forEach>
