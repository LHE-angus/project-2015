...
<input type="button" name="" value="返回" onclick="location.href='${ctx}/customer/manager/ImportCustomerPdData.do?method=add&mod_id=${af.map.mod_id}'" id="btn_reset" class="but5">
...
<table width="100%" border="1" cellpadding="5" cellspacing="0" style="border-collapse:collapse;">
  <tr>
    <th width="5%">序号</th>
    <th width="8%" align="center">*康佳商品标识</th>
    <th align="center">*电视规格型号</th>
    <th width="8%" align="center">*商品状态</th>
    <th width="8%" align="center">*初始化库存</th>
    <th width="8%" align="center">*进货单价</th>
    <th width="8%" align="center">*销售单价</th>
    <th width="8%" align="center">商品条码</th>
    <th width="8%" align="center">商品描述</th>
  </tr>
