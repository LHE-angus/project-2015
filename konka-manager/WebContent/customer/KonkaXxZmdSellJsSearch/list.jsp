...
<div class="oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/manager/KonkaXxZmdSellJsSearch">
  ...
  <div class="rtabcont1">
    ...
    <table id="table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          <td align="center" class="fblue" style="cursor:pointer;"><a href="${ctx}/customer/manager/KonkaXxZmdAddSalesOrder.do?method=view&sell_bill_id=${cur.sell_bill_id}&mod_id=${af.map.mod_id}"><font style="text-decoration:underline;">
