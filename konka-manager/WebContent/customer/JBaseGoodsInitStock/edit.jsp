    ...
    <html-el:form action="/manager/JBaseGoodsInitStock">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left"><html-el:select property="store_id" styleId="store_id" multiple="multiple">
        ...
        <tr>
          ...
          <td width="83%" align="left"><html-el:select property="goods_id" styleId="goods_id" multiple="multiple">
		        		<html-el:option value="">请选择</html-el:option>
