...
<div class="Wallpaper">
    ...
    <div id="imgplayer1" class="sub_r smallslider" style="width:258px;height:311px;">
      <ul>
        <c:forEach var="cur" items="${imgList_1201}">
          <li><a href="${cur.image_url}" target="_blank"><img src="${ctx}/${cur.image_path}" title="" alt="${cur.title}" width="258" height="311" /></a></li>
        </c:forEach>
      ...
      <div id="imgplayer2" class="sub_r smallslider" style="width:380px;height:179px;">
        <ul>
          <c:forEach var="cur" items="${imgList_1202}">
            <li><a href="${cur.image_url}" target="_blank"><img src="${ctx}/${cur.image_path}" title="" alt="${cur.title}" width="380" height="179" /></a></li>
          </c:forEach>
  ...
  <div class="loginbox">
    <h3 class="logintit">客户登录</h3>
    <html-el:form action="/login" method="post" style="margin:0px;padding:0px;">
      ...
      <table width="330" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          ...
          <tr>
            <td>&nbsp;</td>
            <td class="logintd3" colspan="2"><input type="checkbox" name="is_remember" value="1" id="is_remember" style="vertical-align:middle;padding:0;margin:0 3px 3px 0 " />
              <font style="font-size:12px; color: #666;">记住密码</font></td>
          </tr>
          <tr>
            <td colspan="3" class="logintd4" align="center"><a title="登录" href="#" onclick="$('#loginForm').submit();"><img alt="登录" src="${ctx}/styles/customer-login/images/but_login.gif" width="307" height="34"></a></td>
          </tr>
        </tbody>
      </table>
    </html-el:form>
...
<div class="foot">康佳集团 版权所有 KONKA 2013.All Rights Reserved   | 版本号 ：${VersionOfVip}<br>
    网站管理：多媒体渠道管理部 | 运营电话：0755-26608866-6303 | 粤ICP备05059413</div>
