  ...
  <div class="rtabcont2">
    <html-el:form action="/manager/KonkaXxZmdAddSalesOrder">
      ...
      <table id="main_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right" ><span style="color:#FF0000;">[必填]</span><strong>顾客姓名：</strong></td>
        ...
        <tr>
	        <td class="title_item" nowrap="nowrap" align="right"><font color="red">[必填]</font>配送方式：</td>
			<td>
				<label for="send_type_1"><html-el:radio property="send_type" onclick="showShr(1)" styleClass="send_type_c" styleId="send_type_1" value="1" /> 自提</label>
				<label for="send_type_2"><html-el:radio property="send_type" onclick="showShr(2)" styleClass="send_type_c" styleId="send_type_2" value="2" /> 配送</label>
			</td>
		</tr>
		<tbody id="shr_tb">
	         <tr>
...
<!--         </tr> -->
		<html-el:hidden property="buyer_province" styleId="buyer_province"/>
		<html-el:hidden property="buyer_city" styleId="buyer_city"/>
		<html-el:hidden property="buyer_country" styleId="buyer_country"/>
		<html-el:hidden property="buyer_town" styleId="buyer_town"/>
        ...
        <tr>
          ...
          <td align="left" style="padding-bottom:5px;" colspan="3">	  			
            ...
            <label for="pay_way_1" style="cursor:pointer;">
              <html-el:radio property="pay_way" styleId="pay_way_1" value="1">现金支付</html-el:radio>
            </label>
            <label for="pay_way_2" style="cursor:pointer;">
              <html-el:radio property="pay_way" styleId="pay_way_2" value="2">POS刷卡</html-el:radio>
            </label></td>
            <html-el:hidden property="sell_bill_type" value="90200"/>
...
<%--             </c:forEach></td> --%>
        ...
        <tr style="display: none;">
          ...
          <td align="left" colspan="3" style="padding-bottom:5px;">
          	<html-el:hidden property="submit_type"  value="0"/>
<!--             <label for="submit_type_0" style="cursor:pointer;"> -->
...
// 	$("#buyer_province").change();
	...
	$("input[type='radio'][name='pay_way']").eq(0).attr("dataType", "Group").attr("msg", "请选择付款方式！");
	$("input[type='radio'][name='send_type']").eq(0).attr("dataType", "Group").attr("msg", "请选择配送方式！");
...
// 	});
	...
	$("#btn_submit").click(function(){
		...
		//	return false;
		//}
		var send_type = $('.send_type_c:checked').val();
		if(send_type == 1){//自提
			$("#province").removeAttr("dataType");
			$("#city").removeAttr("dataType");
			$("#country").removeAttr("dataType");
			$("#sell_post_addr").removeAttr("dataType");
		} else if(send_type == 2){//配送
			$("#province").attr("dataType", "Require").attr("msg", "请选择省/直辖市/自治区！");
			$("#city").attr("dataType", "Require").attr("msg", "请选择市！");
			$("#country").attr("dataType", "Require").attr("msg", "请填写区/县！");
			$("#sell_post_addr").attr("dataType", "Require").attr("msg", "请填写送货街道地址！");
		...
		//由于是隐藏信息，所以最好有赋值
// 		alert("province="+$("#province").val()+"   city="+city+"   country=="+country+"    town="+town);
		$("#buyer_province").val($("#province").val());
// 		$("#buyer_city").val($("#city").val());
// 		$("#buyer_country").val($("#country").val());
// 		$("#buyer_town").val($("#town").val());
