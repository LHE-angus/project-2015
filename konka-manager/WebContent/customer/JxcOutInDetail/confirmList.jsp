...
<body style="font-family:Microsoft Yahei;">
	...
	<html-el:form action="/manager/JxcOutInDetail">
      <html-el:hidden property="method" value="confirmList" />
          ...
          <tr>
             <td>
	          ...
	          <html-el:select property="type" styleId="type">
	        		<html-el:option value="1">调入</html-el:option>
	        		<html-el:option value="0">调出</html-el:option>
	            </html-el:select>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
	    ...
	    <c:forEach items="${entityList}" var="cur" varStatus="vs">
	      <tr>
	        ...
	        <td align="center">
	        	<c:if test="${cur.trans_type eq 0}"><font color="green">调出</font></c:if>
	        	<c:if test="${cur.trans_type eq 1}"><font color="red">调入</font></c:if>
	        </td>
	        ...
	        <td align="center">
	        	...
	        	<c:if test="${cur.state eq 2}">拒绝</c:if>
	        ...
	        <td align="center" nowrap="nowrap">
	        	...
	        	<c:if test="${cur.state eq 0 }">
		        	<span style="cursor:pointer;"  class="fblue"  onclick="doNeedMethod(null, 'JxcOutInDetail.do', 'confirm','&mod_id=${af.map.mod_id}&id=${cur.id}&'+$('#bottomPageForm').serialize())">确认  </span> 
	        	</c:if>
	        	<c:if test="${cur.state ne 0 }"><span style="color:grey;">确认 </span></c:if>
	        </td>
	      </tr>
	      <c:if test="${vs.last}">
	        ...
	        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
	          <tr>
	            <td height="40" align="center"><script type="text/javascript">
		            ...
		            pager.addHiddenInputs("method", "confirmList");
