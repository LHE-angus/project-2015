...
<style type="text/css">
 ...
 #btn_submit{
 	background:transparent url("${ctx}/images/manager/but_serv2.jpg") no-repeat scroll 0% 0%;
 	width:62px;height:30px;
 }
 #btn_temp_save{
 	background:transparent url("${ctx}/images/manager/but_serv1.jpg") no-repeat scroll 0% 0%;
 		width:62px;height:30px;
 }
 input#btn_can_use_money {
  background: url("../../images/manager/btn_submit.jpg") no-repeat;
  height: 30px;
  width: 62px;
}
 #btn_temp_save_add{
 	background:transparent url("${ctx}/images/manager/but_add1.jpg") no-repeat scroll 0% 0%;
 		width:62px;height:30px;
 }
 #btn_back{
 	background:transparent url("${ctx}/images/manager/but_return1.jpg") no-repeat scroll 0% 0%;
 		width:62px;height:30px;
...
<div style="width:100%">
	<div class="oartop">
	    <table width="400" border="0" cellpadding="0" cellspacing="0">
	      <tr style="height:28px;background-color:#eceaea">
	        <td width="3%"><img src="${ctx}/styles/admin-index/images/k_tup.jpg" style="vertical-align:middle;" /></td>
	        <td><font style='font-size:12px;color:#3e3e3e'>当前位置：</font>${naviString}</td>
	      </tr>
	    </table>
  	</div>
...
<%-- 	      	<html-el:hidden property="trade_index" styleId="trade_index" value="${af.map.trade_index}" /> --%>
	      	...
	      	<html-el:hidden property="FROMSALESMAN" styleId="FROMSALESMAN" value="${FROMSALESMAN}" />
	      	<html-el:hidden property="CUSTID" styleId="CUSTID" value="${CUSTID}" />
			...
			<div id="content"> 
			    <div id="tab1">
			    	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass" id="hbtable">
						...
						<!-- 常规信息 -->
						<tr>
    					<td align="center" width="5%" style="font-weight: bold; color: rgb(255, 255, 255); background-color: rgb(39,169,227);">常规信息</td>
    					<td width="90%" colspan="3" style="border-bottom: 2px solid gray;"></td>
						</tr>
						<tr>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">提交时间：</td>
							<td><html-el:text property="order_date" styleId="order_date" size="10" maxlength="9" style="width:130px;" readonly="true" styleClass="webinput" value="${af.map.today}"/></td>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">创建日期：</td>
							<c:if test="${empty af.map.add_date}">
							<td><html-el:text property="add_date" styleId="add_date" size="10" maxlength="9" style="width:130px;" readonly="true" styleClass="webinput" value="${af.map.today}"/></td>
							</c:if>
							<c:if test="${not empty af.map.add_date}">
							<td><fmt:formatDate value="${af.map.add_date}" pattern="yyyy-MM-dd hh:mm:ss" var="add_date1"/>
							<html-el:text property="add_date1" styleClass="webinput" styleId="add_date1" value="${add_date1}" />
							</td>
							</c:if>
							</tr>
							<tr>
							<c:if test="${sessionScope.from_manager_is_salesman eq '1'}">
								<td class="title_item_no_bc"><font color="red" style="font-size:12px;color:#3e3e3e;height:40px;">*</font>订单流程：</td>
								<td colspan="3">
							...
							<c:if test="${sessionScope.from_manager_is_salesman ne '1'}"><td></td><td></td><td></td><td></td></c:if>
						</tr>
						<tr>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">订单状态：</td>
							<td>
							...
							<td class="title_item_no_bc"  style="font-size:12px;color:#3e3e3e;height:40px;">出货状态：</td>
							<td>
						...
						<tr>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">制单人：</td>
							<td><html-el:text property="userName" value="${af.map.userName}" style="width:100px;" styleClass="webinput" readonly="true" /></td>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">业务员：</td>
						...
						<tr style="display:none;" id="process_id_tr">
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">订单分类：</td>
							<td colspan="3">
						...
						<tr>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">采购订单编号：</td>
							<td><html-el:text property="third_cg_order_num" maxlength="50" style="width:100px;" styleClass="webinput" /></td>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">采购订单日期：</td>
						...
						<tr>
							<td class="title_item_no_bc" style="font-size:12px;color:#3e3e3e;height:40px;">备注：</td>
							<td colspan="3">
						...
						<!-- 产品明细 -->
						<tr>
    					<td align="center" width="5%" style="font-weight: bold; color: rgb(255, 255, 255); background-color: rgb(39,169,227);"> 产品明细</td>
    					<td width="90%" colspan="3" style="border-bottom: 2px solid gray;"></td>
						</tr>
						<tr><td colspan="4" height="20px">&nbsp;</td></tr>
						<tr>
							<td colspan="4">
  								<table width="100%" class="tableClass" style="margin:5px 0px;">
    								<tr class="title_top_no_bc" >
    								<td width="5%" align="center" style="cursor:pointer;background-color:rgb(236,234,235);" title="添加" onclick="getPePdModel();">
										<img src="${ctx}/styles/jxc/images/+.gif" style="vertical-align:text-bottom;"/></td>
										<td width="14%" nowrap="nowrap" style="background-color:rgb(236,234,235);">产品型号<c:if test="${call_r3_interface}">&nbsp;<span style="font-weight:normal;">（<span id="btn_check" style="text-decoration:underline;cursor:pointer;color:#F00;">点击检查库存</span>）</span></c:if></td>
										<td width="8%" nowrap="nowrap" style="background-color:rgb(236,234,235);"> 数量</td>
										<td width="5%" nowrap="nowrap" style="background-color:rgb(236,234,235);">单位</td>
										<td width="8%" nowrap="nowrap" style="background-color:rgb(236,234,235);">单价</td>
										<td width="10%" nowrap="nowrap" style="background-color:rgb(236,234,235);">金额</td>
										<!-- 
										<td width="10%" nowrap="nowrap">单台折扣</td>
										 -->
										<td width="10%" nowrap="nowrap" style="background-color:rgb(236,234,235);">折扣金额-RB00</td>
										<td width="10%" nowrap="nowrap" style="background-color:rgb(236,234,235);">折扣(%)-K007</td>
										<td width="8%" nowrap="nowrap" style="background-color:rgb(236,234,235);">折扣后金额</td>
										<td nowrap="nowrap" style="background-color:rgb(236,234,235);">产品备注</td>
										<td width="5%" align="center" style="cursor:pointer;background-color:rgb(236,234,235);" title="添加" onclick="getPePdModel();">
										<img src="${ctx}/styles/jxc/images/+.gif" style="vertical-align:text-bottom;"/></td>
									</tr>
									...
									<td align="center" title="删除"><img src="${ctx}/styles/jxc/images/x.gif" style="vertical-align:text-bottom;"/></td>
										<td align="center">
											...
											<span id="md_name" class="md_name"></span><span id="span_1" class="span_1"></span>
										</td>
										...
										<td align="center"><html-el:text property="good_price" value="0" styleId="good_price"  maxlength="10" size="10" styleClass="" /></td>
										<td align="center">
						...
						<!-- 汇总信息 -->
						<tr>
    					<td align="center" width="5%" style="font-weight: bold; color: rgb(255, 255, 255); background-color: rgb(39,169,227);">付款信息</td>
    					<td width="90%" colspan="3" style="border-bottom: 2px solid gray;"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<html-el:button property="btn_can_use_money" styleId="btn_can_use_money" value=" " style="margin-left:10px;" /></td>
		        		</tr>
		        		 -->
			        	<tr>
				        	<td class="title_item_no_bc" valign="top"><font color="red">*</font>货款支付方式：</td>
				        	<td><label for="pay_type_4"><input type="checkbox" name="pay_type" id="pay_type_4" value="4" />现汇&nbsp;</label>
		        		...
		        		<tr>
		        		<td>&nbsp;</td>
		        			<td colspan="3"><span style="color:#666666;font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">提醒：</span>1、现汇：采用现金汇款或转帐的方式支付货款<br>
						...
						<!-- 收货信息 -->
						<tr>
    					<td align="center" width="5%" style="font-weight: bold; color: rgb(255, 255, 255); background-color: rgb(39,169,227);">收货信息</td>
    					<td width="90%" colspan="3" style="border-bottom: 2px solid gray;"></td>
						</tr>
						...
						<tr>
							<c:if test="${vs.count eq 1}">
								<td class="title_item_no_bc" width="15%" class="hbtd">收货人信息：</td>
							</c:if>
							<c:if test="${vs.count > 1}">
								<td class="title_item_no_bc" width="15%" class="hbtd" ></td>
							</c:if>
...
<!--						</tr>-->
						<tr>
    					<td align="center" width="5%" style="font-weight: bold; color: rgb(255, 255, 255); background-color: rgb(39,169,227);">R3系统订单凭证</td>
    					<td width="90%" colspan="3" style="border-bottom: 2px solid gray;"></td>
						</tr>
						<tr>
							<td width="8%" align="left" class="title_item_no_bc">销售凭证类型</td>
							<td width="12%">
								<html-el:select property="doc_type" styleId="doc_type">
...
<!-- 			    	</div>  -->
			...
			<div style="position:absolute;top:0;right:0;">
				<html-el:button property="btn_submit" styleId="btn_submit" value=" " />&nbsp;
				<html-el:button property="btn_temp_save" styleId="btn_temp_save" value=" " />&nbsp;
				<html-el:button property="btn_temp_save_add" styleId="btn_temp_save_add" value=" " />&nbsp;
				<html-el:button property="btn_back" styleId="btn_back" value=" " onclick="history.back();" />&nbsp;
...
$(document).ready(function(){
	 ...
	 //   }
		...
		if (Validator.Validate(this.form, 1)){
			...
			if ("${call_r3_interface}" == "true") {
				...
				if (check_stocks == '') {
					var check = confirm("是否不检查库存直接提交？(若产品库存不足，提交可能导致部分产品无法发货!)");
					if(check == true){
						//提交
						refer();
					}else{
				...
				} else if (check_stocks == 0){
					var checks = confirm("部分产品库存不足，提交可能导致部分产品无法发货，确定继续？");
					if(checks == false) {
						return;
					}else{
						//提交
	...
	$("#btn_temp_save_add").click(function(){
		var content1=$('#content1').val(); 
		if(content1.length>200){alert('最多只能输入50个字');return false;	}
	...
	<c:if test="${not empty konkaOrderInfoDetailsList}">
		...
		<c:forEach items="${konkaOrderInfoDetailsList}" var="cur" varStatus="vs">
			...
			good_price.attr("dataType","Double").attr("msg","非KF-22PB,KF-22XD,KF-22KK等型号的商品，单价不能为负数！");
	...
	/*		good_discount_price.blur(function(){
				if(parseFloat(good_discount_price.val())>0){
   					alert("折扣金额-RB00只能是负数");
					}
			});
			good_price.blur(function(index,b){
	                   if($("#md_name",b).val()!='KF-22PB' && parseFloat($("#good_price",b).val())<0){}
			...
			good_price.keyup(function(){
				if(md_name.val()!='KF-22PB' && parseFloat(good_price.val())<0){
					alert("非KF-22PB型号的商品，单价不能为负数！");
					good_price.val(0);
					}
					});*/
			...
			if(md_name.text()!="KF-22PB" && md_name.text()!="KF-22XD"  && md_name.text()!="KF-22KK"){
				good_price.blur(function(){ 
	               if(parseFloat(this.value)< 0 ){
	            	   alert("非KF-22PB,KF-22XD,KF-22KK等型号的商品，单价不能为负数！");
	            	   this.focus();
	            	//  this.value=0;
	                   }
				});
			...
			$("td:first", lastTR).click(function (){
				var pd_id_td1 = $("#pd_id", $(this).parent()).val()+",";
				var pd_id_td2 = ","+$("#pd_id", $(this).parent()).val();
				var pd_ids_new1 = $("#pd_ids").val().replace(pd_id_td1,"");
				pd_ids_new2 = pd_ids_new1.replace(pd_id_td2,"");
...
$("#btn_check").click(function(){
	...
	$(".span_1").each(function(){
		span_index[span_index.length] = $.trim($(this).attr("id"));
	});
	...
	$.ajax({
		...
		data: {"sales_org" : sales_org, "md_name" : md_names.join(','), "good_count" : good_counts.join(','),"span_index":span_index.join(',')},
		dataType: "json",
		sync: true, 
		error: function (xhr, ajaxOptions, thrownError) { alert("数据加载请求失败【" + xhr.statusText + "," + xhr.responseText + "," + xhr.status + "," + thrownError +"】！"); },
		success: function(result) {
	...
	if (ids != "") {
		...
		for(var i = 0; i < pd_id_array.length; i++){
			...
			$("#tbodyContent tr").each(function(){
				var a=$("#good_price",this).val();
				var b=$("#md_name",this).val();
	            $("#good_price",this).blur(a,b,function(){
	                   if(a!='KF-22PB' && parseFloat(b)<0){}
	                   alert("非KF-22PB型号的商品，单价不能为负数！");
	                   $("#good_price",b).val(0);
	                   return;
		            })
			...
			pd_id.val(pd_id_array[i]);//隐藏域选择的产品
	      	...
	      	if(md_name1.val()!="KF-22PB" && md_name1.val()!="KF-22XD" &&md_name1.val()!="KF-22KK"){
				good_price.blur(function(){ 
	               if(parseFloat(this.value)< 0 ){
	            	   alert("非KF-22PB,KF-22XD,KF-22KK等型号的商品，单价不能为负数！");
	            	  this.focus();
...
// 	    	});
			...
			span_1.attr("id",md_name_array[i]+a);//改变id
			a++;
...
good_count.blur(function(){//数量
	...
	good_price.blur(function(){//单价
		...
		$.ajax( {
    		...
    		cache : false,
    		url : "${ctx}/CsAjax.do",
    		data : "method=getKonkaR3PdPrice2ForLowestPrice&pd_sn=" + md_name+"&r3_code=" + r3_code,
    		dataType: "json",
    		error : function(data) {good_price.val("0");},
    		success : function(data) {
       
    			if(data[0].price != 0){
	    			if(price < parseFloat(data[0].price)){
		    			//alert(price);
		    			//alert(parseFloat(data[0].price));
	    				good_price.val(data[0].price);
	    				price=data[0].price;
	    				alert("价格不能低于最低限价"+data[0].price);
	    			}
    			}
        	}
    	});
...
function refer(){
	...
	$.ajax({
		...
		success: function(result) {
			...
			html += '<td width="30%" nowrap="nowrap" align="center">产品型号</td>';
			html += '<td width="20%" nowrap="nowrap" align="center">前'+result.list[0].weeks+'周的销售数量</td>';
			html += '<td width="20%" nowrap="nowrap" align="center">当前库存</td>';
			html += '<td width="30%" nowrap="nowrap" align="center">周转天数</td>';
			html += '</tr>';
			for ( var x in result.list) {
				...
				if(result.list[x].order_fourweek_count!=0 &&result.list[x].curr_ku_count!=0){
				html += '<td align="center">' + (result.list[0].weeks*7 *result.list[x].curr_ku_count /result.list[x].order_fourweek_count)+ '</td>';
				}else{
