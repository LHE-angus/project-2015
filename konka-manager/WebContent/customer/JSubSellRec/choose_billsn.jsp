    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="TabTitle">
      <tr>
        <td align="left" nowrap="nowrap">
        	分销单编号：<html-el:text property="bill_sn_like" />
        	&nbsp;
        	分销日期：<html-el:text property="opr_date_gt" styleId="opr_date_gt" size="8" maxlength="8" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width:80px;" disabled="${readonly}" />
...
function returnBillSn(val){
	...
	$(W.document.getElementById("view_a")).attr("href","${ctx}/customer/manager/JSubSellRec.do?method=view&bill_sn=" + val).show();
