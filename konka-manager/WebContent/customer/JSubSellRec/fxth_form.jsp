  ...
  <div class="rtabcont2" style="padding-left:5px;padding-right:5px">
    ...
    <html-el:form action="/manager/JSubSellRec.do">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
        	<td width="10px"></td>
        	<td width="35px" nowrap="nowrap" class="title_item"><span style="color:red;">* </span>网&nbsp;&nbsp;&nbsp;&nbsp;点：</td>
	        <td width="400px">
	        	<c:if test="${empty flag }">
		        	<span id="partner_name_t"></span>
	        	</c:if>
	        	<c:if test="${not empty flag }">${partner_name }</c:if>
	        	<html-el:hidden property="partner_id" styleId="partner_id" ></html-el:hidden>
	        </td>
	        <td width="35px" nowrap="nowrap" class="title_item">
        ...
        <tr>
          ...
          <td><span id='link_name'>${link_name }</span></td>
          <td nowrap="nowrap" class="title_item">联系电话：</td>
          <td><span id='link_mobile'>${link_mobile }</span></td>
        </tr>
        <tr>
          <td width="10px"></td>
        ...
        <tr>
          <td colspan="5"><table id="xsth_t" width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
          	<tr>
       			<td width="15%" align="center" nowrap="nowrap">仓库名称</td>
       		...
       		<c:forEach var="cur" items="${jbillDetailsList}" varStatus="vs">
       			<tr>
					...
					<td><input type='text' name='num' id='num' size='4' onfocus='javascript:setOnlyInt(this)' value='${cur.num }' maxlength='6' class='num' /></td>
					<td>
					...
					<td align='center' nowrap='nowrap'><input type='text' name='notes' value='${cur.notes }'></input></td>
...
function SetRBillSnDetails(r_bill_sn){
	$.ajax({
		type: "POST",
		url: "JSubSellRec.do",
		data: {method : "ajaxGetAgentDetails", "r_bill_sn": r_bill_sn},
		dataType: "json",
		cache:false,
			...
			if(ret){
				...
				if(null != ret.jdetails){
					...
					for(var i = 0; i < ret.jdetails.length; i++){
						...
						html += "<td align='center' nowrap='nowrap'>" + cur.map.type_name + "</td>";
						...
						html += "<td><input type='text' name='num' id='num' size='4' onfocus='javascript:setOnlyInt(this)' value='1' maxlength='6' class='num' /></td>";
						...
						html += "<td><span>"+cur.price*cur.num+"</span><input type='hidden' name='goods_money' class='goods_money' value='"+cur.price*cur.num+"'/></td>";
						html += "<td align='center' nowrap='nowrap'><input type='text' name='notes' size='6'/></td>";
...
function openChild(){
   $.dialog({
        ...
        lock:   true ,
        drag: false,
		content:"url:${ctx}/customer/manager/JSubSellRec.do?method=chooseBillSn"
	});
}
