...
<div class="maincont">
    ...
    <div class="topmid">
    	...
    	<div class="topnav"><ul class="topnavul"><li><a href="#main4">竞猜</a></li><li><a href="#main3">赛事结果</a></li><li><a href="#main6">竞猜积分榜</a></li><li><a href="#main5">竞猜规则</a></li><li><a href="<c:url value='/member/KonkaGroupPeArticleInfo.do?method=view&id=826079' />">赛程查询</a></li><li><a href="#main1">球队介绍</a></li></ul></div>
  </div>
...
<div class="maincont">
	<div <c:if test="${vs.count eq 1}">class="left1"</c:if><c:if test="${vs.count eq 2}">class="left2"</c:if><c:if test="${vs.count eq 3}">class="left3"</c:if><c:if test="${vs.count eq 4}">class="left8"</c:if>>
	<c:if test="${vs.count eq 1}"><img src="../styles/member/sjb/images/leftbg_1.jpg" /></c:if>
	<c:if test="${vs.count eq 2}"><img src="../styles/member/sjb/images/leftbg_2.jpg" /></c:if>
	<c:if test="${vs.count eq 3}"><img src="../styles/member/sjb/images/leftbg_3.jpg" /></c:if>
	<c:if test="${vs.count eq 4}"><img src="../styles/member/sjb/images/leftbg_8.jpg" /></c:if>
	</div>
    <div <c:if test="${vs.count eq 1}">class="midbox1"</c:if><c:if test="${vs.count eq 2}">class="midbox2"</c:if><c:if test="${vs.count eq 3}">class="midbox3"</c:if><c:if test="${vs.count eq 4}">class="midbox8"</c:if> id="main4">
		...
		<div <c:if test="${vs.count eq 1}">class="vstable1"</c:if><c:if test="${vs.count eq 2}">class="vstable2"</c:if><c:if test="${vs.count eq 3}">class="vstable3"</c:if><c:if test="${vs.count eq 4}">class="vstable3"</c:if>>
        	<div class="ttime">
            ...
            <div class="midresult">
                ...
                <div class="vstit2">猜输赢</div>
                <ul class="vstab1">
                	<li><img src="../styles/member/sjb/images/victory.gif" /><br/><input type="radio" name="is_win" class="is_win_${cur.match_id}" id="is_win_${cur.match_id}" value="0" /></li>
                    <li class="draw"><img src="../styles/member/sjb/images/draw.gif" /><br/><input type="radio" name="is_win" class="is_win_${cur.match_id}" id="is_win_${cur.match_id}" value="1" /></li>
                    <li class="fail"><img src="../styles/member/sjb/images/victory.gif" /><br/><input type="radio" name="is_win" class="is_win_${cur.match_id}" id="is_win_${cur.match_id}" value="2" /></li>
                </ul>
                <div class="vs_result">
                	<div class="vstit2">猜比分</div>
                	<ul class="vs_resultul">
                    <li><input class="a_team_result_${cur.match_id}" name="a_team_result" type="text"   maxlength="3" onfocus="javascript:setOnlyInt(this);" style="width:44px;height:25px;border:1px solid #e8e8e8;font-size:24px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;color:#1f55a5;line-height:27px;text-align:center;"/></li>
                    <li class="rcenter">:</li>
                    <li class="rnumber"><input class="b_team_result_${cur.match_id}" name="b_team_result" type="text"   maxlength="3" onfocus="javascript:setOnlyInt(this);" style="width:44px;height:25px;border:1px solid #e8e8e8;font-size:24px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;color:#1f55a5;line-height:27px;text-align:center;"/></li>
                    </ul>
              </div>
     ...
     <div <c:if test="${vs.count eq 1}">class="right1"</c:if><c:if test="${vs.count eq 2}">class="right2"</c:if><c:if test="${vs.count eq 3}">class="right3"</c:if><c:if test="${vs.count eq 4}">class="right8"</c:if>>
     <c:if test="${vs.count eq 1}"> <img src="../styles/member/sjb/images/rightbg1.jpg" /></c:if>
     <c:if test="${vs.count eq 2}"> <img src="../styles/member/sjb/images/rightbg2.jpg" /></c:if>
     <c:if test="${vs.count eq 3}"> <img src="../styles/member/sjb/images/rightbg3.jpg" /></c:if>
     <c:if test="${vs.count eq 4}"> <img src="../styles/member/sjb/images/rightbg8.jpg" /></c:if>
     </div>
	<div class="clear"></div>
</div>
</c:forEach>
...
<div class="maincont">
	<div class="left2">
	<img src="../styles/member/sjb/images/leftbg_2.jpg" />
	</div>
	<div class="m2">
	</div>
	<div class="right2">
      <img src="../styles/member/sjb/images/r2.jpg" />
     </div>
	<div class="clear"></div>
</div>
</c:if>
...
<div class="maincont">
  <div class="left4"><img src="../styles/member/sjb/images/leftbg4.jpg" /></div>
  <div class="midbox4">
	 <c:if test="${not empty entity.img_path}"> <img src="${ctx}/${fn:substringBefore(entity.img_path, '.')}.jpg" title="${entity.img_desc}" width="790" /></c:if> 
  </div>
...
<div class="maincont">
	<div class="left4"></div>
    <div class="midbox4">
		<div class="tit_integral" id="main3">小组赛积分</div>
        ...
        <div class="integraltab1" id="main6">
            ...
            <ul class="integteamul">
            <li class="curteam jf" style="width: 50px;" id="AA">1-4</li>
            <li class="jf" style="width: 50px;" id="BB">5-8</li>
            <li class="jf" style="width: 50px;" id="CC">9-12</li>
            <li class="jf" style="width: 50px;" id="DD">13-16</li>
            <li class="jf" style="width: 50px;" id="EE">17-20</li>
            </ul>
        	<table id="AA_AA" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:'';overflow-x:hidden;">
              <tr>
                <th width="15%">排名</th>
                <th width="23%">工卡号</th>
                <th width="17%">姓名</th>
              ...
              <c:forEach items="${jfList_1_4}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><span <c:if test="${vs.count eq 1}">class="number1"</c:if><c:if test="${vs.count eq 2}">class="number2"</c:if>>${vs.count}</span></td>
            ...
            <table id="BB_BB" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="15%">排名</th>
                <th width="23%">工卡号</th>
                <th width="17%">姓名</th>
              ...
              <c:forEach items="${jfList_5_8}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><span <c:if test="${vs.count eq 1}">class="number1"</c:if><c:if test="${vs.count eq 2}">class="number2"</c:if>>${vs.count+4}</span></td>
                <td>${cur.map.card_no}</td>
                <td>${cur.map.real_name}</td>
                <td>${cur.map.ww2_count}</td>
                <td>${cur.map.ww1_count}</td>
            ...
            <table id="CC_CC" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="15%">排名</th>
                <th width="23%">工卡号</th>
                <th width="17%">姓名</th>
              ...
              <c:forEach items="${jfList_9_12}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><span <c:if test="${vs.count eq 1}">class="number1"</c:if><c:if test="${vs.count eq 2}">class="number2"</c:if>>${vs.count+8}</span></td>
                <td>${cur.map.card_no}</td>
                <td>${cur.map.real_name}</td>
                <td>${cur.map.ww2_count}</td>
                <td>${cur.map.ww1_count}</td>
            ...
            <table id="DD_DD" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="15%">排名</th>
                <th width="23%">工卡号</th>
                <th width="17%">姓名</th>
              ...
              <c:forEach items="${jfList_13_16}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><span <c:if test="${vs.count eq 1}">class="number1"</c:if><c:if test="${vs.count eq 2}">class="number2"</c:if>>${vs.count+12}</span></td>
                <td>${cur.map.card_no}</td>
                <td>${cur.map.real_name}</td>
                <td>${cur.map.ww2_count}</td>
                <td>${cur.map.ww1_count}</td>
            ...
            <table id="EE_EE" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="15%">排名</th>
                <th width="23%">工卡号</th>
                <th width="17%">姓名</th>
              ...
              <c:forEach items="${jfList_17_20}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><span <c:if test="${vs.count eq 1}">class="number1"</c:if><c:if test="${vs.count eq 2}">class="number2"</c:if>>${vs.count+16}</span></td>
                <td>${cur.map.card_no}</td>
                <td>${cur.map.real_name}</td>
                <td>${cur.map.ww2_count}</td>
                <td>${cur.map.ww1_count}</td>
        ...
        <div class="integraltab1" id="main4">
            ...
            <ul class="integteamul">
            <li class="curteam jc" style="width: 15px;"  id="X1">1</li>
            <li class="jc" style="width: 15px;" id="X2">2</li>
            <li class="jc" style="width: 15px;" id="X3">3</li>
            <li class="jc" style="width: 15px;" id="X4">4</li>
            <li class="jc" style="width: 15px;" id="X5">5</li>
            <li class="jc" style="width: 15px;" id="X6">6</li>
            <li class="jc" style="width: 15px;" id="X7">7</li>
            <li class="jc" style="width: 15px;" id="X8">8</li>
            <li class="jc" style="width: 15px;" id="X9">9</li>
            <li class="jc" style="width: 25px;" id="X10">10</li>
            <li class="jc" style="width: 25px;"  id="X11">11</li>
            <li class="jc" style="width: 25px;" id="X12">12</li>
            <li class="jc" style="width: 25px;" id="X13">13</li>
            <li class="jc" style="width: 25px;" id="X14">14</li>
            <li class="jc" style="width: 25px;" id="X15">15</li>
            <li class="jc" style="width: 25px;" id="X16">16</li>
            </ul>
        	<table id="X1_X1" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:'';overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList1}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
            ...
            <table id="X2_X2" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList2}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X3_X3" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList3}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X4_X4" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList4}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X5_X5" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList5}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X6_X6" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList6}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X7_X7" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList7}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X8_X8" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList8}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X9_X9" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList9}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X10_X10" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList10}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X11_X11" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList11}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X12_X12" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList12}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X13_X13" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList13}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X14_X14" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList14}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X15_X15" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList15}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
            ...
            <table id="X16_X16" width="100%" border="0" cellspacing="0" cellpadding="0" class="gametabel" style="display:none;overflow-x:hidden;">
              <tr>
                <th width="16%">时间</th>
                <th width="50%">竞猜记录</th>
                <th width="17%">竞猜积分</th>
               ...
               <c:forEach items="${grList16}" var="cur" varStatus="vs">
              <tr <c:if test="${vs.count mod 2 eq 0}"> class="orgtd" </c:if>>
                <td><fmt:formatDate value="${cur.guess_date}" pattern="MM-dd" /></td>
                <td>${cur.map.team_a}-${cur.map.team_b}(
                <c:if test="${cur.guess_win eq 0}">${cur.map.team_a}赢</c:if> 
...
<div class="maincont">
    ...
    <div class="midbox5" id="main5">
        ...
        <div class="introtab">
            ...
            <p>4.竞猜积分：猜对一场比赛输赢获30奖励积分；猜对一场比分获50奖励积分，猜错一场比赛比分扣减15分；</p>
...
$(document).ready(function(){
	...
	// A,B,C,D组切换 
	$(document).delegate(".pd_content", "hover", function(){
	...
	// E,F,G,H组切换
	$(document).delegate(".pd_content_2", "hover", function(){
		$(this).attr("hover", "hover"); // 这里标记鼠标指向的那个图片
	...
	//  积分排行 1-20
	$(document).delegate(".jf", "hover", function(){
		$(this).attr("hover", "hover"); // 这里标记鼠标指向的那个图片
		...
		$(".jf").each(function(){
			var id = $(this).attr("id");
		    if($(this).attr("hover") == "hover"){
				 $(this).removeClass("curteam jf").addClass("curteam jf");
				 $("#" + id + "_" + id).show();
				 
			} else {
				$(this).removeClass("curteam jf").addClass("jf");
				 $("#" + id + "_" + id).hide();
			}
		});
...
//  个人竞猜1-64场
	$(document).delegate(".jc", "hover", function(){
		$(this).attr("hover", "hover"); // 这里标记鼠标指向的那个图片
		...
		$(".jc").each(function(){
			var id = $(this).attr("id");
		    if($(this).attr("hover") == "hover"){
				 $(this).removeClass("curteam jc").addClass("curteam jc");
				 $("#" + id + "_" + id).show();
				 
			} else {
				$(this).removeClass("curteam jc").addClass("jc");
				 $("#" + id + "_" + id).hide();
			}
		});
