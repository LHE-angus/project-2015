...
<div class="top_cont">
<div class="t_c">
<div class="logo" ><span class="l"><a href="${ctx}/zxmall/Index.do"><img src="${ctx}/styles/zxmall/images/zxmall3.jpg" /></a></span><span class="r"><img src="${ctx}/styles/zxmall/images/tel.gif" width="166" height="33" /></span></div>
</div>
</div>
</div>
<div class="clear"></div>
...
<font class="inf">会员身份验证</font> 
  ...
  <div class="login_int"><label><span class="s2"><i class="lg_redStar">&nbsp;*&nbsp;</i>用户名：</span><html-el:text property="user_name" styleClass="reUser_text" styleId="user_name" maxlength="15" /></label></div>
  ...
  <div class="login_int"><label><span class="s2"><i class="lg_redStar">&nbsp;*&nbsp;</i>手机号码：</span><html-el:text property="link_phone" styleClass="reUser_text" styleId="link_phone" maxlength="15" /></label></div>
...
$("#link_phone").attr("datatype", "Require").attr("msg", "手机号码不能为空！");
