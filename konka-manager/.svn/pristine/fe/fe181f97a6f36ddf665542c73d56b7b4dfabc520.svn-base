...
<body style="font-family: Microsoft Yahei;">
		...
		<div class="rtabcont2">
			<div class="tab1" style="overflow-x: auto;">
				<html-el:form  action="KonkaOrderInfoTransKh.do" method="post">
					  ...
					  <c:if test="${not empty entityList}">
							<c:forEach var="cur" items="${entityList}" varStatus="vs">
								<table width="100%" id="fhdetails" border="0" cellspacing="0" cellpadding="0" 
						           class="rtable2" style="margin-top: 10px;">
									<tr class="tabtt1"><html-el:hidden property="ensu_id" styleId="ensu_id" value="${cur.ensu_id}"/>
									<td align="right" nowrap="nowrap">物流交货单号</td><td nowrap="nowrap" align="left">${cur.r3_vbedl }</td>		
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">订单流水号</td><td nowrap="nowrap" align="left">${cur.trade_index }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">发货单号</td><td nowrap="nowrap" align="left"><div class="div_trans_index_detail">${cur.trans_index_detail }</div></td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">提交日期</td><td nowrap="nowrap" align="left"><fmt:formatDate value="${cur.add_date }" pattern="yyyy-MM-dd"/></td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">客户名称</td><td nowrap="nowrap" align="left">${cur.map.customer_name }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">型号</td><td nowrap="nowrap" align="left">${cur.model_name }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">数量</td><td nowrap="nowrap" align="left">${cur.model_num }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">已发货数量</td><td nowrap="nowrap" align="left">${cur.trans_num }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">已签收数量</td><td nowrap="nowrap" align="left">${empty cur.trans_ensured_num?0:cur.trans_ensured_num }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">未签收数量 <input type="hidden" name="trans_unensu_num" value="${cur.trans_num-cur.trans_ensured_num }"/></td><td nowrap="nowrap" align="left">${cur.trans_num-cur.trans_ensured_num }</td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">本次签收数量<font color="red">*</font></td><td nowrap="nowrap" align="left"><html-el:text property="trans_ensu_num" styleId="trans_ensu_num" styleClass="trans_ensu_num" onfocus="setOnlyInt(this)"/></td>
									</tr>
									<tr class="tabtt1">
									<td align="right" nowrap="nowrap">签收说明</td><td nowrap="nowrap" align="left"><html-el:text property="trans_ensu_desc" styleId="trans_ensu_desc" styleClass="webinput" maxlength="200"/></td>
									</tr>
								</table>
							</c:forEach>
						</c:if>
					...
					<!--上面的详情list---end -->
					<table id="fhdetails" border="0" cellspacing="0" cellpadding="0" 
						           class="rtable2" style="margin-top: 10px;">
					<tr class="tabtt1">
						<td align="right" nowrap="nowrap">签收人姓名</td>
					...
					<tr class="tabtt1">
						<td align="right" nowrap="nowrap">收货时间</td>
