...
<div class="oarcont" id="body_oarcont">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        ...
        <tr>
          ...
          <td><strong class="fb">销售状态：</strong>
            <html-el:select property="sell_type">
          ...
          <td><strong class="fb">上报时间：</strong>
            <html-el:text property="add_date_start"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
            至
            <html-el:text property="add_date_end"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2011, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" /></td>
  ...
  <div class="rtabcont1">
    ...
    <form id="listForm" name="listForm" method="post" action="KonkaSell.do?method=delete">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <!-- <td nowrap="nowrap">${cur.customer_type}</td>
            <td nowrap="nowrap">${fn:escapeXml(cur.area_name)}</td>
            <td nowrap="nowrap">${fn:escapeXml(cur.handle_name)}</td> -->
            <td nowrap="nowrap"><%@ include file="../_inc/view_fgs_jyb_bsc_ywy_name.jsp" %></td>
            <td align="center"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaSell.do','toSell' ,'r3_shop_id=${cur.id}&' + $('#bottomPageForm').serialize())">数据上报</span></td>
          </tr>
    ...
    <br />
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaSell.do">
