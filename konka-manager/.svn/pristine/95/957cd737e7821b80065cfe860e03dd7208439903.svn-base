	...
	<div class="navTab-panel tabsPageContent">
		<div class="page">
			<div class="pageHeader">
				<html-el:form action="/admin/KonkaMobileReportHistory">
			...
			<div class="pageContent">
				<form id="listForm" name="listForm" method="post" action="KonkaMobileReportHistory.do?method=delete">
					<input type="hidden" name="method" id="method" value="delete" />
					<input type="hidden" name="mod_id" id="mod_id" value="${af.map.mod_id}" />
					<div class="panelBar">
						<ul class="toolBar">
							<logic-el:match name="popedom" value="+1+">
								<li><a class="add" onclick="location.href='KonkaMobileReportHistory.do?method=add&mod_id=${af.map.mod_id}';"><span>添加</span></a></li>
							</logic-el:match>
					...
					<table class="list" width="100%">
						...
						<tr>
							...
							<th nowrap="nowrap" align="center">1.销售数据上报
2.退货
3.终端
4.竞品</th>
							<th nowrap="nowrap" align="center">content</th>
							<th nowrap="nowrap" align="center">report_man</th>
							<th nowrap="nowrap" align="center">report_time</th>
						...
						<tr>
							...
							<td align="left" nowrap="nowrap">${cur.type}</td>
							<td align="left" nowrap="nowrap">${cur.content}</td>
							<td align="left" nowrap="nowrap">${cur.report_man}</td>
							<td align="left" nowrap="nowrap">${cur.report_time}</td>
							<td align="center">
							<logic-el:match name="popedom" value="+2+">
								<span style="cursor:pointer;" onclick="confirmUpdate(null, 'KonkaMobileReportHistory.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span>
							</logic-el:match>
							<logic-el:notMatch name="popedom" value="+2+">
								<span style="color:#CCC;">修改</span>
							</logic-el:notMatch>
							<logic-el:match name="popedom" value="+4+">
								<span style="cursor:pointer; margin-left:7px;" onclick="confirmDelete('确定删除吗?', 'KonkaMobileReportHistory.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())">删除</span>
							</logic-el:match>
							<logic-el:notMatch name="popedom" value="+4+">
				...
				<form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaMobileReportHistory.do">
