...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcGiftOrdeConfirm">
  ...
  <div class="rtabcont1">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcGiftOrdeConfirm.do','confirm' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">确认收货</span>
              </c:if>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcGiftOrdeConfirm.do">
