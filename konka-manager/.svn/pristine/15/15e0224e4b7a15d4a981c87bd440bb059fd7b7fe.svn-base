...
var url="${ctx}/zxmall/FlvPlayer.do?method=view&id=${af.map.id}&width=720&height=426";
var img_url="${ctx}/zxmall/FlvPlayer.do?method=showImg&id=${af.map.id}&width=720&height=426"; 
function showdiv() {  
...
<body> 
<div id="eppFlvPlayer_1" style="width:<c:out value="${empty width ? 315:width  }"/>px;margin-top:-1px;" >
