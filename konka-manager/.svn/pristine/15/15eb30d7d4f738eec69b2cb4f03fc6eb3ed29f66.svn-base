...
/**
 * 解析主动通知的消息，解析成SDK中自带的NotifyItem,NotifyRefund,NotifyTrade,NotifyTopats
 * 
...
public class MessageDecode {
	...
	public static final String NOTIFY_TOPATS = "notify_topats";
	...
	public static Object decodeMsg(String msg) throws ApiException {
		...
		if (rootObj instanceof Map<?, ?>) {
			...
			} else if (rootJson.containsKey(NOTIFY_TOPATS)) {
				clazz = NotifyTopats.class;
			}
