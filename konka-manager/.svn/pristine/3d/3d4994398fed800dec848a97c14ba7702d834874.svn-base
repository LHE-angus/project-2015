...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/chengduoa/DocIssue">
  ...
  <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <input style="align:left" name="button" type="button"  value="新增" class="but2" onclick="location.href='DocIssue.do?method=add&mod_id=${af.map.mod_id}';" />
        </logic-el:match>
    ...
    <form id="listForm" name="listForm" method="post" action="DocIssue.do?method=delete">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        ...
        <tr class="tabtt1">
          ...
          <td width="80" nowrap="nowrap" align="center">公文类别</td>
          <td width="120" nowrap="nowrap" align="center">发布时间</td>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="left" valign="top" ><span style="cursor:pointer;" onclick="doNeedMethod(null, 'DocIssue.do', 'view', 'id=${cur.id}&mod_id=${af.map.mod_id }&' + $('#bottomPageForm').serialize())">${cur.file_no}</span></td>
              ...
              <td align="center" valign="top"><c:choose>
                  <c:when test="${cur.doc_type eq 0}">公告信息 </c:when>
                  <c:when test="${cur.doc_type eq 1}">公文下发 </c:when>
                </c:choose>
             </td>
