...
<div class="oarcont">
  ...
  <div>
    <h3 align="center" ><strong class="fb">${type_name}信息查看</strong></h3>
  </div>
  <div class="rtabcont2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      ...
      <tr >
        <td height="28" width="15%" nowrap="nowrap" class="title">${type_name}标题：</td>
        <td><c:out value="${entity.title}" /></td>
      </tr>
      <tr >
        <td height="28" width="15%" nowrap="nowrap" class="title">${type_name}类别名称：</td>
