...
<jsp:include page="/zxmall/__inc/_nav.jsp" flush="true" />
<div class="hotsell" style="margin-bottom:5px;">
	<div class="hotsell_l" style="width:876px;">
        ...
        <c:forEach items="${bcomp_pd_list_tj_5}" var="cur" varStatus="vs" end="4">
        	<ul>
            	<li><a href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />"><img src="${ctx}/${cur.main_pic}" width="160" height="105" /></a></li>
                <li class="name"><a href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />"><span style="word-wrap:break-word;word-break:break-all;">${fnx:abbreviate(cur.pd_name, 2 * 30, '')}</span></a></li>
                <c:if test="${zxmall.user_type eq 2 or empty zxmall}"> <li class="price" style="margin-left:0"><b>￥<fmt:formatNumber value="${cur.ecGoodsPrice.price}" pattern="0" /></b> <span>市场价 ￥<fmt:formatNumber value="${cur.ecGoodsPrice.original_price}" pattern="0" /></span></li></c:if>
           		<c:if test="${zxmall.user_type eq 22 }"> <li class="price" style="margin-left:0"><b>￥<fmt:formatNumber value="${cur.ecGoodsPrice.original_price}" pattern="0" /></b><font color="#005AA0" > 已售出：${cur.sale_num}件</font> </li></c:if>
            </ul>
        </c:forEach>    
        </div>
    </div>
    <div class="hotsell_r" style="width:316px;">
    	<div class="information" style="width:316px;">
		    ...
		    <iframe border="0" src="${ctx }/zxmall/FlvPlayer.do?method=showImg&id=838505&height=249" frameborder="0" marginheight="0" marginwidth="0" width="312" height="249" scrolling="no"></iframe>
		    </div>
	    </div>
    </div> 
</div>
<div class="logo2">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=0&label_of_cate=0" title="更多新品"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多新品&nbsp;&nbsp;&nbsp;&nbsp;</font></a></div>
  ...
  <div class="m1-l">
    <table border="0" width="1200" height="608"  cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="276" width="294px"><div class="com"><a href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}&nbsp;${cur.pd_name}"><img src="${ctx}/${cur.main_pic}" height="216" width="288"/></a>
           <div class="price">
	         <a href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}&nbsp;${cur.pd_name}">康佳<c:out value="${cur.pd_sn}" /> 
              <div><font class="redfont">${fnx:abbreviate(cur.pd_name, 2 * 16, '')}</font></div></a>
             </div>
            <div class="pri"> <c:if test="${zxmall.user_type eq 2 or empty zxmall}">
            <font color="#d40207" style="font-size:14px">￥<font style="font-size:18px"><fmt:formatNumber value="${cur.ecGoodsPrice.price}" pattern="0" /></font></font>
             ...
             </c:if><c:if test="${zxmall.user_type eq 22 }"> 
...
<div class="logo5">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=0&label_of_cate=7"  title="更多精品"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多精品&nbsp;&nbsp;&nbsp;&nbsp;</font></a></div>
</div>
...
<div class="logo3">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=0&label_of_cate=2"  title="更多热销"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多热销&nbsp;&nbsp;&nbsp;&nbsp;</font></a></div>
...
<div class="clear"></div> 
<div class="logo4"><div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=0&label_of_cate=3"  title="更多特惠"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多特惠&nbsp;&nbsp;&nbsp;&nbsp;</font></a></div></div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">  
      <tr>
...
<div class="logo_bx">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=4" title="更多冰箱"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多冰箱&nbsp;&nbsp;&nbsp;&nbsp;</font></a></div>
</div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
...
<div class="logo_xyj">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=5"  title="更多洗衣机"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多洗衣机&nbsp;&nbsp;&nbsp;</font></a></div>
</div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
...
<!--div class="logo5">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=6">更多</a></div>
</div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
...
<div class="logo_shdq">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=3" title="更多生活电器"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多生活电器&nbsp;</font></a></div>
</div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
...
<div class="logo_sj">
  <div class="lef"><a href="${ctx}/zxmall/KonkaBcompPd.do?prod_type=7"  title="更多手机"><font color="#ffffff" style="font-size:12px;font-weight: normal;font-family: 宋体;">更多手机&nbsp;&nbsp;&nbsp;</font></a></div>
</div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
...
<div class="tab">
  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#e3e3e3" >
    ...
    <c:forEach items="${bcomp_pd_list_top_8}" var="cur">
      <td align="center">
      <div class="sz"><a title="${cur.pd_name}" href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />"><img alt="${cur.pd_name}" height="92" width="128" src="${ctx}/${cur.main_pic}" style="max-height:100px;" /></a></div>
      <div style="text-align:center; margin-top:10px;"><a href="<c:url value='/zxmall/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}" style="font-size:13px;font-color:#666666;">康佳&nbsp;${fnx:abbreviate(cur.pd_sn, 2 * 7, '.')}</a></div>
      </td> 
    </c:forEach>
    </tr>
  </table>
