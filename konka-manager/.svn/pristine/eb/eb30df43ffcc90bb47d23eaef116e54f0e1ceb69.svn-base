...
<div id="content" style="margin:20px 10px 20px 10px; min-height:450px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="ph_ts_table">
            <tbody>
                <tr>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_1.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_2.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_3.jpg"></td>
                </tr>
                <tr>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_4.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_5.jpg"></td>
                    <td><img alt="" src="${ctx}/styles/shop/images/ph_teshe_pic_6.jpg"></td>
                </tr>
            </tbody>
        </table>
        </div>
