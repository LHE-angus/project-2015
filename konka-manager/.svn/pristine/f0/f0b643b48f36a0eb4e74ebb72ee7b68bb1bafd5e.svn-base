          ...
          <td>
           ...
           <html-el:select property="year_id" styleId="year_id">
           	...
           	<html-el:select property="month_id" styleId="month_id">
                ...
                <html-el:option value="${cur.id}">${cur.month}</html-el:option>
              </c:forEach>
           	</html-el:select>
<!--            &nbsp;&nbsp; -->
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td colspan="3" nowrap="nowrap" align="center" width="24%">上一月度(${month_pre }月份)</td>
        <td colspan="3" nowrap="nowrap" align="center" width="24%">本月度(${month_now }月份)</td>
        <td colspan="5" nowrap="nowrap" align="center" width="40%">(${month_now }月份)结算区间(万元)</td>
       </tr>
      <tr class="tabtt1">
