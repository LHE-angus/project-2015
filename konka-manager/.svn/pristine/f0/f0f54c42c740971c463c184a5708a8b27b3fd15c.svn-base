...
<div class="oarcont" style="margin-bottom: 100px;">
    ...
    <table width="500" border="0" cellpadding="0" cellspacing="0">
 	...
 	<div class="rtabcont2">
    <html-el:form action="/spgl/EcLogoInfo" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td><c:if test="${not empty (af.map.logo_url)}" var="hasImage"> <img src="${af.map.logo_url}" title="${af.map.remark}" width="180px;" height="120px;" /> <br />
            ...
            <c:if test="${empty (af.map.logo_url)}">
        ...
        <tr>  
         ...
         <tr>
          <td nowrap="nowrap" class="title_item"><span style="color: #F00;">* </span>LOGO类型：</td>
          <td>
