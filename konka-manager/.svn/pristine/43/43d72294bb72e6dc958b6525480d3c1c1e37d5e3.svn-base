...
import com.weixin.popular.bean.pay.PayFeedback;
import com.weixin.popular.bean.pay.PayNativeInput;
import com.weixin.popular.bean.pay.PayNotify;
import com.weixin.popular.bean.pay.PayWarn;
