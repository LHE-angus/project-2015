...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaR3ShopDevNew">
        ...
        <tr>
          <td height="15" align="left" style="padding-left:5px;">
	    	 ...
	    	 <html-el:option value="">-请选择-</html-el:option>
		       ...
		       &nbsp;&nbsp;&nbsp;&nbsp;
		              <strong>   开始日期：</strong>
          	    <html-el:text property="begin_time" styleId="begin_time"  size="20" maxlength="10" readonly="true" onclick="new Calendar(2010, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
				&nbsp;&nbsp;&nbsp;&nbsp;<strong>结束日期：</strong>
				<html-el:text property="end_time" styleId="end_time"  size="20" maxlength="10" readonly="true" onclick="new Calendar(2010, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
               &nbsp;&nbsp; <strong> 开拓状态：</strong>
		       <html-el:select property="state" styleId="state" style="width:80px;">
	               <html-el:option value="">请选择</html-el:option>
        	 ...
        	 <br/>
        	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>客户名称：</strong>
        	 <html-el:text property="cust_name_like" maxlength="30" title="客户名称不能超过30个字符"></html-el:text>&nbsp;&nbsp;&nbsp;
        	 <strong>联系人姓名：</strong>
        	 <html-el:text property="link_man_name_like" maxlength="30" title="联系人姓名不能超过30个字符"></html-el:text>&nbsp;&nbsp;&nbsp;
        	  
        	<strong> 状态：</strong>
		      <html-el:select property="is_del" styleId="is_del" style="width:80px;">
		           <html-el:option value="">请选择</html-el:option>
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;&nbsp;<input type="button" class="but2" value="新 增" onclick="location.href='KonkaR3ShopDevNew.do?method=add&mod_id=${af.map.mod_id}';" />
  ...
  <div class="rtabcont1" style="overflow-x:auto;">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td  nowrap="nowrap" align="center">联系人姓名</td>
        <td  nowrap="nowrap" align="center">联系人电话</td>
        <td  nowrap="nowrap" align="center">客户地址</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
         ...
         <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaR3ShopDevNew.do','edit' ,'cust_id=${cur.cust_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())"')"> ${cur.cust_name}</span>
         </td> 
          <td align="center" nowrap="nowrap">
          <c:out value="${fn:substring(cur.link_man_name, 0, fn:length(cur.link_man_name)-1)}" />
          </td> 
           <td align="center" nowrap="nowrap">
           <c:out value="${fn:substring(cur.link_man_tel, 0, fn:length(cur.link_man_tel)-1)}" />
           </td> 
         ...
         <td align="left" nowrap="nowrap" title="${cur.link_man_addr}">
          ...
          <c:set var="num" value="${fn:length(tt)}" />
	       ...
	       <td align="center">
	       	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaR3ShopDevNew.do','view' ,'cust_id=${cur.cust_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())"')">查看</span>&nbsp;
	       	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaR3ShopDevNew.do','edit' ,'cust_id=${cur.cust_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())"')">修改</span>&nbsp;
	       	<c:if test="${cur.is_del eq 0}">
            	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('确定要删除吗?', 'KonkaR3ShopDevNew.do','delete' ,'cust_id=${cur.cust_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())"')">删除</span>&nbsp; 
          		</c:if>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaR3ShopDevNew.do">
        ...
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;">
              ...
              <script type="text/javascript">
								...
								pager.addHiddenInputs("customer_name_like", "${af.map.cust_name_like}");
