    ...
    <br/>
		<div class="content-primary"> 
			<ul data-role="listview" data-inset="true" data-theme="b" data-divider-theme="a">
				...
				<li><a href="${ctx}/m/admin/SalesReports.do">销售数据</a></li>
				<li><a href="${ctx}/m/admin/SalesReport.do">退货数据</a></li>
				...
				<li><a href="${ctx}/mobile/admin/FilesSubmit.do" data-ajax="false">办公1</a></li>
				<li><a href="${ctx}/mobile/admin/FilesManager.do">办公2</a></li>
			</div>
      </nav>
    </div>
  </div>
