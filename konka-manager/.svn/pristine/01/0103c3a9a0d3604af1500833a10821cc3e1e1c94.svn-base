...
<div class="maincont">
  ...
  <div class="zxmall_right padbot45">
    <div class="position"><a href="${ctx }/zxmall/Index.do">首页</a> &gt; <a href="${ctx }/zxmall/center/Index.do">会员中心</a> &gt; 我的抽奖</div>  
        ...
        <tbody>
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr height="60">
              ...
              <td align="left" nowrap="nowrap"><a href="${ctx }/zxmall/Lucky.do?lucky_id=${cur.lucky_id }"><c:out value="${cur.title }"/></a></td>
