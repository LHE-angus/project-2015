...
<body>
<div class="oarcont">
  <div class="rtabcont2" style="height: 400px;">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td>
            ...
            <html-el:button property="" value="返 回" styleClass="but5" styleId="btn_back" onclick="location.href = '${ctx}/manager/spgl/EcGoodsPriceModifyForTouchNet.do?method=list2&mod_id=${af.map.mod_id}&goods_id=${af.map.goods_id}&own_sys=${af.map.own_sys}' " />
          </td>
        </tr>
      </table>
    </html-el:form>
