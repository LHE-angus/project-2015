...
<div class="oarcont">
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaXxZmdApplyCreditLine.do">
      ...
      <div style="text-align:left;margin-left:5px;margin-top:-5px;margin-bottom:5px;">
        ...
        <input type="button" class="but2" onclick="location.href='KonkaXxZmdApplyCreditLine.do?method=add&mod_id=${af.map.mod_id}'" value="添加" />
      </div>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <td align="right" nowrap="nowrap"><span class="kz-price-12">
              <fmt:formatNumber type="currency" value="${cur.money}" />
              </span></td>
            ...
            <td align="center" nowrap="nowrap"><c:if test="${cur.audit_state lt 1}"> <span style="cursor:pointer;" class="fblue" onclick="confirmUpdate(null, 'KonkaXxZmdApplyCreditLine.do', 'acc_id=${cur.acc_id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">修改</span> |&nbsp;<span style="cursor:pointer;" class="fblue" onclick="confirmDelete('确定删除？', 'KonkaXxZmdApplyCreditLine.do', 'acc_id=${cur.acc_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">删除</span>
              ...
              <c:if test="${cur.audit_state eq 1}"> <span style="color:#ccc">修改</span> |&nbsp;<span style="color:#ccc">删除</span> </c:if></td>
          </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaXxZmdApplyCreditLine.do">
