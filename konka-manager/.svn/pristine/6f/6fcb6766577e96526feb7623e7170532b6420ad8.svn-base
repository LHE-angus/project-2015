    ...
    <html-el:form action="/chengduoa/DocIssue" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td><html-el:radio property="doc_type" styleId="doc_type0" value="0" />
            <label for="doc_type0" id="u_doc_type0">&nbsp;公告信息</label>
            <html-el:radio property="doc_type" styleId="doc_type1" value="1" />
            <label for="doc_type1" id="u_doc_type1">&nbsp;公文下发</label></td>
        </tr>
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr id="tr_select_dept" style="display:none;">
                  <td style="padding-left:22px;">选择部门
