	...
	<div class="navTab-panel tabsPageContent">
		<div class="page">
			<div class="pageContent">
				...
				<html-el:form action="/paragon/KonkaParagonSales" enctype="multipart/form-data">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="list">
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">sales_id：</td>
							<td width="88%" align="left"><html-el:text property="sales_id" size="40" maxlength="30" styleId="sales_id" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">sales：</td>
							<td width="88%" align="left"><html-el:text property="sales" size="40" maxlength="30" styleId="sales" /></td>
						</tr>
						<tr>
							<td width="12%" nowrap="nowrap" class="title_item" align="right">sale_year：</td>
							<td width="88%" align="left"><html-el:text property="sale_year" size="40" maxlength="30" styleId="sale_year" /></td>
						</tr>
						<tr>
...
$(document).ready(function(){
	$("#sales_id").attr("dataType", "Require").attr("msg", "请填写");
	$("#show_shop_code").attr("dataType", "Require").attr("msg", "请填写");
	$("#sales").attr("dataType", "Require").attr("msg", "请填写");
	$("#sale_year").attr("dataType", "Require").attr("msg", "请填写");
