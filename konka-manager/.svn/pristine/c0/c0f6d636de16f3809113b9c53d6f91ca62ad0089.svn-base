...
<div class="nav" style="margin-top:1px;">
  <div class="nav_box">
    <div class="nav_center">
      <div class="l">
        <ul>
          <li class="cur"><a href="${ctx}/customer/manager/PShow.do">首页</a></li>
          <li id="3d"><a href="${ctx}/customer/manager/PShow.do?method=list&label_3d=1&mark=3d">3D电视</a></li>
          <li id="int"><a href="${ctx}/customer/manager/PShow.do?method=list&label_int=1&mark=int">智能电视</a></li>
          <li id="www"><a href="${ctx}/customer/manager/PShow.do?method=list&label_www=1&mark=www">网络电视</a></li>
        </ul>
      </div>
