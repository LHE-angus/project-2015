  	...
  	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
  		...
  		<c:forEach var="cur" items="${entityList}" varStatus="vs">
  			<tr class="list-tr">
  				...
  				<td align="right" nowrap="nowrap" ><fmt:formatNumber value="${cur.r3_price}" pattern="#,##0.00"/></td> 
  				...
  				<td align="right" nowrap="nowrap"><c:if test="${not empty cur.all_price and cur.all_price ne 0}"><fmt:formatNumber value="${cur.stockmoney*100 / cur.all_price}" pattern="#,##0.00"/>%</c:if>
  					<c:if test="${empty cur.all_price or cur.all_price eq 0}">-</c:if>
  				</td>
