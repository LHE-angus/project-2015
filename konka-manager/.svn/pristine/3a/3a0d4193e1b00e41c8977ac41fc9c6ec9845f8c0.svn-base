...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/manager/TouchJieSuan">
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/customer/manager/TouchJieSuan.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/customer/manager/TouchJieSuan.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });
});
