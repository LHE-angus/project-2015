...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcPdEavl">
      <html-el:hidden property="method" value="list" />
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td height="36" align="left" style="padding-left:5px;">&nbsp;评论标题：
            <html-el:text property="eval_title_like" styleId="eval_title_like" styleClass="webinput"  maxlength="30" size="40"/>
            
            <input name="button" type="submit" class="bgSearch" id="button" value="搜 索" style="font-family:Microsoft YAHEI;" />
            
            <input type="button" value="Excel" id="export_excel" class="but_excel" style="margin-left: 10px;float:right;" /></td>
        </tr>
      </table>
    </html-el:form>
  </div>
  <div class="rtabcont1" style="overflow: auto;">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="left" nowrap="nowrap" title="${cur.eval_title}">${fn:escapeXml(fnx:abbreviate(cur.eval_title, 2 * 20, "..."))}</td>
          <td align="center" nowrap="nowrap"><fmt:formatDate value="${cur.eval_date}"  pattern="yyyy-MM-dd"></fmt:formatDate></td> 
          <td align="center" width="10%" nowrap="nowrap"><span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcPdEavl.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">回复</span></td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcPdEavl.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;"> 
              ...
              <script type="text/javascript">
								...
								pager.addHiddenInputs("eval_title_like", "${af.map.eval_title_like}");
...
$(document).ready(function(){
	$("#export_excel").click(function(){
   	 this.value="正在提交...";
   	 this.disabled=true;
   	 this.form.action="${ctx}/manager/spgl/EcPdEavl.do?method=excel";
   	 this.form.submit();
   	 this.form.action="${ctx}/manager/spgl/EcPdEavl.do";
   	 this.value="Excel";
   	 this.disabled=false;
   });
