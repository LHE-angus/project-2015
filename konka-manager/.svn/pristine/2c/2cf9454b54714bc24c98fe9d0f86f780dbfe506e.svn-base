...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/chengduoa/FilesArchive.do">
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td width="50" nowrap="nowrap" align="center">月份</td>
        <td width="80" nowrap="nowrap" align="center">事务类型</td>
        <td width="80" nowrap="nowrap">文件编号</td>
        <td nowrap="nowrap">文件主题</td>
        <td nowrap="nowrap" width="180">发放人/部门</td>
      ...
      <tbody>
        <c:forEach var='cur' items='${entityList}' varStatus="vs">
          <c:set var="ids" value="${ids},${cur.id }" />
            ...
            <td valign="top" align="left" ><c:choose>
