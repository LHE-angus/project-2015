...
<style type="text/css">
  ...
  input[type="button"]{
    background: url("../images/manager/but_return.gif") no-repeat scroll 0 0 rgba(0, 0, 0, 0);
    border: 0 none;
    color: #333;
    cursor: pointer;
    font: 12px/20px "宋体";
...
<!--  <div>-->
<%--  <h3 align="center" ><strong class="fb">查看“${af.map.store_id}”门店信息</strong></h3>--%>
<!--  </div>-->
	...
	<div class="rtabcont2">
        ...
        <tr>
          ...
          <td colspan="3">
          	<c:if test="${not empty af.map.province}">
          		<div style="color:#F00;">建议您按“${af.map.province}/${af.map.city}/${af.map.country}/${af.map.town}”选择</div>
          	</c:if>
        	<select name="_province" id="_province" class="bd">
            	<option value="">-请选择省/直辖市/自治区-</option>
          	</select>
          	<select name="_city" id="_city" class="bd">
            	<option value="">-请选择市-</option>
          	</select>
          	<select name="_country" id="_country" class="bd">
            	<option value="">-请选择县-</option>
          	</select>
          	<select name="_town" id="_town" class="bd">
