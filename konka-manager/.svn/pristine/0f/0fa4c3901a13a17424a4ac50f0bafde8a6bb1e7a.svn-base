...
<div class="oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/BaseProvinceListFour.do">
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="BaseProvinceListFour.do">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
       <tbody>
          ...
          <tr>
            ...
            <td align="center"><a href="BaseProvinceListFour.do?method=view&p_index=${cur.p_index}&mod_id=${af.map.mod_id}" title="${cur.p_index}" style="text-decoration:underline">${fn:escapeXml(cur.p_index)}</a></td>
            <td align="left" nowrap="nowrap">${fn:escapeXml(cur.p_name)}</td>
            <td align="left" nowrap="nowrap">${cur.s_name}</td>
            <td align="left" nowrap="nowrap"><c:if test="${cur.par_index ne 0}"><a href="BaseProvinceListFour.do?method=view&p_index=${cur.par_index}&mod_id=${af.map.mod_id}" title="${cur.map.par_name}" style="text-decoration:underline">${fn:escapeXml(cur.map.par_name)}</a></c:if><c:if test="${cur.par_index eq 0}">--</c:if> </td>
            <td align="left" nowrap="nowrap"><a href="BaseProvinceListFour.do?method=view&p_index=${cur.root_code}&mod_id=${af.map.mod_id}" title="${cur.map.root_name}" style="text-decoration:underline">${fn:escapeXml(cur.map.root_name)}</a></td>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="BaseProvinceListFour.do">
