...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaPeArticleInfoToFgs" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td><html-el:textarea property="summary" styleId="summary" cols="80" rows="10" style="resize:none"/>
