...
public class FTPClientTemplate {
	...
	public static FTPClientTemplate instance = null;

	public static FTPClientTemplate getInstance(String server, String user, String pwd, int port) {
		if (instance == null) {
			instance = new FTPClientTemplate(server, user, pwd, port);
		}
		return instance;
	}
	...
	private FTPClientTemplate(String server, String user, String pwd, int port) {
		this.server = server;
		this.username = user;
		this.password = pwd;
		this.port = port;
	...
	private FTPClientTemplate(String server, String user, String pwd) {
		this(server, user, pwd, 21);
	}

	/**
	 * the common interface method for ftp operations, only refer to this method if other methods don't meed your need.<br>
	 * with your own FtpTransferCallback implementation, you can do almost everything that you can do with FTPClient.<br>
	 * 
	 * @param callback The FtpTransferCallback instance
	 * @throws IOException some thing goes wrong while ftp operations.
	 */
