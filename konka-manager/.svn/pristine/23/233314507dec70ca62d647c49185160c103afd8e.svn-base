...
<div class="mainbox">
	<div class="maincont">    
<form action="<c:url value='/epp/mobile/Payment.do' />" method="post" id="pay_form" target="_blank">
  ...
  <table style="width:100%;">
  	 <tr>
  		...
  		<td width="60%" align="center"><p style="margin-top:10px;">稍后支付&gt;&gt;<a href="${ctx }/epp/mobile/center/Orders.do?method=list&orderState=1">查看我的订单</a></p></td>
	  </tr>
...
$(document).ready(function(){ 
	...
	$(document).delegate("#heckOrderStatus", "click", function(){
		location.href = "${ctx}/epp/mobile/Payment.do?method=checkOrderStatus&trade_index=${af.map.trade_index}"
	}); 
