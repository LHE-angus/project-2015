...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
		...
		<tr>
			<td nowrap="nowrap" class="title_item" align="right">申请人：</td>
			<td align="left">
				${af.map.apply_user_name}
			</td>
		</tr>
          <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right">是否需要加密：</td>
          <td width="88%" align="left">
          <c:if test="${not empty af.map.vouchers_pwd}">需要</c:if>
          <c:if test="${empty af.map.vouchers_pwd}">不需要</c:if>
          </td>
        </tr>
          <tr>
