  ...
  <div class="oartop">
    <table width="400" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td>当前位置：决策分析 &gt; 客户结算分析</td>
      </tr>
    </table>
  </div>
  
 <div class="rtabcont1" style="margin:1px; ">
  <html-el:form action="/admin/ChannelCustomerBillingAnalysis2.do" >
   ...
   <div class="rtabcont1" style="overflow: scroll; height: 500px">
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2" >
     <tr class="tabtt1">
			<td width="30" align="center" nowrap="nowrap">序号</td>
			<td align="center" nowrap="nowrap" id="ah" >分公司</td>
			<td align="center" nowrap="nowrap" id="bh" >经营部</td>
			<td align="center" nowrap="nowrap" id="ch" >办事处</td>
			<td align="center" nowrap="nowrap" id="dh" >售达方</td>
			<td align="center" nowrap="nowrap" id="eh" >送达方</td>
			<td align="center" nowrap="nowrap" id="fh" >客户类型</td>
			<td align="center" nowrap="nowrap" id="gh" >业务员</td>
			<td align="center" nowrap="nowrap" id="hh" >机型</td>
			...
			<td align="center" nowrap="nowrap">数量（上年同期）</td>
			<td align="center" nowrap="nowrap">总金额（含税）（上年同期）</td>
			<td align="center" nowrap="nowrap">增长率（数量）</td>
			<td align="center" nowrap="nowrap">增长率（金额）</td>
		</tr>
		<c:forEach var="cur" items="${entityList}" varStatus="vs">
	        <tr>
	            <td align="center" nowrap="nowrap">${(af.map.pager.currentPage - 1)*af.map.pager.pageSize + vs.count}</td>
            	<td align="center" nowrap="nowrap" id="al" >${cur.fgs_name}</td>
            	<td align="center" nowrap="nowrap" id="bl" >${cur.jyb_name}</td>
				<td align="center" nowrap="nowrap" id="cl" >${cur.bsc_name}</td>
				<td align="center" nowrap="nowrap" id="dl" >${cur.column_1}</td>
            	<td align="center" nowrap="nowrap" id="el" >${cur.column_5}</td>
            	<td align="center" nowrap="nowrap" id="fl" >${cur.customerTypeName}</td>
            	<td align="center" nowrap="nowrap" id="gl" >${cur.userName}</td>
            	<td align="center" nowrap="nowrap" id="hl" >${cur.column_11}</td>
	            <td align="center" nowrap="nowrap">${cur.c_all_amount}</td>
	            <td align="center" nowrap="nowrap">${cur.c_all_money}</td>
	            <td align="center" nowrap="nowrap">${cur.c_all_k007}</td>
	            <td align="center" nowrap="nowrap">${cur.c_all_rb00}</td>
	            <td align="center" nowrap="nowrap">${cur.p_all_amount}</td>
	            <td align="center" nowrap="nowrap">${cur.p_all_money}</td>
	            <td align="center" nowrap="nowrap">${cur.p_amount} %</td>
	            <td align="center" nowrap="nowrap">${cur.p_money} %</td>
	        </tr>
		</c:forEach>
    </table>
