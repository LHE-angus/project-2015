...
<div class="oarcont" id="body_oarcont">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr style="height:25px;">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<strong class="fb">客户R3编码：</strong>
            <html-el:text property="r3_code_like" styleId="r3_code_like" style="width:160px;" />&nbsp;&nbsp;&nbsp;&nbsp;
            <strong class="fb">触网类型：</strong><html-el:select property="user_type" styleId="user_type" >
                <html-el:option value="">请选择...</html-el:option>
         ...
         <strong class="fb">&nbsp;&nbsp;&nbsp;&nbsp;姓名：</strong>
            <html-el:text property="name_like" styleId="name_like" style="width:160px;" />&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <input class="but2" type="submit" name="Submit2" value="新增" onclick="location.href='EcUser2.do?method=add&mod_id=${af.map.mod_id}&tree_param=${tree_param}';return false;" />
        </logic-el:match>
        </td>
      </tr>
    </table>
  ...
  <div class="rtabcont1" style="overflow-x:auto; ">
    <form id="listForm" name="listForm" method="post" action="EcUser2.do">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tbody>
          <tr class="tabtt1">
            ...
            <td width="10%" nowrap="nowrap" ><font class="blue">客户R3编码</font></td>
            <td width="10%" nowrap="nowrap" ><font class="blue">触网类型</font></td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td  nowrap="nowrap" align="left" valign="middle"><a style="text-decoration:underline;" href="EcUser2.do?method=view&user_id=${cur.id}&mod_id=${af.map.mod_id}">${cur.real_name}</a></td>
              ...
              <td  nowrap="nowrap" align="center"><a style="text-decoration:underline;" href="EcUser2.do?method=view3&user_id=${cur.id}&mod_id=${af.map.mod_id}"><c:out value="${not empty cur.map.pay_integral ? cur.map.pay_integral:0.00 }" /></a></td>
              <td  nowrap="nowrap" align="center"><c:out value="${cur.map.jlScore}" /></td>
              <td  nowrap="nowrap" align="center"><a style="text-decoration:underline;" href="EcUser2.do?method=view3&user_id=${cur.id}&mod_id=${af.map.mod_id}"><c:out value="${not empty cur.map.da_score ? cur.map.da_score:0.00 }" /></a></td>
              <td  nowrap="nowrap" align="center"><a style="text-decoration:underline;" href="EcUser2.do?method=view3&user_id=${cur.id}&mod_id=${af.map.mod_id}">
              ...
              <td  nowrap="nowrap" align="center"><a style="text-decoration:underline;" href="EcUser2.do?method=view1&user_id=${cur.id}&mod_id=${af.map.mod_id}"><c:out value="${not empty cur.map.da_rebates ? cur.map.da_rebates:0.00 }" /></a></td>
              <td  nowrap="nowrap" align="center"><a style="text-decoration:underline;" href="EcUser2.do?method=view2&user_id=${cur.id}&mod_id=${af.map.mod_id}"><c:out value="${not empty cur.map.wa_rebates ? cur.map.w_rebates:0.00 }" /></a></td>
              ...
              <c:if test="${cur.is_del eq 0}">
                  ...
                  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcUserScoreRec.do', 'list','user_id=${cur.id}&mod_id=${af.map.mod_id }&'+$('#bottomPageForm').serialize())">会员积分</span>
                    ...
                    |
                   <logic-el:match name="popedom" value="+2+"><span style="cursor:pointer;" class="fblue" onclick="if(confirm('是否重置？')){doNeedMethod(null, 'EcUser2.do', 'initPassword','user_id=${cur.id}&'+$('#bottomPageForm').serialize())}" title="重置密码">登录密码重置</span></logic-el:match>
                   <logic-el:notMatch name="popedom" value="+2+"><span style="color:#ccc" class="fblue" title="重置密码">登录密码重置</span></logic-el:notMatch>
                 |
                 <logic-el:match name="popedom" value="+2+"><span style="cursor:pointer;" class="fblue" onclick="if(confirm('是否重置？')){doNeedMethod(null, 'EcUser2.do', 'initPassword2','user_id=${cur.id}&'+$('#bottomPageForm').serialize())}" title="重置密码">支付密码重置</span></logic-el:match>
                   <logic-el:notMatch name="popedom" value="+2+"><span style="color:#ccc" class="fblue" title="重置密码">支付密码重置</span></logic-el:notMatch>
                  |
                  <logic-el:match name="popedom" value="+2+">
                  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcUser2.do', 'edit','user_id=${cur.id}&'+$('#bottomPageForm').serialize())">修改</span>
                  </logic-el:match>
                  ...
                  |
                  <logic-el:match name="popedom" value="+2+">
                  <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcUser2.do', 'audit','user_id=${cur.id}&'+$('#bottomPageForm').serialize())">审核</span>
                  </logic-el:match>
                  <logic-el:notMatch name="popedom" value="+2+">
                  ...
                  |
                  <logic-el:match name="popedom" value="+2+">
                  <span class="fblue" style="cursor:pointer;" onclick="confirmDelete('是否停用该用户？', 'EcUser2.do', 'user_id=${cur.id}&'+$('#bottomPageForm').serialize())">停用</span>
                  </logic-el:match>
                  <logic-el:notMatch name="popedom" value="+2+">
                ...
                <span style="color:#CCC;" class="fblue">修改</span>|
                 <span class="fblue" style="cursor:pointer;" onclick="doNeedMethod('是否启用该用户？', 'EcUser2.do', 'reStart','user_id=${cur.id}&'+$('#bottomPageForm').serialize())">启用</span>  
                </c:if></td>
            </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcUser2.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
$(document).ready(function(){
    ...
    $("#export_excel").click(function(){
    	 this.value="正在提交...";
    	 this.disabled=true;
    	 this.form.action="${ctx}/manager/spgl/EcUser2.do?method=excel";
    	 this.form.submit();
    	 this.form.action="${ctx}/manager/spgl/EcUser2.do";
    	 this.value="导出Excel";
    	 this.disabled=false;
    });
