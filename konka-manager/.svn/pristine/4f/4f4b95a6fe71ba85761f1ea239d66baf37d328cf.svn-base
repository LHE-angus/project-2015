...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaOrderInfoTransEnsu">
...
<!--         <td width="10%" align="center" nowrap="nowrap">客户id</td> -->
...
<%--               <td align="center" nowrap="nowrap">${cur.map.cust_id}</td> --%>
            ...
            <td align="left" nowrap="nowrap">${cur.trans_ensu_user}</td>
...
<!-- 	 pagination="true" rownumbers="true" url="KonkaOrderInfoTransEnsu.do?method=list1" fit="true" > -->
<!-- 		<thead> -->
<!-- 			<tr> -->
<!-- 				<th field="id" checkbox="true"></th> -->
<!-- 				<th field="ensu_id" width="50" align="center">编号</th> -->
<!-- 				<th field="trans_ensu_id" width="100" align="center">客户姓名</th> -->
<!-- 			</tr> -->
<!-- 		</thead> -->
<!-- 	</table> -->
