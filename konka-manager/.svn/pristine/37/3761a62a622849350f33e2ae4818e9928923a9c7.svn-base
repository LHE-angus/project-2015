...
<link href="${ctx}/styles/mobiscroll.custom-2.5.0.min.css" rel="stylesheet" type="text/css" />
<script src="${ctx}/commons/scripts/mobiscroll.custom-2.5.0.min.js" ></script>
</head>
...
<div class="headtab3" >
  ...
  <tr style="padding-top:10px">
    <td class="p10"><a href="${ctx}/m/admin/SalesReports.do"><img src="${ctx}/mobile/admin/Frames/images/g1.png" width="64" height="64" /></a></td>
  ...
  <tr>
    <td class="pb15"><a href="${ctx}/m/admin/SalesReports.do" style="color:#666666;">销量上报</a></td>
    ...
    <td class="p10"><a href="${ctx}/mobile/admin/CompeteReport.do"><img src="${ctx}/mobile/admin/Frames/images/g6.png" alt="" width="64" height="64" /></a></td>
  </tr>
  <tr>
    ...
    <td class="pb15"><a href="${ctx}/mobile/admin/CompeteReport.do" style="color:#666666;">竞品信息</a></td>
  </tr>
    <tr style="padding-top:10px">
    <td class="p10"><img src="${ctx}/mobile/admin/Frames/images/g7.png" width="64" height="64" /></td>
    <td class="p10"><a href="${ctx}/mobile/admin/HistoryReport.do" ><img src="${ctx}/mobile/admin/Frames/images/g8.png" alt="" width="64" height="64" /></a></td>
    <td class="p10"><a href="${ctx}/mobile/admin/RestReport.do"><img src="${ctx}/mobile/admin/Frames/images/g9.png" width="64" height="64" /></a></td>
  </tr>
  <tr>
    <td class="pb15"><a href="${ctx}/m/admin/SalesReports.do" style="color:#666666;">公司新闻</a></td>
    <td class="pb15"><a href="${ctx}/mobile/admin/HistoryReport.do" style="color:#666666;">上报历史</a></td>
    <td class="pb15"><a href="${ctx}/mobile/admin/RestReport.do" style="color:#666666;">请假申请</a></td>
  </tr>
    <tr style="padding-top:10px">
    <td class="p10"><a href="${ctx}/mobile/admin/TerminalFeedbackReport.do"><img src="${ctx}/mobile/admin/Frames/images/g10.png" width="64" height="64" /></a></td>
    <td class="p10">&nbsp;</td>
    <td class="p10">&nbsp;</td>
  </tr>
  <tr>
    <td class="pb15"><a href="${ctx}/mobile/admin/TerminalFeedbackReport.do" style="color:#666666;">信息反馈</a></td>
    <td class="pb15">&nbsp;</td>
    <td class="pb15">&nbsp;</td>
  </tr>
</table>
