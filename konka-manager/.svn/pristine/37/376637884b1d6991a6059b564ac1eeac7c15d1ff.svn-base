...
<div class="oarcont" id="body_oarcont">
	...
	<div class="rtabcont1">
		<html-el:form action="/spgl/EcBcompPdRebates">
	...
	<div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<input type="button" class="but2" value="新 增" onclick="location.href='EcBcompPdRebates.do?method=add&mod_id=${af.map.mod_id}';" />
				</td>
			</tr>
		</table>		
	</div>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
			...
			<c:forEach items="${entityList}" var="cur" varStatus="vs">
				<tr>
					...
					<td align="center" nowrap="nowrap">
						<a style="color: blue"  href="javascript:doNeedMethod(null, 'EcBcompPdRebates.do', 'view', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize());">查看</a> | 
						<a style="color: blue" href="javascript:doNeedMethod(null, 'EcBcompPdRebates.do', 'edit', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize());">修改</a> | 
						<a style="color: blue" href="javascript:doNeedMethod('确定删除此记录？', 'EcBcompPdRebates.do', 'delete', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize());">删除</a>
					</td>
				</tr>
			</c:forEach>
		</table>
					...
					<td height="40">
						<div style="text-align: right; padding-right: 5px;"> 
							...
							<script type="text/javascript">
								...
								pager.addHiddenInputs("b_type", "${fn:escapeXml(af.map.b_type)}");
