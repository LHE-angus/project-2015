...
<form action="<c:url value='/touch/Payment.do' />" method="post" id="pay_form" target="_blank">
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center" style="width:550px;margin-top:70px;">
  	 <tr>
  		...
  		<td width="30%"><p style="margin-top:10px;font-size:12px;">稍后支付&gt;&gt;<a href="${ctx }/touch/center/Orders.do?">查看我的订单</a></p></td>
	  </tr>
...
$(document).ready(function(){ 
	...
	$(document).delegate("#heckOrderStatus", "click", function(){
		location.href = "${ctx}/touch/Payment.do?method=checkOrderStatus&trade_index=${af.map.trade_index}"
	}); 
