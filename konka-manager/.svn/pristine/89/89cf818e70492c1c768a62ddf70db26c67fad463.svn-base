      ...
      <div class="tg_l">
        <div class="tg_left">
          <div class="tg_k">
            ...
            <div class="tg_cn"><a href="<c:url value='/shop/PshowOrderPanicBuying.do?method=add&goods_id=${konkaBcompPd.id}' />"><img src="${ctx}/styles/shop/images/qianggou.jpg" width="117" height="51" /></a></div>
            <div class="tg_down">
              <ul>
                <li>原价<br>
