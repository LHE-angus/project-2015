...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcVouchersApply" method="post">
      ...
      <html-el:hidden property="goods_hid" styleId="goods_hid" value="${af.map.goods_hid}"/>
      <html-el:hidden property="goods_name_hid" styleId="goods_name_hid" value="${af.map.goods_name_hid}"/>
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>是否需要加密：</td>
          <td width="88%" align="left">
          <html-el:select property="has_pwd" styleId="has_pwd" >
         		<html-el:option value="">-请选择-</html-el:option>
         		<html-el:option value="0">不需要</html-el:option>
         		<html-el:option value="1">需要</html-el:option>
         </html-el:select>
          </td>
        </tr>
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>申请数量：</td>
          <td width="88%" align="left"><html-el:text property="apply_num" styleId="apply_num" size="30" maxlength="6"/></td>
        </tr>
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>面额：</td>
        ...
        <input type="text" name="prod_name" maxlength="125" value="${af.map.prod_name}" onclick="openEntpChild()" readonly="readonly" id="prod_name" style="width: 280px; color: rgb(153, 153, 153);" class="webinput" />
         &nbsp;
         <a class="butbase" onclick="openEntpChild()"><span class="spancss">选择</span></a>&nbsp;&nbsp;不选择表示允许全部类别
       </td>
      </tr>
       <tr>
        ...
        <input type="text" name="goods_types" maxlength="125" value="${af.map.goods_types}" onclick="openTypeChild()" readonly="readonly" id="goods_types" style="width: 280px; color: rgb(153, 153, 153);" class="webinput" />
         &nbsp;
         <a class="butbase" onclick="openTypeChild()"><span class="spancss">选择</span></a>&nbsp;&nbsp;不选择表示允许全部属性
       </td>
      </tr>
      <tr>
        ...
        <input type="text" name="goods" maxlength="125" value="${af.map.goods}" onclick="openGoodsChild()" readonly="readonly" id="goods" style="width: 280px; color: rgb(153, 153, 153);" class="webinput" />
         &nbsp;
         <a class="butbase" onclick="openGoodsChild()"><span class="spancss">选择</span></a>&nbsp;&nbsp;<font color="red">如果选择了商品，则以商品数据作为唯一过滤条件，当产品类别和产品属性改变时会清空商品，请重新选择</font>
       </td>
      </tr>
       <tr>
...
$(document).ready(function(){
	...
	$("#has_pwd").attr("datatype", "Require").attr("msg", "请选择是否需要加密！");
	$("#apply_num").attr("datatype", "Require").attr("msg", "申请数量必须为大于0的整数！").focus(function(){setOnlyInt(this);});  
...
function openGoodsChild(){
	var prod_types=$("#prod_types").val();
	var goods_types_hid=$("#goods_types_hid").val();  

	var url="${ctx}/manager/spgl/EcVouchersApply.do?method=chooseGoods&prod_types="+prod_types+"&goods_types_hid="+goods_types_hid;
