...
<!-- 只支持单个审批节点的提交 对应的是 /oa/FilesSubmit-->
</head>
<body>
<div class="oarcont">
  <div class="oartop">
  ...
  <div class="rtabcont2">
    <html-el:form action="/oa/FilesSubmit" enctype="multipart/form-data">
      <html-el:hidden property="queryString" styleId="queryString" />
      <html-el:hidden property="method" styleId="method" value="save" />
      <html-el:hidden property="mod_id" styleId="mod_id" />
      <!-- 没有指定的流程的 -->
      <html-el:hidden property="is_node" styleId="is_node" value="0" />
      <html-el:hidden property="mod_type" styleId="mod_type" value="file" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
          <tr>
            ...
            <td nowrap="nowrap"><html-el:text property="apply_user_name" styleId="apply_user_name" maxlength="50" style="width:80%" /></td>
            ...
            <td nowrap="nowrap"><div id="audits">
                ...
                <c:if test="${not empty filesAuditNodeList}">
                  ...
                  <div style="">
                    ...
                    <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" value="${cur.audit_user}" style="width:80%;vertical-align:middle;" />
                ...
                <c:if test="${empty filesAuditNodeList}">
                  <div style="">
                    ...
                    <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" style="width:80%;vertical-align:middle;" />
                    <img onclick="selectUser(this);" src="${ctx}/images/search.gif" style='cursor: pointer;vertical-align:middle;' alt='选择人员' title="选择人员" /></div>
                </c:if>
              </div></td>
          ...
          <tr>
	        ...
	        <td colspan="3"><html-el:select property="module_name" styleId="module_name" style="width:225px;" value="${af.map.audit_node_id }"> 
          ...
          <tr>
            ...
            <td colspan="4"><span style="color: gray">复制Word文档的内容,会引入大量的文档样式。会影响在浏览器的显示效果，请尽量避免类似操作,并且注意预览模板的效果</span></td>
          </tr>
          <tr>
          ...
          <c:if var="is_atta_edit" test="${not empty attachmentList and not empty af.map.file_no}">
            <tr>
              ...
              <td><ol>
                  <c:forEach var="cur" items="${attachmentList}" varStatus="vs">
                    <li><a href="${ctx}/manager/admin/Download.do?method=downloadFile&save_name=${cur.save_name}">${cur.file_name}</a>&nbsp;&nbsp;&nbsp;<a href="#" id="att_del_${cur.id}">
                      ...
                      <img src="../../images/x.gif" style="vertical-align:middle; cursor: pointer;" id="imgDelTr" title="删除"/></a></li>
                  </c:forEach>
                </ol></td>
            </tr>
          </c:if>
          <c:if test="${!is_atta_edit}">
            <tr>
              <td height="28" class="title_item">已上传的附件：</td>
              <td><ol>
                  <c:forEach var="cur" items="${attachmentList}" varStatus="vs">
                    <li><a href="${ctx}/manager/admin/Download.do?method=downloadFile&save_name=${cur.save_name}">${cur.file_name}</a>&nbsp;&nbsp;&nbsp;<a href="#" id="att_del_${cur.id}">
                      <html-el:hidden property="copy_file_id" styleId="copy_file_id_${cur.id}" value="${cur.id}" />
                      <img src="../../images/x.gif" style="vertical-align:middle; cursor: pointer;" title="删除" onclick="$(this).parent().parent().remove()"/></a></li>
                  </c:forEach>
                </ol></td>
            </tr>
          </c:if>
          <tr>
            ...
            <td colspan="5">
              <html-el:radio property="is_forward" value="0" styleId="is_forward_0" />
          ...
          <tbody id="is_forward_tr" style="display:${display};">
            ...
            <tr>
              ...
              <td colspan="5">
              <input type="hidden" name="receive_dept_1_ids" id="receive_dept_1_ids" value="${af.map.dept_ids}" />
