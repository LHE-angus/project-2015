...
<!-- buy start -->
<form action="<c:url value='/sfmall/EcGift.do' />" method="post" id="step_two_form">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><input type="radio" name="deliver_way" value="1" id="deliver_way_1" />
                        <label for="deliver_way_1" style="cursor:pointer;">商家配送</label></td>
                    </tr>
                  </tbody>
                </table>
              </ul></td>
      ...
      <tbody>
        <tr class="item">
          ...
          <td width="10%">所需积分</td>
	        ...
	        <tr>
	          <td>${ecGift.id}</td>
	          <td><a href="<c:url value='/sfmall/EcGift.do?method=view&goods_id=${ecGift.id}' />" target="_blank">${ecGift.pd_name}</a></td>
	          <td>1</td>
