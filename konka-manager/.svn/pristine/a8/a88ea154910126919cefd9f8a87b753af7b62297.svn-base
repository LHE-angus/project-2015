  ...
  <div class="rtabcont2">
    ...
    <html-el:form action="/manager/JxcOutInDetail">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          <td nowrap="nowrap" class="title_item" align="right"><span style="color:red;">* </span>移出仓库：</td>
...
<%-- 	        		<html-el:option value="">请选择</html-el:option> --%>
        ...
        <tr>
          <td nowrap="nowrap" class="title_item" align="right"><span style="color:red;">* </span>移入仓库：</td>
        ...
        <tr>
          <td nowrap="nowrap" class="title_item" align="right"><span style="color:red;">* </span>移出数量（单位：台）：</td>
        ...
        <tr>
          <td nowrap="nowrap" class="title_item" align="right"><span style="color:red;">* </span>移出日期：</td>
