...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaPdModelTask">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td height="36" align="left" style="padding-left:5px;">
               &nbsp;&nbsp;
                    产品型号：<html-el:text property="md_name_like" size="16" maxlength="30" styleId="md_name_like" styleClass="webinput" />
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
		          ...
		          &nbsp;
		          <a class="fblue" href="${ctx }/manager/admin/KonkaPdModelTask/pd_task.xls">excel模版下载</a>
				</td>
			</tr>
		</table>		
	</div>
  <div class="rtabcont1">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td width="10%" nowrap="nowrap" align="center" >产品型号</td>
         <td nowrap="nowrap" width="10%" align="center" >年</td>
        <td width="10%" nowrap="nowrap" align="center">月</td>
         <td width="10%" nowrap="nowrap" align="center">生产计划</td>
         <td width="10%" nowrap="nowrap" align="center">销售计划</td>
        <td width="10%" nowrap="nowrap" align="center">是否退市</td>
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap">
           <c:if test="${cur.is_sails eq 0}">否</c:if>
           <c:if test="${cur.is_sails eq 1}">是</c:if>
          </td>
          <td align="center" nowrap="nowrap">
          <fmt:formatDate value="${cur.add_date}" pattern="yyyy-MM-dd"/>
           </td>
          <td  align="center" nowrap="nowrap">
          	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaPdModelTask.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
          </td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaPdModelTask.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
<div class="float_div" id="uploadPanel" style="z-index:10000;position:absolute;">
	...
	<form action="KonkaPdModelTask.do?method=excelImport" method="post" enctype="multipart/form-data">
