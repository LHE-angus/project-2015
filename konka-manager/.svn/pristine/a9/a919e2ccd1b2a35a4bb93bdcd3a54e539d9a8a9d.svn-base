    ...
    <html-el:form action="/zmd/KonkaXxZmdAddSalesOrder">
      ...
      <table id="main_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          ...
          <td align="right"><c:if test="${af.map.return_money_0 eq 1}"><a style="color: blue;cursor: pointer;font-weight:900;" href="${ctx}/manager/zmd/KonkaXxZmdAddSalesOrder.do?method=add2&mod_id=${af.map.mod_id}&stock_from=0&return_money_0=${af.map.return_money_0}">切换到非返利模式订单</a></c:if></td>
        </tr>
        <tr>
