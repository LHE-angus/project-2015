      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        <tr class="tabtt1">
         ...
         <tr class="tabtt1">
          ...
          <td width="8%" align="center" nowrap="nowrap">销售金额</td>
             <td width="8%" align="center" nowrap="nowrap">其他数量</td>
             <td width="8%" align="center" nowrap="nowrap">其他金额</td>
         </tr>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
        	<c:set var="s_init_num" value="${s_init_num+ cur.map.init_num}"></c:set>
	          ...
	          <c:set var="s_result_money" value="${s_result_money+ cur.map.init_money + cur.map.come_money - cur.map.sale_cost+cur.map.other_money}"></c:set>
	          <c:set var="s_result_num" value="${s_result_num+ cur.map.init_num + cur.map.come_num - cur.map.out_num +cur.map.other_num}"></c:set>
...
<%-- 	            <span style="cursor:pointer;" class="fblue" onclick="openDialog('${af.map.mod_id}','${af.map.store_id}','${cur.map.goods_id}','${af.map.cust_id }',0)">${cur.map.come_num}</span> --%>
	            <a class='iframea' href="${ctx}/manager/admin/KonkaR3ShopStock.do?method=viewDetail&mod_id=${af.map.mod_id}&store_id=${af.map.store_id}&goods_id=${cur.map.goods_id}&cust_id=${af.map.cust_id }&direction=0">${cur.map.come_num}</a>
            </td>
...
<%-- 	            <span style="cursor:pointer;" class="fblue" onclick="openDialog('${af.map.mod_id}','${af.map.store_id}','${cur.map.goods_id}','${af.map.cust_id }',1)">${cur.map.out_num}</span> --%>
	            <a class='iframea' href="${ctx}/manager/admin/KonkaR3ShopStock.do?method=viewDetail&mod_id=${af.map.mod_id}&store_id=${af.map.store_id}&goods_id=${cur.map.goods_id}&cust_id=${af.map.cust_id }&direction=1">${cur.map.out_num}</a>
            </td>
            ...
            <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur.map.out_money}" type="currency" /></span></td>
              <td align="right" nowrap="nowrap">
                  <a class='iframea' href="${ctx}/manager/admin/KonkaR3ShopStock.do?method=viewDetail&mod_id=${af.map.mod_id}&store_id=${af.map.store_id}&goods_id=${cur.map.goods_id}&cust_id=${af.map.cust_id }&direction=2">${cur.map.other_num}</a>

              </td>
              <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur.map.other_money}" type="currency" /></span></td>
          	<td align="right" nowrap="nowrap"><span style="font-size:150%;font-weight:800;font-family:verdana;color:#C00;">${cur.map.init_num + cur.map.come_num - cur.map.out_num+cur.map.other_num}</span></td>
            <td align="right" nowrap="nowrap"><span class="kz-price-12">
          		<fmt:formatNumber value="${cur.map.init_money + cur.map.come_money - cur.map.sale_cost+cur.map.other_money}" type="currency" />
          	</span></td>
          </tr>
        </c:forEach>
         <tr>
          <td align="center" nowrap="nowrap" style="font-weight:800;">合计</td>
            ...
            <td align="right" nowrap="nowrap" style="font-weight:800;"><span class="kz-price-12"><fmt:formatNumber value="${s_out_money}" type="currency" /></span></td>
             ...
             <td align="right" nowrap="nowrap" style="font-weight:800;">${s_other_num}</td>
             <td align="right" nowrap="nowrap" style="font-weight:800;"><span class="kz-price-12"><fmt:formatNumber value="${s_other_money}" type="currency" /></span></td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable2">
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
            ...
            <tr class="tr_${cur.map.init_num}${cur.map.come_num}${cur.map.out_num} sortable">
                ...
                <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur.map.sale_cost}" type="currency" /></span></td>
                <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur.map.out_money}" type="currency" /></span></td>
                <td align="right" nowrap="nowrap">${cur.map.other_num}</td>
                <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur.map.other_money}" type="currency" /></span></td>
                <td align="right" nowrap="nowrap"><span style="font-size:150%;font-weight:800;font-family:verdana;color:#C00;">${cur.map.init_num + cur.map.come_num - cur.map.out_num+cur.map.other_num}</span></td>
                <td align="right" nowrap="nowrap"><span class="kz-price-12">
          		<fmt:formatNumber value="${cur.map.init_money + cur.map.come_money - cur.map.sale_cost+cur.map.other_money}" type="currency" />
