...
public class Encrypt {
	// 默认密码
	private static final String defaultPassword = "WoAiBeiJingTianAnMen";
	// 默认的盐
	...
	public static String encrypt(String data) {
		...
		byte[] tmp = encrypt(data.getBytes(), null);
		return byteArr2HexStr(tmp);
	}
	...
	public static void main(String[] args) {
		...
		String str2 = Encrypt.encrypt("13721115508", null);
		// //System.out.println("加密后：" + str2);
		// //System.out.println("解密后：" + Encrypt.decrypt(str2, null));
	}
}