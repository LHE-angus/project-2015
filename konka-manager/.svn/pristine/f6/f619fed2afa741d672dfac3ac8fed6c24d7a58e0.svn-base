...
<div class="maincont">
  ...
  <div class="touch_right padbot45">
    <div class="position"><a href="${ctx }/touch/Index.do">首页</a> &gt; <a href="${ctx }/touch/center/Index.do">会员中心</a> &gt; 我的关注</div>
    <div class="touchtab3">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="touch_form_table0">
            ...
            <tbody>
              <c:forEach var="cur" items="${entityList}" varStatus="vs">
                <tr style="border:1px solid #e3e3e3;" >
                  ...
                  <td align="center" nowrap="nowrap"> <a href="${ctx }/touch/PdShow.do?goods_id=${cur.goods_id}"><img src="${ctx}/${cur.img_url }" width="81" height="80"/></a></td>
          ...
          <c:if test="${empty entityList}">
            <tr style="border:1px solid #e3e3e3;height:46px;" >
              <td colspan="6" align="center"> 您还没有关注任何商品,点击<a href="${ctx }/touch/Index.do"><font color="#2233ff">这里</font></a>去关注您喜爱的商品吧</td>
            </tr>
          </c:if>
        </table>
      </form>
...
function deleteInfo(obj){
	...
	if(confirm("您确定取消关注吗？")){
		...
		location.href="${ctx}/touch/center/EcUserFavotrites.do?method=delete"+id;
		}
	}
}
