...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcGiftOrdeAudit">
  ...
  <div class="rtabcont1">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="left" valign="middle"> <c:out value="${cur.map.dept_name}" /></td>
              ...
              <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcGiftOrdeAudit.do','audit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">审核</span>
              </c:if>
              <c:if test="${cur.state ne 10}"><span style="color:#CCC;" class="fblue">审核</span></c:if>
              </td>
            </tr>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcGiftOrdeAudit.do">
