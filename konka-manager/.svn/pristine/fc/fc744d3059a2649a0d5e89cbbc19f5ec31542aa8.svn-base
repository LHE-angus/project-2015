...
<form id="iForm">
    <div data-role="fieldcontain">
		...
		<textarea name="visit_note" id="visit_note" data-native-menu="false" data-theme="b" data-form="ui-btn-up-a">拜访说明</textarea>
