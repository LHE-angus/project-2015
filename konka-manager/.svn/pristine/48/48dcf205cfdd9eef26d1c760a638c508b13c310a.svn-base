...
<div class="maincont">
  ...
  <div class="zxmall_right padbot45">
    <div class="position"><a href="${ctx }/zxmall/Index.do">首页</a> &gt; <a href="${ctx }/zxmall/center/Index.do">会员中心</a> &gt; 地址簿</div>
...
function deleteInfo(obj){
	...
	if(confirm("您确定删除吗？")){
		location.href="${ctx}/zxmall/center/EcUserAddrs.do?method=delete"+id;
	}
}
