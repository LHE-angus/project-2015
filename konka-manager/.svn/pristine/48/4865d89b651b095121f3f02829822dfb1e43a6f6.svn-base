...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<html-el:form action="/admin/StatisticalDimensionSaleArea" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      	<tr>
      		...
      		<td><input class="but_excel" type="button" name="btn_submit" id="btn_submit" value="导入" />&nbsp; <input class="but5" type="button" name="Submit5" value="返回" onclick="history.back();return false;" /><span id="searchTip" style="color:red;">备注：请仔细检查excel数据是否正确</span></td>
      	</tr>
      	<tr>
      		<td colspan="3"><a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/statistical_dimension_sale_area_template.xls">Excel模板下载</a></td>
      	</tr>
      </table>
    </html-el:form>
  </div>
