 ...
 */
public class KonkaMobileShopStore extends BaseDomain implements Serializable {
	...
	private Date gene_date;

	public KonkaMobileShopStore() {
	...
	public Date getGene_date() {
		return gene_date;
	}

	public void setGene_date(Date geneDate) {
		gene_date = geneDate;
	}
