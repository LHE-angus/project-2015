...
<div class="oarcont">
  ...
  <div id="print" class="rtabcont2" align="center" title="购物单" style="margin-top:4px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center" colspan="4"><span style="font-weight:bold;font-size:20px;">购物单</span></td>
      </tr>
      <tr>
        <td colspan="3" width="68%">&nbsp;</td>
        <td align="left">
          <input name="chk_pic_print" type="checkbox" id="chk_pic_print" />
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td class="title_item" width="8%" style="text-align: center;" nowrap="nowrap">增值服务</td>
      ...
      <c:forEach var="cur" items="${pshowOrdeDetails}" varStatus="vs">
        ...
        <img id="pic_${vs.count}" src="${ctx}/${fn:substringBefore(cur.map.main_pic, '.')}_240.jpg" width="50px" height="50px" style="display: none" /> 
        ${cur.map.pd_sn }</td>
    ...
    <tr>
        ...
        <td align="left" ><b>应付总金额：</b><span class="kz-price">
          <fmt:formatNumber type="currency" value="${t_price}" />
          </span></td>
      </tr>
  </table>
