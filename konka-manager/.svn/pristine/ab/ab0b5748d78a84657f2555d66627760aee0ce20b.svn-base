...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/zmd/KonkaXxDistAccountForMyRec">
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2" >
      ...
      <tr class="tabtt1">
        <td width="12%" align="center" nowrap="nowrap"><font class="blue">物流结算流水号</font></td>
        <td align="center" nowrap="nowrap"><font class="blue">汇款/转账流水号</font></td>
        <td width="12%" align="center" nowrap="nowrap"><font class="blue">应结算金额</font></td>
        <td width="10%" align="center" nowrap="nowrap"><font class="blue">结算人</font></td>
        <td width="12%" align="center" nowrap="nowrap"><font class="blue">提交结算时间</font></td>
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap"><fmt:formatDate value="${cur.plan_date}" pattern="yyyy-MM-dd HH:mm:ss" />
            <c:if test="${empty cur.plan_date}"><span style="color:gray;">未填写</span></c:if></td>
          ...
          <td align="center" nowrap="nowrap"><span style="cursor: pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaXxDistAccountForMyRec.do', 'view','dist_id=${cur.dist_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span></td>
        </tr>
      </c:forEach>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaXxDistAccountForMyRec.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>&nbsp;</td>
