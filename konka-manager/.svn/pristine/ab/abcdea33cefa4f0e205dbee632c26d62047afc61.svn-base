				...
				<div style="padding: 7px; width: 98%;" class="middle">
						...
						<div class="widget-content referrer">
							<html-el:form>
								...
								<table width="100%" border="0" cellspacing="5" cellpadding="0"
									...
									<tr>
										<td align="right" width="80%"><strong>年度</strong> <html-el:select
							...
							<div class="widget">
								...
								<div class="widget-content referrer">
									<table id="table1" style="width: 100%;">
										<tr>
											<td><span class="mychar_title"
												style="padding: 10px 0 10px;" id="title1">...</span>
												<p
													style="margin-top: 5px; color: blue; font: normal 14px '微软雅黑';">
													目标销售额:<span id="option1_b">... </span>万元
												</p>
												<p
													style="margin-top: 5px; color: red; font: normal 14px '微软雅黑';">
													实际销售额: <span id="option1_a">... </span>万元
												</p>
												<div id="main1" style="height: 300px;"></div></td>
										</tr>
									</table>
								</div>
							</div>
							...
							<div class="widget">
								...
								<div class="widget-content referrer">
									<table id="table1" style="width: 100%; height: 420px">
										<tr>
											<td valign="top" align="center" id="option_table1"></td>
										</tr>
									</table>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="widget">
								<div class="widget-head">
									<div class="pull-left">分公司销售完成情况</div>
									<div class="widget-icons pull-right">
										<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
										<a href="#" class="wclose"><i class="icon-remove"></i></a>
									</div>
					...
					<div class="widget">
						...
						<div class="widget-content referrer">
							...
							<table id="table5" style="width: 100%; height: 1900px;">
								<tr>
...
$(".sidebar #nav > li > a:eq(2)").attr("class","open");

$(".sidebar #nav > li > a:eq(2) > ul").attr("display","block");
...
function myChart1(year,month){
	...
	$.ajax({
		type: "POST",
		url: "<c:url value='/manager/leader/JcfxReportXswc.do' />",
