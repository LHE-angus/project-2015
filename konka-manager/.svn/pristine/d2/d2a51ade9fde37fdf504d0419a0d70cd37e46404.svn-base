...
<body>
  <table class="areause1" >
     <tbody>
        <tr>
         <td>
          <span id="area_name_0">供选择区域列表</span>
          <div style="width:250px;height:180px;overflow-x:hidden;overflow-y:auto;border:1px solid black;">
             <table width="100%" class="areause2" ><tbody id="areaList0"></tbody></table>
          </div>
        </td>
        <td width="20"></td>
        <td>
          <span id="area_name_1">已选择区域列表</span>
          <div style="width:250px;height:180px;overflow-x:hidden;overflow-y:auto;border:1px solid black;">
