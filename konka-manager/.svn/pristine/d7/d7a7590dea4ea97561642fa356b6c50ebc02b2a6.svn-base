...
public class GcxmProjBeiAnAction extends BaseAction {
	...
	public ActionForward sheet(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition", "attachment;filename=" + EncryptUtils.encodingFileName("全国项目备案")
				+ ".xls");
		return new ActionForward("/../manager/admin/GcxmProjBeiAn/sheet.jsp");
