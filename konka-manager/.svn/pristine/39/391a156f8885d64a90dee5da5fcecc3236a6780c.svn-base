...
<div class="oarcont">
	...
	<div class="rtabcont1">
	  <html-el:form action="/admin/PeShopMsg.do">
	    <html-el:hidden property="method" value="saveReply" />
	    <input type="hidden" name="receive_user_id" id="receive_user_id" value="${af.map.receive_user_id}" />
	    ...
	    <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
	    <c:if test="${not empty entity}">
	      <tr>
	        <td colspan="2" align="right"><b>站内信原文</b></td>
	      </tr>
	      <tr >
	    ...
	    <c:if test="${empty entity }"><tr><td colspan="2" align="right" ><b>站内信原文被发件人删除</b></td></tr>
	    </c:if>
	      <tr>
	        <td colspan="2" align="right"><b>站内信回复</b></td>
	      </tr>
	      <tr>
