...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/StatisticalDimensionData">
      <html-el:hidden property="method" value="storeAgentList" />
        ...
        <tr>
          ...
          <td>
           ...
           <strong class="fb">客户名称：</strong>
           		<html-el:text property="customer_name_like" styleId="customer_name_like" maxlength="30" size="20" styleClass="webinput" />
           &nbsp;&nbsp;
           <strong class="fb">业务员名称：</strong>
      ...
      <tbody>
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
            ...
            <td align="right"><fmt:formatNumber value="${cur.annual_retail_money}" type="currency"/></td>
            <td align="right">
            	<c:if test="${not empty cur.annual_retail_num && cur.annual_retail_num gt 0 }">
            		<fmt:formatNumber value="${(cur.annual_retail_money / cur.annual_retail_num) }" type="currency"/>
            	</c:if>
            </td>
            <td align="right">
            	<c:if test="${not empty cur.annual_settle_num && cur.annual_settle_num gt 0 }">
            		<fmt:formatNumber value="${(cur.annual_settle_money / cur.annual_settle_num) }" type="currency"/>
            	</c:if>
            </td>
          </tr>
        </c:forEach>
        ...
        <tr>
          <td height="40"><div style="text-align: right; padding-right: 5px;">
              ...
              <script type="text/javascript">
				...
				pager.addHiddenInputs("method", "storeAgentList");
