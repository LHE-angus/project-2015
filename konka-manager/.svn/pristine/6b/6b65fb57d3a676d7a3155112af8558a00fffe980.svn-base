    ...
    <div class="viewright">
      ...
      <div class="viewtab1">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
        	...
        	<tr>
              <td colspan="3" height="22">规&nbsp;&nbsp;&nbsp;&nbsp;格：10KG/箱</td>    
            </tr>
             <tr>
            ...
            <tr>
              	<td colspan="3" height="22">团购时间：${konkaBcompPd.map.start_time} 至 ${konkaBcompPd.map.end_time} </td>       
            </tr>
            <tr>
              	<td colspan="3" height="22">已参与团购：${konkaBcompPd.map.buy_num}斤 <span><font style="color: red;font-size:10px;font-weight:bold;">（满1000斤开团）</font></span> </td> 
            </tr>
            <tr>
              <td colspan="3" height="22">浏 览 量：<strong class="redfont">${empty konkaBcompPd.view_counts ? '0' : konkaBcompPd.view_counts}</strong>&nbsp;次</td>
            </tr>
			<tr>
              <td colspan="3" height="22">配 送 至：仅限深圳总部地区</td>  
            </tr>
            <tr>
              <td colspan="3" height="22">领取时间及地点：12月23日于深圳总部南门自提</td>
            </tr> 
        </table>
      </div>
      <div class="viewtab2"> 
          ...
          <tbody>
            <tr>
              ...
              <td width="90%"><div class="addtab"><img src="${ctx}/styles/member/images/edd.gif" id="num_jian" style="cursor:pointer;" /></div>
                ...
                <div class="addtab"><img src="${ctx}/styles/member/images/add.gif" id="num_jia" style="cursor:pointer;" /></div>  <span style="display: none;"><font style="color: red;font-size:10px;font-weight:bold;"></font></span></td>
            </tr>
            <tr>
...
$(document).ready(function(){ 
	...
	$(document).delegate("#buy_btn", "click", function(){
		...
		if(parseInt(buy_num) <1){
         ...
         location.href="${ctx}/member/PdShowForTuan.do?method=add&goods_id=${konkaBcompPd.id}&buy_num="+buy_num;
	});
