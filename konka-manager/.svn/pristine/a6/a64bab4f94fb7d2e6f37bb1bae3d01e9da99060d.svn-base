...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<html-el:form action="/zmd/KonkaXxPd" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      	<tr>
      		...
      		<td><input class="but_excel" type="button" name="btn_submit" id="btn_submit" value="导入" />&nbsp;<span id="searchTip" style="color:red;"></span></td>
      	</tr>
      	<tr>
      		<td colspan="3"><a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/konka_XxPd_import_template.xls">Excel模板下载</a></td>
      	</tr>
      </table>
    </html-el:form>
  </div>
