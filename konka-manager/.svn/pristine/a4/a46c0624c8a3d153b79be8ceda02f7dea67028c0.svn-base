      ...
      <div class="viewtab2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
          <tbody>
            ...
            <tr>
              <td colspan="2"><div class="padtop20"><img alt="加入购物车" src="${ctx}/styles/zxmall/images/but_joinshop.gif" width="132" height="38" style="cursor:pointer;" id="add_shoping_car_btn" />&nbsp;&nbsp;<img alt="立即购买" src="${ctx}/styles/zxmall/images/but_buy2.gif" style="cursor:pointer;" id="buy_btn" /></a>&nbsp;&nbsp;<img alt="关注" style="cursor:pointer;" id="add_favotrites_btn" src="${ctx}/styles/zxmall/images/but_attention.gif" /></a></div></td>
            </tr>
          </tbody>
        </table>
      </div>
