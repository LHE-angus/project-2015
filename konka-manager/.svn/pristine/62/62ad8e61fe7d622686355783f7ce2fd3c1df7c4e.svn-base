...
<body><div class="top_class"><span class="lspan"><a href="javascript:void(0);history.back();"><img src="${ctx}/styles/epp/mobile/images/return.gif" /></a></span><h3>收货地址管理</h3><a href="javascript:void(0);showNav();" id="btnJdkey" class="new-a-jd"><span>开心猫</span></a>
...
function deleteInfo(obj){
	...
	if(confirm("您确定删除吗？")){
		location.href="${ctx}/epp/mobile/center/EcUserAddrs.do?method=delete"+id;
	}
}
      
function defaultAddr(obj){
	var	id ="&id="+ obj.id.replace("d",""); 
	location.href="${ctx}/epp/mobile/center/EcUserAddrs.do?method=defaultaddr"+id;
}
