...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/admin/KonkaDLSVisit">
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaDLSVisit.do">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center" nowrap="nowrap">
                <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'KonkaDLSVisit.do', 'visit','shop_id=${cur.id}&shop_name=${cur.customer_name}&visit_count=${cur.map.visit_count}&'+$('#bottomPageForm').serialize())">拜访</span>
              </td>
            </tr>
