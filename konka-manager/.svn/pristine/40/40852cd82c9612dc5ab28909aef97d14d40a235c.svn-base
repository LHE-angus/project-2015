...
<body onload="checkSelect();"><div class="top_class"><span class="lspan"><a href="javascript:void(0);history.back();"><img src="${ctx}/styles/epp/mobile/images/return.gif" /></a></span><h3>购物车</h3><a href="javascript:void(0);showNav();" id="btnJdkey" class="new-a-jd"><span>开心猫</span></a>
...
<div id="content" >
	<div class="mainbox">
		<div class="maincont">    
		<form action="<c:url value='/epp/mobile/ShoppingCar.do' />" method="post" id="shopping_car_form">
