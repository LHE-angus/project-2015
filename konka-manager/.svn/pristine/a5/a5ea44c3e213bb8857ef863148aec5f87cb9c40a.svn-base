...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/demo/KonkaMobileRetailZeroSalesQuery">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td width="15"></td>
          <td >
          销售时间： <html-el:text property="report_date_start"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2000, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
                 	 至
      					<html-el:text property="report_date_end"  size="10" maxlength="10" readonly="true" onclick="new Calendar(2000, 2021, 0).show(this);" style="cursor:pointer;text-align:center;" title="点击选择日期" />
                   <strong class="fb">所属部门：</strong>
  ...
  <div class="rtabcont1">
    <form id="listForm" name="listForm" method="post" action="KonkaMobileRetailZeroSalesQuery.do?method=delete">
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="KonkaMobileRetailZeroSalesQuery.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
function subcomp_id_chg(){
	...
	var url = "${ctx}/manager/admin/KonkaMobileRetailZeroSalesQuery.do?method=getDept&subcomp_id="+$('#subcomp_id').val();
