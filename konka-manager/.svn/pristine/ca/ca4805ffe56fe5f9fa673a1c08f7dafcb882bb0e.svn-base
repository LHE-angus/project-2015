...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
      ...
      <tr>
        <td width="15%" nowrap="nowrap" class="title_item" align="right">活动标题：</td>
        <td width="85%">${konkaXxZmdHdSet.hd_title} </td>
      </tr>
      <tr>
        <td width="15%" nowrap="nowrap" class="title_item" align="right">活动开始时间：</td>
        <td width="85%"><fmt:formatDate value="${konkaXxZmdHdSet.start_date}" pattern="yyyy-MM-dd HH:mm"/></td>
      </tr>
      <tr>
        <td width="15%" nowrap="nowrap" class="title_item" align="right">活动结束时间：</td>
        <td width="85%"><fmt:formatDate value="${konkaXxZmdHdSet.end_date}" pattern="yyyy-MM-dd HH:mm"/></td>
      </tr>
      <tr>
