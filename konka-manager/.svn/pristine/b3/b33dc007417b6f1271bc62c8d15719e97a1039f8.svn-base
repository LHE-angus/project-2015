...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
 <c:forEach var="cur" items="${entityList}" varStatus="vs">
      <tr>
        ...
        <td width="10%"><input name="button" type="button" class="but6" style="cursor:pointer"  value="" onclick="window.returnValue=document.getElementById('${cur.category_id}').value;window.close();" />
        </td>
       </tr>
