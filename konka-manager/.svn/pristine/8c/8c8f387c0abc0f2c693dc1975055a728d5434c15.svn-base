  ...
  <div class="rtabcont1" style="overflow-x:auto;">
    <table width="100%" border="1" cellpadding="0" cellspacing="1" class="rtable2">
      <tr class="tabtt1">
        ...
        <td  nowrap="nowrap" align="center">休息开始时间</td>
        <td nowrap="nowrap" align="center">休息结束时间</td>
        <td nowrap="nowrap" align="center" >添加人</td>
        <td nowrap="nowrap" align="center" >添加时间</td>
        <td nowrap="nowrap" align="center" >备注</td>
         <td nowrap="nowrap" align="center" >是否启用</td>
      </tr>
      <c:forEach items="${allList}" var="cur" varStatus="vs">
        <tr>
         <td align="center" nowrap="nowrap">${vs.count}</td>
         <td align="left" nowrap="nowrap">${cur.real_name}</td>
          <td align="center" nowrap="nowrap"><fmt:formatDate value="${cur.sign_in_date}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
          <td align="center" nowrap="nowrap"><fmt:formatDate value="${cur.sign_out_date}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
           ...
           <c:if test="${cur.is_lock eq 0}">启用</c:if>
           <c:if test="${cur.is_lock ne 0}">删除</c:if>
           </td>
        </tr>
      </c:forEach>
    </table>
