    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="1" class="rtable2">
      ...
      <c:forEach items="${allList}" var="cur" varStatus="vs">
        <tr>
	         ...
	         --><td align="center" nowrap="nowrap">${cur.cust_name}</td> 
	         <td align="center" nowrap="nowrap">${cur.link_man_name}</td> 
	         <td align="center" nowrap="nowrap">${cur.link_man_tel}</td> 
	         <td align="center" nowrap="nowrap" > ${cur.link_man_addr}
          </td>
