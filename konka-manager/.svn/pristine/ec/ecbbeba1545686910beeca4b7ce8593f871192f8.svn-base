...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/zmd/KonkaXxZmdPosRec">
      <html-el:hidden property="method" value="save" />
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <html-el:hidden property="zmd_id" value="${zmd_id}" />
      <html-el:hidden property="zmd_sn" value="${zmd_sn}" />
      <html-el:hidden property="out_date" value="${out_date}" />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable4">
        ...
        <tr>
          ...
          <td><html-el:text property="man" styleId="man"></html-el:text></td>
        </tr>
        <tr>
          <td>&nbsp;&nbsp;</td>
          <td><input class="but4" type="button" value="提交" id="send" />
