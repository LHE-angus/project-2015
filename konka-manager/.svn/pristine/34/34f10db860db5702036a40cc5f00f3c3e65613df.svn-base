	...
	<tr>
		<td width="50%" valign="top" ><!-- valign="top" style="padding:55px 0 0 0;"-->
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tableClass">
				<tr>
					<th align="center" width="30%"><c:if test="${af.map.tj_type eq 1}">日期</c:if><c:if test="${af.map.tj_type eq 2}">月份</c:if></th>
					<th align="center" width="30%">采购数量</th>
					<th align="center" width="30%">采购成本</th>
				</tr>
...
if(${not empty entityList}){
   ...
   chart.setDataURL("${ctx}/customer/manager/JxcXsReport.do?method=cg_time_chart");		
