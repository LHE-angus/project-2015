    ...
    <html-el:form action="/admin/KonkaShopVisit.do">
      ...
      <div align="left">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
          ...
          <tr>
            <td nowrap="nowrap"  height="28" class="title_item" width="100">备注：</td>
            <td align="left"><html-el:textarea property="remarks" styleId="remarks" cols="50" rows="4"/>
            <div style="display: none; font-size: 12px; color: #F00;">注：不可超过1000个中文字符！</div></td>
          </tr>
...
<script type="text/javascript">//<![CDATA[
	$(document).ready(function(){
		...
		$("#visit_note" ).attr("datatype","LimitB").attr("max","1000").attr("min","1").attr("msg","请填写拜访记录，且不超过1000字");
		$("#remarks" ).attr("datatype","LimitB").attr("max","1000").attr("min","0").attr("msg","备注不超过1000字");
		  ...
		  $.ajax({
				...
				success: function(jsonData) {
					if(jsonData && jsonData.ajax_status == "1"){
						...
						remarks = ReplaceAll(remarks,"#t#","\t");
						remarks = ReplaceAll(remarks,"#r#","\r");
						remarks = ReplaceAll(remarks,"#n#","\n");
