 ...
 * @author Wang Hao
 */
public class SalesReportAction extends MobileBaseAction {
...
//		}
		...
		entity.setAll_price(BigDecimal.valueOf(Double.parseDouble(price)).multiply(BigDecimal.valueOf(Long.parseLong(count))));
		...
		super.getFacade().getKonkaMobileSailDataService()
				.createKonkaMobileSailDataForHis(entity);
