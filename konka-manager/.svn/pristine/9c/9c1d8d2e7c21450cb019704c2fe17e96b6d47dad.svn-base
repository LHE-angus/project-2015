...
<div class="oarcont"> 
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcBcompPdUpNew" enctype="multipart/form-data" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3"> 
        <tr >
            ...
            <td width="88%" align="left"><html-el:select property="added_dept_id" styleId="added_dept_id" disabled="${readonly}">
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right">商品名称：</td>
          <td align="left">${af.map.pd_name}</td>
        </tr>
        <tr>
          <td class="title_item" nowrap="nowrap" align="right"><font color="red">* </font>上架日期：</td>
          <td>
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right"><font color="red">* </font>下架日期：</td>
         ...
         <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>上架所属：</td>
        ...
        <tr>
          <td class="title_item" align="right">主图：</td>
          <td><c:if test="${not empty af.map.goods_id}">
        ...
        <tr>
          <td class="title_item" align="right">图片：</td>   
...
$(document).ready(function(){
	...
	$("#added_dept_id").attr("datatype", "Require").attr("msg", "请选择组织！");


	$(".plat_sys").change(function(){  
		if($(this).val()=="0"){
			$("#added_dept_id option:eq(1)").css({"display":"block"});
		}else if($(this).val()=="1"){
			$("#added_dept_id option:eq(1)").css({"display":"none"});     
		}
