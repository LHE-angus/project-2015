...
<form action="<c:url value='/Payment2.do' />" method="post" id="pay_form" target="_blank">
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center" style="width:550px;margin-top:70px;">
  	 <tr>
  		...
  		<td width="30%"><p style="margin-top:10px;font-size:12px;">稍后支付&gt;&gt;<a href="${ctx }/member/center/Orders.do?">进入订单中心</a></p></td>
	  </tr>
...
$(document).ready(function(){ 
	...
	$(document).delegate("#heckOrderStatus", "click", function(){
		location.href = "${ctx}/Payment2.do?method=checkOrderStatus&trade_index=${af.map.trade_index}"
	}); 
