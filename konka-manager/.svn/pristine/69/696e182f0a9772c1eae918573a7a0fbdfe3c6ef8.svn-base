...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<c:forEach var="cur" items="${entityList}" varStatus="vs">
		<tr class="tabtt2" align="center">
			...
			<td><span style="cursor: pointer;" class="fblue" onclick="doNeedMethod(null,'KonkaMobileSailDataBill.do', 'viewFinalAudit','id=${cur.switch_id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())">查看</span></td>
