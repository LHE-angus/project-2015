...
<div id="navTab" class="tabsPage" style="text-align:left;">
  <div class="navTab-panel tabsPageContent">
    <div class="pageContent">
      <html-el:form action="/admin/SelectKonkaR3Shop">
        <html-el:hidden property="queryString" styleId="queryString" />
        <html-el:hidden property="method" styleId="method" value="save" />
        <html-el:hidden property="category_r3" styleId="category_r3"/>
...
function getQueryNames() {
   	...
   	$.ajax({
		type: "POST",
		cache: false,
		url: "${ctx}/manager/admin/SelectKonkaR3Shop.do",
		data: "method=" + "getQueryNames" + "&keyword=" + $("#key_word").val() + "&category_r3="+  $("#category_r3").val() +"&dls_r3_id="+$("#dls_r3_id").val(),
		dataType: "json",
