...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/zmd/KonkaXxZmdRemitAdd">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="1" class="rtable3">
        <tr>
          <td colspan="2" style="font-weight:bold;font-size:18px;height:40px;text-align:center;border-bottom:none;">添加汇款计划</td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="1" class="rtable2">
              ...
              <c:forEach var="cur" items="${konkaXxSellBillList}" varStatus="vs">
                <tr>
                  <td align="center" nowrap="nowrap"><c:if test="${cur.pay_way eq 1}">
                      <html-el:checkbox property="xxx_${cur.sell_bill_id}" styleId="${cur.sell_bill_id}_${cur.total_money}" styleClass="bill_values" />
                    </c:if>
                    <c:if test="${cur.pay_way eq 3}">
                      <html-el:checkbox property="xxx_${cur.sell_bill_id}" styleId="${cur.sell_bill_id}_${cur.money_of_deposit}" styleClass="bill_values" />
                    </c:if></td>
        ...
        <tr>
          <td width="25%" nowrap="nowrap" class="title_item" align="right">计划汇款总金额：</td>
          <td colspan="5" align="left"><html-el:hidden property="total_money" styleId="total_money" />
