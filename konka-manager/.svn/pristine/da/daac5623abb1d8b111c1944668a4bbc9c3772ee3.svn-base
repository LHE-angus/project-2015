...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaDeptJbTask" method="post" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rtable3">
        <tr>
          ...
          <td><input type="file" name="up_load_file" id="up_load_file" style="width:250px" />
            &nbsp;&nbsp;&nbsp; <a href="${ctx}/files/template/excel/konka_dept_jb_task.xls" target="_blank">模板下载</a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
