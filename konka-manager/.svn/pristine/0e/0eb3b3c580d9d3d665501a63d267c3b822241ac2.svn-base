...
public class JxcKonkaOrderRegisterAction extends BaseJxcAction {
	...
	public ActionForward list(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		konkaOrderInfo.setShop_id(user.getStdEntpMain().getShop_id());
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		dynaBean.set("userShopName", user.getStdEntpMain().getEntp_name());
		dynaBean.set("userZip", user.getStdEntpMain().getPostcode());
		dynaBean.set("userAddr", user.getStdEntpMain().getAddr());
		dynaBean.set("userTel", user.getStdEntpMain().getTel());
		// dynaBean.set("userPIndex", user.getStdEntpMain().getP_index());
		super.setprovinceAndcityAndcountryToFrom(dynaBean, user.getStdEntpMain().getP_index().longValue());
		...
		HashMap<String, String> result = super.getKonkaDeptIdAndType(user.getStdEntpMain().getShop_id(), true);
	...
	public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		konkaOrderInfo.setAdd_user_id(user.getUser_id());
...
//							String url = "http://sms.mymyty.com/webservice/MerchantSendSms.do";
							// String url = "http://192.168.0.29:8085/webservice/MerchantSendSms.do";
							...
							String content = user.getStdEntpMain().getEntp_name() + "于" + dateTime
			...
			HashMap<String, String> result = super.getFacade().getKonkaOrderInfoService().createKonkaOrderInfo(
					konkaOrderInfo);// 保存订单与短信接口返回值

			String inputline = result.get("sendResult");
			logger.info("Send Message return result : {}", inputline);
