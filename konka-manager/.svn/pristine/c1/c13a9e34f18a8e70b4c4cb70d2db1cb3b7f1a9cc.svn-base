          ...
          <c:forEach items="${bcomp_pd_list_top_5}" var="cur" varStatus="vs">
            ...
            <li style="padding:0;" class="${li_class}">
              <div class="listpic1 box_117_80" style="height:110px;">
              	<table border="0" cellspacing="0" cellpadding="0" width="120"><tr><td height="110" style="overflow:hidden;" width="120" valign="middle" align="center"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img src="${ctx}/${cur.main_pic}" align="absmiddle"  width="100"/></a></td></tr></table>
              </div>
              <div class="listrxt1">
                <h3><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><font style="font-size:13px;">康佳${fnx:abbreviate(cur.pd_sn, 2 * 7, '.')}<br/><c:if test="${not empty cur.pd_size }">${fn:escapeXml(cur.pd_size)}英寸</c:if></font></a></h3>
      ...
      <div class="listbox2">
        <div class="listbox3">
          <form id="listForm" name="listForm" method="post" action="KonkaBcompPd.do" >
            ...
            <h3 class="lsitit2">商品筛选    <c:if test="${not empty af.map.prod_type  }">-</c:if> <c:if test="${af.map.prod_type eq 0  }">电视</c:if><c:if test="${af.map.prod_type eq 1  }">白电</c:if><c:if test="${af.map.prod_type eq 3  }">小家电</c:if><c:if test="${af.map.prod_type eq 10  }">配件</c:if> </h3>
            <ul class="listul5">
              <!-- 
          	<li id="topFilter" style="display:none;"><strong>您已选择：</strong>
          	  ...
          	  <li><strong>产品品牌：</strong> <a href="#" ${empty af.map.brand_name ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="brand_name_class" title="">全部</a><a href="#" ${af.map.brand_name eq 'KONKA' ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="brand_name_class" title="KONKA,康佳">KONKA</a> <a href="#" ${af.map.brand_name eq 'KKTV' ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="brand_name_class" title="KKTV,康佳">KKTV</a><a href="#" ${af.map.brand_name eq 'HYUNDAI' ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="brand_name_class" title="HYUNDAI,康佳">HYUNDAI</a> </li>
          	 <c:if test="${af.map.prod_type eq 0 or empty af.map.prod_type }"><li><strong>产品品类：</strong> <a href="#" ${empty af.map.pd_type ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_type_class" title="">全部</a><a href="#" ${af.map.pd_type eq 4 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_type_class" title="4,4K电视">4K电视</a> <a href="#" ${af.map.pd_type eq 1 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_type_class" title="1,3D电视">3D电视</a><a href="#" ${af.map.pd_type eq 2 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_type_class" title="2,智能电视">智能电视</a><a href="#" ${af.map.pd_type eq 9 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_type_class" title="9,其他">其他</a>  </li>
              <li><strong>屏幕尺寸：</strong> <a href="#" ${empty af.map.pd_size_type ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="">全部</a> <a href="#" ${af.map.pd_size_type eq 31 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="31,32英寸以下">32英寸以下</a> <a href="#" ${af.map.pd_size_type eq 32 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="32,32英寸">32英寸</a> <a href="#" ${af.map.pd_size_type eq 37 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="37,37英寸">37英寸</a> <a href="#" ${af.map.pd_size_type eq 39 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="39,39英寸">39英寸</a> <a href="#" ${af.map.pd_size_type eq 42 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="42,42英寸">42英寸</a> <a href="#" ${af.map.pd_size_type eq 47 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="47,47英寸">47英寸</a> <a href="#" ${af.map.pd_size_type eq 50 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="50,50英寸">50英寸</a> <a href="#" ${af.map.pd_size_type eq 55 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="55,55英寸">55英寸</a> <a href="#" ${af.map.pd_size_type eq 56 ? "style='background: #FF6600;color:#fff;padding:2px;'":""} class="pd_size_type_class" title="56,55英寸以上">55英寸以上</a> </li>
      ...
      <tbody>
        <tr>
          ...
          <td><div class="listul2">
              <div class="rpic2 box"><a title="" href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img alt="" src="${ctx}/${fn:substringBefore(cur.main_pic, '.')}.jpg" align="absmiddle" style="max-height:216px;" width="288"/></a></div>
              <div class="ltt2" ><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" title="${fn:escapeXml(cur.pd_name)}">
              ...
              <div class="ltt3"><c:if test="${ecUser.user_type eq 1 }">
                <p style="color:#666666;"><font color="#d40207" style="font-size:12px;">￥<a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" style="color:red;font-size:18px;font-family:arial,宋体b8b\4f53;"><fmt:formatNumber value="${cur.map.price}" pattern="0" />
                </a></font>&nbsp; <del >市场价：￥<fmt:formatNumber value="${cur.map.original_price}" pattern="0" /></del></c:if>
                <c:if test="${ecUser.user_type eq 2 }">
                <p style="color:#666666;"><font color="#d40207" style="font-size:12px;">￥<a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" style="color:red;font-size:18px;font-family:arial,宋体b8b\4f53;"><fmt:formatNumber value="${cur.map.original_price}" pattern="0" />
                </a></font>&nbsp; </c:if>
