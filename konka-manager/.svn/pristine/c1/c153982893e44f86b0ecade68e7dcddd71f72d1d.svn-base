...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/AuditFiles" enctype="multipart/form-data">
      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tr>
          <td width="120" align="center" class="td_bord">申请负责人</td>
          <td>${fn:escapeXml(af.map.apply_user_name)}&nbsp;</td>
          <td width="80" align="center" class="td_bord">电　　话</td>
          <td width="140">${fn:escapeXml(af.map.apply_user_tel)}&nbsp;</td>
          <td width="80" align="center" class="td_bord">编　　号</td>
          <td width="122">${fn:escapeXml(af.map.file_no)}&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td nowrap="nowrap"><c:forEach var="cur" items="${category12List}" varStatus="vs">
          ...
          <c:forEach var="cur" items="${filesAuditNodeList}" varStatus="vs">
            ...
            <tr>
              ...
              <td align="center">
                ...
                <c:if test="${empty cur.audit_datetime}"><span style="color:#f00">未审批</span> </c:if></td>
              <td align="center">
                <c:if test="${not empty cur.audit_datetime}">
              ...
              <c:if test="${empty cur.audit_comment}"><span style="color:#f00">未审批</span> </c:if></td>
    ...
    <div> <br />
      ...
      <html-el:button property="" value="打印" styleClass="websub" styleId="btn_print" onclick="$('#btn_back').hide();$('#btn_print').hide();$('.tabsPageHeader').hide();window.print();$('#btn_back').show();$('#btn_print').show();$('.tabsPageHeader').show();" />
      </label>
    </div>
  </div>
  <div class="clear"></div>
