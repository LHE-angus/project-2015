        ...
        <div class="tg_l">
          <div class="tg_left">
            <div class="tg_k">
              ...
              <div class="tg_cn"><img src="${ctx}/styles/member/images/but_buy2.gif" width="117" height="51" id="pic1"  data="${cur.id}"/></div>
              <div class="tg_down">
                <ul>
                  <li>原价<br>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="606" style="margin-left:-145px;">
              <tr>
                <td height="317" style="overflow:hidden;" width="606" valign="middle" align="center">
                  <a href="<c:url value='/member/LzPdBuy.do?method=view&goods_id=${cur.id}' />">
