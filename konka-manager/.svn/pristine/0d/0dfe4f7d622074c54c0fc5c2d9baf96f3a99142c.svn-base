  		...
  		<tr>
  			<td width="100%" valign="top" >
			      ...
			      <c:set var="total_money" value="0" />
	  			  ...
	  			  <c:set var="total_rw_money" value="0" />
			      <c:forEach items="${entityList}" var="cur" varStatus="vs">
			        <tr>
			          ...
			          <td align="right" nowrap="nowrap"><span class="kz-price-12"><fmt:formatNumber value="${cur[2]}" type="currency" /></span></td>
			          <td align="right" nowrap="nowrap">${cur[3]}</td>
			          <td align="center" nowrap="nowrap">${cur[6]}%</td>
			        </tr>
...
$(document).ready(function(){
	...
	if(${not empty entityList}){
		   ...
		   chart.setDataURL("${ctx}/manager/admin/KonkaR3OrderRank.do?method=chart_100");		
