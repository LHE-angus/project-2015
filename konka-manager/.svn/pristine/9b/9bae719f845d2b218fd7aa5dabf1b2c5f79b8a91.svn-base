      ...
      <html-el:select property="size_section" styleId="size_section" >
       ...
       <html-el:text property="add_date_start" styleId="add_date_start" size="7" maxlength="10" readonly="true" styleClass="webinput" style="cursor:pointer;" onclick="new Calendar(2005, 2030, 0).show(this);" />
        ...
        <td> <strong>门店名称：</strong>
         <html-el:text property="store_name_like" maxlength="30"></html-el:text></td>
  ...
  <div class="rtabcont1">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
      <tr class="tabtt1">
        ...
        <td nowrap="nowrap"  align="center" width="10%">促销活动名称</td>
        <td nowrap="nowrap"  align="center" width="10%">预约点名称</td>
        ...
        <c:forEach var="cur" items="${entityList}" varStatus="vs">
          <tr>
           ...
           ${cur.map.dept_name}
            ...
            <td align="left"nowrap="nowrap" title="${cur.sp_name}">  
           <a href="${ctx}/manager/admin/KonkaSpActivityManager.do?method=view&mod_id=986010&id=${cur.sp_id}"
					style="text-decoration: underline;">
            ${fn:escapeXml(cur.sp_name)}</a></td>
            <td align="left"nowrap="nowrap" title="${cur.addr_name}">
