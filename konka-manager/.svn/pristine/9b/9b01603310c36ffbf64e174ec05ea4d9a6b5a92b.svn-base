      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          ...
          <td>
          	...
          	<html-el:text property="customer_name_like" size="25" maxlength="40" styleId="customer_name_like" />
          	...
          	<html-el:text property="real_name_like" size="25" maxlength="40" styleId="real_name_like" />
          </td>
