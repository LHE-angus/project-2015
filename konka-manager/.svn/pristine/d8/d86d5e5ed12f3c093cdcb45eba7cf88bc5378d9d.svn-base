...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/EcVouchers">
      <html-el:hidden property="method" value="list" />
      <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
        <tr>
          <td height="36" align="left" style="padding-left:5px;">
          			&nbsp;&nbsp;购物券名称  ： <html-el:text property="title_like" styleId="title_like" maxlength="30" styleClass="webinput" />&nbsp;&nbsp;
  ...
  <div class="rtabcont1">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					&nbsp;<!-- <input type="button" class="but2" value="新 增" onclick="location.href='EcVouchers.do?method=add&mod_id=${af.map.mod_id}';" /> -->
				</td>
			</tr>
		</table>		
	</div>
  <div class="rtabcont1">
      ...
      <c:forEach items="${entityList}" var="cur" varStatus="vs">
        <tr>
          ...
          <td align="center" nowrap="nowrap"> 
         	<a  class="fblue" href="javascript:doNeedMethod(null, 'EcVouchers.do', 'view', 'id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize());">查看</a>
         	<!--   <span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'EcVouchers.do','edit' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">修改</span> 
          	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod('您确定删除吗？', 'EcVouchers.do','delete' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">删除</span> -->
          </td>
        </tr>
      </c:forEach>
    </table>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="EcVouchers.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
