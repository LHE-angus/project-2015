...
<div class="oarcont">
  ...
  <div class="rtabcont1" >
    <table class="rtable2" width="100%" border="0" cellspacing="1" cellpadding="0">
      ...
      <tr>
        <td colspan="8" align="center"><html-el:button property="1" value="返 回" styleClass="but5" styleId="btn_back" onclick="location.href = '${ctx}/customer/manager/PdShow.do?method=list&own_sys=${af.map.own_sys}&mod_id=${af.map.mod_id}' " /></td>
      </tr>
    </table>
  </div>
</div>
