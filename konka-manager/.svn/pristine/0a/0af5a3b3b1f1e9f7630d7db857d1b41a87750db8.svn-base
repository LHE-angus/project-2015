          ...
          <td><table style="padding-left:15px;border:1px solid #CCCCCC">
              <tbody>
                ...
                <tr>
                  ...
                  <td width="88%" align="left"><html-el:select property="branch_area_name" styleId="branch_area_name">
						         	<html-el:option value="">请选择</html-el:option>
                ...
                <tr>
                  ...
                  <td width="88%" align="left"><html-el:text property="r3_code" size="40" maxlength="30" styleId="r3_code" />
                   &nbsp;<span style="color:#f00;display:none;" id="r3_code_exist_error"><span style="color:red">*</span>该R3编码已存在，请重新输入！</span></td>
                </tr>
                <tr>
