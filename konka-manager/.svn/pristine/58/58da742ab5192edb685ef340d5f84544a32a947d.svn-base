...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/spgl/KonkaGroupPeArticleInfoNew" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          <td nowrap="nowrap" class="title_item">资讯标题：</td>
        ...
        <c:if test="${empty type_id}">
          <tr>
            <td nowrap="nowrap" class="title_item">资讯类别：</td>
        ...
        <tr>
            ...
            <td><html-el:select property="msg_info_type" styleId="msg_info_type">
        ...
        <tr id="select_5">
          <td nowrap="nowrap" class="title_item" align="left">选择群组：</td>
          <td><html-el:select property="group_id" styleId="group_id">
              <html-el:option value="">--请选择--</html-el:option>
              <html-el:option value="-1">全部</html-el:option>
              <c:forEach items="${konkaPeArticleUserGroupList}" var="cur" varStatus="vs">
                <html-el:option value="${cur.group_id}">${cur.group_name}</html-el:option>
              </c:forEach>
            </html-el:select></td>  
        </tr>
         <tr >
            <td width="12%" nowrap="nowrap" class="title_item" align="left">所属组织：</td>  
            <td width="88%" align="left"><html-el:select property="dept_id" styleId="dept_id" disabled="${readonly}">
              ...
              </html-el:select><font color="red">* </font> 
            </td>
          </tr>
        <tr>
...
$(document).ready(function(){
  ...
  $("#group_id").attr("dataType", "Require").attr("msg", "请选择群组！");
  $("#article_type_id").attr("dataType", "Require").attr("msg", "请选择资讯类别！");
 ...
 $("a[id^='att_del_']").click(function() {
  var a = this;
   if(!confirm('确实要删除此附件？')) return;
    $.post("KonkaGroupPeArticleInfoNew.do", { method : "deleteFile", id : $(this).attr("id").replace(/att_del_/g, '')}, function(success) {
