...
<link rel="stylesheet" type="text/css" href="${ctx}/styles/shop/qqonline/css/qqonline_blue.css" /> 
<script type="text/javascript" src="${ctx}/styles/shop/qqonline/jquery.Sonline.js"></script>
<style type="text/css">
.float_div{
	position: absolute;
...
.app_div div{margin-top: 0px;}
	...
	<div class="top-2" ><c:if test="${ecUser.user_type eq 1 }">
	    <div class="p1" style="margin-top:6px;"><img src="${ctx}/styles/shop/images/pingtai.jpg" height="65"  /></div></c:if>
	    <c:if test="${ecUser.user_type eq 2 }">
	     <div class="p1" style="margin-top:6px;"><img src="${ctx}/styles/shop/images/pingtai2.jpg" height="65"  /></div></c:if>	    
	    <div class="p2">
	   	 <form method="post" action="<c:url value='/shop/KonkaBcompPd.do' />" id="search_form_top">
	      <div class="p2-1">
	        <input type="text"  name="pd_sn_or_pd_name_like" id="pd_sn_or_pd_name_like" value="${search_pd_name}"  maxlength="50" />
	      </div>
	      <div class="p2-2"><img id="search_btn_sub_top" src="${ctx}/styles/shop/images/search.jpg" height="28" width="91" /></div>
	  	 </form>
	    </div>
	    <div class="p3"> <img src="${ctx}/styles/shop/images/tel.jpg" height="33" width="166" /> </div>
	    <div class="p4">
	    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size:9px;">
	    	<tr>
	   		<td width="50%" align="center"><a href="http://weibo.com/konka" target="_blank"><img src="${ctx}/styles/shop/images/weibo01.png" /></a></td>
	    	<td width="50%" align="center"><img id="weixin" src="${ctx}/styles/shop/images/weixin01.png"  /></td>
	    	</tr>
...
<img src="${ctx}/styles/shop/images/weixin_code.jpg"  /> 
</div>
<div class="app_div" id="appPanel" style="display:none;z-index:10000;position:absolute;">
<img src="${ctx}/styles/shop/images/app_code.jpg"  width="147"  /> 
</div>
...
$(function(){$("body").Sonline({
	...
	Qqlist:"3010785153|客服01,2291790018|客服02,2949037121|客服03,2822530662|客服04"
	});})
</script>