...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" id="table">
  <tr>
        ...
        <tr>
          <td align="center" bgcolor="#FFFFFF"><table width="960" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td valign="top"><html-el:form action="/leader/Login.do?method=login" method="post" styleClass="form_class">
                    <html-el:hidden property="url" value="${url}" />
                    <table width="260" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="50" valign="top"><span class="gldl">用户登录</span></td>
                      </tr>
                      <tr>
    ...
    网站管理：多媒体渠道管理部 | 运营电话：0755-26608866-6303 | 粤ICP备05059413</div></td>
        </tr>
      </table></td>
  </tr>
</table>
