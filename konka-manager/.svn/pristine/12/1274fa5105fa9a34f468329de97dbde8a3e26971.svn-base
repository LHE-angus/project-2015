...
<div class="mainbox">
<div class="maincont">  
<html-el:form action="/mobile/center/User" enctype="multipart/form-data">
         ...
         <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top"><html-el:radio property="is_own" value="1">是</html-el:radio><html-el:radio property="is_own" value="0">否</html-el:radio>  
              <br/><font color="red" style="line-heght:0px;">注： 发放佣金时，如绑定为本人的银行卡，将连同工资计算扣税，如绑定为非本人的银行卡，将按劳务费扣税 .  </font>
            </td>
          </tr>         
         </table> 
