package com.weixin.popular.util;
...
import com.weixin.popular.bean.pay.PayJsRequest;
import com.weixin.popular.bean.pay.PayNativeReply;
import com.weixin.popular.bean.pay.PayNativeRequest;
import com.weixin.popular.bean.pay.PayPackage;
