...
<link rel="stylesheet" type="text/css" href="${ctx}/styles/zxmall/register/css/global.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/styles/zxmall/register/css/css.css" />
<style type="text/css">
...
<div class="top_cont">
<div class="t_c">
<div class="logo" style="margin-top:10px;"><span class="l" style="margin-top:5px;"><img src="${ctx}/styles/zxmall/images/k_logo1.gif" width="429" height="25" /></span><span class="r"><img src="${ctx}/styles/zxmall/images/tel.gif" width="166" height="33" /></span></div>
</div>
</div>
</div>
<div class="clear"></div>
<div class="content">
<div class="cont_a">
<font class="inf">注册会员身份验证</font> 
  <div class="confir">
  <html-el:form action="/Register">
  <html-el:hidden property="method" styleId="method" value="nextStep" />
  <html-el:hidden property="id"/>
  <%@ include file="/commons/pages/messages.jsp" %>
  <div class="login_int1"><label><span><i class="lg_redStar">&nbsp;*&nbsp;</i>公司名称：</span><html-el:text property="company_name" styleClass="reUser_text" styleId="company_name" maxlength="15" /></label></div>
  <div class="login_int1"><label><span><i class="lg_redStar">&nbsp;*&nbsp;</i>姓名：</span><html-el:text property="zxmall_name" styleClass="reUser_text" styleId="zxmall_name" maxlength="15" /></label></div>
  <div class="login_int1"><label><span><i class="lg_redStar">&nbsp;*&nbsp;</i>工卡号：</span><html-el:text property="card_no" styleClass="reUser_text" styleId="card_no" maxlength="15" /></label></div>
  <div class="login_int1"><label>
  ...
  <label class="re_agreed"><input class="xz" id="xycheck" type="checkbox"  />&nbsp;我已阅读， 同意以下协议并注册 <font class="xiyi"><a href="javascript:openStaticPopup()">《EPP平台会员注册协议》</a></font></label>
...
<p>本协议是您与康佳EPP内部优惠购机平台网站（简称“本站”，网址：epp.konka.com）所有者（以下简称为“康佳EPP平台”）就康佳EPP平台网站服务等相关事宜所订立的契约。</p>
<p>在此特别提醒，请您仔细阅读、充分理解本注册协议各条款。请您审慎阅读并选择是否接受本协议，除非接受所有条款，否则用户无权使用康佳EPP平台所提供的服务。点击“同意以下协议并注册”按钮后，本协议即构成对双方有约束力的法律文件。</p>
<p>一、本站服务条款的确认和接纳</p>
<p>（一）本站各项电子服务的所有权属康佳EPP平台所有。用户同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有规定或约定的，依其约定。</p>
...
<p>（四）康佳EPP平台保留在中华人民共和国大陆地区法施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消订单的权利。</p>
<p>二、本站服务</p>
<p>（一）康佳EPP平台通过互联网依法为用户提供互联网信息等服务，用户在完全同意本协议及本站规定的情况下，方有权使用本站的相关服务。</p>
<p>（二）用户须自行准备如下设备和承担如下费用：</p>
<p>1、上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他必备的上网装置。</p>
<p>2、上网费用，包括并不限于网络接入费、上网设备租用费、手机流量费等。</p>
<p>三、用户信息</p>
<p>（一）用户应如实向本站提供注册资料，注册资料如有变动的，应及时更新。如提供的注册资料不合法、不真实、不准确、不详尽的，用户须承担因此引起的相应责任及后果，并且康佳EPP平台保留终止用户使用康佳EPP平台各项服务的权利。</p>
...
<p>（四）用户同意，康佳EPP平台拥有通过邮件、短信电话等形式，向在本站注册、购物用户、收货人发送订单信息、促销活动等告知信息的权利。</p>
<p>（五）用户不得将在本站注册获得的账户借给他人使用，否则用户应承担由此产生的全部责任，并与实际使用人承担连带责任。</p>
<p>（六）用户同意，康佳EPP平台有权使用用户的注册信息、用户名、密码等，登陆进入用户的注册账户，进行证据保全，包括但不限于公证、见证等。</p>
<p>四、用户依法言行义务</p>
...
<p>五、商品信息</p>
<p>本站商品价格、数量、是否有货等商品信息随时都有可能发生变动，本站不作特别通知。网站商品信息数量庞大，本站会尽最大努力保证您所浏览商品信息的准确性，由于互联网技术因素等客观原因存在，本站网页显示的信息可能会有一定的滞后性或差错，对此情形您知悉并理解；康佳EPP平台欢迎纠错，并会视情况给予纠错者一定的奖励。为表述便利，商品和服务简称为“商品”或“货物”。</p>
<p>六、订单</p>
...
<p>八、所有权及知识产权条款</p>
<p>（一）一旦接受本协议，即表明该用户主动将其在任何时间段在本站发表的任何形式的信息（包括但不限于客户评价、客户咨询、各类话题文章等信息内容）的财产性权利等任何可转让的权利，如著作权财产权（包括并不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权以及应当由著作权人享有的其他可转让权利），全部独家且不可撤销地转让给康佳EPP平台所有，用户同意康佳EPP平台有权就任何主体侵权而单独提起诉讼。</p>
<p>（二）本协议已构成《中华人民共和国著作权法》第二十五条（条文序号依照2011年版著作权法确定）及相关法律规定的著作财产权等权利转让书面协议，其效力及于用户在康佳EPP平台网站上发布的任何受著作权法保护的作品内容，无论该等内容形成于本协议订立前还是本协议订立后。</p>
<p>（三）用户同意并已充分了解本协议的条款，承诺不将已发表于本站的信息，以任何形式发布或授权其它主体以任何方式使用。（包括但限于在各类网站、媒体上使用）</p>
<p>（四）康佳EPP平台是本站的制作者,拥有此网站内容及资源的著作权等合法权利,受国家法律保护,有权不时地对本协议及本站的内容进行修改，并在本站张贴，无须另行通知用户。在法律允许的最大限度范围内，康佳EPP平台对本协议及本站内容拥有解释权。</p>
<p>（五）除法律另有规定，未经康佳EPP平台书面许可,任何单位或个人不得以任何方式非法全部或部分复制、转载、引用、链接、抓取或以其他方式使用本站的信息内容，否则，康佳EPP平台有权追究其法律责任。</p>
<p>（六）本站资料信息（诸如文字、图表、标识、按钮图标、图像、声音文件片段、数字下载、数据编辑和软件），均为康佳EPP平台或其内容提供者的财产，受中国和国际版权法的保护。本站上所有内容的汇编是康佳EPP平台的排他财产，受中国和国际版权法的保护。本站上所有软件都是康佳EPP平台或其关联公司或其软件供应商的财产，受中国和国际版权法的保护。</p>
<p>九、责任限制及不承诺担保</p>
<p>除非另有书面说明,本站及其所包含的或以其它方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务，均为在"按现状"和"按现有"的基础上提供。</p>
<p>除非另有书面说明,康佳EPP平台不对本站的运营及其包含在本网站上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保。（根据中华人民共和国法律另有规定的以外）</p>
<p>康佳EPP平台不担保本站所包含的或以其它方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务、其服务器或从本站发出的电子信件、信息没有病毒或其他有害成分。</p>
<p>如因不可抗力或其它本站无法控制的原因使本站销售系统崩溃或无法正常使用导致网上交易无法完成或丢失有关的信息、记录等，康佳EPP平台会合理地尽力协助处理善后事宜。</p>
<p>十、协议更新及用户关注义务</p>
<p>根据网站运营需要，康佳EPP平台有权对本协议条款进行修改，修改后的协议一旦被张贴在本站上即生效，并代替原来的协议。用户可随时登陆查阅最新协议；用户有义务不时关注并阅读最新版的协议及网站公告。如用户不同意更新后的协议，可以且应立即停止接受本网站提供的服务；如用户继续使用，视为同意更新。康佳EPP平台建议您在使用本站之前阅读本协议及本站的公告。 如果本协议中任何一条被视为废止、无效或因任何理由不可执行，该条应视为可分的且并不影响任何其余条款的有效性和可执行性。</p>
<p>十一、法律管辖和适用</p>
...
<p>（二）康佳EPP平台尊重用户和消费者的合法权利，本协议及本网站上发布的各类规则、声明等其他内容，均是为了更好地为用户和消费者服务。本站欢迎用户和社会各界提出意见和建议，康佳EPP平台将虚心接受并适时修改本协议及本站上的各类规则。</p>
<p>（三）点击本协议左侧的“我已看过并接受《用户注册协议》”按钮即视为您完全接受本协议，在点击之前请您再次确认已知悉并完全理解本协议的全部内容。</p>
			</div>
		</div>
		<a class="close" onclick="$.closePopupLayer('myStaticPopup')" title="关闭窗口">阅读完毕，关闭窗口</a>
	</div>
</div>
</div>
</div>
