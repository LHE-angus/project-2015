...
<div class="maincont margintop10">
  <div class="position"><a href="<c:url value='/touch/Index.do' />">首页</a> &gt; <a href="<c:url value='/touch/EcGift.do' />">积分商城</a> &gt; 康佳&nbsp;<c:out value="${ecGift.pd_sn}" /></div>
  <div class="viewbox1">
    <jsp:include page="../__inc/ec_gift_images.jsp" flush="true" />
    <!-- 表单开始 -->
    <form action="<c:url value='/touch/EcGift.do' />" id="form_pd_buy" method="post">
    ...
    <div class="viewright">
      ...
      <div class="viewtab2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="proxltab">
          <tbody>
            <tr>
              <td><div class="padtop20">&nbsp;&nbsp;<img alt="立即兑换" src="${ctx}/styles/touch/images/but_jifen.jpg" style="cursor:pointer;" id="buy_btn" /></div></td>
            </tr>
          </tbody>
        </table>
      </div>
