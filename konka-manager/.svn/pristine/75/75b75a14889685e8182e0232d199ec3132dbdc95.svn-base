  ...
  <div class="rtabcont1">
      ...
      <table class="rtable3" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td align="left" colspan="3">${af.map.map.par_partner_name }</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3">******************** （注：默认密码为“888888”）</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">
            <html-el:button property="" value="返 回" styleClass="but5" styleId="btn_back" onclick="goback();" /></td>
        </tr>
      </table>
  </div>
</div>
