  		...
  		<html-el:form action="/spgl/PdShow" enctype="multipart/form-data" method="post">
  			...
  			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
  				<tr>
	          		...
	          		<td>${af.map.dept_id eq 0?'多媒体事业本部':af.map.dept_name}</td>
	          	</tr>
	          	<tr>
	          	...
	          	<tr>
	          		...
	          		<td><html-el:text property="up_date" styleId="up_date" styleClass="webinput" size="10" readonly="true" style="cursor:pointer;"/></td>
	          	</tr>
	          	<tr>
	          		<td class="title_item" nowrap="nowrap">下架日期：</td>
	          		<td><html-el:text property="down_date" styleId="down_date" styleClass="webinput" size="10" readonly="true" style="cursor:pointer;" /></td>
	          	</tr>
	          	<tr>
	          		<td class="title_item" nowrap="nowrap">尺寸：</td>
	          		<td>${af.map.pd_size}<c:if test="${not empty af.map.pd_size}">英寸</c:if></td>
	          	</tr>
	          	<tr>
	          		...
	          		<td>
	          			<c:if test="${not empty af.map.id}">
	          				<div id="main_pic_div" class="main_box">
		          				<div class="pic_box">
		          					<a id="main_pic_a" href="${ctx}/${af.map.main_pic_file}" title="用创新赢的尊严！">
					       						...
					       						<li id="pic_${vs.count}_li" class="box" style="display:inline-table;margin:5px 0px 5px 20px">
				       								<div class="pic_box">
						       							<a rel="group" href="${ctx}/${cur}" title="康佳彩电">
						       								<img src="${ctx}/${fn:substringBefore(cur, '.')}_120.jpg" />
						       							</a>
	          	...
	          	<tr>
	          		<td align="center" colspan="2">
	          			<input class="but4" type="button" name="Submit4" value="上架" id="btn_submit" />
