  ...
  <div class="rtabcont2">
    ...
    <html-el:form action="/zmd/KonkaXxZmdReturnSalesOrder">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="rtable3">
        ...
        <!-- 商品信息Begin -->
        <tr>
          <td colspan="4" style="font-weight:900;">商品明细清单
          	<!-- （<span style="cursor:pointer;" class="fblue" onclick="location.href='KonkaXxZmdSearchSalesOrder.do?method=showDetail&mod_id=${af.map.mod_id}&sell_bill_id=${af.map.sell_bill_id}';" >导出明细</span>） -->
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="6" height="40"  align="center">          	
          	<input class="but4" type="button" name="Submit4" value="退货" id="btn_submit" />
