...
<div class="rtabcont1">
  <html-el:form action="/KonkaJxcJnhmAllowance">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableTop">
	  ...
	  &nbsp;&nbsp;产品型号：
        <html-el:text property="pd_name_like" styleId="pd_name_like" maxlength="10"></html-el:text>
          &nbsp;&nbsp;<span style="color:#f00;">*</span>销售日期：
...
<c:url value="" var="expPara">
  ...
  <c:if test="${not empty entityList}">
	<div class="rtabcont1">
	<html-el:form action="/KonkaJxcJnhmAllowance.do${expPara}">
...
<div class="rtabcont1">
    <div align="center" style="height:30px;font-size:20px;font-weight:bolder;">
     ${af.map.sell_date_eq}${customer_name}节能惠民补贴统计</div>
