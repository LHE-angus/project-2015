...
<div class="rtabcont1">
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      <tr>
          <td width="10%" nowrap="nowrap"><strong class="fb">&nbsp;&nbsp;&nbsp;&nbsp;创建时间：</strong>
            ...
            &nbsp;<strong class="fb">当年零售规模：</strong>
          		<html-el:text property="sale_money_gt" styleId="sale_money_gt" size="9" styleClass="webinput" onfocus="javascript:setOnlyInt(this);" />
          		 -&nbsp;
          		<html-el:text property="sale_money_lt" styleId="sale_money_lt" size="9" styleClass="webinput" onfocus="javascript:setOnlyInt(this);" />&nbsp;万元
  ...
  <div class="rtabcont1">
      <a href="${ctx}/manager/admin/KonkaR3ShopHomePage.do">客户分布</a>&nbsp;&nbsp;<a href="${ctx}/manager/admin/KonkaR3StoreHomePage.do" style="background: #FF6600;color:#fff;padding:3px;">门店分布</a>
      &nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">//<![CDATA[
   ...
   function map_show(){
	...
	function showDetails(value){
		...
		var url = "${ctx}/manager/admin/KonkaR3StoreHomePage.do?method=view&province=" + province;
		url += "&add_date_start=" + $("#add_date_start").val();
		url += "&add_date_end=" + $("#add_date_end").val();
		url += "&sale_money_gt=" + $("#sale_money_gt").val();
		url += "&sale_money_lt=" + $("#sale_money_lt").val();
