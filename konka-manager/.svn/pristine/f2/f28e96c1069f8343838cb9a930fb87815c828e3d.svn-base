...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
    <html-el:form action="/spgl/TouchOrderDetail">
       ...
       <tr> 
        ...
        <tr><td width="100%" nowrap="nowrap">
            ...
            <html-el:select property="pay_way" styleId="pay_way" style="width:120px;">
             ...
             &nbsp;<strong class="fb">R3_CODE：</strong>&nbsp;
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2">
        <tbody>
          ...
          <!--   <td width="10%" nowrap="nowrap" align="center">下单人姓名</td> -->
            <td width="10%" nowrap="nowrap" align="center">R3_CODE</td>
           ...
           <!--  <td width="10%" nowrap="nowrap" align="center">支付单号</td> -->
            ...
            <td width="7%" nowrap="nowrap" align="center">订单来源</td>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
	         ...
	         <td align="center">
		     <c:choose>
             <c:when test="${cur.pay_way eq 9 }"> 触网2
			 </c:when>
			 <c:otherwise> 触网1
			 </c:otherwise>
             </c:choose>
             ...
             <%--  <td align="center">
              ...
              <td align="center" nowrap="nowrap">
              	<span style="cursor:pointer;" class="fblue" onclick="doNeedMethod(null, 'TouchOrderDetail.do','view' ,'id=${cur.id}&' + $('#bottomPageForm').serialize())">查看</span>
              </td>
            </tr>
