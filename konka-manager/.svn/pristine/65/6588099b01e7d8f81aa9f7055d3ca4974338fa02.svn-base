...
<div class="oarcont" id="body_oarcont">
  ...
  <div class="rtabcont1">
	<div style="padding:10px 5px;">
	  ...
	  <div id="show1" style="display:none"> 请选择人员：
  ...
  <div class="rtabcont1">
	...
	<div style="width:100%;height:500px;display:none;" id="expDate">
	   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable2" id="datatab">
		   <tr class="tabtt1">
...
function showInfoWindow(_marker, name, phone, date) {
	...
	info[info.length] = '</span><br /><br /><b>手机号码：</b>';
	info[info.length] = phone;
	info[info.length] = '<br /><br /><b>时　　间：</b>';
	info[info.length] = date;
	info[info.length] = '<br /><br /><b>位　　置：</b>';
