  ...
  <div class="rtabcont2">
    <html-el:form action="/admin/KonkaPlanRatio">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
        ...
        <tr>
          <td height="28" width="15%" nowrap="nowrap" class="title_item">经办：</td>
          <td><html-el:select property="dept_sn" styleId="dept_sn" onchange="">
          	<html-el:option value="">请选择</html-el:option>
          </html-el:select></td>
        </tr>
        <tr>
          <td height="28" width="15%" nowrap="nowrap" class="title_item">任务系数：</td>
          <td><html-el:text property="ratio" styleId="ratio" size="20" maxlength="6" onfocus="javascript:setOnlyNum(this);" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><label>
			...
			success: function(ret) {
				if(ret){
					...
					for(var i=0; i<ret.list.length; i++){			
						if(ret.list[i].dept_sn == "${af.map.dept_sn}"){
