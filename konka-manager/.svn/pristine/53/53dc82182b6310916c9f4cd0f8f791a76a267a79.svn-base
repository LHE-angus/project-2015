...
<div class="oarcont" id="body_oarcont">
  <div class="oartop">
   ...
   <div class="rtabcont1">
      <html-el:form action="/spgl/EcArticleInfo">
    ...
    <html-el:form action="/spgl/EcArticleInfo?method=delete">
      <div class="rtabcont1">
       <logic-el:match name="popedom" value="+4+"> 
        ...
        <input type="button" class="but2" name="add" value="添加 " onclick="location.href='EcArticleInfo.do?method=add&mod_id=${af.map.mod_id}';" />
        </logic-el:match>
        <html-el:hidden property="mod_id" value="${af.map.mod_id}" />
          ...
          <tr>
            ...
            <td align="center" nowrap="nowrap"> 
                 <logic-el:match name="popedom" value="+2+"> 
              	<a href="#" onclick="confirmUpdate(null, 'EcArticleInfo.do', 'id=${cur.id}&mod_id=${af.map.mod_id}&' + $('#bottomPageForm').serialize())">修改</a>
              	</logic-el:match>
            	 ...
            	 <span style="color: #ccc">修改</span>
              	 ...
              	 | 
              	  <logic-el:match name="popedom" value="+4+"> 
                <a href="#" onclick="confirmDelete(null, 'EcArticleInfo.do', 'mod_id=${af.map.mod_id}&id=${cur.id}&pager.requestPage=${af.map.pager.requestPage}')">删除</a>
            	</logic-el:match>
    ...
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="../spgl/EcArticleInfo.do">
