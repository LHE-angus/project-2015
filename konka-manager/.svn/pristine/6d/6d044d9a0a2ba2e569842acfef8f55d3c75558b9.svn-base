...
<jsp:include page="/shop/__inc/_nav.jsp" flush="true" />
<div class="hotsell" style="margin-bottom:5px;">
	<div class="hotsell_l" style="width:876px;">
        ...
        <c:forEach items="${bcomp_pd_list_tj_5}" var="cur" varStatus="vs"  end="4">
        	<ul>
            	<li><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img src="${ctx}/${cur.main_pic}" width="160" height="105" /></a></li>
                <li class="name"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><span style="word-wrap: break-word; word-break: break-all;">${fnx:abbreviate(cur.pd_name, 2 * 25, '')}</span></a></li>
    ...
    <div class="hotsell_r" style="width:316px;">
    	<div class="information" style="width:316px;">
		    ...
		    <iframe border="0" src="${ctx }/shop/FlvPlayer.do?method=showImg&id=838505&height=249" frameborder="0" marginheight="0" marginwidth="0" width="312" height="249" scrolling="no"></iframe>
		    </div>
	    </div>
    </div> 
</div>
...
<div class="logo2">
  <div class="lef"><a href="${ctx}/shop/KonkaBcompPd.do?label_of_cate=0">更多</a></div>
</div> 
  ...
  <div class="m1-l">
    <table border="0" width="1200" height="608"  cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="276" width="294px"><div class="com"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}&nbsp;${cur.pd_name}"><img src="${ctx}/${cur.main_pic}" height="216" width="288"/></a>
           <div class="price">
	         <a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}&nbsp;${cur.pd_name}">康佳<c:out value="${cur.pd_sn}" /> 
...
<div class="logo5">
  <div class="lef"><a href="${ctx}/shop/KonkaBcompPd.do?label_of_cate=7">更多</a></div>
</div>
...
<div class="logo3">
  <div class="lef"><a href="${ctx}/shop/KonkaBcompPd.do?label_of_cate=2">更多</a></div>
</div>
...
<div class="clear"></div> 
<div class="logo4">  <div class="lef"><a href="${ctx}/shop/KonkaBcompPd.do?label_of_cate=3">更多</a></div></div>
<div class="main1" style="height:308px;">
  <div class="m1-l">
    <table border="0" width="1200" height="308"  cellspacing="0" cellpadding="0">
      <tr>
...
<div class="tab">
  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#e3e3e3" >
    ...
    <c:forEach items="${bcomp_pd_list_top_8}" var="cur">
      <td align="center">
      <div class="sz"><a title="${cur.pd_name}" href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />"><img alt="${cur.pd_name}" height="92" width="128" src="${ctx}/${cur.main_pic}" style="max-height:100px;" /></a></div>
      <div style="text-align:center; margin-top:10px;"><a href="<c:url value='/shop/PdShow.do?goods_id=${cur.id}' />" title="康佳${cur.pd_sn}" style="font-size:13px;font-color:#666666;">康佳&nbsp;${fnx:abbreviate(cur.pd_sn, 2 * 7, '.')}</a></div>
      </td> 
    </c:forEach>
    </tr>
  </table>
