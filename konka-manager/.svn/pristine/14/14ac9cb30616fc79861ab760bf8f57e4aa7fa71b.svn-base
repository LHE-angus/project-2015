...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <html-el:form action="/oa/ExpenseClaims" enctype="multipart/form-data">
      ...
      <html-el:hidden property="is_node_fg" value="${af.map.is_node_fg} "/>
            ...
            <td nowrap="nowrap"><div id="audits">
                ...
                <c:if test="${not empty filesAuditNodeList}">
                  ...
                  <div style="">
                    ...
                    <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" value="${cur.audit_user}" style="width:60%;vertical-align:middle;" />
                    <img onclick="selectUser(this);" src="${ctx}/images/search.gif" style='cursor: pointer;vertical-align:middle;' alt='选择人员' title="选择人员" /> <span style="color:red">&nbsp;*</span> </div>
                </c:if>
                <c:if test="${empty filesAuditNodeList}">
                  <div style="">
                    <input type="hidden" name="audit_user_id" id="audit_user_id" />
                    <input type="text" name="audit_user_name" id="audit_user_name" readonly="readonly" style="width:60%;vertical-align:middle;" />
                    <img onclick="selectUser(this);" src="${ctx}/images/search.gif" style='cursor: pointer;vertical-align:middle;' alt='选择人员' title="选择人员" /> <span style="color:red">&nbsp;*</span></div>
                </c:if>
              </div></td>
