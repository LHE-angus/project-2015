...
<body style='margin:0 auto;width:900px'>
	...
	<div style="margin:0 auto;border:1px dashed red; width:800px">
		<div id="p_div" >
		<table width="100%" border="0" >
			...
			<tr>
			    <td colspan="3" align="left" style="font-size: 12px;">送货地址(电话):${orderinfo.user_addr }&nbsp;${orderinfo.user_tel }&nbsp;${orderinfo.user_phone }</td>
