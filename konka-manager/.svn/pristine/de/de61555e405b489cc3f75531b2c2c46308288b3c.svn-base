...
<div class="oarcont">
  ...
  <div class="rtabcont2">
  	<html-el:form action="/admin/KonkaSpTask" enctype="multipart/form-data">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" class="rtable1">
      	<tr>
      		...
      		<td><input class="but_excel" type="button" name="btn_submit" id="btn_submit" value="导入" />&nbsp;<span id="searchTip" style="color:red;">备注：导入成功后，您的Excel文件数据将覆盖原有数据，请仔细检查excel数据是否正确</span></td>
      	</tr>
      	<tr>
      		<td colspan="3"><a style="cursor:pointer;color:blue;" href="${ctx}/files/upload/konka_sp_task_import_template.xls">Excel模板下载</a></td>
      	</tr>
      </table>
    </html-el:form>
  </div>
