...
<div class="oarcont">
  ...
  <div class="rtabcont2">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3">
      ...
      <tr>
        <td width="12%" class="title_item" nowrap="nowrap">简介：</td>
        <td align="left">${af.map.brief}</td>
      </tr>
       <tr>
        <td width="12%" class="title_item" nowrap="nowrap">内容：</td> 
      ...
      <tr>
        <td nowrap="nowrap" class="title_item">投票记录</td>
        <td align="left">   
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr><td>序号</td><td>投票人</td><td>时间</td></tr>
        	<c:forEach items="${af.map.ecVoteRecordList}" var="cur" varStatus="vs">
         	<tr><td>${vs.count}</td><td>${cur.user_name}</td><td><fmt:formatDate value="${cur.add_date}"  pattern="yyyy-MM-dd HH:ss"></fmt:formatDate></td></tr>
       		</c:forEach>
        </table>
        </td>
      </tr>
