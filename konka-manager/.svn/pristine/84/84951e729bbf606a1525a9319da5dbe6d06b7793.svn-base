...
<div id="navTab" class="tabsPage" style="text-align:left;">
	<div class="navTab-panel tabsPageContent">
		<div class="pageContent">
			<html-el:form action="/manager/KonkaR3MmtMatch.do">
				...
				<table width="100%" border="0" align="left" class="list">
					<tr>
						<td>
					          &nbsp;R3分类：
					            <html-el:select property="is_sdf" styleId="is_sdf" style="width:70px;" onchange="getQueryNames($('#key_word').val());">
                  					...
                  					<td>
                    					...
                    					<html-el:select property="select1" multiple="true" style="width:290px;height:258px;" styleId="select1" onchange="moveSelected(this.form.select1, this.form.select2);">
                      						<c:forEach var="cur" items="${entityList}" varStatus="vs">
                        						<option value="${cur.map.l4_dept_id}_${cur.map.l4_dept_name}_${cur.map.ywy_user_name}_${cur.map.customer_name}_${cur.map.customer_type}_${cur.map.customer_type_name}_${cur.map.job_id}_${cur.map.r3_code}">${cur.map.customer_name}</option>
                      						</c:forEach>
                    					</html-el:select>
                    				</td>
                  					<td>
