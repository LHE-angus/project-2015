...
<div class="maincont">
  ...
  <div class="sfmall_right padbot45">
    <div class="position"><a href="${ctx }/sfmall/Index.do">首页</a> &gt; <a href="${ctx }/sfmall/center/Index.do">会员中心</a> &gt; <a href="${ctx }/sfmall/center/Orders.do">我的订单</a> </div>
    <div class="sfmalltab3">
      <p style="margin-top:15px;font-size:16px;"> 我的订单</p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="sfmall_form_table0"  style="border:1px solid #e3e3e3;">
        <tr >
        ...
        <tr>
          ...
          <c:if test="${af.map.pay_way ne 0 and  af.map.pay_way ne 1}">
             <c:if test="${af.map.state eq 0 }">&nbsp;&nbsp; &nbsp;&nbsp; <a class="btn btn-4" href="<c:url value='/sfmall/Payment.do?trade_index=${af.map.trade_index}' />"><s></s>付款</a></c:if>
             </c:if>
          </td>
        </tr>
      </table>
      ...
      <table id="tbl1" width="100%" border="0" cellpadding="0" cellspacing="0" class="sfmall_form_table0" >
      ...
      <table id="tbl2" width="100%" border="0" cellpadding="0" cellspacing="0" class="sfmall_form_table0" style="border:1px solid #e3e3e3;display:none;" >
        <tr>
          <td align="left">付款方式：
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="sfmall_form_table0" style="border:1px solid #e3e3e3;" >
        <tr>
...
$(document).ready(function(){  
  ...
  $("#syncBtn").click(function(){
		...
		$.ajax({
			type: "post",
			url: "${ctx}/sfmall/center/Orders.do?method=sfList",
			data: {"id" : id},
			dataType: "json",
