...
<body style="font-family:Microsoft Yahei;">
  ...
  <html-el:form action="/manager/JBill.do">
    <html-el:hidden property="method" value="listForOther" />
    ...
    <div class="rtabcont1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable1">
        <tr>
        	...
        	<td>
          		<html-el:text property="opr_date_gt" size="12" maxlength="10" readonly="true" title="点击选择日期" styleClass="Wdate" style="cursor:pointer;" onclick="WdatePicker({readOnly:true})" />
            	-
            	<html-el:text property="opr_date_lt" size="12" maxlength="10" readonly="true" title="点击选择日期" styleClass="Wdate" style="cursor:pointer;" onclick="WdatePicker({readOnly:true})" />
            </td>
        	<td nowrap="nowrap" align="right">
				<strong class="fb">
        ...
        <tr>
        	<td nowrap="nowrap" align="right"><strong class="fb">供应商名称：</strong></td>
        	<td><html-el:text property="p_name_like" styleClass="webinput" styleId="p_name_like" maxlength="30" size="20"/></td>
        	<td nowrap="nowrap" align="right"><strong class="fb">供应商编码：</strong></td>
			...
			<td nowrap="nowrap" colspan="2" align="center">
				...
				<input type="button" class="but_excel" onclick="if(confirm('提示，您确认导出数据？')){doNeedMethod(null, 'JBill.do', 'listForOther', 'export=true&' + $('#bottomPageForm').serialize())}" value="导出" />
			</td>
        </tr>
      </table>
    </div>
        ...
        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <script type="text/javascript">
		            ...
		            pager.addHiddenInputs("method", "listForOther");
