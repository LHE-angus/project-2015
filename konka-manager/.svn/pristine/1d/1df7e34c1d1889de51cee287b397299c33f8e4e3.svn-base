...
<div class="oarcont"> 
  <div class="rtabcont2">
    <html-el:form action="/spgl/EcGoodsIntegralNew" enctype="multipart/form-data" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rtable3"> 
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" width="12%" align="right">商品编码：</td>
          <td align="left">${af.map.pd_sn}</td>
        </tr>
         <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>积分类型：</td>
          <td width="88%" align="left">
          <html-el:select property="integral_type" styleId="integral_type" disabled="${readonly}">
         		<html-el:option value="">-请选择-</html-el:option>
         ...
         <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>计算方式：</td>
          <td width="88%" align="left">
          <html-el:select property="integral_way" styleId="integral_way" disabled="${readonly}" >
         		<html-el:option value="">-请选择-</html-el:option>
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right" width="12%"><font color="red">* </font>积分值：</td>
          <td align="left"><html-el:text property="integral_value"  styleId="integral_value"/> <span id="point_b_type" style="font-size:15px;"></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right" width="12%"><font color="red">* </font>有效开始日期：</td>
          <td>
        ...
        <tr>
          <td class="title_item" nowrap="nowrap" align="right" width="12%"><font color="red">* </font>有效截止日期：</td>
         ...
         <tr>
          <td width="12%" nowrap="nowrap" class="title_item" align="right"><font color="red">* </font>积分所属：</td>
          <td width="88%" align="left">
        ...
        <tr>
          		<td class="title_item" nowrap="nowrap" align="right" width="12%">状态：</td>
          		<td>
...
$(document).ready(function(){
	...
	$("#integral_value").attr("datatype", "Require").attr("msg", "请填写积分值！").attr("focus",setOnlyPosNum);  
	$("#integral_type").attr("datatype", "Require").attr("msg", "请选择积分类型！");
	$("#integral_way").attr("datatype", "Require").attr("msg", "请选择计算方式！");
	$("#own_sys").attr("datatype", "Require").attr("msg", "请选择所属系统！");
	
	$("#integral_way").change(function(){
