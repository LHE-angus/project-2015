...
public class LoginAction extends BaseAction {
	...
	public ActionForward showLoginForm(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		// sysSetting.setTitle("VersionOfManage");
		...
		// request.setAttribute("VersionOfManage", sysSetting.getContent() ==
		// null ? "v14.1.2" : sysSetting
		// .getContent());
		// }
		...
		if (null != userInfo) {
			return mapping.findForward("successleader");
		}
		return new ActionForward("/leader/login.jsp");
	}
	...
	public ActionForward login(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (!userInfo.getPass_word().equals(entity.getPass_word())) {
			...
			if (checkPassword(password) < 7) {
				ActionForward af = mapping.findForward("successleader");
